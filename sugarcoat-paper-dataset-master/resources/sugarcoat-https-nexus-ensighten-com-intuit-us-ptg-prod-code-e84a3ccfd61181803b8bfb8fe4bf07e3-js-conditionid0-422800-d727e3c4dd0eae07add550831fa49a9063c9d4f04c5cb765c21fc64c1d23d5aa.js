  ...
  (function () {
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        _linkedin_partner_id = ['71656', '24214'];
        window._linkedin_data_partner_ids = window._linkedin_data_partner_ids || [];
        for (i = 0; i < _linkedin_partner_id.length; i++)
          window._linkedin_data_partner_ids.push(_linkedin_partner_id[i]);
        (function () {
          ...
          Bootstrapper.data.define(
            {
              extract: function () {
                ...
                var parts = value.split('; pcg_nilla=');
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        var ids = [];
        ids.push('DC-8264798');
        ids.push('AW-1053758848');
        ids.push('AW-1070354288');
        ids.push('AW-1030533779');
        var url =
    ...
    Bootstrapper.bindImmediate(
      function () {
        var Bootstrapper = window['Bootstrapper'];
        var ensightenOptions = Bootstrapper.ensightenOptions;
        var phoneEle = document.querySelectorAll('a[href*="tel"]');
        var nmbrMtrx = {
          8448779422: 'rTapNumber420010',
          8448185400: 'rTapNumber420018',
          8448804648: 'rTapNumber420011',
          8445918071: 'rTapNumber420024',
          8669428348: 'rTapNumber420019',
          8448183677: 'rTapNumber420014',
          8776824254: 'rTapNumber420017',
          8448779425: 'rTapNumber420016',
          8448247164: 'rTapNumber420022',
          8002007599: 'rTapNumber420015',
          8447392127: 'rTapNumber420021',
          8448185401: 'rTapNumber420012',
          8447392129: 'rTapNumber420023',
          8447392128: 'rTapNumber420020',
          8448183676: 'rTapNumber420013',
        };
        try {
          for (var i = 0; i < phoneEle.length; i++) {
            var phoneKey = phoneEle[i].innerText.replace(/[^0-9]/g, '');
            if (phoneKey && nmbrMtrx[phoneKey])
              if (phoneEle[i].hasAttribute('class'))
                phoneEle[i].className += ' ' + nmbrMtrx[phoneKey];
              else phoneEle[i].className = nmbrMtrx[phoneKey];
          }
        } catch (err) {}
      },
      3391598,
    ...
    Bootstrapper.bindImmediate(
      function () {
        ...
        window._elqQ.push(['elqSetSiteId', '113755760']);
    ...
    Bootstrapper.bindImmediate(
      function () {
            ...
            ie = function (e, t) {
              return {
                corsMetadata: (function () {
                  const $___old_6b569e425c1bc479 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    ),
                    $___old_26de31670dddb905 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                  try {
                    if ($___old_6b569e425c1bc479)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_d666925c34f35308.XMLHttpRequest
                      ));
                    if ($___old_26de31670dddb905)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_d666925c34f35308.XMLHttpRequest
                    ...
                    if ($___old_6b569e425c1bc479)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_6b569e425c1bc479
                      ));
                    if ($___old_26de31670dddb905)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_26de31670dddb905
                      ));
                  }
                })(),
                getCORSInstance: function () {
                  const $___old_604bb7a893235ce0 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    ),
                    $___old_30ced853cb041b31 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                  try {
                    if ($___old_604bb7a893235ce0)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_d666925c34f35308.XMLHttpRequest
                      ));
                    if ($___old_30ced853cb041b31)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_d666925c34f35308.XMLHttpRequest
                    ...
                    if ($___old_604bb7a893235ce0)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_604bb7a893235ce0
                      ));
                    if ($___old_30ced853cb041b31)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_30ced853cb041b31
                      ));
                  }
                },
        ...
        function getCookie (name) {
          var theCookieName = new RegExp(name + '=([^;]+)');
          var theCookieValue = theCookieName.exec(document.cookie);
          return theCookieValue != null ? unescape(theCookieValue[1]) : null;
        }
        ...
        var ividValue = getCookie('ivid');
        if (ividValue)
          visitor.setCustomerIDs({
            IVID: { id: ividValue, authState: Visitor.AuthState.UNKNOWN },
          });
    ...
    Bootstrapper.bindDOMParsed(
      function () {
        ...
        var cookieDomain = '' || location.host,
          cookieExpiration = new Date(new Date().setDate(new Date().getDay() + 90)).toUTCString(),
          gclid = Bootstrapper.getQueryParam('gclid');
        if (gclid) {
          var cookieVal = [
            'GCL',
          ...
          document.cookie =
            ...
            ';path=/;domain=' +
            cookieDomain;
          if (Bootstrapper.getQueryParam('gclid'))
            document.cookie =
              '_gcl_dc' +
              '=' +
              cookieVal +
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        fbq('init', '781169042408060');
        var pcg_nilla = Bootstrapper.data.resolve('62448');
        fbq('track', 'PageView', { segment_ids: pcg_nilla });
      },
      3307268,
      639166
    );
    Bootstrapper.bindDOMLoaded(
      function () {
        Bootstrapper.ensEvent.add(['beacon_aam_ccpa'], function () {
          ...
          try {
            ...
            if (storedVal && storedVal !== sentVal) {
              ...
              var pubPath = Bootstrapper.ensightenOptions.publishPath;
              var src = 'web',
                org = 'ptg',
                env = /[-_]dev$/i.test(pubPath) ? 'dev' : 'prd',
                ccpa = sentVal;
              if (ccpa && ccpa !== '') {
                var url =
                  '//turbotax.demdex.net/event' +
                  '?c_xintuit_org=' +
                  org +
                  '&c_xintuit_env=' +
                  env +
      ...
      function () {
        ...
        try {
          var adiInit = null,
            adiFunc = null,
            adiRVO = true,
            adiCookieSuffix = null;
          if (
            window.location.host === 'quickbooks.intuit.com' ||
            window.location.host === 'www.intuit.com'
          ) {
            adiInit = '59671';
            (function () {
              ...
              adiSrc.src =
                ('https:' == document.location.protocol
                  ? 'https://static-ssl'
                  : 'http://static-cdn') + '.responsetap.com/static/scripts/rTapTrack.min.js';
              var s = document.getElementsByTagName('script')[0];
              s.parentNode.insertBefore(adiSrc, s);
            })();
          } else if (window.location.host === 'proconnect.intuit.com') {
            window.adiInit = '73286';
            window.adiCookieSuffix = 'proconnect';
            (function () {
              var adiSrc = document.createElement('script');
              adiSrc.type = 'text/javascript';
              adiSrc.async = true;
              adiSrc.src =
                ('https:' == document.location.protocol
                  ? 'https://static-ssl'
                  : 'http://static-cdn') +
                '.responsetap.com/static/scripts/rTapTrackCookieOverride.min.js';
              var s = document.getElementsByTagName('script')[0];
              s.parentNode.insertBefore(adiSrc, s);
            })();
          }
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        var pcg_nilla = Bootstrapper.data.resolve('62448');
        var type = 'async',
          custom_conversion_id = '659601465',
          custom_conversion_label = '',
          local_params = {};
        local_params['aam'] = ensVar0.call(this);
        if (type === 'async')
