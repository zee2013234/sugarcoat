      ...
      var z = /:[0-9]+$/,
        ...
        D = function (a, b) {
          ...
          'port' === b
            ...
            : 'host' === b &&
              (a.hostname = (a.hostname || u.location.hostname).replace(z, '').toLowerCase());
        ...
        C = function (a, b, c, d, e) {
          ...
          switch (b) {
            case 'url_no_fragment':
              ...
              a &&
                a.href &&
                ((d = a.href.indexOf('#')), (d = 0 > d ? a.href : a.href.substr(0, d)));
              a = d;
              break;
            case 'protocol':
              a = f;
    ...
    (function () {
      ...
      $c.prototype.encode = function () {
        ...
        for (b = 0; b < a.length; b++)
          a[b] = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_'.charAt(
            a[b] || 0
          );
        return a.join('') + '~';
      };
      ...
      var ea = function (a) {
        ...
        ra = function () {
          const $___old_859f67b6724481f0 = {}.constructor.getOwnPropertyDescriptor(
            Navigator.prototype,
            'userAgent'
          );
          try {
            if ($___old_859f67b6724481f0)
            ...
            return function () {
              for (
                ...
                a += c-- ^ b++;
              return [hd() ^ (La(a) & 2147483647), Math.round(new Date().getTime() / 1000)].join(
                '.'
              );
        ...
        Id = function (a, b, c) {
          if (a) {
            ...
            if (c) {
              ...
              f.test(a) && M.write('<script' + c + e + ' src="' + a + '"></script>');
            } else
        ...
        ya = function (a, b) {
          ...
          if (/^(https?|android-app):\/\//i.test(c)) {
            ...
            if (!de(c, a))
              return b && ((b = a.replace(/\./g, '-') + '.cdn.ampproject.org'), de(c, b))
                ? void 0
                : c;
          }
        },
          ...
          e.onload = function () {
            ...
            if (4 == e.readyState) {
              try {
                ...
                g.optOut
                  ? (J(63), Qc('', '$OPT_OUT', 31536000000))
                  : g.clientId
                  ? Qc(g.clientId, g.securityToken, 31536000000)
                  : !c && g.alternateUrl
                  ? (Ga && clearTimeout(Ga), (Fa = !0), Pc(a, b, g.alternateUrl))
                  : (J(64), Qc('', '$NOT_FOUND', 3600000));
              } catch (ca) {
                J(65), Qc('', '$ERROR', 30000);
              }
              e = null;
        ...
        ye = function (a) {
          a: {
            if (ja.test(M.referrer)) {
              ...
              (d = b === c) ||
                ((c = '.' + c), (d = b.substring(b.length - c.length, b.length) === c));
              if (d) {
                b = !0;
                break a;
              } else J(78);
      ...
      var bd = function (a) {
        ...
        wd = function (a, b, c, d) {
          const $___old_7088cd082770e544 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'XMLHttpRequest'
            ),
            $___old_87ebdd8773f43bde = {}.constructor.getOwnPropertyDescriptor(
              window,
              'XMLHttpRequest'
            );
          try {
            if ($___old_7088cd082770e544)
              ({}.constructor.defineProperty(
                window,
                'XMLHttpRequest',
                $___stub_afd3abb015d4d981.XMLHttpRequest
              ));
            if ($___old_87ebdd8773f43bde)
              ({}.constructor.defineProperty(
                window,
                'XMLHttpRequest',
                $___stub_afd3abb015d4d981.XMLHttpRequest
            ...
            if ($___old_7088cd082770e544)
              ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_7088cd082770e544));
            if ($___old_87ebdd8773f43bde)
              ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_87ebdd8773f43bde));
          }
        },
        Ea = function (a, b, c) {
      ...
      function Ja (a) {
        if (100 != a.get(Ka) && La(P(a, Q)) % 10000 >= 100 * R(a, Ka)) throw 'abort';
      }
      function Ma (a) {
      ...
      var Qb = T('_oot'),
        ...
        Zb = T('cookieExpires', void 0, 63072000),
        ...
        mc = function (a) {
          if ('cookie' == P(a, ac)) {
            ...
            if (a.get(je)) {
              var c = P(a, ce);
              if (c) {
                var d = Math.min(R(a, he), 1000 * R(a, Zb));
                ...
                g && 'aw.ds' != g
                  ? b && (b.ua = !0)
                  : ((c = ['1', e, Cc(c)].join('.')),
                    0 < d && (b && (b.ta = !0), zc('_gac_' + Cc(k), c, ca, l, k, d, a)));
                le(b);
              }
            } else J(75);
          }
      ...
      function af (a) {
        ...
        if (c && a.get(je)) {
          var d = b(a.get(fe));
          if (1000 * d + b(a.get(he)) <= new Date().getTime()) J(76);
              ...
              if ((g = d._up))
                (g = Jc.exec(M.referrer))
                  ? ((g = g[1]),
                    ...
                    (g =
                      ca === g || 0 <= ca.indexOf('.' + g) || 0 <= g.indexOf('.' + ca) ? !0 : !1))
                  : (g = !1);
              g = g ? !0 : !1;
            }
            ca = d.gclid;
