  ...
  (function () {
    (function (a) {
      ...
      (b.img_set = 'apple'),
        ...
        (b.inits = {}),
        (b.map = {}),
        (b.replace_emoticons = function (a) {
          return (
            b.init_emoticons(),
            a.replace(b.rx_emoticons, function (a, c, d) {
        ...
        (b.replace_colons = function (a) {
          return (
            b.init_colons(),
            a.replace(b.rx_colons, function (a) {
              ...
              if (c.indexOf('::skin-tone-') > -1) {
                ...
                return g
                  ? b.replacement(g, c, ':', { idx: f, actual: e, wrapper: ':' })
                  : ':' + c + ':' + b.replacement(f, e, ':');
              }
              var g = b.map.colons[c];
        ...
        (b.replace_unified = function (a) {
          return (
            b.init_unified(),
            a.replace(b.rx_unified, function (a, c, d) {
              ...
              return (
                ...
                '\uD83C\uDFFF' == d && (f = '1f3ff'),
                f
                  ? b.replacement(e, null, null, { idx: f, actual: d, wrapper: '' })
                  : b.replacement(e)
              );
            })
          );
        ...
        (b.replacement = function (a, c, d, e) {
          ...
          if (
            ('object' == typeof e &&
              ((f = b.replacement(e.idx, e.actual, e.wrapper)), (g = a + '-' + e.idx)),
            (d = d || ''),
            b.colons_mode)
          )
            return ':' + b.data[a][3][0] + ':' + f;
          var h = c ? d + c + d : b.data[a][8] || d + b.data[a][3][0] + d;
          if (b.text_mode) return h + f;
          if ((b.init_env(), 'unified' == b.replace_mode && b.allow_native && b.data[a][0][0]))
            return b.data[a][0][0] + f;
          if ('softbank' == b.replace_mode && b.allow_native && b.data[a][1])
            return b.data[a][1] + f;
          if ('google' == b.replace_mode && b.allow_native && b.data[a][2])
            return b.data[a][2] + f;
          ...
          if (
            (g &&
              b.variations_data[g] &&
              b.variations_data[g][2] &&
              !b.data[a][9] &&
              b.variations_data[g][2] & b.img_sets[b.img_set].mask &&
              ((i = b.img_sets[b.img_set].path + g + '.png'),
              (l = b.variations_data[g][0]),
              (m = b.variations_data[g][1]),
              (f = '')),
            b.supports_css)
          ) {
            ...
            return b.use_css_imgs
              ? '<span class="emoji emoji-' + a + '"' + j + '>' + k + '</span>' + f
        ...
        (b.init_emoticons = function () {
          if (!b.inits.emoticons) {
            ...
            for (var c in b.emoticons_data) {
              ...
              b.map.colons[b.emoticons_data[c]] &&
                ((b.map.emoticons[d] = b.map.colons[b.emoticons_data[c]]),
                a.push(b.escape_rx(d)),
                d != c &&
                  ((b.map.emoticons[c] = b.map.colons[b.emoticons_data[c]]),
                  a.push(b.escape_rx(c))));
            }
        ...
        (b.init_colons = function () {
          if (!b.inits.colons) {
            (b.inits.colons = 1),
              (b.rx_colons = new RegExp(':[a-zA-Z0-9-_+]+:(:skin-tone-[2-6]:)?', 'g')),
              (b.map.colons = {});
            for (var a in b.data)
        ...
        (b.init_unified = function () {
          if (!b.inits.unified) {
            ...
            b.map.unified = {};
            for (var c in b.data)
              for (var d = 0; d < b.data[c][0].length; d++)
                a.push(b.data[c][0][d]), (b.map.unified[b.data[c][0][d]] = c);
        ...
        (b.init_env = function () {
          const $___old_2cd133dec7ad94ac = {}.constructor.getOwnPropertyDescriptor(
            Navigator.prototype,
            'userAgent'
          );
          try {
            if ($___old_2cd133dec7ad94ac)
            ...
            return function () {
              if (!b.inits.env) {
                if (
                  ...
                  if (
                    a.match(/Mac OS X 10[._ ](?:[789]|1\d)/i) &&
                    !a.match(/Chrome/i) &&
                    !a.match(/Firefox/i)
                  )
                    return void (b.replace_mode = 'unified');
                  if (
                    !b.avoid_ms_emoji &&
                    (a.match(/Windows NT 6.[1-9]/i) || a.match(/Windows NT 10.[0-9]/i)) &&
                    !a.match(/Chrome/i) &&
                    !a.match(/MSIE 8/i)
                  )
                    return void (b.replace_mode = 'unified');
    ...
    var $___var_268e02e6c3acbe72 = (function () {
      function a (a, b) {
        (emoji.use_sheet = !1),
          (emoji.img_set = 'apple'),
          (emoji.img_sets[emoji.img_set].path =
            config.imagesDomain + '/content/images/emoji-data/'),
          (emoji.include_title = !0),
          (emoji.avoid_ms_emoji = !0),
          (emoji.allow_native = b),
          emoji.init_env();
      }
      function b (a) {
        var b = a || document.getElementById('container-wrapper');
        if (b) {
          var d = b instanceof jQuery;
          d
            ? b.each(function () {
                c(this);
              })
      ...
      function c (a) {
        if (a && $.isFunction(document.createTreeWalker)) {
          for (
            var b,
              c,
              d,
              ...
              f = [],
              g = document.createTreeWalker(a, NodeFilter.SHOW_TEXT, null, !1);
            null !== (b = g.nextNode());
            ...
            if (
              ...
              3 === b.nodeType &&
                ...
                'OPTION' !== d.nodeName &&
                'FORM' !== d.nodeName &&
                ('string' != typeof d.className || d.className.indexOf('noemoji') < 0))
            ) {
              var h = b.nodeValue.trim();
              if (h.length > 0) {
                e.innerText = b.nodeValue.replace(/\r?\n|\r/gm, '');
                var i = emoji.replace_emoticons(e.innerHTML);
                (i = emoji.replace_unified(i)),
                  i !== e.innerHTML &&
                    ((e.innerHTML = i),
                    f.push({ node: b, newNodes: e.childNodes }),
                    (e = document.createElement('div')));
              }
            }
          for (var j = 0; j < f.length; j++) {
            for (b = f[j].node, c = f[j].newNodes, d = b.parentNode; c.length > 0; )
              d.insertBefore(c[0], b);
            d.removeChild(b);
          }
        }
      }
      function d (a, b) {
        this.parse(a.children().slice(-b));
      }
      function e (a, b) {
        this.parse(a.children().slice(b));
      }
      return { init: a, parse: b, parseBottomChildren: d, parseTopChildren: e };
    })();
    gagEmoji = $___var_268e02e6c3acbe72;
  })();
}
