  ...
  (function () {
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        if (
          window.qualtricsEnabled &&
          !(document.location.pathname.toLowerCase().indexOf('/signup/') > -1)
        )
          Bootstrapper.bindDOMParsed(function () {
            var sampleRate = '100';
            var zoneID = 'znew2pz3yjx9poggn';
            var QZID = 'ZN_eW2Pz3YjX9PoGGN';
            var brandName = 'intuitsocial';
            var path = document.location.pathname;
            if (
              path === '/priority-circle/' ||
              path === '/priority-circle/resource-center-2/' ||
              path === '/priority-circle/resource-center/' ||
              path === '/priority-circle/training-dashboard/'
            ) {
              zoneID = 'zn0ecd1pjabokgelj';
            ...
            var myElem = document.getElementById(zoneID);
            if (myElem === null) {
              var divCreator = document.createElement('div');
              divCreator.id = zoneID;
    ...
    Bootstrapper.bindImmediate(
      function () {
        ...
        dataElements.pageLoadTime = {
          definition: function (data, config, utils, wa) {
            const $___old_3ecc224e81418b31 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'performance'
            );
            try {
              if ($___old_3ecc224e81418b31)
              ...
              if ($___old_3ecc224e81418b31)
                ({}.constructor.defineProperty(window, 'performance', $___old_3ecc224e81418b31));
            }
          },
        ...
        dataElements.decibelSessionId = {
          runOrder: 'last',
          definition: function (data, config, utils, wa) {
            const $___old_3d08c256b6da6625 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'sessionStorage'
            );
            try {
              if ($___old_3d08c256b6da6625)
                ({}.constructor.defineProperty(
                  window,
                  'sessionStorage',
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        Bootstrapper.ensEvent.add(['US - SBG - QBOA - Accountant Sign In Click'], function () {
          ...
          Bootstrapper.bindDOMParsed(function () {
            ...
            frame.src =
              'https://1996823.fls.doubleclick.net/activityi;src=1996823;type=fmsco864;cat=qboasign;u10=US;ord=1;num=' +
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        Bootstrapper.ensEvent.add(['beacon_segment_identify'], function () {
          var ensEventContext = this;
          if (ensEventContext == window) ensEventContext = undefined;
          var Bootstrapper = window['Bootstrapper'];
          var ensightenOptions = Bootstrapper.ensightenOptions;
          try {
            var sentVal = this.advertising.toString();
            var storedVal = wa.privOptVal || '';
            if (storedVal && storedVal !== sentVal) {
              wa.privOptVal = sentVal;
              var ccpa = Bootstrapper.Cookies.get('ccpa') || null;
              var prefChange = 'ccpa';
              if (ccpa && ccpa !== '')
                if (
                  intuit &&
                  intuit.tracking &&
                  intuit.tracking.ecs &&
                  intuit.tracking.ecs.webAnalytics &&
                  typeof intuit.tracking.ecs.webAnalytics.identify == 'function'
                )
                  intuit.tracking.ecs.webAnalytics.identify({ object_detail: prefChange });
              intuit.tracking.ecs.webAnalytics.track({
                object: 'preferences',
                action: 'updated',
                object_detail: prefChange,
              });
            }
          } catch (err) {}
        });
          ...
          !(function () {
            ...
            'function' != typeof window.DIL &&
              ((window.DIL = function (s) {
                const $___old_41fe82ebc52fc297 = {}.constructor.getOwnPropertyDescriptor(
                    window,
                    'XMLHttpRequest'
                  ),
                  $___old_6e20a9333333c99a = {}.constructor.getOwnPropertyDescriptor(
                    window,
                    'XMLHttpRequest'
                  );
                try {
                  if ($___old_41fe82ebc52fc297)
                    ({}.constructor.defineProperty(
                      window,
                      'XMLHttpRequest',
                      $___stub_c92db3a21e6ea955.XMLHttpRequest
                    ));
                  if ($___old_6e20a9333333c99a)
                    ({}.constructor.defineProperty(
                      window,
                      'XMLHttpRequest',
                      $___stub_c92db3a21e6ea955.XMLHttpRequest
                    ...
                    var E,
                      ...
                      M = {
                        ...
                        getCORSInstance: function () {
                          const $___old_6546b49961ff4690 = {}.constructor.getOwnPropertyDescriptor(
                              window,
                              'XMLHttpRequest'
                            ),
                            $___old_93c8d65665027d80 = {}.constructor.getOwnPropertyDescriptor(
                              window,
                              'XMLHttpRequest'
                            );
                          try {
                            if ($___old_6546b49961ff4690)
                              ({}.constructor.defineProperty(
                                window,
                                'XMLHttpRequest',
                                $___stub_c92db3a21e6ea955.XMLHttpRequest
                              ));
                            if ($___old_93c8d65665027d80)
                              ({}.constructor.defineProperty(
                                window,
                                'XMLHttpRequest',
                                $___stub_c92db3a21e6ea955.XMLHttpRequest
                            ...
                            if ($___old_6546b49961ff4690)
                              ({}.constructor.defineProperty(
                                window,
                                'XMLHttpRequest',
                                $___old_6546b49961ff4690
                              ));
                            if ($___old_93c8d65665027d80)
                              ({}.constructor.defineProperty(
                                window,
                                'XMLHttpRequest',
                                $___old_93c8d65665027d80
                              ));
                          }
                        },
                  ...
                  if ($___old_41fe82ebc52fc297)
                    ({}.constructor.defineProperty(
                      window,
                      'XMLHttpRequest',
                      $___old_41fe82ebc52fc297
                    ));
                  if ($___old_6e20a9333333c99a)
                    ({}.constructor.defineProperty(
                      window,
                      'XMLHttpRequest',
                      $___old_6e20a9333333c99a
                    ));
                }
              }),
      ...
      function () {
        ...
        Bootstrapper.registerDataDefinition(function () {
          Bootstrapper.data.define(
            {
              extract: function () {
                const $___old_9c6d3fbe5a1769db = {}.constructor.getOwnPropertyDescriptor(
                  window,
                  'localStorage'
                );
                try {
                  if ($___old_9c6d3fbe5a1769db)
                    ({}.constructor.defineProperty(
                      window,
                      'localStorage',
            ...
            ie = function (e, t) {
              return {
                corsMetadata: (function () {
                  const $___old_3a8c757789d4310d = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    ),
                    $___old_448f660129422436 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                  try {
                    if ($___old_3a8c757789d4310d)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_c92db3a21e6ea955.XMLHttpRequest
                      ));
                    if ($___old_448f660129422436)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_c92db3a21e6ea955.XMLHttpRequest
                    ...
                    if ($___old_3a8c757789d4310d)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_3a8c757789d4310d
                      ));
                    if ($___old_448f660129422436)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_448f660129422436
                      ));
                  }
                })(),
                getCORSInstance: function () {
                  const $___old_99cf94ebb23abeb8 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    ),
                    $___old_b86f915edee891ba = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                  try {
                    if ($___old_99cf94ebb23abeb8)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_c92db3a21e6ea955.XMLHttpRequest
                      ));
                    if ($___old_b86f915edee891ba)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_c92db3a21e6ea955.XMLHttpRequest
                    ...
                    if ($___old_99cf94ebb23abeb8)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_99cf94ebb23abeb8
                      ));
                    if ($___old_b86f915edee891ba)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_b86f915edee891ba
                      ));
                  }
                },
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        var ensightenOptions = Bootstrapper.ensightenOptions;
        (function () {
          var manageCookieObj = document.getElementById('intuitManageCookies');
          if (manageCookieObj)
            manageCookieObj.addEventListener('click', function (e) {
              e.preventDefault();
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        var param_url = '//ad.doubleclick.net/ddm/adj/N5506.nso.codesrv/B21324452.223563153';
        var query_delimiter = 'other';
        var query_delimiter_optional = ';';
        var parameter_delimiter = ';';
        var parameter_delimiter_optional = '';
        var postBody = '';
        var loadScriptCallback = false;
        var scriptCallback = function () {};
        var custom_params = {};
        custom_params['sz'] = '1x2';
        custom_params['ord'] = parseInt(Math.random() * 1000000000);
        custom_params['dc_lat'] = '';
        custom_params['dc_rdid'] = '';
        custom_params['tag_for_child_directed_treatment'] = '';
        custom_params['tfua'] = '?';
        if (query_delimiter_optional) query_delimiter = query_delimiter_optional;
        if (parameter_delimiter_optional) parameter_delimiter = parameter_delimiter_optional;
        var queryString = '';
        for (var k in custom_params)
          if (k !== '' && custom_params[k] !== '')
            queryString += k + '=' + custom_params[k] + parameter_delimiter;
        queryString = queryString.slice(0, -1);
        param_url += query_delimiter + queryString;
        switch (param_type) {
          case 'image':
            Bootstrapper.imageRequest(param_url);
            break;
          case 'script':
            if (loadScriptCallback) Bootstrapper.loadScriptCallback(param_url, scriptCallback);
            else Bootstrapper.insertScript(param_url);
            break;
          case 'iframe':
            var newFrame = document.createElement('iframe');
            newFrame.src = param_url;
    ...
    Bootstrapper.bindImmediate(
      function () {
        ...
        window.AppMeasurement = function (r) {
          const $___old_c49dcf5ac9343cfc = {}.constructor.getOwnPropertyDescriptor(
            Navigator.prototype,
            'userAgent'
          );
          try {
            if ($___old_c49dcf5ac9343cfc)
              ({}.constructor.defineProperty(
                Navigator.prototype,
                'userAgent',
            ...
            return function () {
              ...
              a.Va = function () {
                const $___old_1e39e9de5b171692 = {}.constructor.getOwnPropertyDescriptor(
                  Navigator.prototype,
                  'userAgent'
                );
                try {
                  if ($___old_1e39e9de5b171692)
                    ({}.constructor.defineProperty(
                      Navigator.prototype,
                      'userAgent',
                      $___stub_fb986baf23da602c.userAgent
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        const $___old_43c644d41a85bcf1 = {}.constructor.getOwnPropertyDescriptor(
            window,
            'XMLHttpRequest'
          ),
          $___old_505681c0e7e44fdb = {}.constructor.getOwnPropertyDescriptor(
            window,
            'XMLHttpRequest'
          );
        try {
          if ($___old_43c644d41a85bcf1)
            ({}.constructor.defineProperty(
              window,
              'XMLHttpRequest',
              $___stub_c92db3a21e6ea955.XMLHttpRequest
            ));
          if ($___old_505681c0e7e44fdb)
            ({}.constructor.defineProperty(
              window,
              'XMLHttpRequest',
              $___stub_c92db3a21e6ea955.XMLHttpRequest
          ...
          return function () {
            var Bootstrapper = window['Bootstrapper'];
            var ensightenOptions = Bootstrapper.ensightenOptions;
            var scriptURL = 'https://marketdataservice.api.intuit.com/v1/beacon.js';
            var req;
            if (window.XMLHttpRequest) req = new window.XMLHttpRequest();
            else req = new window.ActiveXObject('Microsoft.XMLHTTP');
            req.open('GET', scriptURL, true);
            req.setRequestHeader(
              'Authorization',
              'Intuit_APIKey intuit_apikey=prdakyresfsWwwDOBJFu0iasToyULgEx1PyFohAy, intuit_apkey_version=1.0'
            );
            req.onreadystatechange = function () {
              if (req.status == 200 && req.readyState === 4) eval(req.responseText);
            };
            req.send();
          }.apply(this, arguments);
        } finally {
          if ($___old_43c644d41a85bcf1)
            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_43c644d41a85bcf1));
          if ($___old_505681c0e7e44fdb)
            ({}.constructor.defineProperty(window, 'XMLHttpRequest', $___old_505681c0e7e44fdb));
        }
      },
      1588374,
      425408
          ...
          Bootstrapper.data.define(
            {
              extract: function () {
                ...
                switch (
                  ...
                  case dev + 'quickbooks.intuit.com/qb_merchant_service/':
                  case dev + 'quickbooks.intuit.com/oa/launchpad/quickbooks-mac-app/':
                  ...
                  case dev + 'quickbooks.intuit.com/pro-advisor/':
                  case dev + 'quickbooks.intuit.com/online/':
                  case dev + 'quickbooks.intuit.com/online-pos-system/':
                  case dev + 'quickbooks.intuit.com/for-accountants/':
                  case dev + 'quickbooks.intuit.com/oa/launchpad/explorations/online_pos_system/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33298/qb_revel/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33299/qb_revel/':
                  case dev + 'quickbooks.intuit.com/self-employed/':
                  case dev + 'quickbooks.intuit.com/referral/':
                  case dev + 'quickbooks.intuit.com/prod/qb_desktop_migrators/':
                  case dev + 'quickbooks.intuit.com/self-employed/':
                  case dev + 'quickbooks.intuit.com/billing/':
                  case dev + 'quickbooks.intuit.com/sandbox/hackathon/':
                  case dev + 'quickbooks.intuit.com/facts-about-electronic-checks/':
                  case dev + 'quickbooks.intuit.com/credit-card-processing-for-small-business/':
                  ...
                  case dev + 'quickbooks.intuit.com/payments/mobile-payments/get-started/':
                  case dev + 'quickbooks.intuit.com/payments/ecommerce-payment-processing/':
                  case dev + 'quickbooks.intuit.com/v2/reviews/':
                  case dev + 'quickbooks.intuit.com/restaurant-business/':
                  case dev + 'quickbooks.intuit.com/amex/':
                  case dev + 'quickbooks.intuit.com/referral/friend-landing-page/':
                  case dev + 'quickbooks.intuit.com/new_quickbooks_online/':
                  case dev + 'quickbooks.intuit.com/quickbooks-mac-app/':
                  ...
                  case dev + 'quickbooks.intuit.com/oa/t/qbks-6371/b/selfemployed/':
                  case dev + 'quickbooks.intuit.com/rm/cmc35964/premier-comp-2/':
                  case dev + 'quickbooks.intuit.com/rm/cmc35964/premier-comp-4/':
                  case dev + 'quickbooks.intuit.com/ss/right-for-me-trial/':
                  case dev + 'quickbooks.intuit.com/ss/online/compare/':
                  ...
                  case dev + 'quickbooks.intuit.com/rm/cmc35888/premier-comp/':
                  case dev + 'quickbooks.intuit.com/apps/':
                  case dev + 'quickbooks.intuit.com/oa/self-employed-web/':
                  case dev + 'quickbooks.intuit.com/sandbox/self-employed/':
                  case dev + 'quickbooks.intuit.com/purchase-order/':
                  case dev + 'quickbooks.intuit.com/premier/compare/':
                  case dev + 'quickbooks.intuit.com/oa/t/qbks-9840/c/selfemployed/':
                  case dev + 'quickbooks.intuit.com/var/accountants/proadvisor/':
                  case dev + 'quickbooks.intuit.com/accountants/proadvisor/':
                  case dev + 'quickbooks.intuit.com/accountants/':
                    console.log(
                      'pageURL from gateway switch Survey and Feedback: ' +
                        location.host +
                        location.pathname +
                        (location.pathname.substr(-1) == '/' ? '' : '/')
                    );
                    return 'Opinion_Lab_Survey_And_Feedback';
                    break;
                  case dev + 'quickbooks.intuit.com/':
                  case dev + 'quickbooks.intuit.com/aag/accountants/campaigns/client-discounts/':
                  case dev + 'quickbooks.intuit.com/aag/accountants/myown_aag/':
                  case dev + 'quickbooks.intuit.com/abc-test/':
                  case dev + 'quickbooks.intuit.com/accountants/client-discounts/':
                  case dev + 'quickbooks.intuit.com/accountants/client-discounts-pricing/':
                  case dev + 'quickbooks.intuit.com/accountants/intuitaccountants/':
                  case dev + 'quickbooks.intuit.com/accountants/offer/':
                  case dev + 'quickbooks.intuit.com/accountants/offeripd/':
                  case dev + 'quickbooks.intuit.com/accountants/offersocial/':
                  case dev + 'quickbooks.intuit.com/accountants/offerweb/':
                  case dev + 'quickbooks.intuit.com/accountants/payments/':
                  case dev + 'quickbooks.intuit.com/accountants/payroll/quickbooks-full-service/':
                  case dev + 'quickbooks.intuit.com/accountants/payroll/quickbooks-online/':
                  case dev + 'quickbooks.intuit.com/accountants/quickbooks-accountant/':
                  case dev + 'quickbooks.intuit.com/accountants/quickbooks-accountant-desktop/':
                  case dev +
                    'quickbooks.intuit.com/accountants/quickbooks-accountant-desktop-disco/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/':
                  case dev +
                    'quickbooks.intuit.com/accountants/resources/accountant-exclusive-tools/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/advanced-security/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/benefits-for-clients/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/choose-online/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/discounts/':
                  case dev +
                    'quickbooks.intuit.com/accountants/resources/discounts-sign-up-clients/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/discounts-wholesale/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/features/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/features-apps/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/features-payments/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/features-payroll/':
                  case dev +
                    'quickbooks.intuit.com/accountants/resources/features-quickbooks-app/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/financial-advantages/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/game-changing-trends/':
                  case dev +
                    'quickbooks.intuit.com/accountants/resources/learn-quickbooks-accountant/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-bookkeeping/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-books-to-tax/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-client-dashboard/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-document-center/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-payroll-tab/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-proadvisor/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-toolbox/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/tools-your-books/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/training/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/training-certification/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/training-webinars/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/university/':
                  case dev +
                    'quickbooks.intuit.com/accountants/resources/university/training-for-accountants/':
                  case dev +
                    'quickbooks.intuit.com/accountants/resources/university/training-for-clients/':
                  case dev + 'quickbooks.intuit.com/accountants/resources/value-pricing/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed1/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed10/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed2/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed3/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed4/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed5/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed6/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed7/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed8/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed9/':
                  case dev + 'quickbooks.intuit.com/accountants/self-employed-proadvisor/':
                  ...
                  case dev + 'quickbooks.intuit.com/aemafterswitch/':
                  case dev + 'quickbooks.intuit.com/asbdc/':
                  case dev + 'quickbooks.intuit.com/bbt/':
                  case dev + 'quickbooks.intuit.com/business-expenses/':
                  case dev + 'quickbooks.intuit.com/business-type/bigcommerce/':
                  case dev + 'quickbooks.intuit.com/business-type/Personalization_Just_Script/':
                  case dev + 'quickbooks.intuit.com/business-type/project/':
                  case dev + 'quickbooks.intuit.com/business-type/qb-pos/':
                  case dev + 'quickbooks.intuit.com/business-type/shopify/':
                  case dev + 'quickbooks.intuit.com/business-type/square/':
                  ...
                  case dev + 'quickbooks.intuit.com/contact-quickbooks/':
                  case dev + 'quickbooks.intuit.com/costco-internal-member-validation/':
                  case dev + 'quickbooks.intuit.com/currency-converter/':
                  case dev + 'quickbooks.intuit.com/customers/costco-internal-validation/':
                  case dev + 'quickbooks.intuit.com/customers/dang/':
                  case dev + 'quickbooks.intuit.com/customers/future-glory-qbo/':
                  case dev + 'quickbooks.intuit.com/customers/home-ftr-vid/':
                  case dev + 'quickbooks.intuit.com/customers/how-it-works-paypal/':
                  case dev + 'quickbooks.intuit.com/customers/inventory_hro_vid/':
                  case dev + 'quickbooks.intuit.com/customers/inventory-mid-vid/':
                  case dev + 'quickbooks.intuit.com/customers/moran-auto/':
                  case dev + 'quickbooks.intuit.com/customers/mountain-view-general-store/':
                  case dev + 'quickbooks.intuit.com/customers/oa_cookie_drop/':
                  case dev + 'quickbooks.intuit.com/customers/products/':
                  case dev + 'quickbooks.intuit.com/customers/redmond-accounting/':
                  case dev + 'quickbooks.intuit.com/customers/resp_vch_responsivevf':
                  case dev + 'quickbooks.intuit.com/customers/se-home-vid/':
                  case dev + 'quickbooks.intuit.com/customers/shopify-future-glory-testimonial/':
                  case dev + 'quickbooks.intuit.com/customers/shopify-how-it-works/':
                  case dev + 'quickbooks.intuit.com/customers/signup-with-paypal/':
                  case dev + 'quickbooks.intuit.com/customers/square-how-it-works/':
                  case dev + 'quickbooks.intuit.com/customers/square-social-proof/':
                  case dev + 'quickbooks.intuit.com/customers/thank-you/':
                  case dev + 'quickbooks.intuit.com/customers/the-academy-of-self-defense/':
                  case dev + 'quickbooks.intuit.com/customers/the-new-primal/':
                  case dev + 'quickbooks.intuit.com/customers/trash-amps/':
                  case dev + 'quickbooks.intuit.com/customers/village-cheese-house/':
                  case dev + 'quickbooks.intuit.com/disclosures/qbo-qbop/':
                  case dev + 'quickbooks.intuit.com/disclosures/self-employed-buy-now/':
                  case dev + 'quickbooks.intuit.com/download2017/':
                  case dev + 'quickbooks.intuit.com/download-quickbooks/':
                  case dev + 'quickbooks.intuit.com/ebay-business/':
                  case dev + 'quickbooks.intuit.com/features/':
                  case dev + 'quickbooks.intuit.com/first_ecommerce_page/':
                  case dev + 'quickbooks.intuit.com/food-restaurant-licenses-permits/':
                  case dev + 'quickbooks.intuit.com/franchise/index/':
                  case dev + 'quickbooks.intuit.com/franchise/subway/':
                  case dev + 'quickbooks.intuit.com/freesub/':
                  ...
                  case dev + 'quickbooks.intuit.com/hztest0912/':
                  case dev + 'quickbooks.intuit.com/income-statement/':
                  case dev + 'quickbooks.intuit.com/insurance-restaurant-business/':
                  case dev + 'quickbooks.intuit.com/invoicing/':
                  case dev + 'quickbooks.intuit.com/journal-entries/':
                  case dev + 'quickbooks.intuit.com/legal/payments/acceptable-use/':
                  case dev + 'quickbooks.intuit.com/legal/payments/chase-cea/':
                  case dev + 'quickbooks.intuit.com/legal/payments/merchant-agreement/':
                  case dev + 'quickbooks.intuit.com/legal/payments/merchant-agreement-12-13-2013/':
                  case dev + 'quickbooks.intuit.com/legal/payments/overview/':
                  case dev + 'quickbooks.intuit.com/legal/payments/pricing-schedule/':
                  case dev + 'quickbooks.intuit.com/legal/payments/qualified-pricing-schedule/':
                  case dev + 'quickbooks.intuit.com/legal/payments/standard-pricing-schedule/':
                  case dev + 'quickbooks.intuit.com/legal-accounting-software/':
                  case dev + 'quickbooks.intuit.com/legalzoom/':
                  case dev + 'quickbooks.intuit.com/limited-time-offer/':
                  case dev + 'quickbooks.intuit.com/mac/':
                  case dev + 'quickbooks.intuit.com/macdownload/dt/':
                  case dev + 'quickbooks.intuit.com/microsite/qbocostco/':
                  ...
                  case dev + 'quickbooks.intuit.com/oa/accountants/offer/':
                  case dev + 'quickbooks.intuit.com/oa/affsignup/':
                  case dev + 'quickbooks.intuit.com/oa/compare/online/':
                  case dev + 'quickbooks.intuit.com/oa/launchpad/explorations/payroll/':
                  case dev + 'quickbooks.intuit.com/oa/launchpad/explorations/qb_lead_gen_revel/':
                  case dev + 'quickbooks.intuit.com/oa/partners/affiliates/quickbooks-program/':
                  case dev + 'quickbooks.intuit.com/oa/payroll/':
                  case dev + 'quickbooks.intuit.com/oa/pla/buy-quickbooks-mac-2016/':
                  case dev + 'quickbooks.intuit.com/oa/pla/buy-quickbooks-premier-2016/':
                  case dev + 'quickbooks.intuit.com/oa/pla/buy-quickbooks-premier-2017/':
                  case dev + 'quickbooks.intuit.com/oa/pla/buy-quickbooks-pro-2016/':
                  ...
                  case dev + 'quickbooks.intuit.com/oa/promos/limited-time-offer-op/':
                  case dev + 'quickbooks.intuit.com/oa/promos/limited-time-offer-se/':
                  case dev + 'quickbooks.intuit.com/oa/promos/limited-time-offer-se-tt/':
                  case dev + 'quickbooks.intuit.com/oa/promos/limited-time-offer-sign-in/':
                  case dev + 'quickbooks.intuit.com/oa/promos/pricing-bundle/':
                  case dev + 'quickbooks.intuit.com/oa/promos/qbo-limited-time-offer/':
                  case dev + 'quickbooks.intuit.com/oa/promos/special-offer':
                  case dev + 'quickbooks.intuit.com/oa/promos/special-offer-extended/':
                  case dev + 'quickbooks.intuit.com/oa/promos/t/air-340/a/limited-time-offer/':
                  case dev + 'quickbooks.intuit.com/oa/promos/t/air-340/b/limited-time-offer/':
                  case dev +
                    'quickbooks.intuit.com/oa/promos/t/air-340/c/limited-time-offer-sign-in/':
                  case dev + 'quickbooks.intuit.com/oa/seg/brand/all/quickbooks/':
                  case dev + 'quickbooks.intuit.com/oa/seg/brand/tof/quickbooks-own-it/':
                  case dev + 'quickbooks.intuit.com/oa/seg/starting-up/':
                  case dev + 'quickbooks.intuit.com/oa/selfemployed-old/':
                  case dev + 'quickbooks.intuit.com/oa/selfemployed-promo/':
                  case dev + 'quickbooks.intuit.com/oa/signup/':
                  case dev + 'quickbooks.intuit.com/oa/t/qbks-4299/a/starting-up/':
                  case dev + 'quickbooks.intuit.com/oa/t/qbks-5379/a/selfemployed-promo/':
                  case dev + 'quickbooks.intuit.com/oa/t/qbks-9453/a/qb-online/':
                  case dev + 'quickbooks.intuit.com/oa/t/sep/a/selfemployed-promo/':
                  case dev + 'quickbooks.intuit.com/oa/t/sep/b/selfemployed-promo/':
                  case dev + 'quickbooks.intuit.com/oa/t/sep/c/selfemployed-promo/':
                  case dev + 'quickbooks.intuit.com/oem/adagility/':
                  case dev + 'quickbooks.intuit.com/oem/canon/':
                  case dev + 'quickbooks.intuit.com/oem/hp/':
                  case dev + 'quickbooks.intuit.com/oem/sony/':
                  case dev + 'quickbooks.intuit.com/oem/toshiba/':
                  case dev + 'quickbooks.intuit.com/oem/tpac/':
                  case dev + 'quickbooks.intuit.com/oem/vistaprint/':
                  case dev + 'quickbooks.intuit.com/om/qbhp/':
                  case dev + 'quickbooks.intuit.com/payments/verizon/':
                  case dev + 'quickbooks.intuit.com/payments/vistaprint/':
                  case dev + 'quickbooks.intuit.com/payments-offers/':
                  case dev + 'quickbooks.intuit.com/payroll/full-service/':
                  case dev + 'quickbooks.intuit.com/payroll/payroll-disclosures-weekday/':
                  case dev + 'quickbooks.intuit.com/payroll/payroll-disclosures-weekend/':
                  case dev + 'quickbooks.intuit.com/payroll/payroll-promo-banner/':
                  case dev + 'quickbooks.intuit.com/payroll/quickbooks-online/':
                  case dev + 'quickbooks.intuit.com/payroll-service/':
                  case dev + 'quickbooks.intuit.com/point-of-sale-software/':
                  case dev + 'quickbooks.intuit.com/point-of-sale-software-thankyou/':
                  case dev + 'quickbooks.intuit.com/pos_v12_terms_of_service/':
                  ...
                  case dev + 'quickbooks.intuit.com/pos-referral-program/':
                  case dev + 'quickbooks.intuit.com/pos-referral-thankyou/':
                  ...
                  case dev + 'quickbooks.intuit.com/pro-advisor-sign-up/':
                  case dev +
                    'quickbooks.intuit.com/prod-ecommerce-test-pages/essentials-all-products/':
                  case dev + 'quickbooks.intuit.com/prod-ecommerce-test-pages/plus-all-products/':
                  case dev +
                    'quickbooks.intuit.com/prod-ecommerce-test-pages/selfemployed-all-products/':
                  case dev + 'quickbooks.intuit.com/prod-ecommerce-test-pages/ss-all-products/':
                  ...
                  case dev + 'quickbooks.intuit.com/quickbooks-offers/':
                  case dev + 'quickbooks.intuit.com/quickbooks-payments-update-faq/':
                  case dev + 'quickbooks.intuit.com/reconcile-bank-statements/':
                  case dev + 'quickbooks.intuit.com/return_policy/':
                  case dev + 'quickbooks.intuit.com/revel-terms-of-service/':
                  case dev + 'quickbooks.intuit.com/right-for-me-buynow/':
                  case dev + 'quickbooks.intuit.com/rm/cmc32697/cell1_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33053/cell1/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33053/cell1_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33298/cell1/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33298/cell1_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33370/cell1_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell1/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell10/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell11/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell12/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell2/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell3/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell4/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell5/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell6/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell7/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell8/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33560/cell9/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell1/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell1_dm/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell1_dm_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell1_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell2.html/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell2_dm.html/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell2_dm_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33753/cell2_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell1/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell1_dm/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell1_dm_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell1_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell2/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell2_dm/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell2_dm_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc33754/cell2_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/cmc35964/premier-2/':
                  case dev + 'quickbooks.intuit.com/rm/cmc35964/premier-4/':
                  case dev + 'quickbooks.intuit.com/rm/cmc36538/cell2/':
                  case dev + 'quickbooks.intuit.com/rm/cmc36538/cell2_thankyou/':
                  case dev + 'quickbooks.intuit.com/rm/email-legos/shells/index/':
                  case dev + 'quickbooks.intuit.com/rm/email-style-guide/colors/':
                  ...
                  case dev + 'quickbooks.intuit.com/sandbox/Brett_Sample_Page/':
                  case dev + 'quickbooks.intuit.com/sandbox/brett_sample_page_2/':
                  case dev + 'quickbooks.intuit.com/sandbox/code_block_sample/':
                  case dev + 'quickbooks.intuit.com/sandbox/var_page/':
                  case dev + 'quickbooks.intuit.com/search/':
                  case dev + 'quickbooks.intuit.com/shared/disclosures/qbdt-pro-banner-image/':
                  case dev +
                    'quickbooks.intuit.com/shared/disclosures/qbo-standard-banner-image-no-cta/':
                  case dev +
                    'quickbooks.intuit.com/shared/mobile-promo-banner-presidents-with-cta/':
                  case dev + 'quickbooks.intuit.com/shared/promo-banner/':
                  case dev + 'quickbooks.intuit.com/shared/promo-banner-disclosures/':
                  case dev + 'quickbooks.intuit.com/shared/promo-banner-non-clickable/':
                  case dev + 'quickbooks.intuit.com/shared/promo-banner-presidents-NO-cta/':
                  case dev + 'quickbooks.intuit.com/shared/promo-banner-presidents-with-cta/':
                  case dev + 'quickbooks.intuit.com/shared/promo-banner-qbse/':
                  case dev + 'quickbooks.intuit.com/shared/promo-banner-qbse-test/':
                  case dev + 'quickbooks.intuit.com/shared/weekend-promo-disclosure/':
                  case dev + 'quickbooks.intuit.com/shared/weekend-promo-disclosure-pricing/':
                  case dev + 'quickbooks.intuit.com/signup/':
                  case dev + 'quickbooks.intuit.com/signup/core_resp/':
                  case dev + 'quickbooks.intuit.com/sitemap/':
                  case dev + 'quickbooks.intuit.com/smallbusiness/':
                  case dev + 'quickbooks.intuit.com/software-licenses/':
                  case dev +
                    'quickbooks.intuit.com/software-licenses/learning_QB_2014_software_license_agreement/':
                  case dev +
                    'quickbooks.intuit.com/software-licenses/QB2012_and_intuit_payroll_services_eula/':
                  case dev +
                    'quickbooks.intuit.com/software-licenses/QB2013_and_intuit_payroll_services_eula/':
                  case dev +
                    'quickbooks.intuit.com/software-licenses/QB2014_and_intuit_payroll_services_eula/':
                  case dev +
                    'quickbooks.intuit.com/software-licenses/QB2015_and_intuit_payroll_services_eula/':
                  case dev +
                    'quickbooks.intuit.com/software-licenses/qb2016_and_intuit_payroll_services_eula/':
                  case dev +
                    'quickbooks.intuit.com/software-licenses/qb2017_and_intuit_payroll_services_eula/':
                  case dev + 'quickbooks.intuit.com/software-licenses/QBO_QBA_TOS_2014_11_20/':
                  case dev + 'quickbooks.intuit.com/software-licenses/website_terms_of_service/':
                  case dev + 'quickbooks.intuit.com/square_landing_page/':
                  case dev + 'quickbooks.intuit.com/ss/business-type/project/':
                  case dev + 'quickbooks.intuit.com/ss/mac/':
                  case dev + 'quickbooks.intuit.com/ss/mac1/':
                  case dev + 'quickbooks.intuit.com/ss/payroll/full-service/':
                  case dev + 'quickbooks.intuit.com/ss/payroll/quickbooks-online/':
                  case dev + 'quickbooks.intuit.com/ss/payroll-service/':
                  case dev + 'quickbooks.intuit.com/ss/payroll-service1/':
                  case dev + 'quickbooks.intuit.com/ss/products/':
                  case dev + 'quickbooks.intuit.com/ss/right-for-me-buynow/':
                  ...
                  case dev + 'quickbooks.intuit.com/var/client-discounts/':
                  case dev + 'quickbooks.intuit.com/var/client-discounts-alt1/':
                  case dev + 'quickbooks.intuit.com/var/right-for-me-buynow/':
                  case dev + 'quickbooks.intuit.com/wellsfargo/':
                  case dev + 'quickbooks.intuit.com/why-quickbooks/':
                  case dev + 'quickbooks.intuit.com/write-off-bad-debt/':
                  case dev + 'quickbooks.intuit.com/zenefits/':
                    console.log(
                      'pageURL from gateway switch Feedback: ' +
                        location.host +
                        location.pathname +
                        (location.pathname.substr(-1) == '/' ? '' : '/')
                    );
                    return 'Opinion_Lab_Feedback';
                    break;
                }
              },
              load: 'instance',
              trigger: Bootstrapper.data.immediateTrigger,
              dataDefName: 'Opinion Lab - Feedback vs Feedback and Survey',
              collection: 'FMS',
              source: 'Manage',
              priv: 'false',
            },
