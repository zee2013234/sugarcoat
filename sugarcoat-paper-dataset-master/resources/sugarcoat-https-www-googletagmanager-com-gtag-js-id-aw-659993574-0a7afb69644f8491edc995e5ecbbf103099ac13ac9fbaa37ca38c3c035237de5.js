{
  ...
  (function () {
    (function () {
      const $___old_a489662e357cfd3a = {}.constructor.getOwnPropertyDescriptor(
          Navigator.prototype,
          'userAgent'
        ),
        $___old_75e186a63c262fac = {}.constructor.getOwnPropertyDescriptor(
          Navigator.prototype,
          'appVersion'
        );
      try {
        if ($___old_a489662e357cfd3a)
          ({}.constructor.defineProperty(
            Navigator.prototype,
            'userAgent',
            $___stub_47c01efa79e9f191.userAgent
          ));
        if ($___old_75e186a63c262fac)
          ({}.constructor.defineProperty(
            Navigator.prototype,
            'appVersion',
        ...
        return function () {
          ...
          (C.Hc = 'page_view'),
            (C.Zd = 'user_engagement'),
            (C.Af = 'app_remove'),
            (C.Bf = 'app_store_refund'),
            (C.Cf = 'app_store_subscription_cancel'),
            (C.Df = 'app_store_subscription_convert'),
            (C.Ef = 'app_store_subscription_renew'),
            (C.Hf = 'first_open'),
            (C.If = 'first_visit'),
            (C.Jf = 'in_app_purchase'),
            (C.Kf = 'session_start'),
            (C.Lf = 'allow_custom_scripts'),
            (C.Mf = 'allow_display_features'),
            (C.Ic = 'allow_enhanced_conversions'),
            (C.pe = 'enhanced_conversions'),
            (C.Ta = 'client_id'),
            (C.V = 'cookie_domain'),
            (C.Vb = 'cookie_name'),
            (C.Ua = 'cookie_path'),
            ...
            (C.Va = 'language'),
            (C.fe = 'country'),
            (C.fi = 'non_interaction'),
            (C.rb = 'page_location'),
            (C.Fa = 'page_referrer'),
            (C.Sc = 'page_title'),
            (C.sb = 'send_page_view'),
            (C.Ga = 'send_to'),
            (C.Vc = 'session_engaged'),
            (C.Zb = 'session_id'),
            (C.Wc = 'session_number'),
            (C.eg = 'tracking_id'),
            (C.ka = 'linker'),
            (C.ya = 'url_passthrough'),
            (C.ob = 'accept_incoming'),
            (C.D = 'domains'),
            (C.qb = 'url_position'),
            (C.pb = 'decorate_forms'),
            (C.ve = 'phone_conversion_number'),
            (C.te = 'phone_conversion_callback'),
            (C.ue = 'phone_conversion_css_class'),
            (C.we = 'phone_conversion_options'),
            (C.$f = 'phone_conversion_ids'),
            (C.Zf = 'phone_conversion_country_code'),
            (C.$d = 'aw_remarketing'),
            (C.ae = 'aw_remarketing_only'),
            (C.Ub = 'gclid'),
            (C.za = 'value'),
            (C.ag = 'quantity'),
            (C.Qf = 'affiliation'),
            ...
            (C.S = 'items'),
            (C.ee = 'aw_merchant_id'),
            (C.ce = 'aw_feed_country'),
            (C.de = 'aw_feed_language'),
            (C.be = 'discount'),
            (C.je = 'disable_merchant_reported_purchases'),
            (C.se = 'new_customer'),
            (C.he = 'customer_lifetime_value'),
            (C.Pf = 'dc_natural_search'),
            (C.Of = 'dc_custom_params'),
            (C.fg = 'trip_type'),
            (C.Yf = 'passengers'),
            (C.Wf = 'method'),
            (C.dg = 'search_term'),
            ...
            (C.Mc = 'event_settings'),
            (C.Jc = 'dynamic_event_settings'),
            (C.cg = 'screen_name'),
            (C.Vf = '_x_19'),
            (C.Uf = '_x_20'),
            (C.Rc = 'internal_traffic_results'),
            (C.xe = 'traffic_type'),
            (C.Tc = 'referral_exclusion_definition'),
            (C.Qc = 'ignore_referrer'),
            (C.Xc = 'delivery_postal_code'),
            (C.qe = 'estimated_delivery_date'),
            (C.gg = [
              C.ca,
              C.Ic,
              C.kb,
            ...
            (C.ye = [C.rb, C.Fa, C.Sc, C.Va, C.cg, C.vb, C.Nc]),
            (C.hg = [C.Af, C.Bf, C.Cf, C.Df, C.Ef, C.Hf, C.If, C.Jf, C.Kf, C.Zd]),
            (C.Od = [
              C.Ga,
              C.$d,
              C.ae,
          ...
          var xg = function (a, b, c) {
            ...
            Eg = function (a, b, c, d) {
              ...
              if (b && c) {
                d = d || {};
                for (
                  var e = { countryNameCode: c, destinationNumber: b, retrievalTime: new Date() },
                    f = 0;
                  f < a.length;
                  f++
                ) {
                  ...
                  Cg[h.id] ||
                    (h && 'AW' === h.prefix && !e.adData && 2 <= h.C.length
                      ? ((e.adData = { ak: h.C[0], cl: h.C[1] }), (Cg[h.id] = !0))
                      : h &&
                        'UA' === h.prefix &&
                        !e.gaData &&
                        ((e.gaData = { gaWpid: h.containerId }), (Cg[h.id] = !0)));
                }
                      ...
                      for (var x = 0; x < q.length; x++)
                        if (x < v)
                          if (d) Eg(d, q[x], n, { na: u, options: t });
                            ...
                            Fg()
                              ? Eg([a], q[x], n || 'US', { na: u, options: t })
                              : Dg(a.C[0], a.C[1], q[x], { na: u, options: t });
                          else if ('UA' === a.prefix)
          ...
          var Jg = function (a) {
            ...
            Kg = function () {
              const $___old_2ce7b5904d3e6c76 = {}.constructor.getOwnPropertyDescriptor(
                Navigator.prototype,
                'userAgent'
              );
              try {
                if ($___old_2ce7b5904d3e6c76)
                  ({}.constructor.defineProperty(
                    Navigator.prototype,
                    'userAgent',
                    $___stub_47c01efa79e9f191.userAgent
          ...
          var xj = function (a) {
              const $___old_bac63f1897651cd8 = {}.constructor.getOwnPropertyDescriptor(
                Navigator.prototype,
                'userAgent'
              );
              try {
                if ($___old_bac63f1897651cd8)
                  ({}.constructor.defineProperty(
                    Navigator.prototype,
                    'userAgent',
                    $___stub_47c01efa79e9f191.userAgent
            ...
            Fj = function (a, b, c, d) {
              ...
              if (b === C.Ea) {
                ...
                if (M === C.Ub && void 0 === W) {
                  ...
                  0 === Z.length ? P(void 0) : 1 === Z.length ? P(Z[0]) : P(Z);
                } else P(W);
                return;
              }
                  ...
                  var R = function (T, ja) {
                      void 0 != ja &&
                        ...
                        ((J.google_additional_conversion_params =
                          J.google_additional_conversion_params || {}),
                        (J.google_additional_conversion_params[T] = ja));
                    },
                    Q = function (T, ja) {
                      void 0 != ja &&
                        '' !== ja &&
                        ((J.google_additional_params = J.google_additional_params || {}),
                        (J.google_additional_params[T] = ja));
                    };
          ...
          var Lj = function (a, b, c, d) {
            ...
            Qj = function (a, b, c, d) {
              ...
              if (e) {
                ...
                if (b === C.ba) {
                  var w = { prefix: k, domain: l, Ib: q, flags: r },
                    z = f(C.ka) || {},
                    A = f(C.Wb),
                    B = void 0 === A ? !0 : !!A;
            ...
            Vj = function (a, b, c, d) {
              ...
              if (b === C.ba) {
                ...
                if (b !== C.sa) I(d.F);
                  ...
                  B &&
                    'object' === typeof B &&
                    ((A.passengers_total = Ia(B.total)),
                    (A.passengers_adult = Ia(B.adult)),
                    (A.passengers_child = Ia(B.child)),
                    (A.passengers_infant_in_seat = Ia(B.infant_in_seat)),
                    (A.passengers_infant_in_lap = Ia(B.infant_in_lap)));
                  y.conversion_data = A;
                  Sj(y);
                }
              }
          ...
          var jk = function (a, b) {
              ...
              if (ya(e)) {
                var f = 'gtag_' + a.split('-').join('_'),
                  ...
                  k = function () {
                    ...
                    if (w) {
                      var z = w.action;
                      if ('impressions' === z) y('ec:addImpression', w.lh);
                ...
                if (b === C.Hc) l(), h('send', 'pageview', q.Ba);
                  ...
                  l(),
                    Gg(a, c),
                    c.getWithConfig(C.ya) && (gg(), uh(f + '.')),
                    0 != q.sendPageView && h('send', 'pageview', q.Ba),
                    mk(a, f, c);
                else if (u) {
                  jk(f, c);
                } else
                  'screen_view' === b
                    ? h('send', 'screenview', q.Ba)
                    : 'timing_complete' === b
                    ? (r('timingCategory', q.eventCategory, !0),
                      r('timingVar', q.name, !0),
                      r('timingValue', Ia(q.value)),
                      void 0 !== q.eventLabel && r('timingLabel', q.eventLabel, !0),
                      h('send', 'timing', q.Ba))
                    : 'exception' === b
                    ? h('send', 'exception', q.Ba)
                    : 'optimize.callback' !== b &&
                      (0 <=
                        Ba(
                          [
                      ...
                      r('eventCategory', q.eventCategory, !0),
                      r('eventAction', q.eventAction || b, !0),
                      void 0 !== q.eventLabel && r('eventLabel', q.eventLabel, !0),
                      void 0 !== q.value && r('eventValue', Ia(q.value)),
                      h('send', 'event', q.Ba));
                if (!sk) {
                  sk = !0;
                  lh();
            ...
            rk = function (a, b, c, d) {
              if (void 0 !== c)
                if ((xk[b] && (c = Ja(c)), 'anonymize_ip' !== b || c || (c = void 0), 1 === a))
                  d[ik(b)] = c;
                else if (g(a)) d[a] = c;
            ...
            kk = function (a, b, c, d) {
              ...
              if ($a(r))
                for (var p in r)
                  if (r.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && void 0 != r[p]) {
                    var t = f(String(r[p]));
                    void 0 !== t && pk(k, p, t);
                  }
              for (var n = zi(d), u = 0; u < n.length; ++u) {
                ...
                else if (/^(dimension|metric|content_group)\d+$/.test(v)) rk(1, v, x, k);
              ...
              0 <=
                Ba(['view_item', 'view_item_list', 'view_promotion', 'view_search_results'], c) &&
                pk(k, 'nonInteraction', !0);
              'login' === c || 'sign_up' === c || 'share' === c
                ? pk(h, 'eventLabel', f(C.Wf))
                : 'search' === c || 'view_search_results' === c
                ? pk(h, 'eventLabel', f(C.dg))
                : 'select_content' === c && pk(h, 'eventLabel', f(C.Nf));
              var w = h[C.ka] || {},
                z = w[C.ob];
              z || (0 != z && w[C.D])
                ? (l.allowLinker = !0)
                : !1 === z && pk(l, 'useAmpClientId', !1);
              f(C.ya) && (l._useUp = !0);
            ...
            nk = function (a, b) {
              ...
              var n = null,
                u = f(C.Sf);
              a === C.sa || a === C.jb
                ? (n = { action: a, zb: e(), $a: d(h) })
                : a === C.hb
                ? (n = { action: 'add', $a: d(h) })
                : a === C.ib
                ? (n = { action: 'remove', $a: d(h) })
                : a === C.Da
                ? (n = { action: 'detail', zb: e(k), $a: d(h) })
                : a === C.Tb
                ? (n = { action: 'impressions', lh: d(h) })
                : 'view_promotion' === a
                ? (n = { action: 'promo_view', Bd: d(u) })
                : 'select_content' === a && u && 0 < u.length
                ? (n = { action: 'promo_click', Bd: d(u) })
                : 'select_content' === a
                ? (n = { action: 'click', zb: { list: f(C.Kc) || k }, $a: d(h) })
                : a === C.Sa || 'checkout_progress' === a
                ? (n = {
                    action: 'checkout',
                    $a: d(h),
                ...
                : 'set_checkout_option' === a &&
                  (n = { action: 'checkout_option', zb: { step: f(C.me), option: f(C.ke) } });
              n && (n.ri = f(C.va));
              return n;
            },
            Ak = {},
              ...
              if (!(2 > a.length) && g(b)) {
                ...
                if (g(f) || Aa(f)) {
                  for (
                    ...
                    0 <= h[l].indexOf('-') ? k.push(h[l]) : (k = k.concat(Uk[h[l]] || []));
                  e = sg(k);
                } else e = void 0;
                var q = e;
                if (!q) return;
          ...
          (Y.a.get = ['google']),
            (function () {
              (function (a) {
                ...
                (a.vtp_deferrable
                  ? rp
                  : qp)(String(b.streamId), String(a.vtp_eventName), b.eventParameters || {});
                a.vtp_gtmOnSuccess();
              });
            })();
          (Y.a.gtagfl = []),
        ...
        if ($___old_a489662e357cfd3a)
          ({}.constructor.defineProperty(
            Navigator.prototype,
            'userAgent',
            $___old_a489662e357cfd3a
          ));
        if ($___old_75e186a63c262fac)
          ({}.constructor.defineProperty(
            Navigator.prototype,
            'appVersion',
            $___old_75e186a63c262fac
          ));
      }
    })();
  })();
