  ...
  (function () {
        ...
        Bootstrapper.bindDOMParsed(function () {
          var frame = document.createElement('iframe'),
            getCookie = Bootstrapper.Cookies
              ...
              : function (a, c) {
                  const $___old_1fe3f615e12f7495 = {}.constructor.getOwnPropertyDescriptor(
                    Document.prototype,
                    'cookie'
                  );
                  try {
                    if ($___old_1fe3f615e12f7495)
          ...
          frame.src =
            'https://6269322.fls.doubleclick.net/activityi;src=6269322;type=bankp0;cat=banka01_;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;npa=;ord=' +
    ...
    Bootstrapper.bindDOMLoaded(
      function () {
        ...
        var ensightenOptions = Bootstrapper.ensightenOptions;
        new Image().src =
          'https://pt.ispot.tv/v2/TC-3498-3.gif?app=web' + '&' + 'type=HYSA_landing';
      },
      3336944,
      650548
    );
    ...
    Bootstrapper.bindImmediate(
      function () {
        var Bootstrapper = window['Bootstrapper'];
        var ensightenOptions = Bootstrapper.ensightenOptions;
        new Image().src = 'https://pubads.g.doubleclick.net/activity;xsp=4634974;ord=1';
      },
      3269666,
      644810
    );
    Bootstrapper.bindImmediate(
      function () {
        ...
        var ensightenOptions = Bootstrapper.ensightenOptions;
        new Image().src =
          'https://analytics.twitter.com/i/adsct?txn_id=o4bn0&p_id=Twitter&tw_sale_amount=0&tw_order_quantity=0';
        new Image().src =
          '//t.co/i/adsct?txn_id=o4bn0&p_id=Twitter&tw_sale_amount=0&tw_order_quantity=0';
      },
      3330862,
      651289
    );
    ...
    Bootstrapper.bindImmediate(
      function () {
        ...
        (function () {
          ...
          snaptr('init', 'cc5020d4-05c7-4f3c-b43f-7001ce5c6008', {
