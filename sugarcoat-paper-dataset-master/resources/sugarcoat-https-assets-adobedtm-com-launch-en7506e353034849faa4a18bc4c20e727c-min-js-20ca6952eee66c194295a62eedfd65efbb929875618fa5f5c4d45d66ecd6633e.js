  ...
  (function () {
    (window._satellite = window._satellite || {}),
      (window._satellite.container = {
        buildInfo: {
          minified: !0,
          buildDate: '2020-11-17T00:12:40Z',
        ...
        dataElements: {
          'JSLL RedTiger': {
            ...
            settings: {
              source: function () {
                return 0 < $('#primaryArea[data-m]').length && awa.isInitialized;
              },
            },
          },
          MSCC_Consent: {
          ...
          'Surface - All Pages': {
            ...
            settings: {
              source: function () {
                return !(
                  !location.pathname.match(/\/..\-..\/surface\/?/gi) ||
                  location.pathname.match(/\/..\-..\/surface\/business\/?/gi)
                );
              },
            },
          },
          'Surface - EN-US Pages': {
            ...
            settings: {
              source: function () {
                return !(
                  !location.pathname.match(/\/en\-us\/surface\/?/gi) ||
                  location.pathname.match(/\/en\-us\/surface\/business\/?/gi)
                );
              },
            },
          },
          'Surface - Marketo Pages': {
            defaultValue: '',
            modulePath: 'core/src/lib/dataElements/customCode.js',
            settings: {
              source: function () {
                return !(
                  !location.pathname.match(
                    /\/en\-(us|gb|ca|au)\/surface\/devices\/compare-devices\/?/gi
                  ) && !location.pathname.match(/\/en\-(us|gb|ca|au)\/surface\/buy\/?/gi)
                );
              },
            },
          },
          ...
          'ContentSquare Selected Market + Pages': {
            defaultValue: '',
            modulePath: 'core/src/lib/dataElements/customCode.js',
            settings: {
              source: function () {
                return !(
                  location.pathname.match(/\/..\-..\/surface\/business\/?/gi) ||
                  !location.href.match(
                    /(en-us|fr-ca|it-it|en-nz|es-es|en-au|pt-br|en-ca|fr-fr|de-de|ja-jp|nl-nl|en-sg|en-gb)\/(surface|(surface\/devices\/((surface-duo\?activetab=overview)|surface-neo|compare-devices)))/gi
                  )
                );
              },
            },
          ...
          core: {
            ...
            modules: {
                ...
                script: function (n, e, t, r) {
                  ...
                  n.exports = function (n, e) {
                    var t = { settings: n, event: e },
                      r = t.settings.source;
                    if (r) {
                      if (t.settings.isExternal)
                        return u(r).then(function (n) {
                          n && d(c(t, n));
                        });
                      if (
                        f ||
                        ('core.library-loaded' !== e.$type && 'core.page-bottom' !== e.$type)
                      )
                        d(c(t, r));
                      else {
                        if (!s.write)
              ...
              'core/src/lib/events/helpers/pageLifecycleEvents.js': {
                script: function (n, e, t) {
                  const $___old_dc94d89ba4ac9aa1 = {}.constructor.getOwnPropertyDescriptor(
                    Navigator.prototype,
                    'appVersion'
                  );
                  try {
                    if ($___old_dc94d89ba4ac9aa1)
                    ...
                    s = function (e, n) {
                      ...
                      return (
                        (_satellite[t] = function (n) {
                          const $___old_ef17253576141e69 = {}.constructor.getOwnPropertyDescriptor(
                            window,
                            'Storage'
                          );
                          try {
                            if ($___old_ef17253576141e69)
                              ({}.constructor.defineProperty(
                                window,
                                'Storage',
                      ...
                      function (n, e, t) {
                        ...
                        function _ (n, e, t) {
                          var r = 2 < arguments.length && t !== undefined ? arguments[2] : null,
                            a = T + e;
                          k.existy(r) && '' !== r ? n.setAttribute(a, r) : n.removeAttribute(a);
                        }
                        e.__esModule = !0;
                        var C =
                            Object.assign ||
                          ...
                          i = (function () {
                            function r (n, e) {
                              ...
                              w(this, r),
                                ...
                                (this.parser = new S['default']('', { autoFix: t.autoFix })),
                                (this.actuals = [n]),
                                (this.proxyHistory = ''),
                            ...
                            return (
                              (r.prototype.write = function t () {
                                ...
                                for (
                                  ...
                                  k.isFunction(e) ? this._callFunction(e) : this._writeImpl(e);
                                }
                              }),
                              ...
                              (r.prototype._walkChunk = function s () {
                                for (
                                  ...
                                  e.unshift.apply(e, k.toArray(n.childNodes));
                                }
                              }),
                              ...
                              (r.prototype._buildStyle = function e (n) {
                                ...
                                return (
                                  ...
                                  k.eachKey(n.attrs, function (n, e) {
                                    t.setAttribute(n, e);
                                  }),
                                  t
                                );
        ...
        rules: [
          {
            id: 'RLf4bc60361c3d42a3aa9a611421848e28',
            name: 'Temp ContentSquare',
            events: [
            ...
            conditions: [
              {
                ...
                settings: {
                  ...
                  leftOperand: '%ContentSquare Selected Market + Pages%',
                },
              },
            ],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCc0230152987c4e73b3230be623bd92e6-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL7cad1ede03cf4c468f4e61820fc8bdb6',
            ...
            actions: [
              {
                ...
                settings: {
                  global: !0,
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC4531a4e4108f48ab95bfce9b9140bf03-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLcf5b4863eae34acabbf7a64b38972a00',
          ...
          {
            id: 'RL9b869dc931e94d4e8bed8970da7e2279',
            name: 'Global JSLL',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 4 },
            ],
            conditions: [
              {
                modulePath: 'core/src/lib/conditions/valueComparison.js',
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCce79330d434c45ca8ea9effba974a13d-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCa6da6c2ddf044453bdb4d0b0dafda95b-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC54b490a964b8430a93c0a4bea8ec38f8-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCa7a16d61c0134716b6c5d59808f9fd26-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL1462a9d82491491aa9b8a64546a112a9',
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC278c787435b94d148603e89a80d2b336-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLdc5c5fa39a554b2db75698ff9fb8342a',
            name: 'Global DCM',
            events: [
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC15f3408d92fc4519a3a4fbb6f85a3d5e-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLf680ca9dbbd1499fa2198831c2aabc47',
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCb36993ed0cd440348a1b4711c13dbc8e-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL5844cbdaf65949ceaaa492a5b1a7645c',
          ...
          {
            id: 'RLd4abd5f0bb51427d91d32a81105a8da3',
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC42334f278d6d4267a39fc7c0e38b2717-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLa006737ce0cb49089bb077ac07afd67f',
            name: 'Multi Bing',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCea5ad6baf7a84455b0447fa19709190d-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL9b125a76b309402ab1db9fcbed0cf83a',
            name: 'Multi Google',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC683368007e154c38814065ef2499a0b8-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL0881a78f46554cf692219afc61be61ab',
            name: 'Multi Marketo',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            conditions: [
              {
                ...
                settings: {
                  comparison: { operator: 'isTrue' },
                  leftOperand: '%Surface - Marketo Pages%',
                },
              },
            ],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC3bdeba11c6704d10ad41374c56cf3838-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL36781376e4704752bf59267b408b73ad',
            name: 'US Walmart',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCb0e7b7b9bdd945458fd1380859b0de3b-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL618f34711bc843aca6fa337c5fceccfe',
            name: 'Global JSLL RT',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC02d7f5e2095d4ee3a60c3f89ae8c26fa-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL5770834129434803abbb8dc27cf16535',
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC2fdf0b42e0414a7982f3ba48531bc168-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL9f6ce149a513449cb8c5db72bd6fe69d',
            name: 'JSLL Custom Tune In',
            events: [
            ...
            conditions: [
              {
                ...
                settings: { paths: [{ value: 'surface\\/microsoftevent\\/?', valueIsRegex: !0 }] },
              },
            ],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCe5cf7440cb0a45938b28d98c0c3b80e8-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLc3631b2f3d5140758923a8027b5b69c7',
            name: 'Temp JSLL Custom Modal',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 10 },
            ],
            conditions: [],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC05ac5f311ffd4e5c9ad450f46819401c-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL560ed15e3cb943e5bab07b0c8c066779',
            name: 'Pinterest Meta Tag',
            events: [
          ...
          {
            id: 'RL984ede5ae25143edb533520fe7705b03',
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC021d0a1582e845158b9974bf66e669fd-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL228cb10d3ef642f0b58bb730ca2eb5ef',
            name: 'Pinterest ',
            events: [
              { modulePath: 'core/src/lib/events/libraryLoaded.js', settings: {}, ruleOrder: 50 },
            ],
          ...
          {
            id: 'RLd53eab84bf2b4bac94dee7f6ad60afbd',
            name: 'Temp DCM Homepage',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 60 },
            ],
            conditions: [],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCe37a65e1116b45deb0955342783465c4-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL27271cfb121c430ea7ef844656e0d775',
            ...
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC2b0a5d3bb3bb4fbd87511bf038a41141-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLf03eb73ca0154dbf8ce37cf53b94c5db',
            name: 'Comscore Survey Overlay Tagging',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            conditions: [],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCc603b998e8c64e55b78656817f793285-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLc4b7fa87c43a4c40b72ec07cb3c282ef',
            name: 'JSLL Video HTML5',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 60 },
            ],
            conditions: [],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC3743cb8b1ea14f88b7f7258ff32b6dca-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL09c01d9530214aeca39cf3aa4b12dc09',
            name: 'Temp  DUO Twitter',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 60 },
            ],
            conditions: [],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC2df597d0072a4de68e7ad06f8d6467d1-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RLf35e9ad157e94c34a8a6276f2907a2e3',
            name: 'Temp DCM DUO (en-us)',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            conditions: [],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RCb931a36f851d412386794b82eefa6672-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
          ...
          {
            id: 'RL1fd1449e10de488fb621afa631c2b1fe',
            name: 'Temp DCM Surface',
            events: [
              { modulePath: 'core/src/lib/events/domReady.js', settings: {}, ruleOrder: 50 },
            ],
            conditions: [
              {
                modulePath: 'core/src/lib/conditions/valueComparison.js',
                settings: { comparison: { operator: 'isTrue' }, leftOperand: '%MSCC_Consent%' },
              },
            ],
            actions: [
              {
                ...
                settings: {
                  source:
                    'https://assets.adobedtm.com/5ef092d1efb5/4c272e8cc694/8feea6849a28/RC969f921707d54f4099e9ed7c4afc557e-source.min.js',
                  language: 'javascript',
                  isExternal: !0,
                },
              },
    ...
    var $___var_3eb2ce4fbc0e451c = (function () {
      const $___old_e6dfdb26d4f90514 = {}.constructor.getOwnPropertyDescriptor(
        Navigator.prototype,
        'userAgent'
      );
      try {
        if ($___old_e6dfdb26d4f90514)
          ({}.constructor.defineProperty(
            Navigator.prototype,
            'userAgent',
          ...
          if (window.atob) {
            var g = function (n) {
              ...
              A = n(function (r) {
                !(function (n) {
                  ...
                  function n (u) {
                    ...
                    function e (n, e) {
                      const $___old_afdfe12c7f1f02ff = {}.constructor.getOwnPropertyDescriptor(
                        Document.prototype,
                        'cookie'
                      );
                      try {
                        if ($___old_afdfe12c7f1f02ff)
                          ({}.constructor.defineProperty(
                            Document.prototype,
                            'cookie',
              ...
              D = function (r, n) {
                ...
                return {
                  getItem: function (n) {
                    const $___old_7bc2b43454b6359b = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'localStorage'
                    );
                    try {
                      if ($___old_7bc2b43454b6359b)
                        ({}.constructor.defineProperty(
                          window,
                          'localStorage',
                      ...
                      if ($___old_7bc2b43454b6359b)
                        ({}.constructor.defineProperty(
                          window,
                          'localStorage',
                          $___old_7bc2b43454b6359b
                        ));
                    }
                  },
                  setItem: function (n, e) {
                    const $___old_12dc72e13ad9bcfa = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'localStorage'
                    );
                    try {
                      if ($___old_12dc72e13ad9bcfa)
                        ({}.constructor.defineProperty(
                          window,
                          'localStorage',
                          $___stub_9417959baab2caf0.localStorage
                  ...
                  Object.keys(l).forEach(function (r) {
                    ...
                    if (a.modules) {
                      var e = I.createPrefixedLogger(a.displayName),
                        t = Fn(a.hostedLibFilesBaseUrl, d.minified),
                        i = {
                          buildInfo: d,
            ...
            if (re && !window.__satelliteLoaded) {
              ...
              var he = an(re),
                ...
                ke = wn(
                  jn(
                    oe,
                    vn(mn(be, Ln, ye, _e), kn(be, Ce, Se)),
                    pn(dn(be, An, Ln, _e, ye), ln(be, An, Ce), Se),
                    he
                  ),
                  be,
                  Mn,
        ...
        if ($___old_e6dfdb26d4f90514)
          ({}.constructor.defineProperty(
            Navigator.prototype,
            'userAgent',
            $___old_e6dfdb26d4f90514
          ));
      }
    })();
    _satellite = $___var_3eb2ce4fbc0e451c;
  })();
}
