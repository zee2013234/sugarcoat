{
  ...
  (function () {
    ...
    (function (a, b, c, d) {
      ...
      e.exports;
      (function () {
        const $___old_cc6327f9159dccbc = {}.constructor.getOwnPropertyDescriptor(
          window,
          'performance'
        );
        try {
          if ($___old_cc6327f9159dccbc)
          ...
          return function () {
            ...
            f.ensureModuleRegistered('SignalsConvertNodeToHTMLElement', function () {
              return (function (f, g, h, j) {
                ...
                (function () {
                  ...
                  function a (a) {
                    var b =
                      (typeof HTMLElement === 'undefined' ? 'undefined' : i(HTMLElement)) ===
                      'object'
                  ...
                  var i = (function () {
                    ...
                    h(a, [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          this._waitHandle != null &&
                            (g.clearTimeout(this._waitHandle), (this._waitHandle = null)),
            ...
            f.ensureModuleRegistered('signalsFBEventsCoercePixel', function () {
              return (function (g, h, j, k) {
                ...
                (function () {
                  ...
                  function c (c) {
                    if (c == null || (typeof c === 'undefined' ? 'undefined' : i(c)) !== 'object')
                      return null;
                    var d = c.eventCount,
                      e = c.id,
                      f = c.userData;
            ...
            f.ensureModuleRegistered('SignalsFBEventsCoercePrimitives', function () {
              return (function (g, h, j, k) {
                ...
                (function () {
                  ...
                  function n (a) {
                    return (typeof a === 'undefined' ? 'undefined' : i(a)) === 'object' &&
                      !Array.isArray(a) &&
                      a != null
                      ? a
                      : null;
              ...
              return (function (g, h, j, k) {
                ...
                (function () {
                  ...
                  var a = f.getFbeventsModules('SignalsFBEventsUtils'),
                    ...
                    c = a.keys;
                  function d (a) {
                    if ((typeof a === 'undefined' ? 'undefined' : i(a)) !== 'object' || a == null)
                      return null;
                    var d = {};
                    b(c(a), function (b) {
                      var c = a[b];
            ...
            f.ensureModuleRegistered('SignalsFBEventsFBQ', function () {
              return (function (g, i, j, k) {
                ...
                (function () {
                  ...
                  function B (a, b, c) {
                    j.loadJSFile(
                      j.CONFIG.CDN_BASE_URL + 'signals/config/' + a + '?v=' + b + '&r=' + c
                    );
                  }
                  d = (function () {
                    function d (a, b) {
                    ...
                    h(d, [
                      ...
                      },
                      {
                        ...
                        value: function (a) {
                          ...
                          if (
                            (this._argsHasAnyUserData(a) && !this.fbq.loadPlugin('identity')) ||
                            this.locks.isLocked()
                          ) {
                            g.fbq('fire', a);
                            return this;
                        ...
                        value: function (a) {
                          ...
                          (!this.fbq.pendingConfigs ||
                            ...
                            B(
                              a,
                              this.VERSION,
                              this.RELEASE_SEGMENT != null ? this.RELEASE_SEGMENT : 'stable'
                            );
                        },
                      },
                      {
            ...
            f.ensureModuleRegistered('signalsFBEventsGetIsChrome', function () {
              return (function (f, g, h, i) {
                ...
                (function () {
                  'use strict';
                  function a () {
                    const $___old_2205f8610a1f6a3c = {}.constructor.getOwnPropertyDescriptor(
                        Navigator.prototype,
                        'vendor'
                      ),
                      $___old_20c62273fb10bba1 = {}.constructor.getOwnPropertyDescriptor(
                        Navigator.prototype,
                        'userAgent'
                      );
                    try {
                      if ($___old_2205f8610a1f6a3c)
                        ({}.constructor.defineProperty(
                          Navigator.prototype,
                          'vendor',
                          $___stub_5299202f9682c77d.vendor
                        ));
                      if ($___old_20c62273fb10bba1)
                        ({}.constructor.defineProperty(
                          Navigator.prototype,
                          'userAgent',
                      ...
                      if ($___old_2205f8610a1f6a3c)
                        ({}.constructor.defineProperty(
                          Navigator.prototype,
                          'vendor',
                          $___old_2205f8610a1f6a3c
                        ));
                      if ($___old_20c62273fb10bba1)
                        ({}.constructor.defineProperty(
                          Navigator.prototype,
                          'userAgent',
                          $___old_20c62273fb10bba1
                        ));
                    }
                  }
                  var b = a();
                ...
                (function () {
                  ...
                  function d () {
                    for (var a = arguments.length, d = Array(a), e = 0; e < a; e++)
                      d[e] = arguments[e];
                    var f = d[0];
                    if (f == null || (typeof f === 'undefined' ? 'undefined' : i(f)) !== 'object')
                      return null;
                    var g = f.unsafePixel,
                      h = f.unsafeTarget,
                      j = c(g),
                  ...
                  function A (a) {
                    switch (a.type) {
                      ...
                      case 'SET_METADATA_ON_UNINITIALIZED_PIXEL_ID':
                        ...
                        c = a.pixelID;
                        return (
                          'Trying to set argument ' + b + ' for uninitialized Pixel ID ' + c + '.'
                        );
                  ...
                  function D (a, b) {
                    try {
                      ...
                      if ((m && d < 0.01) || f === 'canary') {
                        ...
                        c(a, Error) &&
                          (d.append('f', a.fileName), d.append('s', a.stackTrace || a.stack));
                        d.append('ue', b ? '1' : '0');
                        d.append('rs', f);
                        h(d, {
                  ...
                  function g (a) {
                    b(d(a), function (b) {
                      if (
                        ...
                        throw new Error(
                          'Circular subOpts are not allowed. ' + b + ' depends on another subOpt'
                        );
                    });
                  }
                  a = (function () {
                    ...
                    h(b, [
                      ...
                      },
                      {
                        ...
                        value: function (a) {
                          ...
                          a =
                            d.CONFIG.CDN_BASE_URL + 'signals/plugins/' + a + '.js?v=' + f.version;
            ...
            f.ensureModuleRegistered('signalsFBEventsSendXHR', function () {
              return (function (g, h, i, j) {
                ...
                k.exports;
                (function () {
                  const $___old_15c35d17915c31c1 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    ),
                    $___old_1864208e82ddde1c = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                  try {
                    if ($___old_15c35d17915c31c1)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_8343e440b270d768.XMLHttpRequest
                      ));
                    if ($___old_1864208e82ddde1c)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_8343e440b270d768.XMLHttpRequest
                        ...
                        f.onreadystatechange = function () {
                          ...
                          f.status !== 200 &&
                            (c != null
                              ? c()
                              : d(
                                  new Error('Error sending XHR ' + f.status + ' - ' + f.statusText)
                                ));
                        };
                        f.send(a);
                      }
                    ...
                    if ($___old_15c35d17915c31c1)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_15c35d17915c31c1
                      ));
                    if ($___old_1864208e82ddde1c)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_1864208e82ddde1c
                      ));
                  }
                })();
                return k.exports;
              ...
              return (function (f, g, j, k) {
                ...
                (function () {
                  ...
                  function k (a) {
                    ...
                    a = a.prototype;
                    if (j(a) === !1) return !1;
                    return Object.prototype.hasOwnProperty.call(a, 'isPrototypeOf') === !1
                      ? !1
                      : !0;
                  }
                  var m =
                          ...
                          value: function (b) {
                            ...
                            for (var d in b)
                              Object.prototype.hasOwnProperty.call(b, d) &&
                                this._append({ name: encodeURIComponent(d), value: b[d] }, a, c);
                            return this;
                          },
                        },
                        {
          ...
          if ($___old_cc6327f9159dccbc)
            ({}.constructor.defineProperty(window, 'performance', $___old_cc6327f9159dccbc));
        }
      })();
    ...
    (function (a, b, c, d) {
      ...
      e.exports;
      (function () {
        const $___old_430d737c4a3c1036 = {}.constructor.getOwnPropertyDescriptor(
          window,
          'performance'
        );
        try {
          if ($___old_430d737c4a3c1036)
            ({}.constructor.defineProperty(
              window,
              'performance',
              $___stub_c0f1d0ee9b6f2da6.performance
          ...
          return function () {
            ...
            f.ensureModuleRegistered('SignalsFBEvents.plugins.iwlbootstrapper', function () {
              return (function (a, b, c, d) {
                ...
                e.exports;
                (function () {
                  const $___old_b0ab9db5d1c5eb17 = {}.constructor.getOwnPropertyDescriptor(
                    window,
                    'sessionStorage'
                  );
                  try {
                    if ($___old_b0ab9db5d1c5eb17)
                      ({}.constructor.defineProperty(
                        window,
                        'sessionStorage',
          ...
          if ($___old_430d737c4a3c1036)
            ({}.constructor.defineProperty(window, 'performance', $___old_430d737c4a3c1036));
        }
      })();
    })(window, document, location, history);
    (function (a, b, c, d) {
      ...
      e.exports;
      (function () {
        const $___old_bf47ee54a2d38772 = {}.constructor.getOwnPropertyDescriptor(
          window,
          'performance'
        );
        try {
          if ($___old_bf47ee54a2d38772)
            ({}.constructor.defineProperty(
              window,
              'performance',
              $___stub_c0f1d0ee9b6f2da6.performance
            ...
            f.ensureModuleRegistered('SignalsFBEvents.plugins.opttracking', function () {
              return (function (a, b, c, d) {
                ...
                (function () {
                  ...
                  function t () {
                    const $___old_fd2e8f408bdb4f05 = {}.constructor.getOwnPropertyDescriptor(
                      Navigator.prototype,
                      'userAgent'
                    );
                    try {
                      if ($___old_fd2e8f408bdb4f05)
                        ({}.constructor.defineProperty(
                          Navigator.prototype,
                          'userAgent',
                          $___stub_9d7b4eb662ee43f5.userAgent
          ...
          if ($___old_bf47ee54a2d38772)
            ({}.constructor.defineProperty(window, 'performance', $___old_bf47ee54a2d38772));
        }
      })();
    })(window, document, location, history);
    (function (a, b, c, d) {
      ...
      e.exports;
      (function () {
        const $___old_693fbc73b4630786 = {}.constructor.getOwnPropertyDescriptor(
          window,
          'performance'
        );
        try {
          if ($___old_693fbc73b4630786)
            ({}.constructor.defineProperty(
              window,
              'performance',
              $___stub_c0f1d0ee9b6f2da6.performance
          ...
          return function () {
            ...
            f.ensureModuleRegistered('SignalsFBEvents', function () {
              return (function (a, b, c, d) {
                ...
                e.exports;
                (function () {
                  const $___old_ce91115b77322d89 = {}.constructor.getOwnPropertyDescriptor(
                    window,
                    'performance'
                  );
                  try {
                    if ($___old_ce91115b77322d89)
                      ({}.constructor.defineProperty(
                        window,
                        'performance',
                        $___stub_c0f1d0ee9b6f2da6.performance
          ...
          if ($___old_693fbc73b4630786)
            ({}.constructor.defineProperty(window, 'performance', $___old_693fbc73b4630786));
        }
      })();
    })(window, document, location, history);
    fbq.registerPlugin('global_config', {
      ...
      plugin: function (fbq, instance, config) {
        ...
        fbq.set('experiments', [
          { allocation: 0.005, code: 's', name: 'send_beacon_string', passRate: 0.5 },
        ]);
