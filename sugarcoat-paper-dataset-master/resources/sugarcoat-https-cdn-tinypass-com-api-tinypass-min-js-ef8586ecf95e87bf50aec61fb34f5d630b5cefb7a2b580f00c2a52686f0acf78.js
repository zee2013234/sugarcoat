    ...
    (window.___tp = function () {
      ...
      (tp = function () {
        function t () {
          function i (e, t, r) {
            ...
            for (var u = 0; u < n.length; u++) {
              var a = n[u];
              e === a.module &&
                t.substring(0, a.prefix.length) === a.prefix &&
                ((i =
                  t.substring(a.prefix.length, a.prefix.length + 1).toLowerCase() +
                  t.substring(a.prefix.length + 1, t.length)),
                (s = tp[e].registerCallback(i, r)),
                s !== undefined && (o = s));
            }
            return o;
          }
        ...
        (this.aid = ''),
          ...
          (this.getGAClientId = function () {
            return this.gaClientId
              ? this.gaClientId
              : !tp.gaService || !tp.gaService.getClientId()
              ? undefined
              : tp.gaService.getClientId();
          }),
          ...
          (this.dontScrollTopModal = !1),
          (this.setDontScrollTopModal = function (e) {
          ...
          (this.setApplePayMerchantId = function (e) {
          ...
          (this.setCxCdnUrl = function (e) {
            this.cxCdnUrl = e;
          }),
          (this.c1XLoadCce = !0),
          (this.setC1XLoadCce = function (e) {
            this.c1XLoadCce = e;
          }),
          (this.c1XIntegrationVersion = 'v2'),
          (this.setC1XIntegrationVersion = function (e) {
            this.c1XIntegrationVersion = e;
          }),
          (this.cxenseSiteId = ''),
          (this.setCxenseSiteId = function (e) {
            this.cxenseSiteId = e;
          }),
          (this.cxenseLibAwaitingTimeout = 0),
          (this.setCxenseLibAwaitingTimeout = function (e) {
            this.cxenseLibAwaitingTimeout = e;
          }),
          (this.cxenseLibAwaitingRetryCount = 0),
          (this.setCxenseLibAwaitingRetryCount = function (e) {
          ...
          (this.usePianoIdLiteUserProvider = !1),
          (this.setUsePianoIdLiteUserProvider = function (e) {
            this.usePianoIdLiteUserProvider = e;
          }),
          (this.externalJWT = null),
          (this.setExternalJWT = function (e) {
            this.externalJWT = e;
          }),
          ...
          (this.zIndexes = { backdrop: 300000, modal: 300050, close: 300100 }),
          ...
          (this.setCustomParam = function (e, t, n, r) {
            ...
            if (i.indexOf(n) < 0)
              throw new Error('Undefined scope ' + n + '\nAvailable scopes: ' + i.join(', '));
          ...
          (this.saveCustomVariablesToLocalStorage = function (e) {
            function n () {
              return Math.floor(new Date().getTime() / 1000);
            }
            if (this.customVariables && 'localStorage' in window && window.localStorage !== null) {
              var t = '__tp-customVariables';
              window.localStorage.setItem(t, JSON.stringify(this.customVariables)),
                e && window.localStorage.setItem(t + '-expiration', n() + e);
            }
          }),
          (this.restoreCustomVaribalesFromLocalstorage = function () {
            if ('localStorage' in window && window.localStorage !== null) {
              var e = tp.util.__protected__.getLocalStorageItem('customVariables');
              tp.util.__protected__.removeLocalStorageItem('customVariables');
              if (e) for (var t in e) this.customVariables[t] = e[t];
            }
          }),
          (this.locale = ''),
          (this.setLocale = function (e) {
            (this.locale = e),
              tp.push([
                'init',
                function () {
                  tp.pianoId.isConfigured() && tp.pianoId.updateLang(e),
                    tp.postmessage.broadcast('langChanged', { lang: e });
                },
              ]);
          }),
        ...
        (function () {
          ...
          (function (ba) {
            const $___old_c35cf6d168c7bd35 = {}.constructor.getOwnPropertyDescriptor(
              Navigator.prototype,
              'platform'
            );
            try {
              if ($___old_c35cf6d168c7bd35)
                ...
                function ga (e) {
                  function n (e, t, n) {
                    ...
                    if (e) {
                      (e = e.split('/')),
                        ...
                        '.' === e[0].charAt(0) &&
                          t &&
                          ((i = t.slice(0, t.length - 1)), (e = i.concat(e))),
                        (i = e);
                  ...
                  function i (e) {
                    ...
                    if (t && H(t) && 1 < t.length)
                      return (
                        t.shift(),
                        x.require.undef(e),
                        x.makeRequire(null, { skipMap: !0 })([e]),
                        !0
                      );
                  }
                  function s (e) {
                  ...
                  function l (e, t) {
                    ...
                    t
                      ...
                      : (v(n, function (t) {
                          if ((t = m(O, t)))
                            (t.error = e), t.events.error && ((r = !0), t.emit('error', e));
                        }),
                        !r) && g.onError(e);
                  }
                  function c () {
                  ...
                  function w () {
                    ...
                    for (c(); P.length; ) {
                      ...
                      if (null === e[0])
                        return l(
                          C('mismatch', 'Mismatched anonymous define() module: ' + e[e.length - 1])
                        );
                      y(e);
                    }
                  }
                  ...
                  return (
                                  ...
                                  : ((s = u(this, function (e) {
                                    ...
                                    (s.error = u(this, function (e) {
                                      (this.inited = !0),
                                        ...
                                        (e.requireModules = [r]),
                                        B(O, function (e) {
                                          0 === e.map.id.indexOf(r + '_unnormalized') &&
                                            h(e.map.id);
                                        }),
                                        l(e);
                                    })),
                    ...
                    (x = {
                          ...
                          e.shim &&
                            (B(e.shim, function (e, n) {
                              H(e) && (e = { deps: e }),
                                (e.exports || e.init) &&
                                  !e.exportsFn &&
                                  (e.exportsFn = x.makeShimExports(e)),
                                (t[n] = e);
                            }),
                            (A.shim = t)),
                          e.packages &&
                      ...
                      completeLoad: function (e) {
                        ...
                        if (!n && !t(j, e) && r && !r.inited) {
                          if (A.enforceDefine && (!o || !da(o)))
                            return i(e)
                              ? void 0
                              : l(C('nodefine', 'No define call for ' + e, null, [e]));
                      ...
                      nameToUrl: function (e, t, n) {
                        ...
                        if (g.jsExtRegExp.test(e)) r = e + (t || '');
                          ...
                          (r = e.join('/')),
                            ...
                            (r =
                              ('/' === r.charAt(0) || r.match(/^[\w\+\.\-]+:/) ? '' : A.baseUrl) +
                              r);
                        }
                        return A.urlArgs
                          ? r + ((-1 === r.indexOf('?') ? '?' : '&') + A.urlArgs)
                          : r;
                      },
                      load: function (e, t) {
                        g.load(x, e, t);
                      ...
                      onScriptError: function (e) {
                        var t = b(e);
                        if (!i(t.id))
                          return l(C('scripterror', 'Script error for: ' + t.id, e, [t.id]));
                      },
                    }),
                    ...
                    (g.load = function (e, t, n) {
                      ...
                      if (z)
                        return (
                          ...
                          !(
                            ...
                            0 > r.attachEvent.toString().indexOf('[native code')
                          ) &&
                          !Y
                      ...
                      if (ea)
                        try {
                          ...
                          e.onError(
                            C('importscripts', 'importScripts failed for ' + t + ' at ' + n, i, [
                              t,
                            ])
                          );
                        }
                ...
                tp.prototype = (function () {
                  ...
                  var e = [],
                    n = function (e) {
                      ...
                      return (
                        tp.sandbox === !0 && (tp.endpoint = 'sandbox'),
                        tp.endpoint &&
                          (tp.endpoint === 'sandbox'
                            ? (n = 'https://sandbox.tinypass.com')
                            : tp.endpoint !== 'prod' &&
                              tp.endpoint !== 'production' &&
                              (n = tp.endpoint)),
                        t(n, e)
                      );
                    },
                    ...
                    s = function () {
                      ...
                      return (
                        tp.sandbox === !0
                          ? (e = 'https://sandbox.tinypass.com')
                          : typeof tp.endpoint == 'undefined' ||
                            tp.endpoint === null ||
                            tp.endpoint === '' ||
                            tp.endpoint === 'prod' ||
                            tp.endpoint === 'production' ||
                            tp.endpoint.match(/(buy|api|api-v3)\.tinypass\.com/)
                          ? (e = 'https://api-v3.tinypass.com')
                          : (e = tp.endpoint),
                        t(e, !0)
                      );
                    },
                        ...
                        tp.endpoint &&
                          (tp.endpoint === 'sandbox'
                            ...
                            : tp.endpoint !== 'prod' &&
                              tp.endpoint !== 'production' &&
                              ((n = tp.endpoint),
                              (n = n.replace('//buy.tinypass.com', '//experience.tinypass.com')),
                              (n = n.replace('//api.tinypass.com', '//experience.tinypass.com')),
                              (n = n.replace('//buy-au.piano.io', '//experience-au.piano.io')),
                              (n = n.replace('//api-au.piano.io', '//experience-au.piano.io')),
                              (n = n.replace('//buy-ap.piano.io', '//experience-ap.piano.io')),
                              (n = n.replace('//api-ap.piano.io', '//experience-ap.piano.io')))),
                        t(n, e)
                      );
                    },
                    u = function () {
                      return (
                        tp.sandbox === !0 ||
                        tp.endpoint === 'sandbox' ||
                        tp.endpoint.indexOf('//sandbox.tinypass.com') !== -1
                      );
                    },
                    a = {
                      constructor: tp,
                  ...
                  return (
                    ...
                    (a.loadRequireJs = function (e) {
                      ...
                      var r = function () {
                          ...
                          return (
                            e.indexOf('//buy.tinypass.com') !== -1 &&
                              (e = e.replace(/\/\/buy.tinypass.com/, '//cdn.tinypass.com')),
                            e + '/api/libs'
                          );
                        },
                        i = function () {
                      ...
                      window.tp.require.config({
                        ...
                        tp.require(
                          ...
                          function (t) {
                            ...
                            if (__tp) {
                              var r = [];
                              for (n = 0; n < __tp.length; n++)
                                __tp[n][0] === 'init' && r.push(__tp[n][1]);
                              r.length && tp._init(r), (__tp = null);
                            }
                            tp.externalLibraries.length
                              ? require(tp.externalLibraries, function () {
                                  tp.externalLibraries = [];
                                  if (tp.externalLibrariesCallbacks)
                                    for (var t = 0; t < tp.externalLibrariesCallbacks.length; ++t)
                                      tp.externalLibrariesCallbacks[t]();
                    ...
                    (a.loadRequireReady = function () {
                      ...
                      for (i = 0; i < a.initFinishedCallbacks.length; ++i)
                        a.initFinishedCallbacks[i]();
                    ...
                    (a._init = function (e) {
                      ...
                      if (!tp.isRequireLoaded) {
                        ...
                        window.tp.util &&
                          window.tp.util.hasQueryParamByName('xpdebug') &&
                          tp.setDebug(!0),
                          tp.api.setUserProvider(tp.user.getProvider()),
                          tp.util.setTpccCookies();
                        if (
                          tp.util.isIOsUiWebView() &&
                          !tp.user.isUserValid() &&
                          tp.util.getQueryParamByName('userToken')
                        ) {
                          ...
                          tp.util.setAccessTokenListCookie({ cookie_domain: i, value: o }, s),
                        ...
                        for (t = 0; t < tp.initCallbacks.length; ++t)
                          try {
                            tp.initCallbacks[t]();
                          } catch (a) {
                        ...
                        tp.appList.indexOf(tp.aid) < 0 &&
                          (tp.appList.push(tp.aid), tp.main.init()),
                          u ||
                            tp.api.callApi('/anon/error/log', {
                              log_message:
                                'Incorrect aid integration: ' +
                                tp.aid +
                                ' url: ' +
                    ...
                    (a.init = function (e) {
                      ...
                      a.isInitRequired
                        ? a.isInitRequireFinished
                          ? t()
                          : a.initFinishedCallbacks.push(t)
                        : window.tp.loadRequireJs(t);
                    }),
                    a
                  );
                })();
        ...
        (function (e, t) {
          ...
          function y (e) {
            var t = !!e && 'length' in e && e.length,
              n = p.type(e);
            return n === 'function' || p.isWindow(e)
              ? !1
          ...
          function H () {
            r.addEventListener
              ? (r.removeEventListener('DOMContentLoaded', B), e.removeEventListener('load', B))
              : (r.detachEvent('onreadystatechange', B), e.detachEvent('onload', B));
          }
          function B () {
            if (r.addEventListener || e.event.type === 'load' || r.readyState === 'complete')
              H(), p.ready();
          }
          function R (e, t, n) {
            ...
            if (t) {
              ...
              if (r) {
                p.isArray(t)
                  ...
                  : t in r
                  ? (t = [t])
                  : ((t = p.camelCase(t)), t in r ? (t = [t]) : (t = t.split(' '))),
                  (i = t.length);
          ...
          function it (e, t) {
            ...
            if (!s)
              for (s = [], n = e.childNodes || e; (r = n[i]) != null; i++)
                !t || p.nodeName(r, t) ? s.push(r) : p.merge(s, it(r, t));
          ...
          function ft (e, t, n, r, i) {
              ...
              if (o || o === 0)
                if (p.type(o) === 'object') p.merge(m, o.nodeType ? [o] : o);
                  ...
                  (a = a || v.appendChild(t.createElement('div'))),
                    (f = (Y.exec(o) || ['', ''])[1].toLowerCase()),
                    (h = rt[f] || rt._default),
                    (a.innerHTML = h[1] + p.htmlPrefilter(o) + h[2]),
                    (s = h[0]);
                  ...
                  if (!c.tbody) {
                    ...
                    while (s--)
                      p.nodeName((l = o.childNodes[s]), 'tbody') &&
                        !l.childNodes.length &&
                        o.removeChild(l);
                  }
            ...
            while ((o = m[g++])) {
              ...
              (u = p.contains(o.ownerDocument, o)),
                (a = it(v.appendChild(o), 'script')),
                u && st(a);
              if (n) {
                s = 0;
          ...
          function Lt (e, t) {
            return p.nodeName(e, 'table') && p.nodeName(t.nodeType !== 11 ? t : t.firstChild, 'tr')
          ...
          function Dt (e, t, n, r) {
            ...
            var i,
              ...
              m = t[0],
              g = p.isFunction(m);
            if (g || (d > 1 && typeof m == 'string' && !c.checkClone && xt.test(m)))
              return e.each(function (i) {
                var s = e.eq(i);
                g && (t[0] = m.call(this, i, s.html())), Dt(s, t, n, r);
              });
            if (d) {
              (l = ft(t, e[0].ownerDocument, !1, e, r)),
                (i = l.firstChild),
              ...
              if (i || r) {
                ...
                for (; h < d; h++)
                  (o = l),
                    h !== v && ((o = p.clone(o, !0, !0)), u && p.merge(a, it(o, 'script'))),
                    n.call(e[h], o, h);
                if (u) {
                  ...
                  for (h = 0; h < u; h++)
                    (o = a[h]),
                      Z.test(o.type || '') &&
                        !p._data(o, 'globalEval') &&
                        p.contains(f, o) &&
                        (o.src
                          ? p._evalUrl && p._evalUrl(o.src)
                          : p.globalEval(
                              (o.text || o.textContent || o.innerHTML || '').replace(Nt, '')
                            ));
                }
                l = i = null;
              }
          ...
          function Pt (e, t, n) {
            var r,
              ...
              s = 0;
            for (; (r = i[s]) != null; s++)
              !n && r.nodeType === 1 && p.cleanData(it(r)),
                r.parentNode &&
                  (n && p.contains(r.ownerDocument, r) && st(it(r, 'script')),
          ...
          function Ft (e) {
            ...
            if (!n) {
              n = jt(e, t);
              if (n === 'none' || !n)
                (Ht = (Ht || p("<iframe frameborder='0' width='0' height='0'/>")).appendTo(
                  t.documentElement
                )),
                  (t = (Ht[0].contentWindow || Ht[0].contentDocument).document),
                  t.write(),
                  t.close(),
                  (n = jt(e, t)),
                  Ht.detach();
              ...
              (s[o] = p._data(r, 'olddisplay')),
                ...
                t
                  ? (!s[o] && n === 'none' && (r.style.display = ''),
                    r.style.display === '' &&
                      J(r) &&
                      (s[o] = p._data(r, 'olddisplay', Ft(r.nodeName))))
                  : ((i = J(r)),
                    ((n && n !== 'none') || !i) &&
          ...
          function sn (e, t, n, r, i) {
            var s = n === (r ? 'border' : 'content') ? 4 : t === 'width' ? 1 : 0,
              o = 0;
            for (; s < 4; s += 2)
              n === 'margin' && (o += p.css(e, n + $[s], !0, i)),
                r
                  ? (n === 'content' && (o -= p.css(e, 'padding' + $[s], !0, i)),
                    n !== 'margin' && (o -= p.css(e, 'border' + $[s] + 'Width', !0, i)))
                  : ((o += p.css(e, 'padding' + $[s], !0, i)),
                    n !== 'padding' && (o += p.css(e, 'border' + $[s] + 'Width', !0, i)));
            return o;
          }
          function on (e, t, n) {
            var r = !0,
          ...
          function dn (e, t, n) {
            var r,
              i = (gn.tweeners[t] || []).concat(gn.tweeners['*']),
              s = 0,
              o = i.length;
          ...
          function vn (e, t, n) {
            ...
            n.queue ||
              ...
              e.nodeType === 1 &&
                ...
                (f = p.css(e, 'display')),
                (l = f === 'none' ? p._data(e, 'olddisplay') || Ft(e.nodeName) : f),
                l === 'inline' &&
                  p.css(e, 'float') === 'none' &&
                  (!c.inlineBlockNeedsLayout || Ft(e.nodeName) === 'inline'
            ...
            if (!p.isEmptyObject(d)) {
              ...
              for (r in d)
                (o = dn(m ? g[r] : 0, r, h)),
                  r in g ||
                    ((g[r] = o.start),
                    m && ((o.end = o.start), (o.start = r === 'width' || r === 'height' ? 1 : 0)));
          ...
          function gn (e, t, n) {
            var r,
              ...
              f = u.promise({
                ...
                stop: function (t) {
                  ...
                  return (
                    t
                      ? (u.notifyWith(e, [f, 1, 0]), u.resolveWith(e, [f, t]))
                      : u.rejectWith(e, [f, t]),
                    this
                  );
                },
            ...
            for (; s < o; s++) {
              ...
              if (r)
                return (
                  p.isFunction(r.stop) &&
                    (p._queueHooks(f.elem, f.opts.queue).stop = p.proxy(r.stop, r)),
                  r
                );
            }
            return (
          ...
          function ir (e, t, n, r) {
            ...
            if (p.isArray(t))
              p.each(t, function (t, i) {
                n || er.test(e)
                  ? r(e, i)
                  : ir(e + '[' + (typeof i == 'object' && i != null ? t : '') + ']', i, n, r);
              });
            else if (!n && p.type(t) === 'object') for (i in t) ir(e + '[' + i + ']', t[i], n, r);
            else r(e, t);
          }
          function ar () {
            const $___old_2925ff109116ec90 = {}.constructor.getOwnPropertyDescriptor(
                window,
                'XMLHttpRequest'
              ),
              $___old_fea85540ca1c98ed = {}.constructor.getOwnPropertyDescriptor(
                window,
                'XMLHttpRequest'
              );
            try {
              if ($___old_2925ff109116ec90)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___stub_afd3abb015d4d981.XMLHttpRequest
                ));
              if ($___old_fea85540ca1c98ed)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___stub_afd3abb015d4d981.XMLHttpRequest
              ...
              if ($___old_2925ff109116ec90)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___old_2925ff109116ec90
                ));
              if ($___old_fea85540ca1c98ed)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___old_fea85540ca1c98ed
                ));
            }
          }
          function fr () {
          ...
          (p.fn = p.prototype = {
            ...
            (p.extend = p.fn.extend = function () {
              var e,
                ...
                a = arguments.length,
                f = !1;
              typeof o == 'boolean' && ((f = o), (o = arguments[u] || {}), u++),
            ...
            p.extend({
              ...
              isPlainObject: function (e) {
                ...
                if (!c.ownFirst) for (t in e) return l.call(e, t);
                for (t in e);
              ...
              each: function (e, t) {
                ...
                if (y(e)) {
                  n = e.length;
                  for (; r < n; r++) if (t.call(e[r], r, e[r]) === !1) break;
              ...
              makeArray: function (e, t) {
                ...
                return (
                  e != null &&
                    (y(Object(e)) ? p.merge(n, typeof e == 'string' ? [e] : e) : o.call(n, e)),
                  n
                );
              },
              ...
              map: function (e, t, n) {
                ...
                } else for (o in e) (i = t(e[o], o, n)), i != null && u.push(i);
                return s.apply([], u);
              },
              guid: 1,
              proxy: function (e, t) {
                  ...
                  if (x !== 11 && (d = Y.exec(e)))
                    if ((s = d[1])) {
                      ...
                      if ((s = d[3]) && n.getElementsByClassName && t.getElementsByClassName)
                        return D.apply(r, t.getElementsByClassName(s)), r;
                    }
              ...
              var n = t.length > 0,
                ...
                s = function (s, o, u, a, l) {
                  ...
                  if (n && y !== g) {
                    ...
                    if (s) {
                      if (g > 0) while (y--) !b[y] && !w[y] && (w[y] = M.call(a));
                      w = wt(w);
                    }
            ...
            (n = st.support = {}),
                        ...
                        return r
                          ...
                          : ((r =
                            ...
                            r & 1 || (!n.sortDetached && t.compareDocumentPosition(e) === r)
                              ? e === p || (e.ownerDocument === E && b(E, e))
                                ? -1
                                : t === p || (t.ownerDocument === E && b(E, t))
                                ? 1
                                : l
                                ? H(l, e) - H(l, t)
                                : 0
              ...
              (r = st.selectors = {
                          ...
                          if (m) {
                            ...
                            if (o && y) {
                              ...
                              if (b === !1)
                                while ((h = (++p && h && h[v]) || (b = p = 0) || d.pop()))
                                  if (
                                    (u ? h.nodeName.toLowerCase() === g : h.nodeType === 1) &&
                                    ++b
                                  ) {
                                    y &&
                                      ((c = h[w] || (h[w] = {})),
                ...
                pseudos: {
                  ...
                  lang: ut(function (e) {
                    return (
                      $.test(e || '') || st.error('unsupported lang: ' + e),
                      (e = e.replace(tt, nt).toLowerCase()),
                      function (t) {
                        var n;
                        do
                          if (
                            (n = v ? t.lang : t.getAttribute('xml:lang') || t.getAttribute('lang'))
                          )
            ...
            return (
              ...
              (o = st.tokenize = function (e, t) {
                ...
                while (u) {
                  ...
                  if ((i = W.exec(u)))
                    (n = i.shift()),
                      s.push({ value: n, type: i[0].replace(U, ' ') }),
                      (u = u.slice(n.length));
                  for (o in r.filter)
                    (i = J[o].exec(u)) &&
                      (!f[o] || (i = f[o](i))) &&
                ...
                if (d.length === 1) {
                  ...
                  while (a--) {
                    ...
                    if ((h = r.find[c]))
                      if (
                        (s = h(
                          l.matches[0].replace(tt, nt),
                          (Z.test(f[0].type) && dt(t.parentNode)) || t
                        ))
                      ) {
            ...
            closest: function (e, t) {
              ...
              for (; r < i; r++)
                for (n = this[r]; n && n !== t; n = n.parentNode)
                  if (
                    n.nodeType < 11 &&
                    (o ? o.index(n) > -1 : n.nodeType === 1 && p.find.matchesSelector(n, e))
                  ) {
                    s.push(n);
                    break;
                  }
              ...
              function (e, t) {
                p.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (O[e] || (i = p.uniqueSort(i)), A.test(e) && (i = i.reverse())),
                    this.pushStack(i)
                  );
                };
              }
            ...
            var t,
              ...
              f = {
                add: function () {
                  return (
                    s &&
                      (n && !t && ((u = s.length - 1), o.push(n)),
                      (function r (t) {
                        p.each(t, function (t, n) {
                          p.isFunction(n)
                            ? (!e.unique || !f.has(n)) && s.push(n)
                            : n && n.length && p.type(n) !== 'string' && r(n);
                        });
                      })(arguments),
                      n && !t && a()),
                    this
                ...
                fireWith: function (e, n) {
                  return (
                    i || ((n = n || []), (n = [e, n.slice ? n.slice() : n]), o.push(n), t || a()),
                    this
                  );
                },
                fire: function () {
                ...
                if (r > 1) {
                  ...
                  for (; t < r; t++)
                    n[t] && p.isFunction(n[t].promise)
                      ? n[t].promise().progress(u(t, f, a)).done(u(t, l, n)).fail(o.reject)
                      : --s;
                }
            ...
            p(function () {
              ...
              (t = r.createElement('div')),
                ...
                typeof t.style.zoom != 'undefined' &&
                  ...
                  (c.inlineBlockNeedsLayout = e = t.offsetWidth === 3),
                  e && (n.style.zoom = 1)),
                n.removeChild(i);
            }),
            (function () {
          ...
          var X = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ...
            J = function (e, t) {
              return (
                (e = t || e), p.css(e, 'display') === 'none' || !p.contains(e.ownerDocument, e)
              );
            },
          ...
          (function () {
            ...
            (e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
              (c.leadingWhitespace = e.firstChild.nodeType === 3),
              (c.tbody = !e.getElementsByTagName('tbody').length),
              (c.htmlSerialize = !!e.getElementsByTagName('link').length),
              (c.html5Clone = r.createElement('nav').cloneNode(!0).outerHTML !== '<:nav></:nav>'),
              (n.type = 'checkbox'),
              (n.checked = !0),
              t.appendChild(n),
          ...
          (function () {
            ...
            for (t in { submit: !0, change: !0, focusin: !0 })
              (n = 'on' + t),
                (c[t] = n in e) ||
                  (i.setAttribute(n, 't'), (c[t] = i.attributes[n].expando === !1));
            i = null;
          })();
          ...
          (p.event = {
              ...
              n.handler && ((a = n), (n = a.handler), (i = a.selector)),
                ...
                (l = g.handle) ||
                  ((l = g.handle = function (e) {
                    return typeof p == 'undefined' || (!!e && p.event.triggered === e.type)
                      ? undefined
            ...
            trigger: function (t, n, i, s) {
              ...
              m.indexOf('.') > -1 && ((g = m.split('.')), (m = g.shift()), g.sort()),
                (u = m.indexOf(':') < 0 && 'on' + m),
                (t = t[p.expando] ? t : new p.Event(m, typeof t == 'object' && t)),
                (t.isTrigger = s ? 2 : 3),
                (t.namespace = g.join('.')),
              ...
              d = 0;
              while ((a = v[d++]) && !t.isPropagationStopped())
                (t.type = d > 1 ? f : c.bindType || m),
                  (o = (p._data(a, 'events') || {})[t.type] && p._data(a, 'handle')),
                  o && o.apply(a, n),
                  (o = u && a[u]),
                  o &&
                    o.apply &&
                    F(a) &&
                    ((t.result = o.apply(a, n)), t.result === !1 && t.preventDefault());
              t.type = m;
              if (
                !s &&
                !t.isDefaultPrevented() &&
                (!c._default || c._default.apply(v.pop(), n) === !1) &&
                F(i) &&
                u &&
                i[m] &&
                !p.isWindow(i)
              ...
              while ((s = u[t++]) && !e.isPropagationStopped()) {
                ...
                while ((o = s.handlers[n++]) && !e.isImmediatePropagationStopped())
                  if (!e.rnamespace || e.rnamespace.test(o.namespace))
                    (e.handleObj = o),
                      (e.data = o.data),
                      (r = ((p.event.special[o.origType] || {}).handle || o.handler).apply(
                        s.elem,
                        a
                      )),
                      r !== undefined &&
            ...
            fix: function (e) {
              ...
              return (
                e.target || (e.target = o.srcElement || r),
            ...
            keyHooks: {
              ...
              filter: function (e, t) {
                return (
                  e.which == null && (e.which = t.charCode != null ? t.charCode : t.keyCode), e
                );
              },
            },
            mouseHooks: {
              ...
              filter: function (e, t) {
                ...
                return (
                  ...
                  !e.relatedTarget && u && (e.relatedTarget = u === e.target ? t.toElement : u),
                  !e.which && o !== undefined && (e.which = o & 1 ? 1 : o & 2 ? 3 : o & 4 ? 2 : 0),
                  e
                );
              },
            },
              ...
              e && e.type
                ? ((this.originalEvent = e),
                  ...
                  (this.isDefaultPrevented =
                    e.defaultPrevented ||
                    (e.defaultPrevented === undefined && e.returnValue === !1)
                      ? vt
                      : mt))
                : (this.type = e),
                t && p.extend(this, t),
          ...
          p.extend({
            ...
            clone: function (e, t, n) {
              ...
              c.html5Clone || p.isXMLDoc(e) || !wt.test('<' + e.nodeName + '>')
                ? (s = e.cloneNode(!0))
                : ((kt.innerHTML = e.outerHTML), kt.removeChild((s = kt.firstChild)));
              if (
                ...
                (r = it(s)), (u = it(e));
                for (o = 0; (i = u[o]) != null; ++o) r[o] && _t(i, r[o]);
              }
              if (t)
                if (n) {
                  (u = u || it(e)), (r = r || it(s));
                  for (o = 0; (i = u[o]) != null; o++) Mt(i, r[o]);
                } else Mt(e, s);
              return (
                (r = it(s, 'script')),
                r.length > 0 && st(r, !a && it(e, 'script')),
                (r = u = i = null),
                s
              );
            },
              ...
              for (; (r = e[u]) != null; u++)
                if (t || F(r)) {
                  ...
                  if (o) {
                    ...
                    f[s] &&
                      (delete f[s],
                      !l && typeof r.removeAttribute != 'undefined'
                        ? r.removeAttribute(a)
                        : (r[a] = undefined),
                      n.push(s));
                  }
                ...
                return Q(
                  ...
                  function (e) {
                    var t = this[0] || {},
                      ...
                      r = this.length;
                    if (e === undefined)
                      return t.nodeType === 1 ? t.innerHTML.replace(bt, '') : undefined;
                    if (
                      typeof e == 'string' &&
                      !St.test(e) &&
                      (c.htmlSerialize || !wt.test(e)) &&
                      (c.leadingWhitespace || !et.test(e)) &&
                      !rt[(Y.exec(e) || ['', ''])[1].toLowerCase()]
                    ) {
                      e = p.htmlPrefilter(e);
                      try {
                        for (; n < r; n++)
                          (t = this[n] || {}),
                            t.nodeType === 1 && (p.cleanData(it(t, !1)), (t.innerHTML = e));
                        t = 0;
                      } catch (i) {}
                    }
              ...
              replaceWith: function () {
                ...
                return Dt(
                  ...
                  function (t) {
                    ...
                    p.inArray(this, e) < 0 &&
                      (p.cleanData(it(this)), n && n.replaceChild(t, this));
                  },
                  e
                );
              },
              ...
              function (e, t) {
                p.fn[e] = function (e) {
                  var n,
                    ...
                    u = s.length - 1;
                  for (; r <= u; r++)
                    (n = r === u ? this : this.clone(!0)), p(s[r])[t](n), o.apply(i, n.get());
          ...
          (function () {
            function l () {
              ...
              h.appendChild(a),
                ...
                (n = o = !0),
                e.getComputedStyle &&
                  ((c = e.getComputedStyle(f)),
                  (t = (c || {}).top !== '1%'),
                  (u = (c || {}).marginLeft === '2px'),
                  (i = (c || { width: '4px' }).width === '4px'),
                  (f.style.marginRight = '50%'),
                  (n = (c || { marginRight: '4px' }).marginRight === '4px'),
                  (l = f.appendChild(r.createElement('div'))),
                  (l.style.cssText = f.style.cssText =
            ...
            (f.style.cssText = 'float:left;opacity:.5'),
              (c.opacity = f.style.opacity === '0.5'),
              (c.cssFloat = !!f.style.cssFloat),
              (f.style.backgroundClip = 'content-box'),
              (f.cloneNode(!0).style.backgroundClip = ''),
              (c.clearCloneStyle = f.style.backgroundClip === 'content-box'),
              (a = r.createElement('div')),
              (a.style.cssText =
              ...
              (c.boxSizing =
                f.style.boxSizing === '' ||
                f.style.MozBoxSizing === '' ||
                f.style.WebkitBoxSizing === ''),
              p.extend(c, {
          ...
          p.extend({
            ...
            style: function (e, t, n, r) {
              ...
              var i,
                ...
                u = p.camelCase(t),
                a = e.style;
              (t = p.cssProps[u] || (p.cssProps[u] = tn(u) || u)),
                (o = p.cssHooks[t] || p.cssHooks[u]);
              if (n === undefined)
                return o && 'get' in o && (i = o.get(e, !1, r)) !== undefined ? i : a[t];
              (s = typeof n),
                s === 'string' && (i = V.exec(n)) && i[1] && ((n = K(e, t, i)), (s = 'number'));
              if (n == null || n !== n) return;
              s === 'number' && (n += (i && i[3]) || (p.cssNumber[u] ? '' : 'px')),
                !c.clearCloneStyle &&
                  n === '' &&
            ...
            css: function (e, t, n, r) {
              ...
              return (
                ...
                s === undefined && (s = Wt(e, t, r)),
                s === 'normal' && t in Yt && (s = Yt[t]),
                n === '' || n ? ((i = parseFloat(s)), n === !0 || isFinite(i) ? i || 0 : s) : s
              );
            },
          }),
            p.each(['height', 'width'], function (e, t) {
              p.cssHooks[t] = {
                get: function (e, n, r) {
                  if (n)
                    return Kt.test(p.css(e, 'display')) && e.offsetWidth === 0
                      ? Rt(e, Gt, function () {
                          return on(e, t, r);
                        })
                      : on(e, t, r);
                  ...
                  return rn(
                    ...
                    r
                      ? sn(
                          ...
                          t,
                          r,
                          c.boxSizing && p.css(e, 'boxSizing', !1, i) === 'border-box',
                          i
                        )
                      : 0
                  );
            ...
            (p.cssHooks.marginRight = Vt(c.reliableMarginRight, function (e, t) {
              if (t) return Rt(e, { display: 'inline-block' }, Wt, [e, 'marginRight']);
            })),
            (p.cssHooks.marginLeft = Vt(c.reliableMarginLeft, function (e, t) {
              if (t)
                return (
                  (parseFloat(Wt(e, 'marginLeft')) ||
                    (p.contains(e.ownerDocument, e)
            ...
            (un.prototype = {
              ...
              run: function (e) {
                ...
                return (
                  ...
                  n && n.set ? n.set(this) : un.propHooks._default.set(this),
                  this
                );
              },
            }),
            (un.prototype.init.prototype = un.prototype),
            (un.propHooks = {
              _default: {
                get: function (e) {
                  var t;
                  return e.elem.nodeType !== 1 ||
                    ...
                    ? e.elem[e.prop]
                    : ((t = p.css(e.elem, e.prop, '')), !t || t === 'auto' ? 0 : t);
                },
                set: function (e) {
                  p.fx.step[e.prop]
                    ? p.fx.step[e.prop](e)
                    : e.elem.nodeType !== 1 ||
                      (e.elem.style[p.cssProps[e.prop]] == null && !p.cssHooks[e.prop])
                    ? (e.elem[e.prop] = e.now)
          ...
          (p.Animation = p.extend(gn, {
            ...
            tweener: function (e, t) {
              ...
              var n,
                ...
                i = e.length;
              for (; r < i; r++)
                (n = e[r]), (gn.tweeners[n] = gn.tweeners[n] || []), gn.tweeners[n].unshift(t);
            },
            prefilters: [vn],
              ...
              stop: function (e, t, n) {
                ...
                return (
                  ...
                  this.each(function () {
                    ...
                    else for (i in o) o[i] && o[i].stop && cn.test(i) && r(o[i]);
                    for (i = s.length; i--; )
                      s[i].elem === this &&
                        (e == null || s[i].queue === e) &&
            ...
            (function () {
              ...
              (n = r.createElement('div')),
                ...
                (c.getSetAttribute = n.className !== 't'),
                (c.style = /top/.test(e.getAttribute('style'))),
                (c.hrefNormalized = e.getAttribute('href') === '/a'),
                (c.checkOn = !!t.value),
                (c.optSelected = s.selected),
                (c.enctype = !!r.createElement('form').enctype),
                (i.disabled = !0),
                (c.optDisabled = !s.disabled),
                (t = r.createElement('input')),
                ...
                if (i)
                  return (
                    ...
                    t && 'get' in t && (n = t.get(i, 'value')) !== undefined
                      ? n
                      : ((n = i.value),
                        typeof n == 'string' ? n.replace(yn, '') : n == null ? '' : n)
                  );
                return;
              }
              return (
                ...
                select: {
                  get: function (e) {
                    ...
                    for (; a < u; a++) {
                      ...
                      if (
                        (n.selected || a === i) &&
                        (c.optDisabled ? !n.disabled : n.getAttribute('disabled') === null) &&
                  ...
                  set: function (e, t) {
                    ...
                    while (o--) {
                      r = i[o];
                      if (p.inArray(p.valHooks.option.get(r), s) > -1)
                        try {
                          r.selected = n = !0;
                        } catch (u) {
                          r.scrollHeight;
          ...
          p.fn.extend({
            ...
            p.extend({
              attr: function (e, t, n) {
                ...
                if (s !== 1 || !p.isXMLDoc(e))
                  (t = t.toLowerCase()),
                    (i = p.attrHooks[t] || (p.expr.match.bool.test(t) ? En : wn));
                if (n !== undefined) {
                  if (n === null) {
                    p.removeAttr(e, t);
                    return;
                  }
                  return i && 'set' in i && (r = i.set(e, n, t)) !== undefined
                    ? r
                    : (e.setAttribute(t, n + ''), n);
                }
                return i && 'get' in i && (r = i.get(e, t)) !== null
                  ? r
                  : ((r = p.find.attr(e, t)), r == null ? undefined : r);
              },
              attrHooks: {
                type: {
                  set: function (e, t) {
              ...
              set: function (e, t, n) {
                return (
                  t === !1
                    ? p.removeAttr(e, n)
                    : (Nn && Tn) || !xn.test(n)
                    ? e.setAttribute((!Tn && p.propFix[n]) || n, n)
              ...
              propHooks: {
                tabIndex: {
                  get: function (e) {
                    ...
                    return t
                      ? parseInt(t, 10)
                      : Cn.test(e.nodeName) || (kn.test(e.nodeName) && e.href)
                      ? 0
                      : -1;
                  },
                },
          ...
          p.fn.extend({
            ...
            hasClass: function (e) {
              ...
              t = ' ' + e + ' ';
              while ((n = this[r++]))
                if (n.nodeType === 1 && (' ' + An(n) + ' ').replace(Ln, ' ').indexOf(t) > -1)
                  return !0;
              return !1;
            },
          }),
          ...
          p.extend({
            ...
            ajax: function (t, n) {
              function T (t, n, r, i) {
                ...
                if (l)
                  c.ifModified &&
                    ...
                    t === 204 || c.type === 'HEAD'
                      ...
                      : t === 304
                      ? (T = 'notmodified')
                      : ((T = E.state), (y = E.data), (b = E.error), (l = !b));
                else {
                  b = T;
                ...
                (S.status = t),
                  (S.statusText = (n || T) + ''),
                  l ? v.resolveWith(h, [y, T, S]) : v.rejectWith(h, [S, T, b]),
                  S.statusCode(g),
                  (g = undefined),
                  a && d.trigger(l ? 'ajaxSuccess' : 'ajaxError', [S, c, l ? y : b]),
                  m.fireWith(h, [S, T]),
                  a &&
                    (d.trigger('ajaxComplete', [S, c]), --p.active || p.event.trigger('ajaxStop'));
              }
              ...
              (v.promise(S).complete = m.add),
                (S.success = S.done),
                (S.error = S.fail),
                (c.url = ((t || c.url || Wn) + '').replace(Pn, '').replace(In, Xn[1] + '//')),
                ...
                (c.dataTypes = p
                  ...
                  .match(_) || ['']),
                c.crossDomain == null &&
                  ((r = qn.exec(c.url.toLowerCase())),
                  (c.crossDomain = !(
                    !r ||
                    (r[1] === Xn[1] &&
                      r[2] === Xn[2] &&
                      (r[3] || (r[1] === 'http:' ? '80' : '443')) ===
                        (Xn[3] || (Xn[1] === 'http:' ? '80' : '443')))
                  ))),
                c.data &&
                  c.processData &&
              ...
              if (w === 2) return S;
              (a = p.event && c.global),
                a && p.active++ === 0 && p.event.trigger('ajaxStart'),
                (c.type = c.type.toUpperCase()),
                (c.hasContent = !Fn.test(c.type)),
                (s = c.url),
                c.hasContent ||
                  (c.data && ((s = c.url += (_n.test(s) ? '&' : '?') + c.data), delete c.data),
                  c.cache === !1 &&
                    (c.url = Hn.test(s)
                      ? s.replace(Hn, '$1_=' + Mn++)
                      : s + (_n.test(s) ? '&' : '?') + '_=' + Mn++)),
                c.ifModified &&
                  (p.lastModified[s] && S.setRequestHeader('If-Modified-Since', p.lastModified[s]),
                  p.etag[s] && S.setRequestHeader('If-None-Match', p.etag[s])),
            ...
            p.each(['get', 'post'], function (e, t) {
              p[t] = function (e, n, r, i) {
                return (
                  p.isFunction(n) && ((i = i || r), (r = n), (n = undefined)),
                  p.ajax(
                    p.extend(
            ...
            (p.expr.filters.hidden = function (e) {
              return c.reliableHiddenOffsets()
              ...
              e.ActiveXObject !== undefined
                ? function () {
                    return this.isLocal
                      ...
                      : r.documentMode > 8
                      ? ar()
                      : (/^(get|post|head|put|delete|options)$/i.test(this.type) && ar()) || fr();
                  }
                : ar);
          var sr = 0,
            or = {},
          ...
          e.attachEvent &&
            ...
            (c.cors = !!ur && 'withCredentials' in ur),
            (ur = c.ajax = !!ur),
            ur &&
                ...
                if (!t.crossDomain || c.cors) {
                  ...
                  return {
                    send: function (r, i) {
                      ...
                      if (t.xhrFields) for (s in t.xhrFields) o[s] = t.xhrFields[s];
                        ...
                        (n = function (e, r) {
                          ...
                          if (n && (r || o.readyState === 4)) {
                            ...
                            if (r) o.readyState !== 4 && o.abort();
                              ...
                              (f = {}),
                                (s = o.status),
                                typeof o.responseText == 'string' && (f.text = o.responseText);
                              try {
                                a = o.statusText;
                              } catch (l) {
                                a = '';
          ...
          p.ajaxSetup({
            ...
            p.ajaxPrefilter('json jsonp', function (t, n, r) {
              ...
              if (u || t.dataTypes[0] === 'jsonp')
                return (
                  (i = t.jsonpCallback = p.isFunction(t.jsonpCallback)
                    ? t.jsonpCallback()
                    : t.jsonpCallback),
                  u
                    ? (t[u] = t[u].replace(cr, '$1' + i))
                    : t.jsonp !== !1 &&
                      (t.url += (_n.test(t.url) ? '&' : '?') + t.jsonp + '=' + i),
                  ...
                  r.always(function () {
                    s === undefined ? p(e).removeProp(i) : (e[i] = s),
                      t[i] && ((t.jsonpCallback = n.jsonpCallback), lr.push(i)),
            ...
            (p.parseHTML = function (e, t, n) {
              ...
              return i
                ? [t.createElement(i[1])]
                : ((i = ft([e], t, s)), s && s.length && p(s).remove(), p.merge([], i.childNodes));
            });
          var hr = p.fn.load;
          return (
            (p.fn.load = function (e, t, n) {
              ...
              var r,
                ...
                u = e.indexOf(' ');
              return (
                u > -1 && ((r = p.trim(e.slice(u, e.length))), (e = e.slice(0, u))),
                p.isFunction(t)
                  ? ((n = t), (t = undefined))
            ...
            (p.offset = {
              setOffset: function (e, t, n) {
                ...
                l === 'static' && (e.style.position = 'relative'),
                  ...
                  p.isFunction(t) && (t = t.call(e, n, p.extend({}, u))),
            ...
            p.fn.extend({
              offset: function (e) {
                ...
                return (
                  (t = s.documentElement),
                  p.contains(t, i)
                    ? (typeof i.getBoundingClientRect != 'undefined' &&
              ...
              p.fn[e] = function (r) {
                return Q(
                  ...
                  function (e, r, i) {
                    ...
                    s
                      ? s.scrollTo(n ? p(s).scrollLeft() : i, n ? i : p(s).scrollTop())
                      : (e[r] = i);
                  },
                  e,
                  r,
            ...
            (function (e, t, n) {
              const $___old_eb4ca1a810db8067 = {}.constructor.getOwnPropertyDescriptor(
                Navigator.prototype,
                'userAgent'
              );
              try {
                if ($___old_eb4ca1a810db8067)
                  ({}.constructor.defineProperty(
                    Navigator.prototype,
                    'userAgent',
                ...
                return function () {
                  ...
                  (e.migrateWarnings = []),
                    ...
                    'BackCompat' === r.compatMode &&
                      i('jQuery is not compatible with Quirks Mode');
                  var u = e('<input/>', { size: 1 }).attr('size') && e.attrFn,
                    a = e.attr,
                    f =
                  ...
                  s(e, 'attrFn', u || {}, 'jQuery.attrFn is deprecated'),
                    (e.attr = function (t, r, s, o) {
                      var f = r.toLowerCase(),
                        l = t && t.nodeType;
                      return o &&
                        (a.length < 4 && i('jQuery.fn.attr( props, pass ) is deprecated'),
                        t && !h.test(l) && (u ? r in u : e.isFunction(e.fn[r])))
                        ? e(t)[r](s)
                        : ('type' === r &&
                            s !== n &&
                            c.test(t.nodeName) &&
                  ...
                  (e.fn.init = function (t, s, o) {
                    ...
                    return t &&
                      ...
                      (u = x.exec(e.trim(t))) &&
                      u[0] &&
                      (w.test(t) || i("$(html) HTML strings must start with '<' character"),
                      u[3] && i('$(html) HTML text after last tag is ignored'),
                      '#' === u[0].charAt(0) &&
                      ...
                      e.parseHTML)
                      ? g.call(this, e.parseHTML(u[2], (s && s.ownerDocument) || s || r, !0), s, o)
                      : ((a = g.apply(this, arguments)),
                        t && t.selector !== n
                          ? ((a.selector = t.selector), (a.context = t.context))
                          : ((a.selector = 'string' == typeof t ? t : ''),
                            t && (a.context = t.nodeType ? t : s || r)),
                        a);
                  }),
                    (e.fn.init.prototype = e.fn),
                    (e.find = function (e) {
                      var t = Array.prototype.slice.call(arguments);
                      if ('string' == typeof e && E.test(e))
                        try {
                          r.querySelector(e);
                        } catch (n) {
                  ...
                  (e.parseJSON = function (e) {
                    ...
                    e.browser ||
                      ((v = e.uaMatch(navigator.userAgent)),
                      (m = {}),
                      v.browser && ((m[v.browser] = !0), (m.version = v.version)),
                      m.chrome ? (m.webkit = !0) : m.webkit && (m.safari = !0),
                      (e.browser = m)),
                    s(e, 'browser', e.browser, 'jQuery.browser is deprecated'),
                    (e.boxModel = e.support.boxModel = 'CSS1Compat' === r.compatMode),
                    s(e, 'boxModel', e.boxModel, 'jQuery.boxModel is deprecated'),
                    s(
                      e.support,
                      'boxModel',
                      e.support.boxModel,
                    ...
                    (e.fn.size = function () {
                      return (
                        i('jQuery.fn.size() is deprecated; use the .length property'), this.length
                      );
                    });
                  var N = !1;
                  e.swap &&
                  ...
                  e.fn.data = function (t) {
                    ...
                    return !o ||
                      'events' !== t ||
                      1 !== arguments.length ||
                      ((r = e.data(o, t)), (s = e._data(o, t)), (r !== n && r !== s) || s === n)
                      ? C.apply(this, arguments)
                      : (i("Use of jQuery.fn.data('events') is deprecated"), s);
                  };
                  var k = /\/(java|ecma)script/i;
                  e.clean ||
                    (e.clean = function (t, n, s, o) {
                      (n = n || r),
                        (n = (!n.nodeType && n[0]) || n),
                        (n = n.ownerDocument || n),
                      ...
                      if ((e.merge(c, e.buildFragment(t, n).childNodes), s))
                        for (
                          ...
                          (e.nodeName(a, 'script') && f(a)) ||
                            (s.appendChild(a),
                            'undefined' != typeof a.getElementsByTagName &&
                              ((l = e.grep(e.merge([], a.getElementsByTagName('script')), f)),
                              c.splice.apply(c, [u + 1, 0].concat(l)),
                              (u += l.length)));
                      return c;
                    });
                  var L = e.event.add,
                  ...
                  e.event.props &&
                    ...
                    (e.fn.live = function (t, n, r) {
                      return (
                        ...
                        _
                          ...
                          : (e(this.context).on(t, this.selector, n, r), this)
                      );
                    }),
                    ...
                    (e.event.trigger = function (e, t, n, s) {
                      return (
                        n || B.test(e) || i('Global events are undocumented and deprecated'),
                    ...
                    e.each(H.split('|'), function (t, n) {
                      e.event.special[n] = {
                        setup: function () {
                          ...
                          return (
                            t !== r &&
                              (e.event.add(r, n + '.' + e.guid, function () {
                                e.event.trigger(
                                  n,
              ...
              (e[a] = function (t, n, r) {
                ...
                (t = typeof t == 'string' ? t : e.param(t)),
                  ...
                  c
                    ? r[a](t, n.replace(/([^:]+:\/\/[^\/]+).*/, '$1'))
                    : n &&
                      (r.location = n.replace(/#.*$/, '') + '#' + +new Date() + i++ + '&' + t);
              }),
                (e.receiveMessage = l = function (i, a, h) {
                  c
                    ? (i &&
                        ...
                        (s = function (t) {
                          if (
                            (typeof a == 'string' && t.origin !== a) ||
                            (e.isFunction(a) && a(t.origin) === u)
                          )
                            return u;
                          i(t);
                        })),
                      o[f]
                        ? o[i ? f : 'removeEventListener']('message', s, u)
                        : o[i ? 'attachEvent' : 'detachEvent']('onmessage', s))
                    : (t && clearInterval(t),
                      (t = null),
                      i &&
                        ((h = typeof a == 'number' ? a : typeof h == 'number' ? h : 100),
                  ...
                  (this.o = null),
                    ...
                    (this.run = function () {
                      ...
                      this.$.data('kontroled', !0),
                        ...
                        (this.o = t.extend(
                          {
                            ...
                            cursor:
                              (this.$.data('cursor') === !0 && 30) || this.$.data('cursor') || 0,
                            thickness:
                              (this.$.data('thickness') &&
                        ...
                        (this.$c = t(r.createElement('canvas'))),
                      ...
                      return (
                        ...
                        this.v instanceof Object
                          ...
                          : (this.cv = this.v),
                        this.$.bind('configure', n).parent().bind('configure', n),
                    ...
                    (this._touch = function (e) {
                      var t = function (e) {
                        var t = i.xy2val(
                          e.originalEvent.touches[i.t].pageX,
                          e.originalEvent.touches[i.t].pageY
                        );
                        if (t == i.cv) return;
                      ...
                      return (
                        (this.t = n.c.t(e)),
                        t(e),
                        n.c.d.bind('touchmove.k', t).bind('touchend.k', function () {
                ...
                (n.Dial = function () {
                  n.o.call(this),
                    ...
                    (this.val = function (e) {
                      ...
                      (this.cv = this.o.stopper ? i(s(e, this.o.max), this.o.min) : e),
                        (this.v = this.cv),
                        this.$.val(this.v),
                        this._draw();
                    }),
                    (this.xy2val = function (e, t) {
                      ...
                      return (
                        (n =
                          ...
                          this.angleOffset),
                        this.angleArc != this.PI2 && n < 0 && n > -0.5
                          ? (n = 0)
                          : n < 0 && (n += this.PI2),
                        (r =
                          ~~(0.5 + (n * (this.o.max - this.o.min)) / this.angleArc) + this.o.min),
                        this.o.stopper && (r = i(s(r, this.o.max), this.o.min)),
                        r
                      );
                    }),
                    (this.listen = function () {
                      var n = this,
                        r = function (e) {
                          ...
                          var t = e.originalEvent,
                            ...
                            s =
                              parseInt(n.$.val()) +
                              (r > 0 || i > 0 ? n.o.step : r < 0 || i < 0 ? -n.o.step : 0);
                        ...
                        u,
                        a = 1,
                        f = { 37: -n.o.step, 38: n.o.step, 39: n.o.step, 40: -n.o.step };
                      this.$.bind('keydown', function (r) {
                        var l = r.keyCode;
                        l >= 96 && l <= 105 && (l = r.keyCode = l - 48),
                          (o = parseInt(String.fromCharCode(l)));
                        if (isNaN(o)) {
                          l !== 13 && l !== 8 && l !== 9 && l !== 189 && r.preventDefault();
                          if (t.inArray(l, [37, 38, 39, 40]) > -1) {
                            r.preventDefault();
                            var c = parseInt(n.$.val()) + f[l] * a;
                            n.o.stopper && (c = i(s(c, n.o.max), n.o.min)),
                              n.change(c),
                              n._draw(),
                              (u = e.setTimeout(function () {
                                a *= 2;
                        ...
                        isNaN(o)
                          ? u && (e.clearTimeout(u), (u = null), (a = 1), n.val(n.$.val()))
                          : (n.$.val() > n.o.max && n.$.val(n.o.max)) ||
                            (n.$.val() < n.o.min && n.$.val(n.o.min));
                      }),
            ...
            (function (t) {
              function i (n) {
                const $___old_303ec35cc68e8c86 = {}.constructor.getOwnPropertyDescriptor(
                  window,
                  'localStorage'
                );
                try {
                  if ($___old_303ec35cc68e8c86)
                    ({}.constructor.defineProperty(
                      window,
                      'localStorage',
              ...
              function s (n) {
                ...
                if (t.isPlainObject(o)) {
                  for (var c in o)
                    (a = o[c]),
                      t.isPlainObject(a) ? i.setItem(c, JSON.stringify(a)) : i.setItem(c, a);
                  return o;
                }
                if (r == 3)
                  return (
                    typeof u == 'object' ? i.setItem(o, JSON.stringify(u)) : i.setItem(o, u), u
                  );
                try {
              ...
              function o (n) {
                ...
                if (t.isArray(s[f])) for (var c in s[f]) delete a[s[f][c]];
                else delete a[s[f]];
              ...
              function u (e, n) {
                ...
                if (n) for (var i in t.namespaceStorages) c(i);
              }
              function a (n) {
                var r = arguments.length,
                  s = arguments,
                ...
                if (t.isArray(u)) {
                  for (var f = 0; f < u.length; f++) if (!a(n, u[f])) return !1;
                  return !0;
                }
                try {
                  var c = i.apply(this, arguments);
                  t.isArray(s[r - 1]) || (c = { totest: c });
                  for (var f in c)
                    if (
                      !(
                        (t.isPlainObject(c[f]) && t.isEmptyObject(c[f])) ||
                        (t.isArray(c[f]) && !c[f].length) ||
                        !c[f]
                      )
                    )
                      return !1;
              ...
              function f (n) {
                ...
                if (r < 2) throw new Error('Minimum 2 arguments must be given');
                if (t.isArray(u)) {
                  for (var a = 0; a < u.length; a++) if (!f(n, u[a])) return !1;
                  return !0;
                }
                try {
                  var l = i.apply(this, arguments);
                  t.isArray(s[r - 1]) || (l = { totest: l });
                  for (var a in l) if (l[a] === undefined || l[a] === null) return !1;
                  return !0;
                } catch (c) {
                  return !1;
                }
              ...
              function c (n) {
                ...
                d
                  ? (e.localStorage.getItem(n) || e.localStorage.setItem(n, '{}'),
                    e.sessionStorage.getItem(n) || e.sessionStorage.setItem(n, '{}'))
                  : (e.localCookieStorage.getItem(n) || e.localCookieStorage.setItem(n, '{}'),
                    e.sessionCookieStorage.getItem(n) || e.sessionCookieStorage.setItem(n, '{}'));
                var r = {
                  localStorage: t.extend({}, t.localStorage, { _ns: n }),
                  sessionStorage: t.extend({}, t.sessionStorage, { _ns: n }),
                };
                return (
                  t.cookie &&
                    (e.cookieStorage.getItem(n) || e.cookieStorage.setItem(n, '{}'),
                    (r.cookieStorage = t.extend({}, t.cookieStorage, { _ns: n }))),
                  (t.namespaceStorages[n] = r),
                  r
                );
              }
              function h (t) {
                const $___old_f34f714b5760755f = {}.constructor.getOwnPropertyDescriptor(
                  window,
                  'localStorage'
                );
                try {
                  if ($___old_f34f714b5760755f)
                    ({}.constructor.defineProperty(
                      window,
                      'localStorage',
                      $___stub_b317e19f866a2da7.localStorage
                ...
                v = {
                  ...
                  _callMethod: function (e, t) {
                    ...
                    return (
                      ...
                      typeof r == 'string' &&
                        r.indexOf('.') !== -1 &&
                        (t.shift(), [].unshift.apply(t, r.split('.'))),
                      [].push.apply(n, t),
                      e.apply(this, n)
                    );
                  },
              ...
              if (t.cookie) {
                e.name || (e.name = Math.floor(Math.random() * 100000000));
                var m = {
                  _cookie: !0,
                  _prefix: '',
                  _expires: null,
                  ...
                  clear: function () {
                    for (var e in t.cookie())
                      e != '' &&
                        ((!this._prefix && e.indexOf(n) === -1 && e.indexOf(r) === -1) ||
                ...
                d ||
                  ((e.localCookieStorage = t.extend({}, m, { _prefix: n, _expires: 3650 })),
                  (e.sessionCookieStorage = t.extend({}, m, { _prefix: r + e.name + '_' }))),
                  (p.cookieStorage = t.extend({}, m)),
                  (t.cookieStorage = t.extend({}, v, {
                    _type: 'cookieStorage',
                    setExpires: function (e) {
              ...
              (t.initNamespaceStorage = function (e) {
                ...
                d
                  ? ((t.localStorage = t.extend({}, v, { _type: 'localStorage' })),
                    (t.sessionStorage = t.extend({}, v, { _type: 'sessionStorage' })))
                  : ((t.localStorage = t.extend({}, v, { _type: 'localCookieStorage' })),
                    (t.sessionStorage = t.extend({}, v, { _type: 'sessionCookieStorage' }))),
                (t.namespaceStorages = {}),
                (t.removeAllStorages = function (e) {
                  t.localStorage.removeAll(e),
                    t.sessionStorage.removeAll(e),
                    t.cookieStorage && t.cookieStorage.removeAll(e),
                    e || (t.namespaceStorages = {});
                });
            })(p),
      ...
      tp.define(
        ...
        function (e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y) {
          function w () {
            return t.getCurrentDomainFromCookie(b.__private__.VISIT_ID_COOKIE);
          }
          function E (e, t) {
            var n = b.__private__.collectedAds;
            b.__private__.collectedAds = {};
            var r = {};
            for (var i in n)
          ...
          function S () {
            if (b.__private__.isCxenseActivated())
              return b.__private__.generateCxCompatibleRandomId();
          ...
          function x () {
            var e;
            try {
              e = JSON.parse(t.__protected__.getCookie(b.__private__.VISIT_ID_COOKIE));
            } catch (n) {
              e = {};
            }
            return e;
          ...
          function T (e) {
            var t = { path: '/', expires: 1, domain: b.__private__.visitContainer.currentDomain };
            return e && (t.domain = e), t;
          }
          function N (e, n) {
            (e.domain = n.domain),
              (e.time = new Date().getTime()),
              t.__protected__.setCookie(b.__private__.VISIT_ID_COOKIE, JSON.stringify(e), n);
          }
          function C (e) {
            var n = b.__private__.getVisitCookieOptions();
            !e.domain && !b.__private__.visitContainer.currentDomain
              ? t.waitCall('domainIsReceived', function (t) {
                  b.__private__.setVisitCurrentDomain(t),
                    (n.domain = t),
                    b.__private__.saveVisitCookie(e, n);
                })
              : b.__private__.saveVisitCookie(e, n);
          }
          function k (e) {
          ...
          function L () {
            ...
            if (!b.__private__.visitContainer.currentDomain) return !1;
            var e = t.getReferrer();
            if (b.__private__.lastReferrer && b.__private__.lastReferrer === e) return !1;
            var n = t.getHostname(e),
              r = new RegExp(
                b.__private__.visitContainer.currentDomain
                  .replace(/\./g, '\\.')
                  .replace(/^\\./, '\\.?') + '$'
              ).test(n);
            return Boolean(n) && !r;
          ...
          function A () {
            var e = b.__private__.loadLastVisit(),
              t = !e || !e.id || !e.time;
            if (t || b.__private__.isTimeExpired(e) || b.__private__.hasExternalReferrer())
              e.id = 'v-' + b.__private__.generatePageViewId();
            b.__private__.saveLastVisit(e), (b.__private__.visitContainer.visit = e);
          }
          function O (n, i, s) {
            var o = 'manual';
            ...
            s || (s = tp.tags),
              ...
              typeof s != 'undefined'
                ? Object.prototype.toString.call(s) !== '[object Array]' &&
                  ...
                  ? (t.log(
                      'Tags must be an array or a comma-separated string, ignoring supplied tags'
                    ),
                    (s = ''))
                  : Object.prototype.toString.call(s) === '[object Array]' && (s = s.join(','))
                : (s = ''),
              b.__private__.pageView.track(),
              (n.page_session_id = b.__private__.pageView.pageSessionId),
              (n.track_count = b.__private__.pageView.trackCount),
              b.__private__.setPageViewId(n);
            var a;
            tp.contentCreated
              ? (a = tp.contentCreated)
              : tp.contentCreatedSelector &&
                e(tp.contentCreatedSelector).length === 1 &&
                (a = e(tp.contentCreatedSelector).html()),
              a && (n.content_created = a),
              typeof tp.contentIsNative == 'boolean' && (n.content_is_native = tp.contentIsNative),
              tp.zone && (n.zone = tp.zone);
            var f = tp.contentSection || b.__private__.getMetaTagContent('section');
            f && (n.content_section = f);
            var l = tp.contentAuthor || b.__private__.getMetaTagContent('author');
            l && (n.content_author = l);
            var c = tp.contentId || b.__private__.getMetaTagContent('id');
            c && (n.content_id = c);
            var h = t.__protected__.getCookie('sailthru_hid');
            h && (n.sailthru_hid = h);
            var p;
            b.__private__.lastReferrer && b.__private__.lastReferrer === t.getReferrer()
              ? (p = '')
              : ((p = t.getReferrer()), (b.__private__.lastReferrer = p)),
            ...
            if (
              n.adblocker === t.ADBLOCKER_STATUS.ENABLED_AFTER_DISABLED ||
              n.adblocker === t.ADBLOCKER_STATUS.ENABLED
            )
              tp.setCustomParam('_abr', t.getAdblockerStatusReason(), 'user', !0),
                tp.setCustomParam(
                  '_absh',
                  t.getAdblockerHistoryCookieInfo().cookieValue + '',
                  'user',
                  !0
                );
            (n.timezone_offset = t.getBrowserTimezoneOffset()), (n.submit_type = o);
            var d = b.__protected__.fetchVisitId();
            return (
              (n.visit_id = d),
              (n.new_visit = b.__private__.checkIfNewVisitAndUpdateLastTrackedVisitId(d)),
              (n.keywords =
                e('meta[name="keywords"]').attr('content') ||
                e('meta[name="news_keywords"]').attr('content') ||
                ''),
              ...
              e.each(['keywords', 'title', 'description', 'content_type'], function (e, t) {
                n[t] = n[t].substr(0, 8192);
              }),
              b.__private__.checkCustomVariablesInCookies(),
              (n.custom_variables = JSON.stringify(tp.customVariables)),
              b.__private__.buildPageCustomParams(n),
              n
            );
          }
          function M () {
            var n = { aid: tp.aid },
              r = t.getTbcCookie(),
              i = { active: o.getActiveTimeInSeconds(), total: o.getTotalTimeInSeconds() };
            r && (n.tbc = r),
              ...
              b.__private__.setPageViewId(n),
              (n.visit_id = b.__protected__.fetchVisitId()),
              b.__private__.markVisitToCheckForRefresh();
            var s = {},
              f = 200,
              c = a.getAds(f);
          ...
          function _ (t) {
            var n = {};
            return (
              tp.customParams && (n = e.extend(!0, {}, tp.customParams)),
              e.isEmptyObject(n) || (t.custom_params = JSON.stringify(n)),
              t
            );
          }
          function D () {
            return b.__private__.pageView.id;
          }
          function P (e) {
            var t = b.__private__.visitContainer.lastTrackedVisitId !== e;
            return (b.__private__.visitContainer.lastTrackedVisitId = e), t;
          }
          function H () {
            b.__private__.visitContainer.checkForRefresh = !0;
          }
          function B () {
            return (
              b.__private__.visitContainer.checkForRefresh &&
                (b.__private__.refreshVisit(),
                (b.__private__.visitContainer.checkForRefresh = !1)),
              b.__private__.visitContainer.visit.id
            );
          }
          function j (e) {
          ...
          function F (e) {
            b.__private__.visitContainer.currentDomain = e;
          }
          function I () {
            var t = b.__private__.getVisitCookieOptions();
            e.removeCookie(b.__private__.VISIT_ID_COOKIE, t);
          }
          function q () {
          ...
          function R (e, r, i, s) {
            ...
            if (!b.__private__.currentEnvironmentSupportsPageTrack()) return !1;
          ...
          function U () {
            b.__private__.unloadRegistered &&
              b.__private__.pageView.trackCount > 0 &&
              (b.trackPageUnload(), b.resetTimer());
          }
          function z (e) {
            if (!b.__private__.currentEnvironmentSupportsPageTrack()) return;
            try {
              var n = b.__private__.buildPageUnloadParams();
              l.isInitialized() && l.resetSumOfCodesDirectionToDefault(),
                h.__private__.logBeaconRequest(
                  tp.getTrackingEndpoint() + '/api/v3/page/unload',
                  n
                ),
                b.unregisterTrackUnload();
            } catch (r) {
              t.error('main: error on tracking page unload event: ', r);
            }
          }
          function W () {
            b.__private__.unloadTriggered ||
              ((b.__private__.unloadTriggered = !0), b.trackPageUnload(!0));
          }
          function X () {
            b.__private__.unloadRegistered = !0;
          }
          function V () {
            return b.__private__.unloadRegistered;
          }
          function $ () {
            b.__private__.unloadRegistered = !1;
          }
          function J () {
            b.__private__.unloadRegistered && b.__private__.unloadAction(),
              b.__private__.trackCollectedAds(!0, b.__private__.BEACON_REQUEST),
              p.__protected__.sendStatisticsExecutedNodes('unload');
          }
          function K () {
            o.resetRecordedTime();
          }
          ...
          function G (e) {
            e && (e.pageview_id = b.fetchPageViewId());
          }
          function Y (e, n) {
            if (!b.__private__.currentEnvironmentSupportsPageTrack()) return !1;
            try {
              b.__protected__.trackPageUnloadIfNecessary();
              var r = b.buildPageTrackParams({}, e, n);
              b.__private__.track('/page/track', r), b.registerTrackUnload();
            } catch (i) {
          ...
          function et (e, t, n) {
            b.__private__.collectedAds[e] || (b.__private__.collectedAds[e] = {}),
              (b.__private__.collectedAds[e][t] = n),
              b.__private__.debouncedTrackAds();
          }
          function tt () {
            var e = t.getQueryParamByName(b.__private__.VOUCHER_QUERY);
            e && f.startRedeemVoucher({ voucherCode: e });
          }
          function nt () {
            var e = t.getQueryParamByName(b.__private__.VERIFICATION_CODE_QUERY);
            if (!e || i.getProvider().name !== 'pianoId') return;
            t.waitCall('offerCreate', function () {
              d.isUserValid()
                ? d.__protected__.showEmailConfirmation({ verification_code: e })
                : d.show({ verification_code: e });
            });
          }
          function rt () {
          ...
          function it () {
            return b.__private__.externalResourcesDef
              ? b.__private__.externalResourcesDef.promise()
              : ((b.__private__.externalResourcesDef = e.Deferred()),
                t.__protected__.getLocalStorageItem(b.__private__.EXTERNAL_RESOURCES) !== null &&
                  b.__private__.externalResourcesDef.resolve({
                    has_active_apple_pay_card: t.__protected__.getLocalStorageItem(
                      b.__private__.EXTERNAL_RESOURCES
                    ),
                  }),
                tp.applePayMerchantId
                  ? (m.__protected__.applePayCanMakePaymentsWithActiveCard().then(function (e) {
                      b.__private__.externalResourcesDef.resolve({ has_active_apple_pay_card: e }),
                        t.__protected__.setLocalStorageItem(
                          b.__private__.EXTERNAL_RESOURCES,
                          e,
                          b.__private__.EXTERNAL_RESOURCES_TTL
                        );
                    }),
                    b.__private__.externalResourcesDef.promise())
                  : (b.__private__.externalResourcesDef.resolve({
          ...
          function ut () {
            var n = t.getCustomVariablesFromCookies();
            e.each(n, function (e, t) {
              tp.setCustomVariable(e, t);
            });
          }
          function at () {
            if (tp.aid.length === 0) {
            ...
            tp.isMockMode || (a.initialize(), o.initialize(), u.initialize()),
              c.initialize(),
              m.initialize(),
              b.__private__.checkVoucher(),
              b.__private__.checkVerificationCode(),
              d.__protected__.checkAndShowEmailIsNotConfirmed(),
              b.__private__.initPianoEsp(),
              b.__private__.checkThreeDSRedirect(),
              i.refreshAccessToken(),
              b.__protected__.externalResourcesDelay();
            var e = i.getProvider();
            e.__private__ &&
              t.isFunction(e.__private__.extendUserToken) &&
              e.__private__.extendUserToken();
          }
          var b = { __private__: {}, __protected__: {} };
          return (
            (b.name = 'main'),
            (b.pageTrack = Y),
            (b.trackPage = b.pageTrack),
            (b.buildPageTrackParams = O),
            (b.fetchPageViewId = D),
            (b.trackPageUnload = z),
            (b.registerTrackUnload = X),
            (b.isRegisteredTrackUnload = V),
            (b.unregisterTrackUnload = $),
            (b.resetTimer = K),
            (b.resetAds = Q),
            (b.trackAds = Z),
            (b.trackAd = et),
            (b.init = at),
            (b.__protected__.fetchVisitId = B),
            (b.__protected__.trackPageUnloadIfNecessary = U),
            (b.__protected__.externalResourcesDelay = it),
            (b.__private__.BEACON_REQUEST = 'beacon_request'),
            (b.__private__.saveVisitCookie = N),
            (b.__private__.trackCollectedAds = E),
            (b.__private__.getCurrentDomain = w),
            (b.__private__.generatePageViewId = S),
            (b.__private__.loadLastVisit = x),
            (b.__private__.getVisitCookieOptions = T),
            (b.__private__.saveLastVisit = C),
            (b.__private__.isTimeExpired = k),
            (b.__private__.hasExternalReferrer = L),
            (b.__private__.refreshVisit = A),
            (b.__private__.setPageViewId = G),
            (b.__private__.buildPageUnloadParams = M),
            (b.__private__.buildPageCustomParams = _),
            (b.__private__.checkIfNewVisitAndUpdateLastTrackedVisitId = P),
            (b.__private__.markVisitToCheckForRefresh = H),
            (b.__private__.getMetaTagContent = j),
            (b.__private__.setVisitCurrentDomain = F),
            (b.__private__.invalidateLastVisit = I),
            (b.__private__.currentEnvironmentSupportsPageTrack = q),
            (b.__private__.track = R),
            (b.__private__.unloadAction = W),
            (b.__private__.unloadHandler = J),
            (b.__private__.checkVoucher = tt),
            (b.__private__.checkVerificationCode = nt),
            (b.__private__.initPianoEsp = v.__protected__.init),
            (b.__private__.checkThreeDSRedirect = rt),
            (b.__private__.isCxenseActivated = st),
            (b.__private__.generateCxCompatibleRandomId = ot),
            (b.__private__.checkCustomVariablesInCookies = ut),
            (b.__private__.VOUCHER_QUERY = 'voucher_code'),
            (b.__private__.VERIFICATION_CODE_QUERY = 'verification_code'),
            (b.__private__.VISIT_ID_COOKIE = '__pvi'),
            (b.__private__.unloadRegistered = !1),
            (b.__private__.unloadTriggered = !1),
            (b.__private__.collectedAds = {}),
            (b.__private__.debouncedTrackAds = t.debounce(b.__private__.trackCollectedAds, 3000)),
            (b.__private__.lastReferrer = null),
            (b.__private__.pageView = {
              id: b.__private__.generatePageViewId(),
              pageSessionId: 's-' + b.__private__.generatePageViewId(),
              trackCount: 0,
              tracked: !1,
              track: function () {
                this.tracked
                  ? (this.id = b.__private__.generatePageViewId())
                  : (this.tracked = !0),
                  this.trackCount++;
              },
            }),
            (b.__private__.visitContainer = {
              currentDomain: b.__private__.getCurrentDomain(),
              lastTrackedVisitId: b.__private__.loadLastVisit().id,
              visit: {},
              checkForRefresh: !1,
            }),
            b.__private__.refreshVisit(),
            (b.__private__.EXTERNAL_RESOURCES = 'exrs'),
            (b.__private__.EXTERNAL_RESOURCES_TTL = 7200),
            (b.__private__.externalResourcesDef = null),
            e(window).on('beforeunload unload', b.__private__.unloadHandler),
            b
          );
        }
      ),
      tp.define('api', ['jq', 'util'], function (e, t) {
        var n = t.findCookieByName(/__TP_*/),
          ...
          s;
        typeof window._tpm != 'undefined' &&
          typeof window._tpm.paywallID != 'undefined' &&
          ((paywallID = window._tpm.paywallID),
          (s = t.__protected__.getCookie('umc_' + window._tpm.paywallID)));
        var o = t.__protected__.getCookie('__tac'),
          ...
          a = function (e) {
            ...
            if (typeof e.user_provider == 'undefined' || !e.user_provider)
              e.user_provider = r.getName();
            if (typeof e.user_token == 'undefined' || !e.user_token)
              e.user_token = r.getToken() && r.getToken().length > 0 ? r.getToken() : '';
          },
          f = function (e) {
            var t = '/access/list',
              n = '/access/check',
              ...
              s = e === t || e === n || e === r || e === i;
            if (!s) return null;
            var o = Math.floor(new Date().getTime() / 1000),
              u = { code: 0, count: 0, data: [], limit: 0, offset: 0, total: 0, ts: o },
              a = {
                code: 0,
                ts: 1548942314,
                access: {
      ...
      tp.define(
        ...
        function (e, t, n, r, i, s, o, u, a) {
          function C (e, t) {
            var i = r.getUserInfoParams(e.config),
              s = { iframeParams: e.iframeParams, templateContextParams: i };
            (s.templateContextParams.tracking_id = e.config.trackingId),
              (s.templateContextParams.aid = e.iframeParams.aid),
              (s.iframeParams.trackingId = e.config.trackingId),
              n.send('templateContextDeferredLoadingInitiated', s, t.params.iframeId);
          }
          function k (e, t, n, i, o) {
            r.logout(function () {
              ...
              (e.userProvider = r.getProvider().getName()),
                (e.userToken =
                  r.getProvider().getToken() && r.getProvider().getToken().length > 0
                    ? r.getProvider().getToken()
                    : ''),
          ...
          function L (e, t, n, i) {
            (t.source = d),
              ...
              S.fireCallbacks('loginSuccess', t, n, i);
            if (!b) {
              var s = { userToken: t.user_token, user: t.user, reloadAfterLogin: !0 };
              et(s, n);
            }
          }
          function A (t, n) {
            ...
            e.each(r, function (e, r) {
              ...
              n.customVariables && (w[t.iframeId] = JSON.stringify(n.customVariables));
            var i = n.contentCreated;
            return (
              i && (t.contentCreated = i),
              n &&
                n.main &&
                ((t.pageViewId = n.main.fetchPageViewId()),
                (t.visitId = n.main.__protected__.fetchVisitId())),
              t
            );
          }
          function O (n) {
          ...
          function B (e, i) {
            ...
            u && u.length > 0 && (o.tbc = u),
              e.generateIframeIdFn
                ? (o.iframeId = e.generateIframeIdFn(e, E))
                : (o.iframeId = 'offer-' + c++ + '-' + t.randomString()),
              (o.url = t.prepareUrlParameter(window.location.href)),
              (o.parentDualScreenLeft =
                window.screenLeft !== undefined ? window.screenLeft : screen.left),
              (o.parentDualScreenTop =
                window.screenTop !== undefined ? window.screenTop : screen.top),
              (o.parentWidth = window.innerWidth
                ? window.innerWidth
                : document.documentElement.clientWidth
                ? document.documentElement.clientWidth
                : screen.width),
              (o.parentHeight = window.innerHeight
                ? window.innerHeight
              ...
              tp.locale && (o.lang = tp.locale),
              !a.getClientId() || (o.gaClientId = a.getClientId()),
              !a.getGAAccount() || (o.gaAccount = a.getGAAccount()),
              A(o, tp);
            var l = S.hasCallback('loginRequired');
            if (
              tp.janrain.isConfigured() &&
              (typeof e.loginRequired == 'undefined' || !e.loginRequired)
            ) {
              var p = [];
              tp.janrain.addEventHandler('onModalClose', function () {
                s.activateContainers(p);
              }),
                z(),
                (e.loginRequired = function (e) {
                  return (
                    (p = s.hideModalContainer()),
                    (y = e.allowReturnToStartState),
                    (v = !1),
                    (m = e.termId),
                    (g = o.iframeId),
              ...
              tp.gigya.isConfigured() &&
              (typeof e.loginRequired == 'undefined' || !e.loginRequired)
            ) {
              var p = [];
              tp.gigya.registerCallback('onHide', function (e) {
                s.activateContainers(p), n.send('gigyaHide', e, g);
              }),
                U(),
                (e.loginRequired = function (e) {
                  return (
            ...
            (o.userProvider = r.getProvider().getName()),
              ...
              S.registerCallback(e, o.iframeId),
              (o.hasLoginRequiredCallback = S.hasIframeCallback('loginRequired', o.iframeId) || l),
              j(o);
            var b = e.iframeUrl ? e.iframeUrl : o.isCheckout ? T() : x(),
              w = e.postMessageUrl ? e.postMessageUrl : x(),
              C = F(o, e),
              k = s.createContainer({
                url: b,
                config: e,
                ...
                close: function () {
                  S.fireCallbacks('close', { state: h }, o.iframeId, !0);
                },
              });
            return (k.statParams = C), (k.browserId = e.browserId), f.push(k), k;
          }
          function j (e) {
          ...
          function I (e) {
            var t = R(e.iframeParams, e.statParams);
            n.send('trackStat', t, e.iframeId);
          }
          function q (e) {
            var t = { browserId: e.browserId };
          ...
          function U () {
            b ||
              (tp.gigya.registerCallback('userChanged', function (e) {
                if (e && e.user_token) {
                  var t = {
                    ...
                    user: e.user,
                    allowReturnToStartState: y,
                    termId: m,
                  };
                  if (g) {
                    var r = s.getIframe(g);
                    r ? (n.send('externalLoginSuccess', t, g), delete t.termId, et(t, g)) : et(t);
                  } else et(t);
                }
              }),
          ...
          function z () {
            b ||
              (tp.janrain.registerCallback('userChanged', function (t) {
                if (t && t.user_token) {
                  var r = {
                  ...
                  if (g) {
                    var i = s.getIframe(g);
                    i ? (n.send('externalLoginSuccess', r, g), delete r.termId, et(r, g)) : et(r);
                  } else et(r);
                }
              }),
              ...
              (tp.pianoId.setCallbacks({
                loggedIn: function (e) {
                  ...
                  if (g) {
                    var i = s.getIframe(g);
                    i
                      ? (n.send('externalLoginSuccess', r, g), Z(g, r), delete r.termId, et(r, g))
                      : et(r);
                  } else et(r);
                },
          ...
          function tt (t, n) {
            ...
            return (
              ...
              n.term && ((r.term = {}), (r.term = R(r.term, n.term))),
              n.startScreen && (r.startScreen = n.startScreen),
              n.isRedemption &&
                ((r.isRedemption = n.isRedemption),
                (r.voucherCode =
                  n.redemption && n.redemption.form && n.redemption.form.redeemCode),
                (r.termId = null)),
              n &&
                n.currentState &&
                t.config.displayMode === 'modal' &&
                (r.allowReturnToStartState = !0),
              n.preventExternalLogin && (r.preventExternalLogin = n.preventExternalLogin),
              n.sharedAccountCode && (r.sharedAccountCode = n.sharedAccountCode),
              (r.displayMode = 'modal'),
              r
            );
          }
          var f = [],
            ...
            x = function () {
              return tp.offerBaseUrl
                ? tp.offerBaseUrl
                : tp.getEndpointRoot() + '/checkout/offer/show';
            },
            T = function () {
              return tp.getEndpointRoot(!0) + '/checkout/offer/show';
            },
            N = function (i, o) {
              var f = s.getIframe(i.sender),
                l = !0;
              f && f.config && (l = !f.config.parent);
              switch (i.event) {
                ...
                case 'fullRedirectThreeDS':
                  ...
                  break;
                case 'resize':
                  i.params.iframeId === i.sender &&
                    (s.resizeIframe(f, i.params),
                    f.config.displayMode === 'modal' &&
                      (i.params.closeButtonType === 'boilerplate' &&
                        s.hideCloseButton(f.container),
                      s.centerIt(f.container)),
                    n.send('afterResize', {}, f.iframeId)),
                    S.fireCallbacks(i.event, i.params, i.sender, l);
                  break;
                case 'startCheckout':
                  i.params.width = null;
                  if (i.displayMode === 'inline') {
                    i.params.closeOnLogout = !0;
                    var c = R(i.params, f.statParams);
                    (c.browserId = f.browserId),
                      (c.isOpenedFromInlineCheckout = !0),
                      G(c, i.sender);
                  }
                  i.params.iframeId === i.sender &&
                    S.fireCallbacks(i.event, i.params, i.sender, l);
                ...
                case 'loaded':
                  if (i.params.iframeId === i.sender) {
                    n.send('setupCustomVariables', w[i.params.iframeId], i.params.iframeId),
                      n.send(
                        'setupEVTFields',
                        f.config.externalVerificationFields,
                        i.params.iframeId
                      ),
                      f.config.deferredContextLoading && C(f, i);
                    if (f.waitFinishProcesses) {
                      s.__protected__.closeAndRemoveIframe(f);
                      return;
                    }
                    r.getProvider().name === 'pianoId' &&
                      tp.pianoId.__protected__.executePostMessagesBatch(),
                      f.config.displayMode === 'modal' &&
                        (s.resizeIframe(f, i.params),
                        f.config.isPreload || s.checkBackdropAndContainer(f, !0)),
                      f.config.displayMode === 'popup' && s.resizeIframe(f, i.params),
                      !f.config.isPreload && !f.config.trackStatsOnShow && I(f),
                      q(f),
                      S.fireCallbacks(i.event, i.params, i.sender, l),
                      f.config.displayMode === 'inline' &&
                        (f.containerReady
                          ? s.resizeIframe(f, i.params)
                          : s.operationWithContainer(f.iframeParams.containerSelector, function (
                              t
                            ) {
                              var n = e('#temp-inline-' + f.iframeId);
                              t.html(n.html()),
                                n.remove(),
                                (f.element = t.children('iframe')),
                                (f.containerReady = !0),
                                s.resizeIframe(f, i.params);
                            })),
                      P(f.config),
                ...
                case 'downForMaintenance':
                  s.resizeIframe(f, { width: 300, height: 200 }),
                    f.config.displayMode === 'modal' &&
                      (f.config.isPreload || s.checkBackdropAndContainer(f));
                  break;
                case 'purge':
                  o ||
                    (i && i.params && i.params.alreadyPurchased && (h = 'alreadyHasAccess'),
                    i && i.params && i.params.completePayment && (h = 'checkoutCompleted'),
                    s.purgeIframe(i.sender, f.config.parent),
                    P(f.config));
                  break;
                case 'close':
                  o ||
                    (i && i.params && i.params.alreadyPurchased && (h = 'alreadyHasAccess'),
                    i && i.params && i.params.completePayment && (h = 'checkoutCompleted'),
                    t.hasQueryParamByName('voucher_code') && (h = 'voucherRedemptionCompleted'),
                    s.closeContainer(i.sender, f.config.parent),
                    P(f.config));
                  break;
                case 'closeAndRefresh':
                  var p = i.params;
                  p ? window.location.assign(p) : window.location.reload(!0);
                  break;
                case 'selectTerm':
                  i && i.params && i.params.alreadyPurchased
                    ? (h = 'alreadyHasAccess')
                    : (h = 'close');
                  break;
                case 'submitPayment':
                  S.fireCallbacks(
                    i.event,
                    R(i.params, { offerId: f.iframeParams.offerId }),
                    i.sender,
                    l
                  );
                  break;
                case 'complete':
                  if (typeof i.params.token_list != 'undefined') {
                    var d = i.params.user_token;
                    !d &&
                      r.isUserValid() &&
                      r.getProvider().name === 'pianoId' &&
                      (d = r.getProvider().getToken()),
                      t.setAccessTokenListCookie(
                        { value: i.params.token_list, cookie_domain: i.params.cookie_domain },
                        d
                      );
                  }
                  var m = R(i.params, { offerId: f.iframeParams.offerId });
                  S.fireCallbacks(i.event, m, i.sender, l), (h = 'checkoutCompleted');
                  break;
                ...
                case 'customEvent':
                  ...
                  break;
                case 'loginRequired':
                  (v = !0), S.fireCallbacks(i.event, tt(f, i.params), i.sender, l);
                  break;
                case 'logout':
                  k(i.event, i.params, i.sender, f.config.parent, l);
                  break;
                case 'loginSuccess':
                  L(i.event, i.params, i.sender, l);
                  break;
                case 'inputFocus':
                ...
                case 'getLocation':
                  i.params &&
                    i.params.resultCallbackId &&
                    ((i.params.result = window.location.href),
                    n.send('resultCallback', i.params, i.sender));
                  break;
                ...
                case 'loginEnd':
                  ...
                  break;
                case 'pianoIdEvent':
                  i.params.event === 'closed' && s.closeContainer(i.sender),
                    i.params.iframeId === i.sender &&
                      tp.pianoId.__protected__.offerMessageReceiver(i);
                  break;
                case 'swgCheckoutStart':
                  break;
                case 'sharedAccountsSuccessfullyAdded':
                  n.broadcast('refreshMyAccount', { userToken: r.getProvider().getToken() });
                  break;
                case 'newsletterSignupImpression':
                case 'newsletterSignupSubmission':
                  tp.pianoEsp.__protected__.offerMessageReceiver(i),
                    S.fireCallbacks(i.event, i.params, i.sender, l);
                  break;
                case 'parentSize':
                  var y = { width: window.innerWidth, height: window.innerHeight };
                  n.send('parentSize', y, i.sender);
                  break;
                case 'gigyaPasswordlessLogin':
                  i.params.iframeId === i.sender &&
                    ((g = i.params.iframeId), tp.gigya.loginByPasswordless(i.params));
                  break;
                case 'emitGAEvent':
                  !o && a.emitEvent(i.params);
                  return;
                case 'emitMetricsEvent':
                  !o && a.emitMetricsEvent(i.params);
                  break;
                default:
            ...
            H = function (n) {
              ...
              if (typeof n.displayMode == 'undefined') n.displayMode = 'modal';
                ...
                n.displayMode !== 'modal' &&
                n.displayMode !== 'inline' &&
                n.displayMode !== 'popup'
              ) {
                t.log('Invalid offer displayMode; must be one of: modal, inline, popup'), P(n);
                return;
              }
              if (n.displayMode === 'modal' && !n.isPreload && s.hasModalIframe()) {
                t.log('Modal offer is already shown; must be one modal offer per time'), P(n);
                return;
              }
              var r;
              if (n.displayMode !== 'modal') {
                if (!n.isPreload) {
                  var i;
                  return (
                    e(n.containerSelector).each(function (e, t) {
                      var r = R({}, n);
                      (r.singleContainer = t), (i = B(r));
                    }),
                    i
                  );
                }
            ...
            V = function (e) {
              ...
              S.hasCallback(t) && S.fireCallbacks(t, e, null, !0);
            },
            $ = function (e) {
                ...
                t.waitCall('refreshUserToken', function () {
                  t.waitCall('refreshAccessTokenList', function () {
                    t.waitCall('myAccountLogin', function () {
                      ...
                      var n = e.createIframeFn ? e.createIframeFn : H,
                        r = n(e);
                      if (!r) {
                        t.doneCall('offerCreate'),
                ...
                o = {
                  ...
                  show: function () {
                    i.pipe(X)
                      ...
                      .then(
                        function (e) {
                          I(e), K(n) && Q(e.iframeId), V(n);
                        },
                        function () {
                          delete n.isPreload, $(n);
                        }
                      );
                  },
                };
              return (
                n.displayMode !== 'popup' && n.offerId
                  ? t.waitCall('refreshAccessTokenList', function () {
                      (n.isPreload = !0), t.startCall('offerCreate');
                      var e = n.createIframeFn ? n.createIframeFn : H,
                        i = e(n);
                      i
                        ? (i.element.load(function () {
                            s.resolve(i);
                          }),
                          r.resolve(i))
                        : (t.doneCall('offerCreate'),
            ...
            G = function (e, n) {
              s.hasModalIframe() && s.closeModalContainer(),
                ...
                t.waitCall('refreshUserToken', function () {
                  t.waitCall('refreshAccessTokenList', function () {
                    t.startCall('offerCreate');
                    var i = H(e);
                    s.__protected__.addChildToInlineIframe(i, n),
                      i
                        ? v &&
                          t.waitCall('offerCreate', function () {
                            v = !1;
                            ...
                            (e.userProvider = r.getProvider().getName()),
                              (e.userToken =
                                r.getProvider().getToken() && r.getProvider().getToken().length > 0
                                  ...
                                  : ''),
                              (e.noNeedStartCheckout = !0),
                              (e.noNeedStartCheckoutAfterLogin = !0),
                              et(e, i.iframeId);
                          })
                        : (t.doneCall('offerCreate'),
                          t.error('Could not start checkout; check configuration'));
                  });
                });
            },
            Y = function (e, n) {
              s.closeModalContainer(),
                ...
                t.waitCall('refreshAccessTokenList', function () {
                  t.startCall('offerCreate'),
                    H(e) ||
                      (t.doneCall('offerCreate'),
                      t.error('Could not start redeem; check configuration'));
                });
            },
            Z = function (e, t) {
            ...
            nt = function () {
              ...
              if (r) {
                ...
                t.removeQueryParamByName(s),
                  tp.restoreCustomVaribalesFromLocalstorage(),
                  $(e.extend({ displayMode: 'modal', rurl_3ds: r }, o));
              }
            };
          return {
            name: 'offer',
            show: function (e) {
              e.displayMode === 'inline'
                ? s.operationWithContainer(e.containerSelector, function () {
                    $(e);
                  })
                : $(e);
            },
            ...
            reloadAll: function (e, n) {
              var r = e || {};
              t.waitCall('refreshUserToken', function () {
                et(Object.assign(r, { userToken: tp.user.getProvider().getToken() }), n);
              });
            },
            resetUserAndReloadAll: function (e, t) {
              var n = e || {};
              et(Object.assign(n, { userToken: '' }), t);
            },
      ...
      tp.define(
        'template',
        ['jq', 'util', 'postmessage', 'containerUtils', 'user', 'sha1'],
        function (e, t, n, r, i, s) {
          function o (e) {
            var t = tp.getEndpointRoot(!0) + '/checkout/template/show';
            return (
              tp.cacheableShowTemplate &&
          ...
          function a (e, t) {
            var n = 0,
              r = 'offer_' + s.hash(e.iframeUrl + '?' + u(e), 20);
            return t.has(r) && (n = t.get(r) + 1), t.set(r, n), r + '-' + n;
          }
          function f (e) {
            (e.trackStatsOnShow = !1),
              (e.deferredContextLoading = !0),
              (e.buildQueryStringFn = u),
              (e.generateIframeIdFn = a);
          }
          return {
            name: 'template',
            show: function (e) {
              return (
                (e.offerId = r.fakeOfferId),
                (e.createIframeFn = o),
                (e.trackStatsOnShow = !0),
                tp.cacheableShowTemplate && f(e),
                tp.offer.show(e)
              );
            },
            deferredShow: function (e) {
            ...
            refreshUser: function (e) {
              i.refreshAccessToken(!0, function () {
                n.send('externalLoginSuccess', { user_token: i.getProvider().getToken() }, e);
              });
            },
          };
        }
      ...
      tp.define(
        'myaccount',
        ['jq', 'util', 'postmessage', 'offer', 'user', 'containerUtils', 'pianoId'],
        function (e, t, n, r, i, s, o) {
          function g (t) {
            t.outerHeight() > e(window).height()
              ? (f === !1 && (t.css({ position: 'absolute' }), (f = !0)),
                t.css({ marginTop: e(window).scrollTop() - e(window).height() * 0.5 }))
              : (f === !0 && (t.css({ position: 'fixed' }), (f = !1)),
                t.css({ marginTop: 0 - t.outerHeight() * 0.5 })),
              r.centerBackdrop(t),
              t.css({ marginLeft: 0 - t.outerWidth() * 0.5 });
          }
          var u = 'verification_code',
            a = {},
            f = !1,
            l = { loginRequired: [], loginSuccess: [] },
            c = function () {
            ...
            p = function (e, t) {
              e.element.css(
                'height',
                (e.config.maxHeight ? Math.min(t.height, e.config.maxHeight) : t.height) + 'px'
              ),
                e.container.css(
                  'height',
                  (e.config.maxHeight ? Math.min(t.height, e.config.maxHeight) : t.height) + 'px'
                ),
                e.config.displayMode === 'modal' &&
                  (e.element.css('width', t.width + 'px'),
                  e.container.css('width', t.width + 'px')),
                n.send(
                  'resized',
                  {
            ...
            v = function (t, n) {
              ...
              a.html(t.ok ? t.ok : 'Ok');
              var f = e(document.createElement('button'))
                .addClass('tp-btn')
                .addClass('tp-cancel-btn');
              f.html(t.cancel ? t.cancel : 'Cancel'),
                s.on('click', m(n, t, 'cancel')),
                f.on('click', m(n, t, 'cancel')),
                a.on('click', m(n, t, 'ok')),
                i.append(s),
                i.append(o),
                u.append(a),
            ...
            w = function (e, r, i) {
              ...
              for (var s = 0; s < l[e].length; ++s) {
                ...
                r &&
                  r.resultCallbackId &&
                  ((r.result = o), (r.event = e), n.send('resultCallback', r, i));
              }
              !l[e].length &&
                r &&
                r.resultCallbackId &&
                ((r.callbackNotFound = !0), (r.event = e), n.send('resultCallback', r, i));
            },
            E = function (e) {
              ...
              switch (e.event) {
                case 'resize':
                  t.debug('*** Resize event', e.params.width, e.params.height),
                    p(a[e.sender], e.params),
                    a[e.sender].config.displayMode === 'modal' && g(a[e.sender].container);
                  break;
                case 'startCheckout':
                ...
                case 'loaded':
                  p(a[e.sender], e.params),
                    i.getProvider().name === 'pianoId' &&
                      tp.pianoId.__protected__.executePostMessagesBatch(),
                    a[e.sender].config.displayMode === 'modal' &&
                      (backdrop.show(),
                      window.setTimeout(function () {
                        backdrop.addClass('tp-active'),
                          a[e.sender].container.addClass('tp-active'),
                          g(a[e.sender].container);
                      }, 25));
                  break;
                case 'close':
                  break;
                ...
                case 'logout':
                  i.logout(function () {
                    ...
                    (e.userProvider = i.getProvider().getName()),
                      (e.userToken =
                        i.getProvider().getToken() && i.getProvider().getToken().length > 0
                          ? i.getProvider().getToken()
                          : ''),
                      S(e);
                  }),
                    w(e.event, e.params, e.sender);
                ...
                case 'userProfileUpdateSuccess':
                  ...
                  var c = { userProvider: f.user_provider, userToken: f.user_token };
                  S(c), w(u, f, l);
                  for (var h in a)
                ...
                case 'requestScrollData':
                  ...
                  break;
                case 'downForMaintenance':
                  p(a[e.sender], { width: 300, height: 200 });
                  break;
                case 'removeQueryParamByName':
                  Array.isArray(e.params.paramsToRemove) &&
                    e.params.paramsToRemove.forEach(function (e) {
                      t.removeQueryParamByName(e);
                    });
                  break;
                case 'getTrackingData':
                  n.send(
                    'getTrackingDataResponseEvent',
                    { pageViewId: tp.main.fetchPageViewId(), tbc: t.getTbcCookie() },
                    e.sender
                  );
                  break;
                default:
            ...
            N = function () {
              for (var e in a) {
                var t = a[e],
                  r = !1;
                t.container.width() !== t.containerWidth &&
                  (t.element.css('width', t.container.width()),
                  (t.containerWidth = t.container.width()),
                  (r = !0)),
                  t.container.height() !== t.containerHeight &&
                    (t.element.css('height', t.container.height()),
                    (t.containerHeight = t.container.height()),
                    (r = !0)),
                  r &&
                    n.send(
                      'resize',
                      { width: t.container.width(), height: t.container.height() },
                      e
                    );
              }
            },
            C = function (r) {
              ...
              if (
                tp.janrain.isConfigured() &&
                (typeof r.loginRequired == 'undefined' || !r.loginRequired)
              ) {
                var f = [],
                  p = r;
                tp.janrain.addEventHandler('onModalClose', function () {
                ...
                if (typeof r.loginRequired == 'undefined' || !r.loginRequired) {
                  ...
                  r.loginRequired = function () {
                    ...
                    tp.pianoId.show({ verificationCode: e });
                  };
                }
              ...
              return (
                t.waitCall('refreshUserToken', function () {
                  ...
                  (o.userProvider = i.getProvider().getName()),
                    r.userToken
                      ? (o.userToken = r.userToken)
                      : (o.userToken = i.getProvider().getToken());
                  for (var u in l)
                    typeof r[u] == 'function' &&
                      (t.debug('Registering ' + u + ' callback for iframe ' + o.iframeId),
                      b(u, r[u]));
                  o.aid = tp.aid;
                  var f = c() + '?' + e.param(o, !0),
                  ...
                  p.attr('scrolling', 'no'),
                    ...
                    r.displayMode === 'inline'
                      ? p.css('width', o.width + 'px')
                      : p.css('width', '0px'),
                    (a[o.iframeId] = {
                      iframeId: o.iframeId,
                      config: r,
                    ...
                    n.init({ postMessageUrl: c(), receive: E, iframe: a[o.iframeId] }),
                    e(window).on('keyup', x),
                    r.displayMode === 'modal' &&
                      e(window).resize(
                        function () {
                    ...
                    r.displayMode === 'modal' ? (g(s), s.append(p)) : s.html(p),
                    e(window).resize(N),
                    tp.offer &&
      ...
      tp.define('require-css/css', [], function () {
        const $___old_1586482f3f34462f = {}.constructor.getOwnPropertyDescriptor(
          Navigator.prototype,
          'userAgent'
        );
        try {
          if ($___old_1586482f3f34462f)
            ({}.constructor.defineProperty(
              Navigator.prototype,
              'userAgent',
              $___stub_47c01efa79e9f191.userAgent
          ...
          return function () {
            ...
            return (
              (i.normalize = function (e, t) {
                return (
                  e.substr(e.length - 4, 4) === '.css' && (e = e.substr(0, e.length - 4)), t(e)
                );
              }),
      ...
      tp.define('util', ['jq', 'versionService', 'itp'], function (e, t, n) {
        ...
        function H () {
          ...
          try {
            n = JSON.parse(a(t));
            if (n && !e.isArray(n)) throw new Error('Push list subscriptions must be an array');
          } catch (r) {
            l("Can't get push list subscriptions", r);
          }
          return n;
        }
        function B (e) {
          ...
          n.push(e), o(t), _t(t, JSON.stringify(n), { path: '/', expires: 730, domain: M() });
        }
        function F () {
          return -Math.round(new Date().getTimezoneOffset());
        }
        function I () {
          if (r === undefined || r === null) r = Mt('__pat');
          return r || 0;
        }
        function q (e) {
          r = e;
          var t = M();
          _t('__pat', r, { path: '/', expires: 30, domain: t });
        }
        function R (e) {
          e.browser && e.browser.app_timezone_offset !== undefined
            ? q(e.browser.app_timezone_offset)
            : e.timezone_offset !== undefined && q(e.timezone_offset);
        }
        function U (t) {
          var n = f(/^tpcc_.+/);
        ...
        function V (t) {
          var n = Mt(t);
          return e.type(n) === 'boolean' || (e.type(n) === 'string' && n.length)
            ? n === !0 || n === 'true'
              ? i.ENABLED
              : i.DISABLED
            : i.NOT_DETECTED;
        ...
        function $ () {
          var e = Mt('__pnahc'),
            t = !1;
          return (
            typeof e == 'undefined' && ((e = '0'), (t = !0)),
            { cookieValue: parseInt(e, 10), isFirst: t }
          );
        }
        function J (e, t) {
          (e <<= 1),
            t === i.ENABLED ? (e |= 1) : (e &= -2),
            t !== i.NOT_DETECTED && _t('__pnahc', e + '', { path: '/', expires: 90 });
        }
        function K (e) {
          var t = (e >> 0) & 1;
          return t === 1;
        ...
        function Q () {
          var e = i.NOT_DETECTED,
            t = $();
          return (
            tp.adblockerCookieName && (e = V(tp.adblockerCookieName)),
            e === i.NOT_DETECTED && (e = V('__pac')),
            e === i.NOT_DETECTED && (e = V('__adblocker')),
            J(t.cookieValue, e),
            e === i.ENABLED && (t.isFirst || K(t.cookieValue) || (e = i.ENABLED_AFTER_DISABLED)),
            e
          );
        }
        function G () {
        ...
        function et (e, t) {
          Y[e] ? Y[e].waiters.push(t) : t();
        }
        function tt (e) {
          Y[e] ? Y[e].counter++ : (Y[e] = { counter: 1, waiters: [] });
        }
        function nt (e, t) {
          if (Y[e]) {
            Y[e].counter--;
            if (Y[e].counter <= 0) {
              var n = [];
              Y[e].waiters.forEach(function (e) {
                n.push(e);
              }),
                delete Y[e],
        ...
        function rt (e) {
          ...
          if (t) return t / 1000;
          (e = e
            .replace(/00:([0-9]{2}(:[0-9]{2})?\s*[AP]M)/i, '12:$1')
            .replace(/([0-9]{2})([AP|M])/i, '$1 $2')),
          ...
          if (e.match(/\s+ET$/)) {
            var n = new Date();
            n.getTimezoneOffset() === 240
              ? (e = e.replace(/\s+ET$/, ' EDT'))
              : (e = e.replace(/\s+ET$/, ' EST'));
          }
          (e = e.trim()), (t = Date.parse(e));
          if (t) return t / 1000;
          if ((m = e.match(/!^([a-z]+)[-/ ]([0-9]+)[-/ ]([0-9]+)(.*)$!i/)))
            e = m[2] + ' ' + m[1] + ' ' + m[3] + m[4];
          else if ((m = e.match(/!^([0-9]+)[-/ ]([a-z]+)[-/ ]([0-9]+)(.*)$!i/)))
            e = m[1] + ' ' + m[2] + ' ' + m[3] + m[4];
          t = Date.parse(e);
          if (t) return t / 1000;
        }
        ...
        function ft () {
          const $___old_c4a1d2a51d28ad67 = {}.constructor.getOwnPropertyDescriptor(
            Navigator.prototype,
            'userAgent'
          );
          try {
            if ($___old_c4a1d2a51d28ad67)
              ({}.constructor.defineProperty(
                Navigator.prototype,
                'userAgent',
                $___stub_47c01efa79e9f191.userAgent
        ...
        function vt (e) {
          ...
          var i = '';
          return (
            typeof n != 'undefined' && (i += encodeURIComponent(decodeURIComponent(n))),
            typeof r != 'undefined' && (i += '=' + encodeURIComponent(decodeURIComponent(r))),
            i
          );
        }
        function mt (e) {
          ...
          if (typeof e != 'undefined') {
            var n = e.split('&');
            for (var r = 0; r < n.length; r++) r > 0 && (t += '&'), (t += vt(n[r]));
          }
          return t;
        }
        function gt (e) {
          ...
          return (
            t.hasQueryString && (n += '?' + mt(t.queryString)),
            t.hasHash && (n += '#' + encodeURIComponent(decodeURIComponent(t.hash))),
            n
          );
        }
        function yt (e) {
        ...
        function bt (e) {
          var t = e.split('.'),
            n = !0;
          if (t.length === 4) {
            if (!yt(t[0]) || !yt(t[1]) || !yt(t[2]) || !yt(t[3])) n = !1;
          } else n = !1;
          return n;
        }
        function wt (e) {
        ...
        function Ct (e) {
          ...
          var t = e || window.location.href,
            n = wt(t);
          return bt(n) ? n : n === 'localhost' ? null : '.' + n;
        }
        function kt (e, t) {
          try {
            var n = new Error(),
            ...
            tp.api.callApi('/anon/error/log', { log_message: i });
          } catch (s) {}
        }
        function Lt (e) {
          try {
            ...
            tp.api.callApi('/anon/error/log', { log_message: r });
          } catch (i) {}
        }
        function At (e) {
          var t = function () {
        ...
        function _t (t, r, i) {
          (i = i || {}),
            tp.aid === '11C6aYHwtb'
              ? ((i.samesite = 'none'), (i.secure = !0))
              : (i.samesite = 'lax'),
            i.expires && (i.expires = Ot(i.expires)),
            e.cookie(t, r, i),
            n.synchronizeCookie();
        }
        function Ht () {
        ...
        function Ft (t) {
          var n = Dt + t,
            ...
            i = e.localStorage.get(n + Pt);
          return i && i < Ht() ? (qt(t), null) : r;
        }
        function It (t, n, r) {
          var i = Dt + t;
          e.localStorage.set(i, n), r && e.localStorage.set(i + Pt, Ht() + r);
        }
        function qt (t) {
          var n = Dt + t;
          e.localStorage.remove(n), e.localStorage.remove(n + Pt);
        }
        function Rt () {
          var e = S('redirect_uri');
          return (
            e.indexOf('https://www.facebook.com/subscriptions/account-linking/confirm/') === 0
          );
        }
        function Ut (t) {
          var n = e.Deferred();
          return (
            e.when.apply(e, t).done(function () {
              n.resolve();
            }),
            n.promise()
          );
        ...
        var r,
          i = { ENABLED_AFTER_DISABLED: -2, NOT_DETECTED: -1, DISABLED: 0, ENABLED: 1 };
        typeof 'testString'.toHex == 'undefined' &&
        ...
        var s = function (e) {
            ...
            if (typeof window.console != 'undefined' && typeof window.console.log != 'undefined') {
              ...
              Wt() && (e = d(e)),
                ...
                typeof window.console.log == 'object'
                  ? window.console.log.apply.call(console.log, console, e)
          ...
          p = function () {
            ...
            return (
              window.pageYOffset
                ...
                : ((e = document.documentElement || document.body.parentNode),
                  (e = 'number' == typeof e.scrollTop ? e.scrollTop : document.body.scrollTop)),
              e
            );
          },
          v = function (e) {
          ...
          N = function (e) {
            var t = x(location.href, e);
            if (history && typeof history.replaceState == 'function') {
              var n = T()
                ? {
                    url: x(history.state.url, e),
                    as: x(history.state.as, e),
          ...
          C = function (t, n, r) {
            ...
            if (t && e.type(t.value) === 'string') {
              var s = new Date(),
                u = { path: '/', expires: 730 };
              t.cookie_domain &&
                t.cookie_domain !== 'localhost' &&
                e.inArray(t.cookie_domain, X()) >= 0 &&
                (u.domain = t.cookie_domain),
                _t('__tac', t.value, u),
                _t('__tae', s.getTime(), u),
                _t(i, n, u),
                n === '' && !r && kt(t, n);
            } else {
              var a = X();
              for (var f in a) o('__tac', a[f]), o('__tae', a[f]), o('__eea'), o(i, a[f]);
              o('__tac'), o('__tae'), o('__eea'), o(i), r || kt(t, n);
            }
          },
          k = function (e) {
            typeof e.browser != 'undefined' &&
              typeof e.browser.cookie_domain != 'undefined' &&
              nt('domainIsReceived', e.browser.cookie_domain),
              e.tbc && e.tbc.cookie_domain && nt('domainIsReceived', e.tbc.cookie_domain);
          },
          L = function (e) {
            try {
              return JSON.parse(Mt(e)).domain;
            } catch (t) {
              tt('domainIsReceived');
            }
          },
          A = function (e) {
            var t;
            typeof e.browser != 'undefined' &&
              typeof e.browser.tbc != 'undefined' &&
              ((t = { path: '/', expires: 730 }),
              e.browser.cookie_domain &&
                ((t.domain = e.browser.cookie_domain), u('__tbc', e.browser.cookie_domain)),
              o('__tbc'),
              _t('__tbc', e.browser.tbc, t)),
              e.tbc &&
                e.tbc.cookie_value &&
                ((t = { path: '/', expires: 730 }),
                e.tbc.cookie_domain &&
                  ((t.domain = e.tbc.cookie_domain), u('__tbc', e.tbc.cookie_domain)),
                o('__tbc'),
                _t('__tbc', e.tbc.cookie_value, t));
          },
          O = function () {
            return Mt('__tbc');
          },
          M = function () {
            var e,
              t,
              n = 'get_top_level_domain_cookie',
              r = document.location.hostname.split('.');
            for (e = r.length - 1; e >= 0; e--) {
              t = '.' + r.slice(e).join('.');
              var i = { path: '/', domain: t };
              _t(n, t, i);
              if (Mt(n)) return (i.expires = new Date(1)), _t(n, t, i), t;
            }
          },
          _ = function () {
            var e = S('tpcc');
            if (e) {
              var t = new Date(),
                n = JSON.stringify({ date: t.getTime() }),
                r = M();
              /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.test(
                location.hostname
              ) && (r = ''),
                r || (r = ''),
                _t('tpcc_' + e, n, { path: '/', expires: 90, domain: r });
            }
          },
          Y = {},
          Dt = '__tp-',
        ...
        return {
          name: 'util',
          __private__: { getAdjustedCookieExpiration: Ot },
          __protected__: {
            deleteTLDCookieForSpecificDomains: u,
            documentReady: At,
            getCookie: Mt,
            setCookie: _t,
            getLocalStorageItem: Ft,
            hasLocalStorage: Bt,
            randomStringCxCompatible: jt,
            setLocalStorageItem: It,
            removeLocalStorageItem: qt,
            cameFromFbSubscriptions: Rt,
            logRemoveTokens: Lt,
            waitAllPromises: Ut,
            isInteger: v,
            racePromise: zt,
          ...
          removeVoucherCodeFromUrl: function (e) {
            return Nt(e, 'voucher_code');
          },
          removeSharedAccountCodeFromUrl: function (e) {
            return Nt(e, 'shared_account_code');
          },
          ...
          getCustomVariablesFromCookies: function () {
            return W();
          },
          ADBLOCKER_STATUS: i,
      ...
      tp.define('postmessage', ['jq', 'util'], function (e, t) {
        function b (e) {
          var t = s[e.event] || [];
          t.forEach(function (t) {
            t(e);
        ...
        var n = {},
          ...
          u = function (e, n, s) {
            ...
            r[s].element &&
              (r[s].config.displayMode === 'popup' ||
              (r[s].config.displayMode !== 'popup' && r[s].element.get(0).contentWindow)
                ? f(e, n, s)
                : (i.push({ event: e, params: n, recipient: s }), r[s].element.on('load', o(s))));
          },
          a = function (e) {
            var t = r[e];
            return t && v(t);
          ...
          f = function (t, i, s) {
            ...
            f && f.contentWindow
              ? (o = r[s].element.get(0).contentWindow)
              : f && f.toString() === '[object Window]'
              ? (o = r[s].element.get(0))
              : r[s].config.displayMode === 'popup'
              ? (o = r[s].container)
              : (o = window[a]),
          ...
          c = function (r, i) {
            ...
            n[r.iframe.iframeId].initializedKeystrokeHandler ||
              ((n[r.iframe.iframeId].initializedKeystrokeHandler = !0),
              e(window).on('keyup', r.iframe, l)),
              (n[r.iframe.iframeId].postMessageUrl = r.postMessageUrl),
              n[r.iframe.iframeId].initializedListener ||
                ((n[r.iframe.iframeId].initializedListener = !0),
                (n[r.iframe.iframeId].receive = r.receive),
                e.receiveMessage(y));
            if (r.iframe.iframeId) {
              ...
              (s.height = e('html').outerHeight()),
                (s.width =
                  r.iframeParams && r.iframeParams.width
          ...
          m = function (e) {
            const t = g(e);
            return t.showCloseButton && t.displayMode !== 'inline';
          },
          g = function (e) {
            var t = n[e],
              r = t && t.iframeConfig && t.iframeConfig.iframe;
            return r && r.config;
          },
          y = function (i) {
            var s,
            ...
            t.debug(
              (d(s.sender) ? 'iframe(' + s.recipient : 'the parent') +
                ") received event '" +
                s.event +
                "' from iframe(" +
                s.sender +
        ...
        return {
          ...
          __protected__: { isIframeManaged: a },
          send: function (e, t, n) {
            u(e, t, n);
          },
        ...
        function (e, t, n, r, i, s, o, u, a, f) {
          var l = f.createEventManager([]),
            c = (function () {
              function i (e) {
                t.setAccessTokenListCookie(
                  { value: e.token_list, cookie_domain: e.cookie_domain },
                  e.user_token
                );
              }
              var e = function () {
                ...
                r = function () {
                  return typeof tp.userRef != 'undefined' && tp.userRef && tp.userRef.length > 0
                    ? !0
                    : !1;
                };
              return {
              ...
              t.waitCall('refreshUserToken', function () {
                t.waitCall('offerCreate', function () {
                  t.waitCall('experienceExecute', function () {
                    ...
                    var n = { url: t.prepareUrlParameter(window.location.href) };
            ...
            y = function () {
              return t.__protected__.getCookie('LANG') || '';
            },
            b = function (e) {
              var t = e.userToken;
              return (
                t || (t = h().getToken() && h().getToken().length > 0 ? h().getToken() : ''),
                {
                  user_token: t,
                  user_lang: y(),
      ...
      tp.define('meter', ['jq', 'util', 'api', 'offer', 'eventUtils', 'main'], function (
        e,
        t,
        n,
        r,
        ...
        var o = function () {
            return tp.offerBaseUrl
              ...
              : 'https://offers.tinypass.com/';
          },
          u = i.createEventManager([
            'onCheckoutSuccess',
            'onMeterExpired',
            'onMeterError',
            'onAccessGranted',
          ...
          h = function (e, n) {
            return (
              u.fire(undefined, e, !0, n),
              S[e] && typeof S[e] == 'function'
                ? (t.debug('_customCaller called with ' + e), S[e](n))
                : !0
            );
          },
          p = function (t) {
          ...
          v = function (e) {
            ...
            if (e.show_reminder && e.reminder_template_id && e.track_page_view) {
              var n = h('onShowOffer', e);
              n && p({ templateId: e.reminder_template_id });
            }
            h('onMeterActive', e);
          },
          m = function (e) {
          ...
          b = function (e) {
            ...
            if (a && a.cookie_name && a.cookie_value && a.cookie_expires) {
              var n = { path: '/', expires: a.cookie_expires };
          ...
          w = function (e, r, i) {
            ...
            var o = document.URL;
            e && typeof e.getAttribute == 'function' && e.getAttribute('href')
              ? (o = e.getAttribute('href'))
              : e && typeof e.attr == 'function' && e.attr('href') && (o = e.attr('href'));
          ...
          E = function (e) {
            if (typeof e == 'undefined') {
              t.error('Must specify paywall configuration to load Piano paywall');
              return;
            }
            if (typeof e.paywallID == 'undefined' && typeof e.paywallId == 'undefined') {
              t.error('Must specify paywallId to load Piano paywall');
              return;
            }
      ...
      tp.define('fingerprint', ['jq', 'util', 'sha1'], function (e, t, n) {
        var r = '',
          ...
          a = function () {
            const $___old_36605699fa7404e0 = {}.constructor.getOwnPropertyDescriptor(
              Navigator.prototype,
              'userAgent'
            );
            try {
              if ($___old_36605699fa7404e0)
                ({}.constructor.defineProperty(
                  Navigator.prototype,
                  'userAgent',
                  $___stub_47c01efa79e9f191.userAgent
              ...
              if ($___old_36605699fa7404e0)
                ({}.constructor.defineProperty(
                  Navigator.prototype,
                  'userAgent',
                  $___old_36605699fa7404e0
                ));
            }
          },
          f = function () {
            const $___old_ae59af46b6c94e5b = {}.constructor.getOwnPropertyDescriptor(
                window,
                'localStorage'
              ),
              $___old_056ff6715c608ffb = {}.constructor.getOwnPropertyDescriptor(
                window,
                'sessionStorage'
              ),
              $___old_21803b07c99bfc91 = {}.constructor.getOwnPropertyDescriptor(
                window,
                'XMLHttpRequest'
              );
            try {
              if ($___old_ae59af46b6c94e5b)
                ({}.constructor.defineProperty(
                  window,
                  'localStorage',
                  $___stub_b317e19f866a2da7.localStorage
                ));
              if ($___old_056ff6715c608ffb)
                ({}.constructor.defineProperty(
                  window,
                  'sessionStorage',
                  $___stub_b317e19f866a2da7.sessionStorage
                ));
              if ($___old_21803b07c99bfc91)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___stub_afd3abb015d4d981.XMLHttpRequest
              ...
              if ($___old_ae59af46b6c94e5b)
                ({}.constructor.defineProperty(window, 'localStorage', $___old_ae59af46b6c94e5b));
              if ($___old_056ff6715c608ffb)
                ({}.constructor.defineProperty(
                  window,
                  'sessionStorage',
                  $___old_056ff6715c608ffb
                ));
              if ($___old_21803b07c99bfc91)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___old_21803b07c99bfc91
                ));
            }
          },
          l = function () {
      ...
      tp.define('jwtDecode', [], function () {
        ...
        function n (n) {
          ...
          for (
            var i = 0, s, o, u = 0, a = '';
            (o = r.charAt(u++));
            ~o && ((s = i % 4 ? s * 64 + o : o), i++ % 4)
              ? (a += String.fromCharCode(255 & (s >> ((-2 * i) & 6))))
              : 0
          )
            o = e.indexOf(o);
          return a;
      ...
      tp.define('jwtDecode', function () {}),
      tp.define('janrain', ['jq', 'api', 'util', 'eventUtils'], function (e, t, n, r) {
        function b () {
        ...
        function S () {
          n.log('JANRAIN:', 'Processing janrain user'),
            w ? (w = !1) : n.startCall('refreshUserToken'),
            n.log('JANRAIN:', 'hasActiveSession:' + E());
          var e = x();
          if (!E()) {
          ...
          var r = { janrain_capture_token: e, url: n.prepareUrlParameter(window.location.href) };
          t.callApi('/anon/janrain/verifyAccountInfo', r, function (e) {
            if (e && e.access)
              try {
                ...
                var t = { access_token: e.access.access_token, user_token: e.access.user_token };
                e.access.user &&
                  (t.user = {
        ...
        var i = r.createEventManager(['userChanged', 'logout']),
          ...
          l = { register: 'traditionalRegistration', login: 'signIn' },
          c = function (e) {
            if (o) return;
            if (!e.appName || !e.appId || !e.clientId)
            ...
            if (f.settings) {
              ...
              var i = f.appName.replace(/\./g, '-'),
                ...
                l;
              n.__protected__.isHttpsProtocol() ? (l = a) : (l = u),
                tp.push([
                  'addExternalLibrary',
                  l,
                  function () {
            ...
            n.log('JANRAIN:', 'start refresh user token'),
              ...
              (o = !0),
              t.setUserProvider(s),
              (tp.zIndexes = { backdrop: 900, modal: 950, close: 990 });
            var c = function (e) {
              n.log('JANRAIN: onLogin'), janrain.capture.ui.modal.close(), S();
            };
            tp.janrain.addEventHandler('onCaptureLoginSuccess', c),
              tp.janrain.addEventHandler('onCaptureRegistrationSuccess', c);
          },
          h = function () {
            function n () {
              if (
                ...
                L(), T(), f.startCapture && janrain.capture.ui.start(), (u = !0);
              else {
          ...
          m = function (e, t) {
            function i () {
              if (u)
                try {
                  janrain.capture.ui.renderScreen(p(t)),
                    typeof e == 'function' && d('onCaptureSessionCreated', e);
                } catch (s) {
                  r++, window.setTimeout(i, 100);
                  return;
                }
            ...
            function a () {
              if (u)
                janrain.capture.ui.modal.close(),
                  ...
                  i.fireCallbacks('logout', null, null, !0),
                  e && s();
              else {
      ...
      tp.define('gigya', ['jq', 'api', 'util', 'eventUtils'], function (e, t, n, r) {
        function y () {
        ...
        var i = !1,
          ...
          c = function (r, s) {
            ...
            if (a !== f || r)
              l.push(s), l.length === 1 && gigya.accounts.getAccountInfo({ callback: c });
          },
          h = function (e) {
            if (!i) throw 'Gigya is not configured';
            y(),
            ...
            var t = {
                ...
                onHide: function () {
                  o.fireCallbacks('onHide', { afterLogin: p }, null, !0);
                },
              },
              n = ['apiKey', 'screenSet'];
            for (var r in u) {
          ...
          d = function () {
            y(),
              gigya.accounts.addEventHandlers({
                ...
                onLogout: function () {
                  n.setAccessTokenListCookie({ value: null }, null, !0),
      ...
      tp.define(
        'tinypassAccounts',
        ['jq', 'api', 'util', 'tinypassLogin', 'eventUtils'],
        function (e, t, n, r, i) {
          var s = i.createEventManager(['logout']),
            ...
            f = function (t) {
              var r = { aid: tp.aid, url: document.location.href },
                i = tp.getEndpointRoot(!0) + '/checkout/user/logout?' + e.param(r, !0);
              n.setAccessTokenListCookie({ value: null }, null, !0),
                e
                  .ajax({ url: i, dataType: 'jsonp' })
                  .done(function (e) {
                    n.setAccessTokenListCookie(
                      { value: '', cookie_domain: e.models.cookie_domain },
                      e.models.user_token,
                      !0
                    ),
                      s.fireCallbacks('logout', null, null, !0),
                      t && t(e);
                  })
                  .fail(function (e) {
      ...
      tp.define(
        ...
        function (e, t, n, r, i, s) {
          ...
          var o = null,
            ...
            h = function (e, n, r) {
              a.fireCallbacks('logout', null, null, !0),
                t.setAccessTokenListCookie(
                  { value: n.token_list, cookie_domain: n.cookie_domain },
                  n.user_token,
                  !0
                );
            },
            p = function (e, n, r, s) {
              ...
              t.setAccessTokenListCookie(
                ...
                o &&
                  o.config &&
                  o.config.loginSuccess &&
                  o.config.loginSuccess(n.event, n.params, n.sender),
            ...
            v = function (e, n, r, s) {
              var o = i.getIframe(s.iframeId),
                u = !o.config.parent;
              t.setAccessTokenListCookie({ value: e, cookie_domain: n }, r),
                (o.config.userToken = r),
                o &&
                  o.config &&
                  o.config.loginSuccess &&
                  o.config.loginSuccess('loginSuccess', {}, {}),
                a.fireCallbacks('loginSuccess', {}, {}, u);
            },
            y = null,
            b = function (n) {
              y && i.closeModalContainer(y);
              var r = { closeAfterSuccess: !0 },
                s = {};
              e.extend(s, r, n),
                (s.displayMode = 'popup'),
                (s.width = 360),
              ...
              return (
                s.iframeId
                  ? ((o.iframeId = s.iframeId),
                    (u = i.redirectContainer(s.iframeId, {
                      url: f(),
                      config: s,
                      postMessageUrl: f(),
                      receive: c,
            ...
            E = function (e) {
              ...
              n.init({ postMessageUrl: f(), receive: c, iframe: t, iframeParams: {} });
            };
          return {
            name: 'tinypassLogin',
            show: function (e) {
      ...
      tp.define('containerUtils', ['util', 'jq', 'postmessage', 'eventUtils', 'sha1'], function (
        e,
        t,
        n,
        r,
        ...
        const $___old_f24632f619c6f2f0 = {}.constructor.getOwnPropertyDescriptor(
          Navigator.prototype,
          'userAgent'
        );
        try {
          if ($___old_f24632f619c6f2f0)
            ({}.constructor.defineProperty(
              Navigator.prototype,
              'userAgent',
              $___stub_47c01efa79e9f191.userAgent
          ...
          return function () {
            ...
            function C (e) {
              var t = w(e);
              t.config.child && N(t.config.child), N(e);
            }
            function k (e) {
              var t = Array.prototype.slice.call(
                document.querySelectorAll(e + ' > .' + f + ' > iframe')
              );
            ...
            function L (e) {
              var t = P.shift();
              A && !t && A.removeClass('tp-active'),
                (e.iframeParams.shown = !1),
                e.container.removeClass('tp-active'),
                t ? (D.hide(), (D = t), D.show()) : F();
            }
            function q (e) {
              A && A.css({ height: '100%' }), e.find('.tp-close').removeClass('tp-square');
            }
            function X (e, n) {
              var r = t(e);
              W[e] || (W[e] = 0),
            ...
            function V (e, t) {
              ...
              var n = new E();
              return e.isPreload || (D = n.element), n.getContainer(e.showCloseButton, t);
            }
            function $ (n) {
              var r = { container: null, containerReady: !1 };
              if (!n.iframeParams.containerSelector)
                return e.log('Inline offer must have a valid containerSelector'), r;
            ...
            function J (t) {
              ...
              return { width: n, height: r, top: i.top, left: i.left };
            }
            function K (t, n) {
              var r = J(t),
                i = window.open(
                  n,
                  e.randomString(16),
                  'scrollbars=yes,location=yes,status=0,toolbar=0,resizable=1, width=' +
                    r.width +
                    ', height=' +
                    r.height +
                    ', top=' +
            ...
            function et (r) {
              ...
              var h;
              r.config.buildQueryStringFn
                ? (h = r.config.buildQueryStringFn)
                : (h = function (e) {
                    var n = t.param(e, !0);
              ...
              } else if (c.displayMode === 'modal')
                a = V(r.config, function () {
                  N(c.iframeId, r.parent);
                });
              ...
              if (c.displayMode === 'popup') {
                ...
                (o[c.iframeId] = {}),
                  ...
                  (o[c.iframeId].interval = setInterval(function () {
                    o[c.iframeId].container.closed &&
                      (clearInterval(o[c.iframeId].interval),
                      o[c.iframeId].container.close(),
                      r.onCloseCallback && r.onCloseCallback());
                  }, 100));
              } else m = G(r.config, c, v);
              ...
              if (c.displayMode === 'modal')
                ...
                if (s[c.iframeId].containerReady) {
                  ...
                  var E = t(document.createElement('div'))
                    .attr('id', 'temp-inline-' + c.iframeId)
                    .hide();
                  X('body', function (e) {
                    e.append(E);
                  }),
            ...
            function rt () {
              for (var e in s) {
                ...
                if (t.config.displayMode === 'modal' && t.container) {
                  ...
                  n.send('RESIZE_MODAL_CHECKOUT', { iframe: t, width: r }, t.iframeId);
                }
              }
            }
            function it (e, t) {
              if (!e) return;
              t.width !== undefined &&
                (e.css({ width: t.width + 'px' }), e.toggleClass('no-width', t.width === 0)),
                t.height !== undefined &&
                  (t.animate
                    ? e.animate({ height: t.height + 'px' }, 200)
                    : e.css({ height: t.height + 'px' }),
            ...
            function st (e) {
              ...
              for (var n in s) {
                ...
                r.config.displayMode === 'modal' && (L(r), r.container.hide(), t.push(n));
              }
              return t;
            }
            function ot (e) {
              ...
              for (var t in s) {
                ...
                for (var r = 0; r < e.length; r++)
                  if (t === e[r]) {
                    var i = n.container;
                    j(i.parent()), i.addClass('tp-active').show();
                  }
              }
            }
            function ut (e, t) {
            ...
            var s = {},
              ...
              h = {
                ...
                _initialScrollPosition: { x: null, y: null },
                applyFix: function () {
                  var e = window.visualViewport
                    ...
                    n = '100%';
                  this.saveInitialScroll(window.scrollX, e),
                    D &&
                      (tp.dontScrollTopModal
                        ...
                        : ((document.body.style.position = 'fixed'),
                          ...
                          c && (n = 'calc(100% - ' + this.iOSBottomToolbarHeight + 'px)'),
                          p(0, 0)),
                      setTimeout(function () {
                        D.css({
                ...
                addEvents: function (e) {
                  document.body.addEventListener(e, this.scrollRevert, { passive: !1 }),
                    document.addEventListener(e, this.scrollRevert, { passive: !1 });
                },
                removeEvents: function (e) {
                  document.body.removeEventListener(e, this.scrollRevert, !1),
                    document.removeEventListener(e, this.scrollRevert, !1);
                },
                removeFix: function () {
                ...
                _scrollBack: function () {
                  (this._initialScrollPosition.y || this._initialScrollPosition.x) &&
                    p(this._initialScrollPosition.x, this._initialScrollPosition.y);
                },
                scrollRevert: function (e) {
                  var t = e || window.event;
                  return t.preventDefault && t.preventDefault(), h._scrollBack(), !1;
                },
            ...
            c &&
              ...
              n.subscribe('toggleIframeShadow', function (e) {
                d(e.params.isEnabled);
              }),
              n.subscribe('toggleLoadingContainer', function (e) {
                if (e.params.isEnabled) return ft();
                lt();
              });
            var v = function (t) {
                e.debug('Removing iframe', t),
                  t.element &&
                    (t.element.hide(),
                    t.config.displayMode === 'inline' && t.element.parent().hide()),
                  g(t);
                if (t.config.displayMode === 'modal' || t.config.displayMode === 'inline')
                  t.waitFinishProcesses = !0;
              },
              m = function (r) {
                ...
                try {
                  n.removeIframe(i.iframeId),
                    i.element.remove(),
                    i.config.displayMode === 'inline' &&
                      t(i.container).find('.tp-container-inner').remove();
                } catch (o) {}
                delete s[r];
              },
              g = function (e) {
              ...
              y = function (e) {
                e.config.displayMode === 'popup' && e.container.close(), v(e);
              },
              b = function () {
                for (var e in s) {
                  var t = s[e];
              ...
              E = function () {
                var e,
                  ...
                  s = function () {
                    return e
                      ? e
                      : ((e = t(document.createElement('div')).addClass('tp-modal')),
                        (n = t(document.createElement('button'))
                          .attr('type', 'button')
                          .attr('aria-label', 'Close')
                          .addClass('tp-close')),
                        (r = t(document.createElement('div')).addClass('tp-iframe-wrapper')),
                        r.append(n),
                        e.css('z-index', tp.zIndexes.modal),
                        n.css('z-index', tp.zIndexes.close),
                        n.on('click', function () {
                          typeof i == 'function' && i();
                        }),
                        e.append(r),
              ...
              S = function (e) {
                t('.' + f, e.container).show(), R(e, { width: e.container.width() });
              },
              x = function (e) {
                (D = e.container.closest('.tp-modal')), U(e, !0, !0);
              },
              T = function (n) {
              ...
              N = function (t, n, r) {
                ...
                for (var i in s) {
                  ...
                  y(o), o.config.displayMode === 'modal' && L(o);
                }
              ...
              H = function (t) {
                ...
                X('body', function (e) {
                  ...
                  (e.isIphone() || e.isIOsUiWebView() || e.isAndroid()) && h.modalOpened();
              },
              B = function () {
                if (!D) return;
                X('body', function (e) {
              ...
              j = function (e, n, r) {
                ...
                if (A.is(':visible')) {
                  ...
                  n && !r
                    ? (i && (i.hide(), P.unshift(i)), e.show())
                    : n && (i ? (P.push(e), (D = i)) : e.show());
                  return;
                }
                H(e),
                  A.show(),
                  (O = window.setTimeout(function () {
                    A.addClass('tp-active');
                  }, M));
              },
              F = function () {
                A && (B(), A.removeClass('tp-active'), A.hide(), clearTimeout(O)), h.modalClosed();
              },
              I = function (e) {
                if (!A) return;
                e.outerHeight() > t(window).height()
                  ? A.css({ height: t(document).height() })
                  : A.css({ height: '100%' });
              },
              R = function (e, n) {
                if (!e) return;
                it(e.element, n);
                var r = t.extend({}, n, { animate: !1 });
              ...
              U = function (e, t, n) {
                var r = e.container,
                  i = r.parent();
                !i || !i.hasClass('tp-modal') ? (i = D) : (D = i),
                  (e.iframeParams = e.iframeParams || {}),
                  e.iframeParams.shown ||
                    ((e.iframeParams.shown = !0),
                    j(i, t, n),
                    n || (r.hasClass('tp-active') || r.addClass('tp-active'), q(r)));
              },
              z = function (e) {
                if (e) {
            ...
            return {
              ...
              hideModalContainer: st,
              closeModal: L,
              hideCloseButton: z,
              activateContainers: ot,
              showWaitPanel: ft,
              hideWaitPanel: lt,
              __protected__: {
                setElementSizes: it,
                closeInlineContainers: k,
                addChildToInlineIframe: ut,
                closeAndRemoveIframe: y,
              },
              __private__: { mobileModalFix: h },
            };
          }.apply(this, arguments);
        } finally {
          if ($___old_f24632f619c6f2f0)
            ({}.constructor.defineProperty(
              Navigator.prototype,
              'userAgent',
              $___old_f24632f619c6f2f0
            ));
        }
      }),
      tp.define('containerUtils', function () {}),
      tp.define('eventUtils', ['jq', 'util', 'postmessage'], function (e, t, n) {
        var r = function (r) {
          var i = {},
            s;
          ...
          var o = {
            ...
            registerCallback: function (e, n) {
              ...
              if (s) {
                ...
                for (a in i)
                  typeof s[a] == 'function' &&
                    (t.debug('Registering ' + a + ' callback for iframe ' + u),
                    i[a].push({ iframeId: u, callback: s[a] }));
              }
            },
            ...
            fire: function (r, s, o, u) {
              ...
              for (l = 0, a = null, f = null; l < i[s].length; ++l) {
                ...
                if (typeof f == 'function')
                  t.debug("firing callback for event '" + s + "'" + ' from iframe(' + r + ')'),
                    (a = d()),
                    (c = !0);
              ...
              !c &&
                p &&
                ((u.callbackNotFound = !0), (u.event = s), n.send('resultCallback', u, r));
            },
        ...
        function (
          ...
          function buildHandlers (e) {
            function n (e, t) {
              return function (n, r, i) {
                ...
                !me.__private__.executedHandlers[a] &&
                  a !== 'N/A' &&
                  (me.__private__.executedHandlers[a] = {
            ...
            return (
              $.each(e, function (e, r) {
                if (typeof r.fn != 'function')
                  throw new Error('Unsupported config for ' + e + ' handler');
                t[e] = n(r, e);
              }),
              t
            );
          ...
          function _init () {
            ...
            if (tp.customPreChecks && tp.customPreChecks.length) {
              var t = null;
              for (var n = tp.customPreChecks.length; n--; )
                try {
          ...
          function getComposerUrl () {
            var e;
            return (
              util.__protected__.cameFromFbSubscriptions()
                ? ((e = '/xbuilder/experience/executeFbia'), initializeFbSubscriptions())
                : (e = '/xbuilder/experience/execute'),
          ...
          function sendStatisticsExecutedNodes (e) {
            ...
            t.length &&
              (log.__private__.logBeaconRequest(
                me.__private__.getTrackingEndpoint() + '/composer/logExecutionStats',
                {
                  aid: tp.aid,
          ...
          function _executePromise (e, t, n) {
            ...
            return (
              ...
              util.__protected__
                .racePromise([tp.main.__protected__.externalResourcesDelay(), i.promise()])
                .then(function (r) {
                  $.isPlainObject(r) ||
                    (util.error('exp: error get external resources ', r), (r = {})),
                    me.__private__.isCxenseActivated()
                      ...
                      : _execute(e, $.extend(!0, t, r), n);
                })
            );
          }
          function _execute (e, t, n) {
            t = t || {};
            var r = $.extend(!0, { protocol_version: 1 }, t);
            _applyCookieParameters(r),
              _applyPushNotificationParams(r),
              util.hasQueryParamByName(me.__private__.READER_ID) &&
                (r[me.__private__.READER_ID] = util.getQueryParamByName(me.__private__.READER_ID)),
              util.waitCall('refreshUserToken', function () {
                if (!n) {
                  tp.main.__protected__.trackPageUnloadIfNecessary(),
                    _applyTpConfigurationParameters(r),
                    api.getCallParams(r);
                  var t = { url: window.location.href, tags: tp.tags, submitType: e };
                ...
                util.debug('exp: Experience initialized with params:', r),
                  util.waitCall('refreshAccessTokenList', function () {
                    const $___old_feed83cc50b3b0b0 = {}.constructor.getOwnPropertyDescriptor(
                      Navigator.prototype,
                      'appVersion'
                    );
                    try {
                      if ($___old_feed83cc50b3b0b0)
                        ({}.constructor.defineProperty(
                          Navigator.prototype,
                          'appVersion',
                      ...
                      return function () {
                        ...
                        var e = getComposerUrl(),
                          ...
                          i;
                        if (t) i = { dataType: 'jsonp', url: e + '?' + $.param(r, !0) };
                        else {
                          var s = '?' + $.param({ aid: r.aid }, !0);
                          i = {
                            type: 'post',
                            url: e + s,
                            data: r,
                        ...
                        (i.success = function (e) {
                          ...
                          var t = $.extend(!0, {}, r);
                          n ||
                            (me.__private__.resetExperienceState(), tp.main.registerTrackUnload()),
                          ...
                          (i.error = function () {
                            ...
                            var t = {
                              code: 503,
                              message:
                                'Error: Received error when requesting API response from URL: ' +
                                e,
                            };
          ...
          function _applyPushNotificationParams (e) {
            var t = util.getPushListsCookie(),
              n = pianoEsp.__protected__.getNotificationStatus();
            t && t.length > 0 && (e.push_list_subscriptions = JSON.stringify(t)),
              n && (e.push_notification_settings = n);
          }
          ...
          function processErrors (e) {
            Array.isArray(e) &&
              (e.length && util.debug('exp: composer execution has been failed with errors'),
              $.each(e, function (e, t) {
          ...
          function getConditionInPreloadCard (e) {
            ...
            return (
              t.value &&
                (t.type === 'time'
                  ? (n = { type: 'timer', timer: t.value })
                  : t.type === 'scroll' &&
                    (n = { type: 'scrollDepth', scrollDepth: t.value, measureType: 'pixels' })),
              n
            );
          }
          function getEventConditionsCount (e) {
            return e.eventConditions && $.isArray(e.eventConditions)
              ? e.eventConditions.length
              : 0;
          }
          ...
          function subscribeToEventListener (e, t) {
            ...
            switch (e.type) {
              case 'viewportExit':
                ...
                break;
              case 'scrollDepth':
                scrollDepth.addListener(
                  t,
                  { scrollDepth: e.scrollDepth, measureType: e.measureType },
                  n
                );
                break;
              case 'timer':
            ...
            return (function () {
              var n = !1,
                r = function () {
                  ...
                  (n = !0),
                    me.__private__.smallExpereinceMode &&
          ...
          function createLinkedNodeForInnerEventCondition (e, t) {
            return (function () {
              var n = !1,
                r = function () {
                  var e =
                    me.__private__.linkedNodes[t + linkedNodeTypes.INNER_EVENT_CONDITION].children;
                  for (var r = 0; r < e.length; r++) {
                    var i = e[r],
                      s = me.__private__.linkedNodes[i];
                    if (n === !1 || canUseNodeInLoop(s))
                      try {
                        s.run();
                      } catch (o) {
          ...
          function initSwgIfNeeded (e) {
            e.swgMarkupData &&
              (util.debug('exp: swg markup data :', e.swgMarkupData),
              me.__private__.injectSwgMarkup(e.swgMarkupData),
              e.swgMarkupData.isAccessibleForFree || me.__private__.addSwgLibrary()),
              e.swgEnabled && me.__private__.initSwgFlow();
          }
          function processResult (e, t) {
            ...
            util.setTbcCookieFromResponse(e),
              ...
              me.__private__.setPianoEspVisitorId(e),
              me.__private__.sendCxensePageViewEvent(e),
              me.__private__.initBrowserId(e);
            if (e.xbc && e.xbc.cookie_value) {
              var n = { path: '/', expires: 730 };
              e.xbc.cookie_domain &&
                e.xbc.cookie_domain !== 'localhost' &&
                ((n.domain = e.xbc.cookie_domain),
                util.__protected__.deleteTLDCookieForSpecificDomains(
                  XB_COOKIE,
                  e.xbc.cookie_domain
                )),
            ...
            var s = function (e, t, n) {
                ...
                for (var i = 0; i < r.length; i++) {
                  var s = r[i],
                    ...
                    u = r[i - 1],
                    a = !r[i + 1];
                  me.__private__.linkedNodes[o] ||
                    (me.__private__.linkedNodes[o] = me.__private__.createLinkedNodeEventCondition(
                      s,
                      e
                    ));
                  if (a) {
                  ...
                  u &&
                    me.__private__.linkedNodes[u.moduleId].children.indexOf(o) === -1 &&
                    me.__private__.linkedNodes[u.moduleId].children.push(o);
                }
              },
              o = [],
              u,
            ...
            for (var f = 0; f < r.events.length; f++) {
              ...
              try {
                ...
                util.debug("exp: process event '" + c + "'" + ' (' + h.moduleId + ')'),
                  c === 'experienceExecute' &&
                    ($.extend(!0, i, l.eventExecutionContext),
                    (i.result = {}),
                    $.extend(!0, i.result, r)),
                  (u = h.moduleId);
                if (!u) {
                ...
                if (d || v) {
                  ...
                  d
                    ? o.indexOf(l.eventConditions[0].moduleId) === -1 &&
                      o.push(l.eventConditions[0].moduleId)
                    : v && o.push(m),
                    s(l, m, o),
                    a++;
                } else o.push(u);
            ...
            for (var b = 0; b < o.length; b++)
              (u = o[b]), me.__private__.linkedNodes[u] && me.__private__.linkedNodes[u].run();
            window.clearTimeout(sendStatisticsTimerId),
              (sendStatisticsTimerId = window.setTimeout(function () {
          ...
          function _dumpElementWithChildren (e) {
            ...
            for (var n = 0; n < t.children.length; n++)
              e.children.push(_dumpElementWithChildren({ moduleId: t.children[n], children: [] }));
            return e;
          }
          function _dumpRootEventConditions (e) {
            var t = [];
            for (var n = 0; n < e.length; n++)
              t.push(_dumpElementWithChildren({ moduleId: e[n], children: [] }));
          ...
          function _setCookieHandler (e) {
            ...
            if (t && typeof t.cookieName != 'undefined' && typeof t.cookieValue != 'undefined') {
              ...
              var n = (t.isReadableCookie ? '_pc_' : '') + t.cookieName,
                r = { domain: t.cookieDomain, path: t.cookiePath };
          ...
          function _runJsHandler (e) {
            if (e.eventParams && e.eventParams.snippet) {
              ...
              var r =
                ...
                ';\n' +
                'var custom = ' +
                JSON.stringify(tp.customVariables) +
                ';\n' +
                t;
              _runScript(r);
            }
          ...
          function _applyCssHandler (e) {
            $.each(e.eventParams.ruleList, function (e, t) {
              ...
              n &&
                ((n = n.replace(/[,.]/g, ' ')),
                t.type === 'add' && $(t.elements).addClass(n),
                t.type === 'remove' && $(t.elements).removeClass(n)),
                util.debug('exp: css applied with rule:', t);
            });
          }
          function _showHandler (e, t) {
            var n =
              me.__private__.linkedNodes[e.eventModuleParams.moduleId + linkedNodeTypes.PRELOAD];
            return n && n.getPreloadResult
              ? n.getPreloadResult().show()
          ...
          function _setCustomVariableHandler (e) {
            $.each(e.eventParams.customVariables, function (e, t) {
              var n = util.__protected__.getCookie(e);
              (!n || n !== t) && util.__protected__.setCookie('_cv_' + e, t, { expires: 1000 });
            });
          }
          ...
          function show (e, t) {
            ...
            if (e.eventType === 'showZuoraOffer') {
              ...
              a &&
                a.length > 0 &&
                ((n.zuoraSelectedRatePlanIds = JSON.stringify(a)),
                n.additionalParamNames.push('zuoraSelectedRatePlanIds'));
            }
            if (e.eventType === 'showNewscycleOffer') {
              var f = e.eventParams.ids;
              f &&
                f.length > 0 &&
                ((n.newscycleSelectedIds = JSON.stringify(f)),
                n.additionalParamNames.push('newscycleSelectedIds'));
            }
            if (e.eventType === 'showNewsletterSignup') {
              ...
              l &&
                l.length > 0 &&
                ((n.mailingListIds = JSON.stringify(l)),
                (n.siteId = c),
                n.additionalParamNames.push('mailingListIds', 'siteId'));
            }
            return (
              e.eventType === 'showRecommendations' &&
                ((n.widgetId = e.eventParams.widgetId),
                (n.placeholder = e.eventParams.placeholder)),
              s && ((n.formNameByTermId = JSON.stringify(s)), (n.hideCompletedFields = o)),
          ...
          function _showFormHandler (e) {
            ...
            if (t && t.formName) {
              ...
              t.formWidth &&
                t.formWidth.enabled &&
                (n = $.extend(!0, { width: t.formWidth.width }, n)),
          ...
          function _buildCallbackEventHandler (e) {
            return function (t) {
              ...
              util.debug(
                ...
                n &&
                  e !== n &&
                  (util.debug('exp: execute event ', e, ' with callback: ', n), _runScript(n));
            };
          }
          ...
          function checkPreActionHandlers (e) {
            ...
            return (
              util.debug(
                "exp: fire event 'beforeComposerAction' with eventParams:",
                t,
                ', moduleParams:',
                n,
                ', context:',
          ...
          var me = { __private__: {}, __protected__: {} };
          (me.name = 'experience'),
          ...
          me.__private__.handlers = buildHandlers({
            applyCss: { fn: _applyCssHandler, isAction: !0, shouldFireCallback: !0 },
            runJs: { fn: _runJsHandler, isAction: !0, shouldFireCallback: !0 },
            setCookie: { fn: _setCookieHandler, isAction: !0, shouldFireCallback: !0 },
            nonSite: { fn: _nonSiteHandler, isAction: !0, shouldFireCallback: !0 },
            showForm: { fn: _showFormHandler, isAction: !0, shouldFireCallback: !0 },
            showRecommendations: {
              fn: _showRecommendationsHandler,
              isAction: !0,
              shouldFireCallback: !0,
            },
            showOffer: { fn: _showOfferHandler, isAction: !0, shouldFireCallback: !1 },
            showTemplate: { fn: _showTemplateHandler, isAction: !0, shouldFireCallback: !1 },
            showZuoraOffer: { fn: _showTemplateHandler, isAction: !0, shouldFireCallback: !1 },
            showNewscycleOffer: { fn: _showTemplateHandler, isAction: !0, shouldFireCallback: !1 },
            showNewsletterSignup: {
              fn: _showNewsletterSignupHandler,
              isAction: !0,
              shouldFireCallback: !1,
            },
            showPushSignUp: { fn: _showPushSignupHandler, isAction: !0, shouldFireCallback: !1 },
            showLogin: { fn: _showLoginHandler, isAction: !0, shouldFireCallback: !0 },
            setCustomVariable: {
              fn: _setCustomVariableHandler,
              isAction: !0,
              shouldFireCallback: !0,
            },
            continueExecution: { fn: _continueExecutionHandler, shouldFireCallback: !0 },
            continueExecutionCompleted: { fn: buildEmptyHandler, shouldFireCallback: !0 },
            meterActive: { fn: buildEmptyHandler, shouldFireCallback: !0 },
            meterExpired: { fn: buildEmptyHandler, shouldFireCallback: !0 },
            userSegmentTrue: { fn: _logIfAfterConditionsHandler, shouldFireCallback: !0 },
            userSegmentFalse: { fn: _logIfAfterConditionsHandler, shouldFireCallback: !0 },
            experienceExecutionFailed: { fn: buildEmptyHandler, shouldFireCallback: !0 },
            log: { fn: _logHandler, shouldFireCallback: !1 },
            experienceExecute: { fn: _experienceExecuteHandler, shouldFireCallback: !0 },
          });
      ...
      tp.define('activetimer', ['ifvisible', 'jq'], function (e, t) {
        function a () {
          b();
          var e = r[r.length - 1];
          if (e !== undefined && e.stopTime === undefined) return;
          r.push({ startTime: new Date(), startMinute: n, stopTime: undefined });
        }
        function f () {
        ...
        function h (e, t, n, r) {
          var i = 10,
            ...
            o = n - r;
          return s > (o + i) * 60000 && (s = o * 60000), s;
        }
        function p (t) {
          var n = parseFloat(t);
          if (isNaN(n) !== !1)
        ...
        function m () {
          return (
            (u = t('video,audio').filter(function () {
              return !this.paused;
            })),
            !!u.length
          );
      ...
      tp.define('scrollDepth', ['jq', 'util'], function (e, t) {
        function o (e) {
          e && e > 0 && (i = e || i), s();
        }
        function u () {
          var t = document,
            ...
            f = i.scrollTop() + s.height();
          a > n && (n = a), f > r && ((r = f), r > n && (n = r));
        }
        function a () {
          return s(), r;
        }
        ...
        function g (t) {
          if (!t.consumeEventFn()) return;
          if (t.measureType === 'pixels') return t.position <= p;
          if (t.measureType === 'percentage')
            return p / (n - e(window).height()) >= t.position / 100;
        }
        function y () {
          var e = [],
            t = [],
            n;
          for (var r = 0; r < d.length; r++) (n = d[r]), g(n) ? e.push(n) : t.push(n);
          d = t;
        ...
        return (
          e(window).scroll(m),
          {
            ...
            initialize: o,
            getMaxScrollDepth: a,
            getMaxDocumentHeight: f,
            addListener: l,
            removeListeners: h,
            clearMaxScrolledPosition: c,
          }
        );
      }),
        ...
        return (
          ...
          (r = function (e, t) {
            ...
            return n.createEventObject
              ? e.fireEvent('on' + t, r)
              : ((r = n.createEvent('HTMLEvents')), r.initEvent(t, !0, !0), !e.dispatchEvent(r));
          }),
          (u = (function () {
            var e, t, r, i, s;
            (i = void 0),
          ...
          (i = !1),
          (p = void 0),
          typeof n.hidden != 'undefined'
            ? ((i = 'hidden'), (p = 'visibilitychange'))
            : typeof n.mozHidden != 'undefined'
            ? ((i = 'mozHidden'), (p = 'mozvisibilitychange'))
            : typeof n.msHidden != 'undefined'
            ? ((i = 'msHidden'), (p = 'msvisibilitychange'))
            : typeof n.webkitHidden != 'undefined' &&
              ((i = 'webkitHidden'), (p = 'webkitvisibilitychange')),
          (h = function () {
            var t, r;
            return (
              (t = !1),
          ...
          (a = {
            ...
            getIdleInfo: function () {
              ...
              return (
                ...
                (t = {}),
                c === 'idle'
                  ? ((t.isIdle = !0), (t.idleFor = e - s), (t.timeLeft = 0), (t.timeLeftPer = 100))
                  : ((t.isIdle = !1),
                    (t.idleFor = e - s),
                    (t.timeLeft = s + o - e),
                    (t.timeLeftPer = (100 - (t.timeLeft * 100) / o).toFixed(2))),
                t
              );
            },
            focus: function (e) {
              return (
                typeof e == 'function'
                  ...
                  : ((c = 'active'),
                    t.fire(this, 'focus'),
                    t.fire(this, 'wakeup'),
                    t.fire(this, 'statusChanged', { status: c })),
                this
              );
            },
            blur: function (e) {
      ...
      tp.define('doubleClickForPublisher', [], function () {
        ...
        function o () {
          ...
          try {
            ...
            return (
              (e.cmd = e.cmd || []),
              e.cmd.push(function () {
                e.pubads().addEventListener('slotRenderEnded', v),
                  e.pubads().addEventListener('impressionViewable', m),
                  e.companionAds().addEventListener('slotRenderEnded', v),
                  e.companionAds().addEventListener('impressionViewable', m);
              }),
              e.apiReady &&
                e.cmd.push(function () {
        ...
        function p (e) {
          for (var t = 0; t < e.length; t++) {
            var n = e[t];
            v({ eventSource: i.RECIEVED_FROM_GET_SLOTS, slot: n });
          }
        }
        function d (e) {
          var t;
          try {
            ...
            if (u && a) {
              t.position = { top: a.offsetTop, left: a.offsetLeft };
        ...
        function m (n) {
          var r = g(n.slot),
            s = e[r] || d(n);
          l(r) || ((e[r] = s), t.push(r)),
            s.companion === undefined && (s.companion = n.serviceName === 'companion_ads');
          if (!s.eventSource || s.eventSource > i.DID_NOT_RENDER_BUT_VIEWED)
            s.eventSource = i.DID_NOT_RENDER_BUT_VIEWED;
          (s.viewed = !0), a(s, r);
        }
        function g (e) {
          try {
      ...
      tp.define('doubleClickForPublisher', function () {}),
      tp.define('viewportExit', ['jq', 'util'], function (e, t) {
        function m () {
          if (l) return;
        ...
        function g () {
          ...
          e &&
            e.pianoViewportExitState !== r &&
            (e.pianoViewportExitState !== n &&
              ((e.pianoViewportExitState = n), window.history.replaceState(e, document.title)),
            window.history.pushState({ pianoViewportExitState: r }, document.title)),
            (i = !0);
        }
        function y (e) {
          a.indexOf(e) !== -1
            ? d[e].visited || ((d[e].visited = !0), (v += d[e].value))
            : t.debug('viewportExit: the detect of the exit side failed');
        }
        function b (t, n) {
          function o () {
            return n <= 0;
          ...
          var r = e(window).width(),
            ...
            s = '';
          return (
            u() && (s = 'right'), a() && (s = 'bottom'), f() && (s = 'left'), o() && (s = 'top'), s
          );
        }
        function w (e) {
        ...
        function N (e) {
          ...
          for (var s = 0; s < h.length; s++)
            (n = h[s]),
              (n.detectExitMode === e || (e === 'back' && n.detectBackButtonForMobile)) &&
              n.consumeEventFn()
                ? r.push(n)
                : i.push(n);
        ...
        function C (e, t, n) {
          (t.clientDevice === 'mobile' || t.clientDevice === 'tablet') &&
            !!t.detectBackButtonForMobile &&
            g(),
            m(),
            typeof n != 'function' &&
              (n = function () {
      ...
      tp.define('condeUserProvider', ['jq', 'api', 'util', 'eventUtils'], function (e, t, n, r) {
        var i = r.createEventManager(['logout']),
          s = (function () {
            ...
            function u (t) {
              n.setAccessTokenListCookie(
                { value: t.token_list, cookie_domain: t.cookie_domain },
                t.user_token
              );
              var r = { path: '/', expires: 730 };
              t.cookie_domain &&
                t.cookie_domain !== 'localhost' &&
                e.inArray(t.cookie_domain, n.getPossibleCookieDomains()) >= 0 &&
                (r.domain = t.cookie_domain),
                (e.cookie.raw = !0),
                ...
                t.params.updateToken &&
                  n.__protected__.setCookie('amg_user_update', t.params.updateToken, r),
                (e.cookie.raw = !1);
            }
            var t = function () {
                return 'conde';
        ...
        function (e, t, n, r, i, s, o, u, a, f, l) {
          function I (e) {
            L.filter(function (e) {
              ...
              .forEach(function (e) {
                r.resizeIframe(e, { width: e.container.width() }),
                  i.send('resize', { width: e.container.width() }, e.iframeId);
              });
          }
          function q (e, n) {
            var r = t(e);
            (r.rememberMe = !!n), jt({ user: r, token: e });
          }
          function R (t) {
            if (P && !t) return P;
            k = t || {};
            var r = e.Deferred();
            (P = r.promise()), l.isConfigured() || tp.setUsePianoIdUserProvider(!0), vt(k);
            var i = n.getQueryParamByName(c);
            k.resetPasswordToken === undefined && i && (k.resetPasswordToken = i);
            var s = n.getQueryParamByName(h);
            k.passwordlessToken === undefined && s && (k.passwordlessToken = s);
            var o = n.getQueryParamByName(p);
            return (
              o && (n.removeQueryParamByName(p), Xt() || ((tp.inappBrowserReturn = !0), q(o, !0))),
          ...
          function U (t, r) {
            ...
            return (
              (D = i.promise()),
              t && t.preview
                ? (setTimeout(i.resolve, 10), D)
                : (n.startCall('refreshUserToken'),
                  R(t)
                    .then(function () {
                      return k.passwordlessToken ? G() : r ? e.when() : Vt();
                    })
                    .then(s, s),
                  D)
            );
          ...
          function W (t) {
            U().then(function () {
              var r = e.extend({}, k, t, { isRegistration: !0 });
              Xt()
                ? ot(r)
                : A
                ? (vt(t), n.log('Modal login window already shown'))
                : (vt(t), mt(r), Pt(r));
            });
          }
          function X () {
            var e = 'email_is_not_confirmed',
              t = n.getQueryParamByName(e);
            if (!t) return;
            n.removeQueryParamByName(e);
            const r =
              t === 'registration' ? 'email_is_not_confirmed' : 'email_confirmation_required';
            var i = Rt();
            J({ screen: r, email: i && i.email });
          }
          function V (t) {
            if (A) {
            ...
            U().then(function () {
              var n = e.extend({ screen: 'email_confirmation_required' }, k, t);
              vt(t), mt(n), Pt(n);
            });
          }
          function $ (t) {
            ...
            U().then(function () {
              var n = e.extend({ screen: 'email_confirmation' }, k, t);
              vt(t), mt(n), Pt(n);
            });
          }
          function J (t) {
            ...
            t || (t = {});
            var r = e.extend({}, t, k);
            t.customEvents && typeof t.customEvents == 'object' && (M = t.customEvents),
              mt(r),
              vt(t),
              Pt(r);
          }
          function K (t) {
            U().then(function () {
              var r = e.extend({}, k, t, { isRegistration: !1 }),
                s = r.formName;
              if (!s)
                throw new Error(
              ...
              var o = function () {
                if (A) n.log('Modal login window already shown');
                else {
                  mt(r), vt(t);
                  if (!r.preview && H) {
                    ...
                    return (
                      e.extend(r, {
                        readyCallback: function (e) {
                          i.send('setToken', zt(), e.iframeId);
                        },
                      }),
                      Pt(r)
                    );
                  hn(r).then(function (t) {
          ...
          function Q () {
            i.send('submitLoginForm', null, A.iframeId);
          }
          function G () {
            var t = e.Deferred();
            return (
              e.ajax({
                url: At() + 'api/v1/identity/passwordless/authorization/code',
                dataType: 'jsonp',
                data: { aid: k.aid || tp.aid, passwordless_token: k.passwordlessToken },
                success: function (e) {
                  e.error ? (Z(e), t.reject()) : (Y(e), t.resolve());
                },
                xhrFields: { withCredentials: !0 },
                crossDomain: !0,
              }),
          ...
          function Y (e) {
            !e.error &&
              ...
              delete k.passwordlessToken,
              n.removeQueryParamByName('passwordless_token')),
              n.doneCall('refreshUserToken');
          }
          function Z (e) {
            J({ screen: 'passwordless_confirmation', jsonpError: e }),
              delete k.passwordlessToken,
              n.removeQueryParamByName('passwordless_token');
          }
          function et (e) {
            var t = {
                aid: k.aid || tp.aid,
                login_token_id: e.login_token_id,
                user_token: e.access_token,
              },
              n = { passwordlessToken: e.passwordless_token, redirectUri: e.direction_url };
            tt(t, n);
          }
          function tt (e, t) {
            r.showWaitPanel(),
              f.callApi('/anon/passwordless/complete', e, function (e) {
                if (e.result && e.result.polling_enabled)
                  return nt(e).then(function (e) {
                    it(e, t);
                  });
                it(e, t);
              });
          ...
          function nt (t) {
            ...
            return rt(r, 0, t.result.polling_timeouts, n.resolve), n.promise();
          }
          function rt (e, t, r, i) {
            f.callApi('/anon/passwordless/check', e, function (s) {
              t++,
                s && s.result && s.result.poll_status !== 'waiting'
                  ? i(s)
                  : !s.result && s.message
                  ? (n.error('Passwordless purchase failed', s.message), i())
                  : t <= r.length
                  ? setTimeout(function () {
                      rt(e, t, r, i);
                    }, r[t - 1])
          ...
          function it (e, t) {
            try {
              var n = e.result.resource || {},
                i = JSON.parse(e.result.show_offer_params),
                s = st(t);
              if (!Object.keys(n).length && !Object.keys(i).length) return J(s);
              n.name
                ? (s = st(t, { customParams: { resourceName: n.name } }))
                : (s = st(t, {
                    customEvents: {
                      checkoutContinue: function () {
                        Ht(), r.closeModalContainer(), tp.offer.show(i);
                      },
                    },
                  })),
                J(s);
          ...
          function st (e, t) {
            var n = { screen: 'passwordless_confirmation' };
            return (
              e && ((n.passwordlessToken = e.passwordlessToken), (n.redirectUri = e.redirectUri)),
              t ? Object.assign(n, t) : Object.assign(n, { passwordlessSuccess: !0 })
            );
          }
          function ot (e, t) {
            var n = Rt();
            if (!n) return;
            var r = It(),
              i = { token: r, user: n, source: t };
            if (e) {
              e.loggedIn && e.loggedIn(i);
              return;
            }
            ct('loggedIn', i), ct('loginSuccess', i);
            if (t === w) {
              var s = {
                event: 'loginSuccess',
                source: t,
              ...
              ct('fire_loginSuccess', s), ht('loginSuccess', s);
            }
          }
          function ut (e) {
            var t = { source: e };
            ct('loggedOut', t), ht('logout', t);
          }
          function at (e, t) {
            var n = { login: 'loginDisplayed', register: 'registerDisplayed' },
              r = n[e];
            pt(r, {}, t);
          }
          function ft (e) {
          ...
          function lt (e, t) {
            e && e.customEvent && e.customEvent(t), ht('customEvent', t);
          }
          function ct (e, t) {
            O[e] &&
          ...
          function mt (e) {
            e.aid || (e.aid = tp.aid),
              ...
              e.displayMode === 'popup'
                ? ((e.width = e.width || yt()), (e.height = e.height || 460))
                : e.displayMode === 'modal' && (e.width = e.width || yt()),
              (e.accessToken = It());
          }
          function gt (e) {
            N = e;
          ...
          function Et (e) {
            function t (t) {
              var o = e.config.trackingId,
                u = e.config.formName;
              switch (t.event) {
                case 'loaded':
                  e.config.displayMode === 'modal' && r.checkBackdropAndContainer(e, !0),
                ...
                case 'resize':
                  ...
                  break;
                case 'restoreSize':
                  e.config.displayMode === 'inline' &&
                    r.resizeIframe(e, { width: e.container.width() });
                  break;
                case 'loginSuccess':
                  Ct(t, function () {
                    e.config.callback && e.config.callback(),
                      tp.user.refreshAccessToken(!0),
                      i.broadcast('pianoIdLoginSuccess', t.params);
                  });
                  break;
                case 'loginFailed':
                  pt('loginFailed', t.params);
                  break;
                case 'registrationSuccess':
                  Ct(t, function () {
                    pt('registrationSuccess'), i.broadcast('pianoIdLoginSuccess', t.params);
                  });
                  break;
                case 'registrationFailed':
                  pt('registrationFailed', t.params);
                  break;
                case 'lang':
                  Yt(t.params.lang, !0);
                  break;
                case 'customEvent':
                  lt(e.config, t.params);
                  break;
                case 'closed':
                  Qt(e, !0), e.config.closedCallback && e.config.closedCallback(e);
                  break;
                case 'cfFormSubmission':
                  s.__protected__.logCustomFormSubmission(o, u, S);
                  break;
                case 'formSend':
                case 'formSkip':
                  Qt(e);
                ...
                case 'cfAppImpression':
                  s.__protected__.logCustomFormImpression(o, u, x);
                  break;
                case 'cfAppSubmission':
                  s.__protected__.logCustomFormSubmission(o, u, x);
                  break;
                case 'cfFormImpression':
                  s.__protected__.logCustomFormImpression(o, u, S);
                  break;
                case 'changeScreen':
                  at(t.params.screen);
                  break;
                case 'screenReady':
                  ...
                  break;
                case 'layoutReady':
                  pt('layoutReady', t.params);
                  break;
                case 'confirmationEmailSent':
                  e.config.displayMode !== 'inline' && Qt(e);
                  break;
                case 'verificationCodeStartCheckout':
                  var f = {};
                  try {
                    f = JSON.parse(t.params.startCheckoutParams);
                  } catch (l) {
                    n.log('error parse start checkout params'), (f = {});
                  }
                  Qt(e, !0),
                    Vt(!0, !0),
                    n.waitCall('refreshUserToken', function () {
                ...
                case 'passwordRestored':
                  n.removeQueryParamByName('reset_token'), (k.resetPasswordToken = undefined);
                  break;
                case 'emitGAEvent':
                  a.emitEvent(t.params);
                  break;
                case 'redirect':
                  document.location.href = t.params.url;
                  break;
                default:
          ...
          function St () {
            W({ createPasswordlessUser: !0 });
          }
          function xt (e) {
            var t = e.params.name;
            (camelCaseName = n.fromUnderscoreToCamelCase(t)),
              delete k[camelCaseName],
              e.params.removeFromUrl && n.removeQueryParamByName(t);
          }
          function Tt (t, n) {
            ...
            e.ajax({
              url: At() + 'api/v1/identity/verification/code',
              dataType: 'jsonp',
              data: { client_id: i, access_token: s, site: o, verification_code: r },
              success: function (e) {
                e.error || Nt(e, n);
              },
              xhrFields: { withCredentials: !0 },
          ...
          function Ct (e, t) {
            e && e.params && !e.params.areCookiesSet
              ? ((e.params.source = w), (H = !!e.params.registration), Wt(e.params).then(t))
              : typeof t == 'function' && t();
          }
          function kt (e) {
            switch (e.params.event) {
              case 'cfAppImpression':
              case 'cfFormImpression':
                s.__protected__.logCustomFormImpression(
                  e.params.trackingId,
                  e.params.trackingId,
                  T
                );
                break;
              case 'cfFormSubmission':
                s.__protected__.logCustomFormSubmission(
                  e.params.trackingId,
                  e.params.trackingId,
                  T
                );
                break;
              case 'changeScreen':
                at(e.params.params.screen, !0);
                break;
              case 'loginFailed':
              case 'registrationFailed':
              case 'registrationSuccess':
                pt(e.params.event, e.params.params, !0);
                break;
              case 'emitGAEvent':
                a.emitEvent(e.params.params);
                break;
              default:
          ...
          function Lt () {
            var e = tp.sandbox || tp.isNonProdEndpoint(),
              t = k.iframeUrl || tp.pianoIdUrl || (!e && E) || '/';
          ...
          function _t (t, n, r, i) {
            t.match('proxy.html') || (t += Ot());
            var s = {
                client_id: n.aid,
                sender: r.iframeId,
                origin: i || window.location.origin || window.location.href,
              ...
              o = en();
            o && (s.lang = o),
              !a.getClientId() || (s.ga_client_id = a.getClientId()),
              !a.getGAAccount() || (s.ga = a.getGAAccount()),
              n.disableSignUp && (s.disable_sign_up = !0),
              n.screen && (s.screen = n.screen),
              n.resetPasswordToken && (s.reset = n.resetPasswordToken),
              n.verification_code && (s.verification_code = n.verification_code),
              ...
              n.singleStep && (s.single_step = !0),
              n.createPasswordlessUser && (s.create_passwordless_user = !0),
              n.customParams && (s.custom_params = JSON.stringify(n.customParams));
            if (n.customEvents) {
              var u = [];
            ...
            return (
              n.jsonpError && (s.jsonp_error = JSON.stringify(n.jsonpError)),
              n.passwordlessSuccess && (s.passwordless_success = !0),
              n.passwordlessToken && (s.passwordless_token = n.passwordlessToken),
              n.redirectUri && (s.redirect_uri = n.redirectUri),
              r.iframeUrl && (s.url = r.iframeUrl),
              n.returnBack && (s.return_back = n.returnBack),
              r.pos &&
                ((s.width = r.pos.width),
                (s.height = r.pos.height),
                (s.top = r.pos.top),
                (s.left = r.pos.left)),
              [t, e.param(s)].join('?')
            );
          ...
          function Pt (t) {
            ...
            if (t.displayMode === 'inline') {
              ...
              (c = v.container),
                ...
                (p = v.containerReady),
                t.observeContainer && (d = o.create(c, I));
            } else if (t.displayMode === 'modal')
              (c = r.getModalContainer(t, function () {
                return Qt(A);
              })),
                (h = r.generateIframe(t, a, f));
              ...
              if (n.isIE()) {
                (c = r.generateIframeWrapper()),
                  (f = _t(At(), t, a, At() + 'proxy.html')),
                  (a.iframeUrl = f),
                  (a.pos = r.getPopupPosition(a));
                var m = _t(At() + 'proxy.html', t, a);
            ...
            var y = {
              ...
              w = { center: n.centerScreen(), originUrl: document.location.href };
            i.init({ postMessageUrl: l, receive: Et(y), iframe: y, iframeParams: a }, w);
            if (t.displayMode === 'inline') {
              var E = e('<div>', { class: b });
              ...
              t.displayMode === 'modal'
                ? c.append(h)
                : t.displayMode === 'inlinePopup' && (c.append(h), e('body').append(c));
            return (
              n.debug('creating iframe: ', t),
              L.push(y),
              t.displayMode === 'modal' &&
                ((A = y),
                (A.observer = d),
                (n.isIphone() || n.isIOsUiWebView() || n.isAndroid()) &&
          ...
          function Ht () {
            ...
            r.closeModal(A),
              ...
              e.isIphoneCaretFixed && e.modalClosed(),
              (A = null);
          }
          function Bt (e) {
            var t = { path: '/' },
          ...
          function jt (e) {
            ...
            qt(null, !0, !0);
            var t = Bt(e.cookie_domain);
            !e.extendExpiredAccessEnabled || Ft(e.extendExpiredAccessEnabled, e.cookie_domain);
            if (e.user.rememberMe || sn()) (t.expires = new Date(e.user.exp * 1000)), nn(t);
            n.__protected__.setCookie(d, e.token, t),
              e.cookie_domain &&
                ((t.expires = 30), n.__protected__.setCookie(m, e.cookie_domain, t));
          }
          function Ft (e, t) {
            dn('setExtendExpiredAccess', e, 'broadcast');
            var r = Bt(t);
            (r.expires = 30), n.__protected__.setCookie(y, e ? 'true' : 'false', r);
          }
          function It () {
          ...
          function qt (t, r, i) {
            var s = Bt(),
              o = n.getPossibleCookieDomains(s.domain);
            t && n.__protected__.logRemoveTokens(t),
              o.forEach(function (t) {
                var n = e.extend({}, s, { domain: t });
                e.removeCookie(d, n), i || e.removeCookie(y, n), r || rn(n);
              });
          }
          function Rt () {
            var e = null,
              ...
              try {
                ...
                if (e) {
                  (e.firstName = e.given_name),
                    ...
                    (e.valid = !0),
                    (e.uid = e.sub),
                    (e.confirmed = !e.email_confirmation_required);
                  var i = new Date(),
                    s = new Date(e.exp * 1000);
                  s < i && (n.log('Removing expired tokens'), qt(r), (e = null));
                }
              } catch (o) {}
            return e;
          }
          function Ut (t) {
            var n = e.extend({}, k, t);
            hn(n).then(function (t) {
              var r = e.extend({}, t);
              t &&
                Array.isArray(t.custom_field_values) &&
                (t.custom_field_values = t.custom_field_values.map(function (e) {
                  var t;
                  try {
                  ...
                  return { field_name: e.field_name, value: t, created: e.created };
                })),
                typeof n.extendedUserLoaded == 'function' && n.extendedUserLoaded(r),
                ht('extendedUserLoaded', r);
            });
          }
          function zt () {
            return tp.externalJWT && l.isConfigured() ? tp.externalJWT : It();
          }
          function Wt (e, t, n) {
            jt(e);
            var i = Kt(e).pipe(function () {
              !t && ot(null, e.source);
            });
            n = n || e.withoutCloseModal;
            if (!n) {
              var s = e && e.user && e.user.email_confirmation_required,
                o = A && A.config && A.config.verification_code;
              s || o ? r.hideCloseButton() : Gt();
            }
            return i;
          }
          function Xt () {
            return l.isConfigured() ? !!tp.externalJWT : !!Rt();
          }
          function Vt (r, i) {
            n.startCall('refreshUserToken');
            var s = e.Deferred(),
            ...
            return (
              e.ajax({
                url: At() + 'api/v1/identity/token/verify',
                data: {
                  client_id: k.aid || tp.aid,
                  token: zt() || '',
          ...
          function $t () {
            ...
            var r = new Date().getTime(),
              i = n.__protected__.getCookie(y),
              s = t(e),
              o = r - s.login_timestamp > 86400000;
            i && o && Vt(!1, !0);
          }
          function Jt () {
            var t = e.Deferred();
            return (
              e.ajax({
                url: At() + 'api/v1/identity/logout',
                data: { client_id: k.aid || tp.aid },
                dataType: 'jsonp',
                complete: t.resolve,
                xhrFields: { withCredentials: !0 },
                crossDomain: !0,
              }),
              setTimeout(t.resolve, N),
              t.promise()
            );
          }
          function Kt (t) {
            var n = e.Deferred(),
              r = !((t && t.user && t.user.rememberMe) || sn());
            return (
              e.ajax({
                url: At() + 'api/v1/identity/vxauth/cookie',
                data: { client_id: k.aid || tp.aid, token: t.token, session_cookie: r },
                dataType: 'jsonp',
                complete: n.resolve,
                xhrFields: { withCredentials: !0 },
                crossDomain: !0,
              }),
              setTimeout(n.resolve, N),
              n.promise()
            );
          }
          function Qt (e, t) {
            ...
            t
              ? e.closed ||
                ...
                e.config.displayMode === 'inline'
                  ? e.container.empty()
                  : e.config.displayMode === 'popup'
                  ? e.container.close()
                  : e.config.displayMode === 'modal' && (Ht(e), e.container.parent().remove()))
              : (i.send('close', {}, e.iframeId),
          ...
          function Yt (e, t) {
            var r = Bt();
            (r.expires = 30),
              n.__protected__.setCookie(v, e, r),
              t ||
                L.forEach(function (t) {
                  i.send('lang', { lang: e }, t.iframeId);
                }),
              Object.keys(O.langChangeFromIframe).forEach(function (t) {
                var n = O.langChangeFromIframe[t];
                i.__protected__.isIframeManaged(t) && n ? n(e) : delete O.langChangeFromIframe[t];
              }),
              pt('langChange', e);
          }
          function Zt (e, t) {
            return (
              (O.langChangeFromIframe[t] = e),
              function () {
                delete O.langChangeFromIframe[t];
              }
            );
          }
          function en () {
            return tp.locale || n.__protected__.getCookie(v) || '';
          }
          function tn () {
          ...
          function un (e, t) {
            var n = { token: e.token, user: e.user, cookie_domain: e.cookie_domain };
            Wt(n, !0).pipe(function () {
              t(), ft(n);
            });
          }
          function an () {
          ...
          function hn (t) {
            ...
            return (
              e.ajax({
                url: At() + 'api/v1/identity/userinfo',
                data: { client_id: k.aid || tp.aid, access_token: zt(), form_name: n.formName },
                dataType: 'jsonp',
                success: r.resolve,
                complete: function () {
                  return r.resolve();
          ...
          function dn (e, t, n) {
            j.push({ type: n, name: e, data: t });
          }
          function vn () {
            while (j.length) {
              var e = j.pop();
              e.type === 'broadcast' ? i.broadcast(e.name, e.data) : i.send(e.name, e.data);
            }
          }
          var c = 'reset_token',
            ...
            g = '__idr',
            y = '__eea',
            b = 'piano-id-container',
            w = 'PIANOID',
            E = 'https://id.tinypass.com',
            S = 'show_form',
            x = 'registration',
            T = 'checkout',
            N = 300,
          ...
          return (
            ...
            }),
            {
              ...
              show: W,
              showForm: K,
              checkAndShowEmailIsNotConfirmed: X,
              showEmailConfirmationRequired: V,
              submitLoginForm: Q,
              loginByToken: bt,
              logout: wt,
              getToken: zt,
              ...
              onLoginSuccess: on,
              onProfileUpdate: un,
              onExtendedUserLoginRequired: an,
              isUserValid: Xt,
              setCallbacks: vt,
              getIframeUrl: At,
              updateLang: Yt,
              ...
              isAot: pn,
              registerCallback: cn,
              setRequestTimeout: gt,
              __protected__: {
                offerMessageReceiver: kt,
                showEmailConfirmation: $,
                checkAndShowEmailIsNotConfirmed: X,
                closeModalContainer: Ht,
                executePostMessagesBatch: vn,
              },
              __private__: { prepareConfig: mt, extendUserToken: $t, setRequestTimeout: gt },
            }
          );
        }
      ),
      tp.define('pianoId', function () {}),
      tp.define('pianoIdLite', ['jq', 'api', 'util', 'eventUtils'], function (e, t, n, r) {
        function u () {
        ...
        var i = r.createEventManager(['userChanged', 'onHide']),
          ...
          o = (function () {
            ...
            return { getName: e, getToken: t, isUserValid: r, onLoginSuccess: o };
          })();
        return {
          name: 'pianoIdLite',
          isConfigured: u,
      ...
      tp.define('observer', ['util', 'jq'], function (e, t) {
        function s (e) {
        ...
        var n =
          ...
          i = { attributes: !0 };
        return (
          (s.prototype._mutationSearch = function () {
            var e = this;
            this.targets.forEach(function (t) {
              var n = e._getState(t.element);
              !n === t.currentState && ((t.currentState = n), e.callback([{ target: t.element }]));
            }),
      ...
      tp.define('applePay', ['jq', 'postmessage', 'util'], function (e, t, n) {
        function v (e) {
          try {
            o = JSON.parse(e.data);
          } catch (i) {}
          if (['loaded', 'startCheckout'].indexOf(o.event) !== -1) {
            var s = n.__protected__.isApplePayAllowed();
            t.broadcast('EVENT_APPLE_PAY_CAN_MAKE_PAYMENTS', { canMakePayments: s });
          } else if (o.clientToken) y(o.clientToken);
          else if (o.event === 'applePayCheckoutFlowProperties')
            h = o.params.isBillingAddressShown;
          else if (o.event === 'applyTaxFailed') f.abort();
          else if (o.event === 'checkApplePayBtInstance') l && t.broadcast('applePayInit', {});
          else if (o.event === 'applyTaxCompleted') g(o.params.nonce);
          else if (o.beginSession) {
            var u = {};
            o.resourceTitle && (u = o), o.termId && (d = o.termId);
            var a = {
              currencyCode: o.currencyCode,
              total: { label: o.resourceTitle, amount: o.chargeAmount },
            };
            h &&
              ((a.requiredShippingContactFields = ['email']),
              (a.requiredBillingContactFields = ['postalAddress']));
            try {
              c = l.createPaymentRequest(a);
            } catch (p) {
              t.broadcast('payment-error', { errorCode: 101 });
            }
            (f = new ApplePaySession(r, c)),
              (f.onvalidatemerchant = function (e) {
                l.performValidation(
                  {
                    validationURL: e.validationURL,
                    displayName: o.resourceTitle || u.resourceTitle,
                  },
                  function (e, n) {
                    if (e) {
                      f.abort(), t.broadcast('payment-error', { errorCode: 102 });
                      return;
                    }
              ...
              (f.onpaymentauthorized = function (e) {
                l.tokenize({ token: e.payment.token }, function (n, r) {
                  if (n) {
                    t.broadcast('payment-error', { errorCode: 103 }),
                      f.completePayment(ApplePaySession.STATUS_FAILURE);
                    return;
                  }
                  var i = { nonce: r.nonce };
                  h && e.payment.shippingContact
                    ? ((i.user = { email: e.payment.shippingContact.emailAddress }),
                      m(e.payment.billingContact, i))
                    : g(i);
                });
              }),
              f.begin();
        ...
        function m (e, n) {
          ...
          t.broadcast('applePayPaymentAuthorized' + d, r);
        }
        function g (e) {
          f.completePayment(ApplePaySession.STATUS_SUCCESS), t.broadcast('applePayNonce' + d, e);
        }
        function y (e) {
          (p = e), w();
        }
        function b () {
          braintree.client.create({ authorization: p }, function (e, r) {
            if (e) {
              t.broadcast('payment-error', { errorCode: 100 }),
                n.log('[TP] Client error: ' + e.message);
              return;
            }
            braintree.applePay.create({ client: r }, function (e, n) {
              if (e) {
                t.broadcast('payment-error', { errorCode: 101 });
                return;
              }
              (l = n), t.broadcast('applePayInit', {});
            });
          });
        }
        function w () {
        ...
        var r = 2,
          ...
          p,
          d = '';
        return window.addEventListener('message', v, !1), { name: 'applePay' };
      }),
      tp.define('applePay', function () {}),
      tp.define('applePayIntegrationService', ['jq', 'postmessage', 'util'], function (e, t, n) {
        function f (e) {
          function c (e) {
            return a ? a === e : !0;
          }
          function h () {
            var e = {
              ...
              total: { label: i.params.resourceName, amount: i.params.chargeAmount },
            };
            return e;
          }
          function p () {
          ...
          switch (i.event) {
            ...
            case 'initPwApplePay':
            case 'startCheckout':
              (u = n.__protected__.isApplePayAllowed()),
                t.broadcast('EVENT_APPLE_PAY_CAN_MAKE_PAYMENTS', { canMakePayments: u });
              break;
            case 'pay-session-received':
              try {
                o.completeMerchantValidation(i.params.applePaySession);
              } catch (l) {
                t.broadcast('payment-error', { errorCode: 111, errors: l });
              }
              break;
            ...
            case 'start-purchase':
              (a = i.params.termId || ''),
                (s = i.params.resourceName),
                (o = new ApplePaySession(r, h())),
                ...
                (o.onpaymentauthorized = function (e) {
                  try {
                    ...
                    t.broadcast('payment-error', { errorCode: 110, error: n });
                  }
                });
              try {
                o.begin();
              } catch (l) {
                t.broadcast('payment-error', { errorCode: 112, error: l, termId: a });
              }
              break;
        ...
        function c () {
          ...
          return t && tp.applePayMerchantId
            ? ApplePaySession.canMakePaymentsWithActiveCard(tp.applePayMerchantId)
            : e;
        }
        var r = 3,
          i = {},
        ...
        return {
          ...
          initialize: l,
          __protected__: { applePayCanMakePaymentsWithActiveCard: c },
        };
      }),
      tp.define('applePayIntegrationService', function () {}),
      tp.define('stripeApplePayIntegrationService', ['postmessage'], function (e) {
        function u () {
          if (n != null) return n;
          ...
          switch (t.event) {
            ...
            case 'stripe-applepay-initiate-purchase':
              ...
              u()
                ...
                .then(function (t) {
                  (s = t && t.applePay),
                    e.broadcast('stripe-applepay-initiate-purchase-complete', {
                      canMakePayment: s,
                    });
                  if (!s) return;
                  i.on('cancel', function () {
                    e.broadcast('stripe-applepay-start-purchase-complete' + o, { status: 'fail' });
                  }),
      ...
      tp.define('obi3DSChallenge', ['postmessage', 'jq'], function (e, t) {
        function r (t) {
          var n = {
          ...
          obick
            .handle3dsChallenge(n)
            .then(function (t) {
              console.warn(t),
                e.broadcast('obi-3ds-challenge-complete', {
        ...
        function i (e) {
          ...
          if (n.event === 'obi-handle-3ds-challenge') {
            ...
            if (!window.obick) {
              const s = [
                'https://jsl.qat.obi.aol.com/obipmservice/obick.umd.js',
                'https://jsl.prod.obi.aol.com/obipmservice/obick.umd.js',
              ];
              if (s.indexOf(i.obickUrl) === -1) {
                console.warn('Untrusted obickUrl detected: ' + i.obickUrl);
                return;
              }
      ...
      tp.define('idle', ['jq', 'util'], function (e, t) {
        function o () {
          if (n) return;
          (n = !0),
        ...
        function l (e, t, n) {
          o(),
            ...
            r.push({ callback: e, idleTime: t * 1000, startTime: Date.now(), consumeEventFn: n }),
            i || (i = setTimeout(u, s));
        }
        function c () {
          r = [];
        ...
        var n = !1,
          ...
          i,
          s = 200;
        return { name: 'idle', initialize: o, addListener: l, removeListeners: c };
      }),
      tp.define('idle', function () {}),
      tp.define('interaction', ['jq', 'util'], function (e, t) {
        function r (r, i, s) {
          var o = function (e) {
            var t = {
                click: 'click',
              ...
              for (var t = 0; t < i.length; t++) {
                ...
                a.trim().length &&
                  (function (t, i, o) {
                    ...
                    e('body').on(i, t, u),
                      n.__private__.boundInteractions.push({ action: a, selector: f, func: u });
                  })(f, a, l);
              }
            });
        }
        ...
        var n = { __private__: {}, __protected__: {} };
        return (
          (n.name = 'interaction'),
          (n.bind = r),
          (n.unbindAll = i),
      ...
      tp.define('log', ['jq', 'util', 'postmessage'], function (e, t, n) {
        ...
        var r = function (e) {
            ...
            for (var n in e) {
              ...
              t.push(
                encodeURIComponent(n) +
                  '=' +
                  encodeURIComponent(typeof r == 'object' ? JSON.stringify(r) : r)
              );
            }
            return t.join('&');
          },
          i = function (t, n) {
            var i = r(n);
            i.length > 6000
              ? e.ajax({ type: 'POST', url: tp.getTrackingEndpoint() + t, data: i })
              : e.ajax({ url: tp.getTrackingEndpoint() + t + '?' + i, dataType: 'jsonp' });
          },
          s = function (e, n, r) {
            var s = { tracking_id: e, event_group_id: n, custom_params: r || '' };
            if (!e) {
          ...
          u = function (e, n, r, s, o, u, a, f) {
            var l = { tracking_id: e, term_id: n, term_name: r };
            if (!e) {
          ...
          a = function (e) {
            typeof e == 'object'
              ? u(
                  ...
                  e.currency,
                  e.custom_params,
                  e.conversion_category
                )
              : u.apply(this, arguments);
          },
          f = function (e, n, r, s) {
            var o = { tracking_id: e, step_number: n, step_name: r, custom_params: s || '' };
            if (!e) {
          ...
          l = function (e, n, r) {
            n || t.log('Parameter formName is required to log impression.'),
              r || t.log('Parameter source is required to log impression.');
            var s = {
                aid: tp.aid,
            ...
            return (
              o && (s.user_token = o),
              e && (s.tracking_id = e),
              i('/api/v3/customform/log/impression', s)
            );
          },
          c = function (e, n, r) {
            n || t.log('Parameter formName is required to log submission.'),
              r || t.log('Parameter source is required to log submission.');
            var s = {
                aid: tp.aid,
                pageview_id: tp.main.fetchPageViewId(),
                custom_form_name: n,
            ...
            return (
              o && (s.user_token = o),
              e && (s.tracking_id = e),
              i('/api/v3/customform/log/submission', s)
            );
          },
          h = function (n, i) {
            var s = r(i),
            ...
            if (navigator.sendBeacon)
              ...
              var a = navigator.appVersion.indexOf('MSIE 9') !== -1,
                f;
              a
                ? (f = { dataType: 'jsonp', url: o })
                : (f = { type: 'post', url: o, async: !1, xhrFields: { withCredentials: !0 } }),
                (f.error = function () {
      ...
      tp.define('gaService', ['jq', 'api', 'util', 'postmessage'], function (e, t, n, r) {
        function b () {
          if (g) return;
          (g = !0), k();
          if (!h.gaAccount) {
        ...
        function E (e, t) {
          p.push({ action: e, params: t });
        }
        function S () {
          if (!ga || !h.isTrackerAppended) return;
          while (p.length) {
            var e = p.pop();
            N(e.action, e.params);
          }
        ...
        function x (e, t) {
          m.push({ action: e, params: t });
        }
        function T () {
          if (!ga || !h.isMetricsTrackerAppended) return;
          while (m.length) {
            var e = m.pop();
            C(e.action, e.params);
          }
        ...
        function N (e, t) {
          if (!ga || !h.isTrackerAppended) {
            E(e, t);
            return;
          }
          ga(h.trackerName + '.' + e, t);
        }
        function C (e, t) {
          if (!h.isMetricsEnabled) return;
          if (!ga || !h.isMetricsTrackerAppended) {
            x(e, t);
            return;
          }
          ga(o + '.' + e, t);
        ...
        function k () {
          if (v) return;
          !tp.getGAClientId() || (d = tp.getGAClientId());
          if (n.__protected__.hasLocalStorage()) {
            var e = n.__protected__.getLocalStorageItem(u),
              t = n.__protected__.getLocalStorageItem(a),
              r = n.__protected__.getLocalStorageItem(f);
            (h.isGAEnabled = !!e && e !== l),
              (h.isMetricsEnabled = !!t && t !== l),
              (h.gaAccount = e),
              (h.metricsGAAccount = t),
              (h.trackOnlyAids = r ? r : []);
          }
          v = !0;
        }
        function L () {
          var n = e.Deferred();
          return (
            t.callApi('/anon/assets/gaAccount', { aid: tp.aid }, function (e) {
              e.code === 0 ? (O(e.data), n.resolve()) : n.reject();
            }),
            n.promise()
          );
        }
        function A () {
          var n = e.Deferred();
          return (
            t.callApi('/anon/assets/performanceMetrics', null, function (e) {
              e.code === 0 ? (M(e.performance_metrics_dto), n.resolve()) : n.reject();
            }),
            n.promise()
          );
        }
        function O (e) {
          (h.isGAEnabled = !!e),
            (h.gaAccount = e ? e : l),
            n.__protected__.setLocalStorageItem(u, h.gaAccount, c);
        }
        function M (e) {
          (h.isMetricsEnabled = JSON.parse(e.is_enabled)),
            (h.metricsGAAccount = h.isMetricsEnabled ? e.ga_account : l),
            (h.trackOnlyAids = h.isMetricsEnabled ? JSON.parse(e.track_only_aids) : []),
            n.__protected__.setLocalStorageItem(f, h.trackOnlyAids, c),
            n.__protected__.setLocalStorageItem(a, h.metricsGAAccount, c);
        }
        function _ () {
          var t = e.Deferred();
          return (
            h.isGAEnabled
              ? P().then(function () {
                  if (h.isGAAppended)
                    if (!h.isTrackerAppended)
                      try {
                        var e = document.createElement('script');
                        (e.innerHTML = d ? H() : B()),
                          document.head.appendChild(e),
                          (h.isTrackerAppended = !0),
                          t.resolve();
                      } catch (n) {
                        t.reject();
                      }
        ...
        function D () {
          ...
          return (
            h.isMetricsEnabled
              ? P().then(function () {
                  if (h.isGAAppended)
                    if (!h.isMetricsTrackerAppended)
                      try {
                        var e = !h.trackOnlyAids.length || h.trackOnlyAids.contains(tp.aid),
        ...
        function B () {
          return (
            "ga(function() {  var trackers = ga.getAll();  var found = false;  for (var i = 0; i < trackers.length; i++) {    var tracker = trackers[i];    if (tracker.get('trackingId') ==='" +
            h.gaAccount +
            "') {" +
            "      tp.gaService.setClientId(tracker.get('clientId'));" +
            "      if (tracker.get('name') !== '" +
            s +
            "') {" +
            "        tp.gaService.setTrackerName(tracker.get('name'));" +
            '      }' +
            '      found = true;' +
            '      tp.gaService.trackerAppended();' +
            '      break;' +
            ...
            s +
            "');" +
            "    tp.gaService.setClientId(ga.getByName('" +
            s +
            "').get('clientId'));" +
            '    tp.gaService.trackerAppended();' +
            '  }' +
        ...
        var i = { name: 'gaService', __protected__: {} },
          s = 'pianoTracker',
          o = 'performanceTracker',
          u = 'gaAccount',
          a = 'metricsGAAccount',
          f = 'trackOnlyAids',
          l = 'disabled',
          ...
          y = !1;
        return (
          (i.emitEvent = function (e) {
            e.hitType = 'event';
            if (!h.isTrackerAppended) {
              E('send', e), b();
              return;
            }
            if (!h.isGAEnabled) return;
            if (!ga || !h.isTrackerAppended) {
              E('send', e);
              return;
            }
          ...
          (i.getGAAccount = function () {
            return h.gaAccount;
          }),
          (i.getClientId = function () {
            return d;
          }),
          (i.setClientId = function (e) {
            d = e;
          }),
          (i.setTrackerName = function (e) {
            h.trackerName = e;
          }),
          (i.metricsTrackerAppended = function () {
            (h.isMetricsTrackerAppended = !0), (y = !1), T();
          }),
          (i.trackerAppended = function () {
            (h.isTrackerAppended = !0),
              r.broadcast('gaAppended', { clientId: d, gaAccount: h.gaAccount }),
              (g = !1),
              S();
          }),
          i
      ...
      tp.define('pianoEsp', ['jq', 'util', 'log', 'recWidgetService', 'user', 'api'], function (
        e,
        t,
        n,
        r,
        ...
        var o = '__pnml',
          ...
          a = 'EXTERNAL_LINK',
          f = 'EXTERNAL_EVENT',
          l = r.__protected__.getInstance(),
          c = '300',
          h = { granted: 'ALLOWED', default: 'UNKNOWN', denied: 'FORBIDDEN' },
          p = function () {
            if (u) return u;
            var n = e.Deferred(),
            ...
            return (
              i.id
                ? (e.extend(i, {
                  ...
                  (window.PianoESPConfig = i),
                  t.debug('pianoESP: loading PianoESP with config:', window.PianoESPConfig),
                  r.__protected__.insertWidgetLib({
                    id: 'pnesplucidsdksel',
                    src:
                      v() +
                      '/public/sdk/v04/sdk.js?v=' +
          ...
          d = function (t) {
            window.PianoESPConfig = e.extend(window.PianoESPConfig || {}, { visitor: t });
          },
          v = function () {
            ...
            return (
              tp.espEndpoint
                ? (e = tp.espEndpoint)
                : tp.isSandbox() && (e = '//sandbox-api-esp.piano.io'),
              e
            );
          },
          m = function (e) {
            var t = N();
            return (
              l.showRecommendation({
                widgetConfig: e,
                widgetCallbacks: t,
                createPlaceholderFn: T(e.placeholder),
              }),
              p().then(function () {
          ...
          g = function (e, r) {
            p().then(function () {
              window.PianoESP.getCurrentPushState().then(function (e) {
                e === 'prompt' && n.logMicroConversion(r, 'showPrompt');
              }),
                window.PianoESP.subscribeToPushSquads([e])
                  .then(function (i) {
                    var s = i || {};
                    s.result === !0
                      ? (t.setPushListsCookie(e),
                        t.debug('pianoESP: Push notification was set:', s),
                        n.logMicroConversion(r, 'enrollPushCampaign'))
                      : s.result === !1 &&
                        (s.reason === 'closed'
                          ? n.logMicroConversion(r, 'closePrompt')
                          : n.logMicroConversion(r, 'declineEnrollPushCampaign'));
                  })
                  .catch(function (e) {
          ...
          y = function (e) {
            var t = e || {};
            t.templateId
              ? (n.logMicroConversion(t.trackingId, 'showPushSignupTemplate'),
                tp.template.show({
                  templateId: t.templateId,
                  templateVariantId: t.templateVariantId,
                  displayMode: 'modal',
                  customEvent: function (e) {
                    switch (e.eventName) {
                      case 'push-allow':
                        n.logMicroConversion(t.trackingId, 'allowSoftEnrollPushCampaign'),
                          g(t.pushListId, t.trackingId);
                        break;
                      case 'push-dont-allow':
                        n.logMicroConversion(t.trackingId, 'declineSoftEnrollPushCampaign');
                        break;
                      case 'push-close':
                        n.logMicroConversion(t.trackingId, 'close');
                    }
                  },
                }))
              : g(t.pushListId, t.trackingId);
          ...
          b = function () {
            ...
            return h[window.Notification.permission] || h.default;
          },
          w = function (e) {
            try {
          ...
          S = function (e) {
            ...
            e.notShowIfFilled && r
              ? t.log('Mailing list with ids ' + e.mailingListIds + ' already shown')
              : tp.template.show(e);
          },
          x = function (e) {
            switch (e.event) {
              case 'newsletterSignupSubmission':
                var t = E();
                t.indexOf(e.params.mailingListIds) === -1 &&
                  (t.push(e.params.mailingListIds), w(t));
            }
          },
          T = function (t) {
            return function () {
          ...
          N = function () {
            return {
              onrecsloaded: function (e) {
                return function (r) {
                  if (r.countOfRecs === 0) {
                    l.closeWidget({ widget: e, skipOnclose: !0 });
                    return;
                  }
                  l.fixWidgetModalWidth(e, !0),
                    n.__protected__.logEspMicroConversion(e.trackingId, e.widgetId, 'init', f),
                    t.debug('creating recommendation widget: ', e.config);
                };
              },
              onclick: function (e) {
                return function (t) {
                  var r = { href: t.url };
                  n.__protected__.logEspMicroConversion(e.trackingId, e.widgetId, 'click', a, r);
                };
              },
              onclose: function (e) {
                return function () {
                  var t = { event: 'widgetClosed' };
                  n.__protected__.logEspMicroConversion(e.trackingId, e.widgetId, 'close', f, t);
                };
              },
            };
          },
          C = function () {
            l.clearWidgets(), (u = null), delete window.PianoESP;
          },
          k = function (e) {
            if (!u) return;
            typeof e == 'function' && u.then(e);
          };
        return (
          setTimeout(function () {
            ...
            var e = i.getProvider();
            e.registerCallback &&
              e.registerCallback('logout', function () {
                w([]);
              });
          }, c),
          {
            ...
            __protected__: {
              init: p,
              setVisitorId: d,
              showRecommendation: m,
              showPushSignup: y,
              getNotificationStatus: b,
              showNewsletterSignup: S,
              offerMessageReceiver: x,
            },
            __private__: { removeWidgetsAndSdk: C, getWidgetCallbacks: N, onInit: k },
          }
        );
      }),
      tp.define('versionService', [], function () {
        ...
        var e = '11.95.1, server-v11.95.1';
        return n(), { name: 'versionService', getTinypassVersion: t };
      }),
      tp.define('versionService', function () {}),
      tp.define('amp', ['jq', 'util', 'api', 'user', 'pianoId'], function (e, t, n, r, i) {
        function o () {
        ...
        function u (n) {
          if (n && n.userState && e.isPlainObject(n.userState)) {
            ...
            if (r.filter(s.__private__.isUserStateNameValid).length !== r.length)
              return t.error('user_state accept only contain letters, numbers and underscore'), !1;
          }
          return !0;
        }
        function a (n) {
        ...
        function c (t) {
          ...
          n === i.getName() &&
            (t ? (t = e.extend(!0, t, { userProvider: n })) : (t = { userProvider: n }));
          var o = { user_transient: !0, user_provider: s.__private__.composerOnlyProvider };
          t && t.readerId && (o.reader_id = t.readerId),
            t && t.userToken && (o.user_token = t.userToken),
            t && t.userProvider && ((o.user_provider = t.userProvider), (o.user_transient = !1));
          if (!u(t)) return !1;
          t && t.userState && (o.user_state = JSON.stringify(t.userState));
          var a = function (n) {
            n.code === 0
              ? t.loginSuccess && e.isFunction(t.loginSuccess) && t.loginSuccess()
              : t.loginFail && e.isFunction(t.loginFail) && t.loginFail();
          };
        ...
        var s = { __private__: {}, __protected__: {} };
        return (
          (s.name = 'amp'),
          (s.showLogin = a),
          (s.logout = f),
          ...
          (s.__private__.RETURN_URL = 'return'),
      ...
      tp.define('performanceMetrics', ['postmessage'], function (e) {
        function u () {
          const $___old_4165b39c4e67fe9e = {}.constructor.getOwnPropertyDescriptor(
              window,
              'performance'
            ),
            $___old_5a717635e2e0c28d = {}.constructor.getOwnPropertyDescriptor(
              window,
              'PerformanceObserver'
            ),
            $___old_1e176cba6102ba8e = {}.constructor.getOwnPropertyDescriptor(
              window,
              'PerformanceObserver'
            );
          try {
            if ($___old_4165b39c4e67fe9e)
              ({}.constructor.defineProperty(
                window,
                'performance',
                $___stub_2b47892348e4e4b9.performance
              ));
            if ($___old_5a717635e2e0c28d)
              ({}.constructor.defineProperty(
                window,
                'PerformanceObserver',
                $___stub_2b47892348e4e4b9.PerformanceObserver
              ));
            if ($___old_1e176cba6102ba8e)
              ({}.constructor.defineProperty(
                window,
                'PerformanceObserver',
                $___stub_2b47892348e4e4b9.PerformanceObserver
            ...
            return function () {
              ...
              s.observe({ entryTypes: ['measure', 'resource'] });
            }.apply(this, arguments);
          } finally {
            if ($___old_4165b39c4e67fe9e)
              ({}.constructor.defineProperty(window, 'performance', $___old_4165b39c4e67fe9e));
            if ($___old_5a717635e2e0c28d)
              ({}.constructor.defineProperty(
                window,
                'PerformanceObserver',
                $___old_5a717635e2e0c28d
              ));
            if ($___old_1e176cba6102ba8e)
              ({}.constructor.defineProperty(
                window,
                'PerformanceObserver',
                $___old_1e176cba6102ba8e
              ));
          }
        }
        function a (e) {
        ...
        var t = [
            { resourceRegExp: new RegExp('/checkout/offer/show'), label: 'showOffer' },
            { resourceRegExp: new RegExp('tinypass.min.js$'), label: 'tinypassMinJS' },
            {
        ...
        return u(), { name: 'performanceMetrics' };
      }),
      tp.define('swg', ['postmessage', 'user', 'jq', 'util', 'eventUtils'], function (
        e,
        t,
        n,
        r,
        ...
        function p (e) {
          var t = n.Deferred();
          return (
            tp.api.callApi('/swg/check', { entitlement: JSON.stringify(e) }, function (e) {
              e.code !== 0 &&
                (r.log('swg: check subscription response - ' + e.message), t.reject()),
        ...
        function d (e) {
          var t = n.Deferred();
          return (
            tp.api.callApi('/swg/check/external', { entitlements: JSON.stringify(e) }, function (
              e
            ) {
              e.code !== 0 &&
                (r.log('swg: check external entitlement response - ' + e.message), t.reject());
              var n = e.data;
              n || (r.log('swg: check external entitlement empty response'), t.reject()),
                t.resolve(n);
            }),
            t.promise()
          );
        ...
        function v (t, n, i, s, o) {
          tp.api.callApi(
            '/swg/subscribe',
            { term_id: s, purchase_data: JSON.stringify(n), user_data: JSON.stringify(i) },
            function (n) {
              if (n.code !== 0) {
        ...
        (window.SWG = window.SWG || []),
          window.SWG.push(function (e) {
            e.setOnPaymentResponse(function (e) {
              if (f) return;
              r.debug('swg: onPaymentResponse is triggered'),
                (f = !0),
                e
                  .then(function (e) {
                    r.debug('swg: onPaymentResponse', e),
                      v(e, e.purchaseData, e.userData, l, o.BUY);
                  })
                  .catch(function (e) {
                ...
                if (t.enablesThis()) {
                  ...
                  p(n).then(
                    function (n) {
                      if (f) {
                        r.debug(
                          'swg: onPaymentResponse is already triggered. Skipping entitlements flow.'
                        );
                        return;
                      }
                      if (!n) return;
                      switch (n.type) {
                        ...
                        case 'TERM_FOUND':
                          ...
                          var s = n.term_id;
                          e.completeDeferredAccountCreation({ entitlements: t, consent: !0 })
                            .then(function (e) {
                              r.debug('swg: completeDeferredAccountCreation', e),
                                v(e, e.purchaseData, e.userData, s, o.DEFERRED_ACCOUNT_CREATION);
                            })
                            .catch(function (e) {
                        ...
                        default:
                          r.debug(
                            'swg: check subscription response type ' + n.type + '. Nothing to do'
                          );
                      }
                    },
                    function () {
        ...
        e.subscribe('swgCheckoutStart', function (e) {
          a ||
            r.log(
              'swg: incorrect SwG configuration. Please make sure that Experience user segment is configured properly. Details at https://docs.piano.io/subscribe-with-google/#SwGscript'
            );
          var t = e.params.sku;
          (l = e.params.termId),
            window.SWG.push(function (e) {
          ...
          y = function (e) {
            ...
            if (e) {
              ...
              var t =
                ...
                e.isAccessibleForFree;
              e.isAccessibleForFree === !1 &&
                e.productId &&
                (t =
                  t +
                  ',\n' +
        ...
        return {
          name: 'swg',
          __protected__: { injectMarkup: y, addLibrary: w, initSwgFlow: c },
          registerCallback: function (e, t) {
            u.addEvent(e), u.registerCallback(e, t);
          },
        };
      ...
      tp.define('fbpixel', ['jq', 'util'], function (e, t) {
        var n = !1,
          r = function () {
            if (n) return;
        ...
        return {
          name: 'fbpixel',
          isInitialized: u,
          __private__: { isInitialized: u },
          __protected__: { init: r },
          trackEvent: s,
          trackCustomEvent: o,
        };
      }),
      tp.define(
        'fbsubscriptions',
        ['jq', 'util', 'fbpixel', 'offer', 'pianoId', 'user', 'api'],
        function (e, t, n, r, i, s, o) {
          function c () {
            if (u) return;
            n.__protected__.init(),
              r.registerCallback('loaded', function () {
                ...
                (e === 'meter_limit_reached' || e === 'locked_article') &&
                  !tp.inappBrowserReturn &&
                  b('ViewPaywall', { surface: 'IA' });
              });
            var e = function (e) {
                p().then(function () {
                  e.registration
                    ? b('CreateAccount')
                    : b('LogIntoAccount', { is_subscriber: !!a }),
                    !a ||
                      setTimeout(function () {
                        m();
                      }, 200);
            ...
            tp.addHandler('loginSuccess', e),
              tp.addHandler('experienceExecute', i),
              r.registerCallback('alreadyPurchased', function (e) {
                v(e.rid);
              }),
              r.registerCallback('startCheckout', function (e) {
                y('InitiateCheckout', { offer_code: e.offerId, campaign_code: e.termId });
              }),
              r.registerCallback('complete', function (e) {
                e.hasOwnProperty('chargeCurrency') &&
                  e.hasOwnProperty('chargeAmount') &&
                  y('Purchase', {
          ...
          function p (n) {
            ...
            return (
              n && (i.rid = n),
              o.callApi('/fbia/subscriptionPayload/generate', i, function (e) {
          ...
          function v (e) {
            if (!e) {
              t.error(
                "fbsubscriptions: 'rid' could not be empty on generating subscription payload"
              );
              return;
            }
            var n = h(),
          ...
          function m () {
            var e = t.getQueryParamByName('account_linking_token'),
              n =
                t.getQueryParamByName('redirect_uri') +
          ...
          return {
            ...
            isInitialized: w,
            __private__: { isInitialized: w },
            __protected__: { init: c },
          };
        }
      ),
      ...
      tp.define('tinypassErrorHandler', ['postmessage', 'api', 'jq'], function (e, t, n) {
        function f (e, t) {
          var n = e.map(JSON.stringify);
          return n.indexOf(JSON.stringify(t)) !== -1;
        }
        function l (e, t) {
          var n = e - 0.5 + Math.random() * (t - e + 1);
        ...
        function d (e) {
          const $___old_1f5301ee9fb57ddf = {}.constructor.getOwnPropertyDescriptor(
            Navigator.prototype,
            'userAgent'
          );
          try {
            if ($___old_1f5301ee9fb57ddf)
              ({}.constructor.defineProperty(
                Navigator.prototype,
                'userAgent',
                $___stub_47c01efa79e9f191.userAgent
            ...
            return function () {
              ...
              (t.stack = n ? e.error.stack : 'n/a'),
                (t.message = n ? e.error.message : 'n/a'),
        ...
        function b (e, t) {
          ...
          n.post(e, { log_message: JSON.stringify(t) });
        }
        function w () {
          if (y()) return;
        ...
        function S (e) {
          try {
            var t = {};
            e instanceof Error
              ? ((t.stack = e.stack), (t.message = e.message))
        ...
        return { name: 'tinypassErrorHandler', addError: S };
      }),
      tp.define('tinypassErrorHandler', function () {}),
      tp.define('newscycle', ['jq', 'user', 'api', 'postmessage', 'util'], function (
        e,
        t,
        n,
        r,
        ...
        function o () {
          var t = e.Deferred(),
            r = { aid: tp.aid };
          return (
            n.callApi(s.__private__.SYNCHRONIZE_SUBSCRIPTIONS_URL, r, function (e) {
        ...
        function u (e) {
          r.broadcast('NEWSCYCLE_HAS_BEEN_SYNCHRONIZED_SUCCESS', { data: e });
        }
        function a (e) {
        ...
        function f () {
          s.__private__
            .callSynchronization()
            .then(
              s.__private__.subscriptionsHasBeenSynchronize,
              s.__private__.subscriptionsHasNotBeenSynchronize
            );
        }
        var s = { __private__: {}, __protected__: {} };
        return (
          (s.name = 'newscycle'),
          (s.syncSubscriptions = i.debounce(f, 1500)),
          (s.__private__.SYNCHRONIZE_SUBSCRIPTIONS_URL =
            '/externalVerification/synchronizeSubscriptions'),
          (s.__private__.callSynchronization = o),
          (s.__private__.subscriptionsHasBeenSynchronize = u),
          (s.__private__.subscriptionsHasNotBeenSynchronize = a),
          s
        );
      }),
      tp.define('cxense', ['jq', 'util', 'recWidgetService'], function (e, t, n) {
        var r = n.__protected__.getInstance(),
          ...
          s = function () {
            return typeof tp.c1XIntegrationVersion != 'undefined' && tp.cxenseSiteId !== ''
              ? tp.c1XIntegrationVersion
              : 'N/A';
          },
          o = function () {
            return typeof tp.cxCdnUrl != 'undefined' && tp.cxCdnUrl !== ''
              ? tp.cxCdnUrl
          ...
          a = function (e) {
            return (
              ...
              typeof window.cX.library != 'undefined' &&
              (e ||
                (typeof window.cX.CCE != 'undefined' &&
                  typeof window.cX.CCE.library != 'undefined'))
            );
          },
          f = function (e) {
          ...
          l = function (e) {
            ...
            if (!u() && f(e)) {
              t.debug(
                'cxense: can not send pageview because siteId is not configured using `setCxenseSiteId`'
              );
              return;
            }
            if (u() && !f(e)) {
              t.debug(
                'cxense: can not send pageview because customer prefix is not configured in app settings'
              );
              return;
            }
            c(e);
          ...
          c = function (e) {
            ...
            (n.callQueue = n.callQueue || []),
              n.callQueue.push(['setSiteId', tp.cxenseSiteId]),
              e.uid &&
                e.uid !== 'anon' &&
                e.uid !== '' &&
                (n.callQueue.push(['addExternalId', { id: e.uid, type: e.cxenseCustomerPrefix }]),
                t.debug('c1x: adding externalId', { uid: e.uid, prefix: e.cxenseCustomerPrefix })),
              n.callQueue.push([
                'invoke',
                function () {
                  t.debug('c1x: sending pageview event'),
                    (window.cXNative = {
                      getUserId: function () {
                        return e.browserId;
                      },
              ...
              n.callQueue.push(['setRandomId', e.pageViewId]),
              tp.c1XLoadCce
                ? ((n.CCE = n.CCE || {}),
                  (n.CCE.callQueue = n.CCE.callQueue || []),
                  n.CCE.callQueue.push(['sendPageViewEvent']))
                : n.callQueue.push(['sendPageViewEvent']);
          },
          h = function () {
            ...
            var i = e || n;
            return i
              ? (t.debug('c1x: existing cX_P value has been found: ', i), i)
              : (t.debug('c1x: can not find existing cX_P value, generating a new one'),
                t.__protected__.randomStringCxCompatible());
          },
          p = function () {
            if (u() && a(!0)) return;
            ...
            (n.onerror = function (e) {
              ...
              (n.async = !0),
              (n.type = 'text/javascript'),
              tp.c1XLoadCce ? (n.src = o() + '/' + 'cx.cce.js') : (n.src = o() + '/' + 'cx.js'),
              t.debug('c1x: start loading cx.js on the page...'),
              e.parentNode.insertBefore(n, e);
          },
          d = function (e) {
            if (!u()) {
              t.debug(
                'c1x: can not show recommendation because siteId is not configured using `setCxenseSiteId`'
              );
              return;
            }
            var n = e || {};
            r.showRecommendation({
              ...
              m(function () {
                i(),
                  window.cX.CCE.run(
                    { widgetId: n.widgetId, targetElementId: 'cxense-' + n.widgetId },
                    null,
                    function (e) {
                      n.displayMode === 'modal' &&
                        e &&
                        e.response &&
                        !e.response.error &&
                        r.fixWidgetModalWidth(r.findWidget(n.widgetId));
                    }
                  );
              });
          },
          v = function (t, n) {
            return function () {
              return e(
                '<div class="tp-cxense-placeholder-' +
                  n +
          ...
          y = function (t, n, r) {
            ...
            var i = 0,
              ...
              o = function () {
                g(t)
                  ...
                  ? s.reject(
                      t
                        ? 'c1x: cX object is not found after ' +
                            r +
                            ' retries with ' +
                            n +
                            'ms interval'
                        : 'c1x: cX and cX.CCE objects are not found after ' +
                            r +
                            ' retries with ' +
                            n +
                            'ms interval'
            ...
            return g(t) ? s.resolve(!0) : setTimeout(o, n), s;
          };
        return {
          name: 'cxense',
          __protected__: {
      ...
      tp.define('recWidgetService', ['jq', 'util', 'containerUtils'], function (e, t, n) {
        var r = function (e) {
          ...
          o = function (t, s) {
            ...
            if (r(t)) {
              ...
              i(t) &&
                (o = n.getModalContainer(t, function () {
                  e.isFunction(s) && s();
                }));
            return o;
          },
            ...
            var a = [],
              ...
              l = function (e) {
                ...
                var p = s(r),
                  ...
                  m = l();
                return (
                  (p.container = o(v, function () {
                    h({ widget: p });
                  })),
                  (p.element = m.appendTo(p.container)),
                  i(v) &&
                    ((f = p),
                    (t.isIphone() || t.isIOsUiWebView() || t.isAndroid()) &&
                      n.__private__.mobileModalFix.modalOpened()),
                  u(p, e.widgetCallbacks),
                  a.push(p),
                  p
                );
              },
              ...
              h = function (t) {
                var n = t || {},
                  s = n.widget || {};
                r(s.config) ? s.container.empty() : i(s.config) && (v(s), s.container.detach()),
                  !n.skipOnclose && e.isFunction(s.onclose) && s.onclose(),
              ...
              m = function (e, t) {
                ...
                n.checkBackdropAndContainer(e, !0, !0),
                  setTimeout(function () {
                    n.__protected__.setElementSizes(r, { width: s.width() });
                  }, 100);
              };
            return {
          ...
          f = function (t) {
            ...
            t.id && r.setAttribute('id', t.id),
              e.isFunction(t.onerror) && (r.onerror = t.onerror),
              e.isFunction(t.onload) && (r.onload = t.onload),
              t.defer && (r.defer = !0),
        ...
        return { name: 'recWidgetService', __protected__: { getInstance: l, insertWidgetLib: f } };
      }),
      tp.define('sha1', [], function () {
        function e (e, t) {
          ...
          for (o = 0; o < S.length; o += 16) {
            ...
            (v = l), (m = c), (g = h), (y = p), (b = d);
            for (u = 0; u <= 19; u++)
              (w = (n(v, 5) + ((m & g) | (~m & y)) + b + f[u] + 1518500249) & 4294967295),
                (b = y),
                (y = g),
                (g = n(m, 30)),
                (m = v),
                (v = w);
            for (u = 20; u <= 39; u++)
              (w = (n(v, 5) + (m ^ g ^ y) + b + f[u] + 1859775393) & 4294967295),
                (b = y),
                (y = g),
                (g = n(m, 30)),
                (m = v),
                (v = w);
            for (u = 40; u <= 59; u++)
              (w = (n(v, 5) + ((m & g) | (m & y) | (g & y)) + b + f[u] + 2400959708) & 4294967295),
                (b = y),
                (y = g),
                (g = n(m, 30)),
                (m = v),
                (v = w);
            for (u = 60; u <= 79; u++)
              (w = (n(v, 5) + (m ^ g ^ y) + b + f[u] + 3395469782) & 4294967295),
                (b = y),
                (y = g),
                (g = n(m, 30)),
                (m = v),
        ...
        return { name: 'sha1', hash: e };
      }),
      tp.define('sha1', function () {}),
      tp.define('itp', ['jq'], function (e) {
        function i (i, s) {
          if (!n) return;
          var o = i || 730,
            u = s || 2500;
        ...
        var t,
          n = tp.cloudflareWorkerUrl,
          r = 3600;
        return { name: 'itp', synchronizeCookie: i };
      }),
      (function (e) {
        var t = document,
          n = 'appendChild',
