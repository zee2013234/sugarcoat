  ...
  (function () {
    (function () {
      function webworkerPrefetch () {
        ...
        prefetchFile(
          'https://www.gstatic.com/awn/awsm/brt/awn_awsm_20201118_RC02/aw_blend/blend_main.dart.js'
        );
      }
      function prefetchJS () {
        ...
        worker.addEventListener('message', function (e) {
          const $___old_da76ff2943a30fc1 = {}.constructor.getOwnPropertyDescriptor(
            window,
            'localStorage'
          );
          try {
            if ($___old_da76ff2943a30fc1)
            ...
            if ($___old_da76ff2943a30fc1)
              ({}.constructor.defineProperty(window, 'localStorage', $___old_da76ff2943a30fc1));
          }
        });
      }
      prefetchJS();
