    ...
    (function () {
      new (function () {
        if (!window.ADRUM && !0 !== window['adrum-disable']) {
          var k = (window.ADRUM = {}),
            y = window.console,
            B = y && 'function' == typeof y.log ? y : { log: function () {} };
          ...
          var v =
            ...
            (function () {
              var a =
                ...
                function (a, l) {
                  for (var e in l) l.hasOwnProperty(e) && (a[e] = l[e]);
                };
              return function (b, l) {
                function e () {
                  this.constructor = b;
          ...
          (function (a) {
            (function (b) {
              const $___old_0b107cee05778067 = {}.constructor.getOwnPropertyDescriptor(
                window,
                'performance'
              );
              try {
                if ($___old_0b107cee05778067)
                ...
                return function () {
                  ...
                  function e (a, m) {
                    return c(b.refs.setTimeout.apply)
                      ? b.refs.setTimeout.apply(window, arguments)
                      : b.refs.setTimeout(a, m);
                  }
                  function c (a) {
                  ...
                  function w () {
                    var a = b.refs.la,
                      a =
                        a && a.timing && m(a.timing.navigationStart)
                  ...
                  function C (a, b) {
                    return function (m, g) {
                      if (!c(m)) throw new TypeError(a + ' called on null or undefined');
                      if (!f(g)) throw new TypeError(g + ' is not a function');
                  ...
                  function x (a, b, c) {
                    ...
                    for (; f < g; f++) f in m && (c = b(c, m[f], f, m));
                    return c;
                  }
                  function z (a, c, m) {
                    return b.reduce(
                  ...
                  function E (a, b, c) {
                    ...
                    for (var m = a.length >>> 0, f = 0; f < m; f++)
                      if (f in a && b.call(c, a[f], f, a)) return !0;
                    return !1;
                  }
                  function F (a, c, m) {
                  ...
                  b.isCORSSupported = function () {
                    const $___old_96bef6f352580bca = {}.constructor.getOwnPropertyDescriptor(
                        window,
                        'XMLHttpRequest'
                      ),
                      $___old_066135441b5e44a5 = {}.constructor.getOwnPropertyDescriptor(
                        window,
                        'XMLHttpRequest'
                      );
                    try {
                      if ($___old_96bef6f352580bca)
                        ({}.constructor.defineProperty(
                          window,
                          'XMLHttpRequest',
                          $___stub_c92db3a21e6ea955.XMLHttpRequest
                        ));
                      if ($___old_066135441b5e44a5)
                        ({}.constructor.defineProperty(
                          window,
                          'XMLHttpRequest',
                          $___stub_c92db3a21e6ea955.XMLHttpRequest
                      ...
                      if ($___old_96bef6f352580bca)
                        ({}.constructor.defineProperty(
                          window,
                          'XMLHttpRequest',
                          $___old_96bef6f352580bca
                        ));
                      if ($___old_066135441b5e44a5)
                        ({}.constructor.defineProperty(
                          window,
                          'XMLHttpRequest',
                          $___old_066135441b5e44a5
                        ));
                    }
                  };
                  b.isDefined = c;
                  ...
                  b.isArray =
                    f(b.refs.isArray) && f(b.refs.isArray.bind)
                  ...
                  b.addEventListener = function (b, c, m, f) {
                    ...
                    g.I = !0;
                    b.addEventListener
                      ? b.addEventListener(c, g, f)
                      : b.attachEvent && b.attachEvent('on' + c, g);
                  };
                  ...
                  b.of = function (a, c) {
                    if (b.isFunction(Object.getPrototypeOf))
                      for (; b.isDefined(a) && !t(a, c); ) a = Object.getPrototypeOf(a);
                    return a;
                  };
                  b.dn = function (a) {
                  ...
                  b.Si =
                    c(window.Reflect) && c(window.Reflect.construct)
                      ? function (b, c, m, f) {
                          try {
                ...
                if ($___old_0b107cee05778067)
                  ({}.constructor.defineProperty(window, 'performance', $___old_0b107cee05778067));
              }
            })(a.utils || (a.utils = {}));
          })(k || (k = {}));
          (function (a) {
            ...
            var l = b.userConf.adrumExtUrlHttp || 'http://cdn.appdynamics.com',
            ...
            window['adrum-geo-resolver-url']
              ? ((l = window['adrum-geo-resolver-url']),
                (e = l.indexOf('://')),
                -1 != e && (l = l.substring(e + 3)),
                (l = (a ? 'https://' : 'http://') + l))
              : ((l = b.userConf.geoResolverUrlHttps || ''),
          ...
          (function (a) {
            ...
            a.Wl = function (b, c, m, f) {
              var g = '',
                ...
                e,
                n = a.utils.isString(n) ? n.substring(5) : n + '';
              q(e) ||
                (e = a.utils.map(f, function (a) {
              ...
              l = (function () {
                ...
                e.prototype.processQ = function () {
                  for (var b = this.Hj(), g = 0; g < b.length; g++) {
                    var f = b[g];
                    'function' === typeof a.commands[f[0]]
                      ? (a.isDebug && a.log('M7', f[0], f.slice(1).join(', ')),
                        a.commands[f[0]].apply(a, f.slice(1)))
                      : a.error('M8', f[0]);
                  }
                };
                ...
                e.prototype.push = function (b) {
                  var g = b[0],
                    f = this.ll(g),
                    n = f ? this.Ed : this.ld;
                  if (n.Vb()) return a.log('M9', f ? 'spontaneous' : 'non spontaneous', g), !1;
                  this.Lb.push(b);
                  n.Hk();
                  return !0;
                };
          ...
          (function (a) {
            ...
            a.command = function (b) {
              ...
              a.isDebug &&
                a.log('M10', b, Array.prototype.slice.call(arguments).slice(1).join(', '));
          ...
          (function (a) {
            (function (b) {
              ...
              b.around = function (c, g, f, n, m) {
                ...
                c = c || function () {};
                return function () {
                  const $___old_eca4b6b6a6f730ad = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    ),
                    $___old_5e1f73f61e72631a = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'localStorage'
                    ),
                    $___old_16d913c2e04fc495 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                  try {
                    if ($___old_eca4b6b6a6f730ad)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_c92db3a21e6ea955.XMLHttpRequest
                      ));
                    if ($___old_5e1f73f61e72631a)
                      ({}.constructor.defineProperty(
                        window,
                        'localStorage',
                        $___stub_053c907fde22f83d.localStorage
                      ));
                    if ($___old_16d913c2e04fc495)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___stub_c92db3a21e6ea955.XMLHttpRequest
                    ...
                    if ($___old_eca4b6b6a6f730ad)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_eca4b6b6a6f730ad
                      ));
                    if ($___old_5e1f73f61e72631a)
                      ({}.constructor.defineProperty(
                        window,
                        'localStorage',
                        $___old_5e1f73f61e72631a
                      ));
                    if ($___old_16d913c2e04fc495)
                      ({}.constructor.defineProperty(
                        window,
                        'XMLHttpRequest',
                        $___old_16d913c2e04fc495
                      ));
                  }
                };
              };
              ...
              b.forceWrap = function (b) {
                var g = b.customDescriptorConfig || {},
                  f = null,
                  n = b.parentObject,
                  m = b.property,
                  q = b.setUpFunc,
                  t = b.wrapNewFunctionAgain || !1,
                  p = b.propertyWrappedFunctionName;
                if (n && m) {
                  f = Object.getOwnPropertyDescriptor(n, m);
                  if (!f || f.configurable) {
                    f
                      ? (delete f.writable, delete f.value)
                      : (f = { configurable: !0, enumerable: !0 });
                    var l = f.set,
                      r = f.get;
                    f.set =
                      g.set ||
                      function (m) {
                        !0 !== m.usedByAgent &&
                          (e(l) && l(arguments),
                          (e(b.Ma) && !t) || !a.utils.isFunction(q) || q(m));
                      };
                    f.get =
                      g.get ||
                      function () {
          ...
          (function (a) {
            ...
            b.U[a.EventType.Error] = { msg: 'string', line: 'number', stack: 'string' };
          })(k || (k = {}));
          (function (a) {
            var b = (function () {
              function a () {
          ...
          (function (a) {
            (function (b) {
              ...
              b.Je = function (b, c) {
                ...
                for (m in n)
                  (n = a.utils.Pe(m)),
                    (c['mark' + n] = a.utils.pg(function (a, b) {
                      this.perf.mark(a, b);
                    }, m)),
                    (c['get' + n] = a.utils.pg(function (a) {
            ...
            (function (b) {
              var l = (function (b) {
                ...
                c.prototype.Ia = function (b, f, n, m, e) {
                  c.Rc >= a.conf.ni
                    ? a.log('M22')
                    : ((m = a.utils.tryExtractingErrorStack(e)),
                      a.command(
                        'reportPageError',
                        new a.events.Error(
                          a.utils.mergeJSON(
                    ...
                    ? ((window.onerror = a.aop.around(
                        ...
                        function (f, n, m, e, t) {
                          c.Yb
                            ...
                            : c.hd
                            ? a.log('M25')
                            : (a.log('M24'), b.Ia(f, n, m, e, t), (c.hd = !0));
                        },
                        function () {
                          a.log('M26');
                          c.hd = !1;
                ...
                c = (function (c) {
                  ...
                  f.prototype.setUp = function () {
                    a.utils.map(['error', 'exception'], function (b) {
                      var c = B[b];
                      a.utils.isFunction(c) && a.aop.support(c)
                        ? (l('M29', b),
                          (B[b] = e(c, function (a) {
                            l('M30', b, a);
                            f.Vi(a);
                  ...
                  f.Vi = function (b) {
                    f.pa.length >= a.conf.hi
                      ? l('M34')
                      : a.utils.isString(b)
                      ? (l('M35', b), f.pa.push(b), a.utils.oSTO(f.Dg))
                      : a.utils.isObject(b)
                      ? ((b = a.utils.toJSONString(b)),
                        null !== b
                          ? (l('M36', b), f.pa.push(b), a.utils.oSTO(f.Dg))
                          : a.error('M37'))
                      : l('M38', typeof b);
                  };
                  f.Dg = function () {
            ...
            (function (b) {
              var l = (function () {
                ...
                e.prototype.setUp = function () {
                  ...
                  a.utils.isFunction(b.PerformanceWrapper.perf.getEntriesByType)
                    ? a.utils.isFunction(b.PerformanceWrapper.perf.addEventListener)
                      ...
                      ? a.utils.isFunction(b.PerformanceWrapper.perf.rd)
                        ? (b.PerformanceWrapper.perf.rd = a.aop.around(
                            b.PerformanceWrapper.perf.rd,
                            this.gb.bind(this)
                          ))
                        : (b.PerformanceWrapper.perf.rd = this.gb.bind(this))
                      : a.utils.refs.setInterval.call(window, this.jm.bind(this), this.Gi)
                    : a.log('M43');
                  this.xm();
                  this.km();
                };
                ...
                e.prototype.km = function () {
                  var c = b.PerformanceWrapper.perf;
                  a.utils.isDefined(c) &&
                    (a.utils.isFunction(c.setResourceTimingBufferSize) &&
                      (c.setResourceTimingBufferSize = a.aop.around(
                        c.setResourceTimingBufferSize,
                        function () {
                    ...
                    a.utils.isFunction(c.clearResourceTimings) &&
                      (c.clearResourceTimings = a.aop.around(
                        c.clearResourceTimings,
                        function () {
                          this.gb();
                        }.bind(this)
                      )));
                ...
                e.prototype.tm = function () {
                  ...
                  a.utils.isDefined(c) &&
                    a.utils.isFunction(c.clearResourceTimings) &&
                    (this.sd = c.clearResourceTimings.bind(c));
                };
                e.prototype.setResourceTimingBufferSize = function () {
                  var c = b.PerformanceWrapper.perf,
                    g =
                      ...
                      a.conf.userConf.resTiming &&
                      a.conf.userConf.resTiming.bufSize;
                  !a.utils.isNumber(g) || 0 >= g
                    ? a.log('M45')
                    : c && a.utils.isFunction(c.setResourceTimingBufferSize)
                    ? c.setResourceTimingBufferSize(g)
                    : a.log('M46');
                };
                e.prototype.nf = function () {
                  ...
                  if (this.resourceBuffer.length + b.length > this.qe)
                    return (
                      a.log('M47'),
                      this.resourceBuffer.concat(b.slice(0, this.qe - this.resourceBuffer.length))
                    );
                  this.clearResourceTimings();
            ...
            (function (a) {
              ...
              a.Rb = function (a) {
                ...
                a instanceof HTMLImageElement
                  ...
                  ? (b = a.currentSrc || a.src)
                  : a instanceof SVGImageElement && (b = a.href.baseVal);
                return b;
              };
              a.Rn = function (a) {
                var b = '';
                a instanceof HTMLImageElement
                  ...
                  : 'undefined' != typeof HTMLVideoElement && a instanceof HTMLVideoElement
                  ? (b = 'video')
                  : a instanceof SVGImageElement && (b = 'image');
                return b;
              };
              a.Xc = function (c) {
                return a.isDefined(c.attributes)
                  ? c.attributes.getNamedItem('src') || c.attributes.getNamedItem('href')
                  : void 0;
              };
            })(a.utils || (a.utils = {}));
          })(k || (k = {}));
          (function (a) {
            var b = (function () {
              function b () {
                ...
                this.viewport = { top: 0, left: 0, bottom: this.sc, right: this.tc };
                this.Ta = 0;
              }
              b.prototype.setUp = function () {
                ...
                a.utils.isDefined(b) &&
                  ...
                  a.utils.isDefined(window.Zone.__symbol__('MutationObserver'))
                    ? (this.ac = new window[window.Zone.__symbol__('MutationObserver')](
                        this.jg.bind(this)
                      ))
                    : (this.ac = new b(this.jg.bind(this))),
                  this.ac.observe(document.documentElement, {
                    childList: !0,
                    subtree: !0,
                    attributes: !0,
              ...
              b.prototype.Me = function (b) {
                a.Q();
                var c = a.utils.now();
                a.utils.ob(b) && !b.isAdrumTrackedNode
                  ? (this.mb ||
                    ...
                    a.log('M52', this.g),
                    (c = a.utils.Xc(b)),
                    (c = a.utils.isDefined(c) ? c.value : null),
                    a.utils.Tf(b)
                      ? (b.addEventListener('loadeddata', this.K), a.log('M53', c))
                      : (b.addEventListener('load', this.K), a.log('M54', c)),
                    b.addEventListener('error', this.l),
                    (b.isAdrumTrackedNode = !0))
                  : a.utils.Lf(b) && !b.adrumNodeId
                  ? (a.log('M55'), this.Jb(b, c))
                  : a.utils.Rf(b) && (this.Va = Math.max(this.Va, c));
                a.R();
              };
              b.prototype.K = function (b) {
                ...
                b = b.target;
                var g = a.utils.Rb(b);
                a.utils.isDefined(g) && 0 < g.length
                  ? 'data:' != g.substring(0, 5) || b.adrumNodeId
                    ? this.Xi(g, c, b)
                    : (a.log('M56'), this.Jb(b, c))
                  : b instanceof SVGElement && !b.adrumNodeId && (a.log('M57'), this.Jb(b, c));
              ...
              b.prototype.l = function (b) {
                var c = b.target;
                c &&
                  c.isAdrumTrackedNode &&
                  (this.ub(c), this.g--, (b = a.utils.Rb(b.target)), a.log('M59', b));
              };
              ...
              b.prototype.Xi = function (b, c, g) {
                a.utils.isDefined(this.S[b])
                  ? this.Tb(g) && ((this.S[b] = c), a.log('M60', b, c))
                  : ((this.S[b] = c), a.log('M61', b, c));
              };
              ...
              b.prototype.Ve = function (b) {
                  ...
                  if (a.utils.isDefined(t) && 0 < t.length)
                    if ((a.log('M64', t), a.utils.isDefined(c.S[t]))) {
                      ...
                      a.utils.pb(m) &&
                        (a.log('M66', t, p),
                        c.Aa &&
                          (a.log('M67', f, p, b), (f = Math.max(f, p - b)), a.log('M68', t, f)),
                        c.nb(m) &&
                          (a.log('M69', g, p, b), (g = Math.max(g, p - b)), a.log('M70', t, g)));
                    } else {
                      if (
                        a.utils.ob(m) &&
                        a.utils.pb(m) &&
                        ((p = c.wf(t)), a.utils.isDefined(p))
                      ) {
                        var l = p.startTime - (b - c.ya),
                          r = p.duration * n + l;
                        a.log('M71', t, r);
                    ...
                    a.utils.isDefined(m.adrumNodeId) &&
                      (a.utils.isDefined(c.dc[m.adrumNodeId]) &&
                        ((p = c.dc[m.adrumNodeId]),
                        a.utils.pb(m) &&
                          (c.Aa && ((f = Math.max(f, p - b)), a.log('M75', m.adrumNodeId, p)),
                          c.nb(m) && ((g = Math.max(g, p - b)), a.log('M76', m.adrumNodeId, p)))),
                      delete m.adrumNodeId);
                });
                a.log('M77', g, f);
                this.$j().forEach(function (m) {
                  ...
                  var p = c.wf(t);
                  a.utils.isDefined(p) &&
                    ((p = p.duration * n + (p.startTime - (b - c.ya))),
                    c.Aa && (a.log('M78', t, p), (f = Math.max(f, p))),
                    m && (a.log('M79', t, p), (g = Math.max(g, p))));
                });
              ...
              b.prototype.mk = function (a) {
                ...
                var b = document.documentElement || document.body,
                  g = a.top + (window.pageYOffset || b.scrollTop) - (b.clientTop || 0),
                  b = a.left + (window.pageXOffset || b.scrollLeft) - (b.clientLeft || 0);
                return {
                  top: Math.round(g),
                  left: Math.round(b),
              ...
              b.prototype.nb = function (b) {
                b = this.mk(b);
                if (this.$k(b)) return a.log('M85'), !1;
                var c = {
              ...
              b.prototype.$j = function () {
                ...
                [].slice.call(document.getElementsByTagName('*')).forEach(function (g) {
                  if (a.utils.pb(g)) {
                    var f = b.Zj(g);
                    f &&
                      (b.nb(g) ? c.push({ url: f, Tb: !0 }) : b.Aa && c.push({ url: f, Tb: !1 }));
                  }
                });
                return c;
              };
              ...
              b.prototype.wf = function (b) {
                for (var c = 0, g = this.yf(); c < g.length; c++) {
                  var f = g[c];
                  if (a.utils.isDefined(f.name) && 0 <= f.name.indexOf(b)) return f;
                }
              };
            ...
            (function (b) {
              var l = (function () {
                ...
                e.prototype.Nl = function (b, g, f, n) {
                  if (
                    a.utils.isDefined(f) &&
                    a.utils.isDefined(f.set) &&
                    !a.utils.isDefined(f.I)
                  ) {
                    var m = this;
                ...
                e.prototype.Ok = function () {
                  ...
                  a.utils.isDefined(b.setAttribute) &&
                    (b.setAttribute = a.aop.around(b.setAttribute, null, function () {
                      var a = d(arguments);
                ...
                e.prototype.ed = function (b) {
                  var g = Element.prototype,
                    f = this;
                  a.utils.isDefined(g[b]) &&
                    (g[b] = a.aop.around(g[b], null, function () {
                ...
                e.prototype.vg = function (b) {
                  ...
                  this.qa &&
                    ...
                    (this.Ld(b), this.fh(b.childNodes));
                  a.R();
                };
                ...
                e.prototype.Ld = function (b) {
                  a.monitor.AnySpaMonitor.cd() ||
                    (this.Yk(b) ? this.hj(b) : a.conf.P && this.ij(b));
                };
                e.prototype.hj = function (b) {
                  var g = a.utils.Xc(b);
                  a.utils.isDefined(g) &&
                    ((g = g.value),
                    !a.utils.isDefined(this.cc[g]) &&
                      0 < g.length &&
                      (this.g++, (this.cc[g] = !0), a.log('M91', g, this.g), this.Ne(b)));
                };
                e.prototype.ij = function (b) {
                  ...
                  a.utils.ob(b) && !b.isAdrumTrackedNode
                    ? ((g = a.utils.Rb(b)),
                      !a.utils.isDefined(this.cc[g]) &&
                        0 < g.length &&
                        (this.g++, (this.cc[g] = !0), this.Ne(b), a.log('M92', g, this.g)))
                    : a.utils.Lf(b) && !b.adrumNodeId
                    ? (a.log('M93', g), a.N.Jb(b, g))
                    : a.utils.Rf(b) && (a.N.Va = Math.max(a.N.Va, g));
                };
                e.prototype.Ne = function (b) {
                  this.mb ||
                    ...
                    (this.mb = this.l.I = !0));
                  var g = a.utils.Xc(b),
                    g = a.utils.isDefined(g) ? g.value : null;
                  a.utils.Tf(b)
                    ? (b.addEventListener('loadeddata', this.K), a.log('M94', g))
                    : (b.addEventListener('load', this.K), a.log('M95', g, b.nodeName));
                  b.addEventListener('error', this.l);
                };
                e.prototype.dl = function (b) {
                  return 'LINK' == b.nodeName
                    ? ((b = b.attributes.getNamedItem('rel')),
                      a.utils.isDefined(b) ? 0 <= b.value.indexOf('stylesheet') : !0)
                    : !0;
                };
                ...
                e.prototype.K = function (c) {
                  ...
                  !a.utils.isDefined(this.S[g]) &&
                    0 < this.g &&
                    (this.g--, (this.S[g] = !0), a.log('M96', g, this.g));
                  this.ca = a.utils.now();
                  this.md += 1;
                ...
                e.prototype.l = function (b) {
                  a.Q();
                  var g = this.qf(b.target),
                    f = b.target;
                  a.utils.isDefined(this.pd[g]) ||
                    (this.g--, (this.pd[g] = !0), a.log('M98', g, this.g));
                ...
                e.prototype.qf = function (a) {
                  ...
                  a instanceof HTMLScriptElement
                    ...
                    : a instanceof HTMLImageElement
                    ? (b = a.src)
                    : a instanceof HTMLLinkElement && (b = a.href);
                  return b;
                };
                e.prototype.bd = function (b) {
                  ...
                  return 0 == g &&
                    this.B &&
                    (a.log('M101'), (g = Math.max(this.ca, f)), b - g >= this.qb)
                    ? (this.reset(), g)
                    : -1;
                };
            ...
            (function (b) {
              var l = (function () {
                ...
                e.prototype.Ce = function (b) {
                  a.monitor.AnySpaMonitor.cd() ||
                    a.utils.isDefined(this.vh[b]) ||
                    !this.qa ||
                    ((this.g += 1), (this.vh[b] = !0), a.log('M102', b, this.g));
                };
                e.prototype.Zi = function (c) {
                  !a.monitor.AnySpaMonitor.cd() &&
                    this.qa &&
                    0 < this.g &&
                    (a.utils.isDefined(this.Vd) &&
                      !a.utils.isDefined(this.Vd[c]) &&
                      ((this.Ea = a.utils.now()),
                      (this.g -= 1),
                      (this.Vd[c] = !0),
                      a.log('M103', c, this.g)),
                    (this.nd += 1),
                    1 == this.nd && (b.n.Yg(), (this.B = !0)));
                };
                e.prototype.bd = function (a) {
                  return 0 == this.g && this.B && a - this.Ea >= this.qb
                    ? (this.reset(), this.Ea)
                    : -1;
                };
          ...
          (function (a) {
            ...
            var c = (function () {
              ...
              b.vc = function (c, n, m, q) {
                if (!a.utils.isDefined(n) || n.I) return n;
                var e;
                q || (e = b.ja());
                return function (a) {
                  var q = b.Pa(c, a, e, m);
              ...
              b.Pa = function (b, c, m, g) {
                ...
                a.utils.isDefined(c)
                  ? ((c = a.ce.wl(c.target || c.srcElement)), (c.action = b))
                  : (c = new a.La(b));
                return new e(m, c, g);
              };
              b.hn = function (c, n, m) {
              ...
              b.Ic = function (b, c) {
                var m = b,
                  g = 1,
                  e = '';
                if (!a.utils.isDefined(m)) return null;
              ...
              b.xk = function () {
                ...
                if (a.utils.isDefined(c) && a.utils.isDefined(c.type))
                  return [l.TIMER, l.USER].some(function (a) {
                    return c.type == a;
                  })
                    ? c
                    : void 0;
              ...
              b.setUp = function () {
                ...
                var c = a.utils.refs;
                [
                  { mg: c.setTimeout, lf: 'setTimeout' },
                  { mg: c.setInterval, lf: 'setInterval' },
                ].forEach(function (a) {
                  var m = a.mg,
                    c = a.lf;
                  window[c] = function (a) {
                    var f = d(arguments);
                    if (a) {
                      var n = b.ml(c, arguments[1]) ? l.OTHER : l.TIMER,
                        n = b.hn(c, b.Wk(a), n);
                      f[0] = n;
              ...
              b.ml = function (b, c) {
                return (
                  'setTimeout' == b && ((a.utils.isDefined(c) && 0 == c) || !a.utils.isDefined(c))
                );
              };
              return b;
            })();
          ...
          (function (a) {
            ...
            var f = (function () {
              ...
              f.dk = function (b, c) {
                ...
                if (a.utils.isDefined(b))
                  if ('string' === typeof b.textContent)
                    (g = a.utils.isDefined(String.prototype.trim)
                      ? b.textContent.trim()
                      : b.textContent),
                      (g = a.utils.isDefined(c) ? g.substring(0, c) : g);
                  else
                    for (
                      b = b.firstChild;
                      a.utils.isDefined(b) &&
                      !((g += f.dk(b, c)), a.utils.isDefined(c) && g.length >= c);
                      b = b.nextSibling
                    );
                return g;
              };
              f.wl = function (c) {
                const $___old_375dd0ee7324c9f5 = {}.constructor.getOwnPropertyDescriptor(
                  window,
                  'XMLHttpRequest'
                );
                try {
                  if ($___old_375dd0ee7324c9f5)
                    ({}.constructor.defineProperty(
                      window,
                      'XMLHttpRequest',
                      $___stub_c92db3a21e6ea955.XMLHttpRequest
                  ...
                  return function () {
                    var f = b(c.id) || '',
                      ...
                      e = '',
                      l = new g();
                    c instanceof HTMLHtmlElement
                      ? ((e = 'html'), (l.text = '#html'))
                      : c === document
                      ? ((e = 'document'), (l.text = '#document'))
                      : c === window
                      ? ((e = 'window'), (l.text = '#window'))
                      : c instanceof XMLHttpRequest
                      ? ((e = 'xhr'),
                        (l.src = a.utils.isObject(c._adrumAjaxT)
                          ? encodeURI(c._adrumAjaxT.url())
                          : ''))
                      : c instanceof WebSocket
                      ? ((e = 'websocket'), (l.src = encodeURI(c.url)))
                      : c instanceof HTMLScriptElement
                      ? ((e = 'script'), (l.src = encodeURI(c.src)))
                      : c instanceof HTMLAnchorElement
                      ? ((e = 'a'), (l.text = b(c.text) || ''))
                      : c instanceof HTMLButtonElement
                      ? ((e = 'button'), (l.name = b(c.name)))
                      : c instanceof HTMLDivElement
                      ? (e = 'div')
                      : c instanceof HTMLImageElement
                      ? ((e = 'img'), (l.src = encodeURI(c.src)), (l.text = b(c.title) || ''))
                      ...
                      ? (e = 'form')
                      : c instanceof HTMLFrameElement
                      ? ((e = 'frame'), (l.src = encodeURI(c.src)))
                      : c instanceof HTMLInputElement
                      ? ((e = b(c.type) || 'input'), (l.text = b(c.value)), (l.name = b(c.name)))
                      : c instanceof HTMLTableElement
                      ? (e = 'table')
                      : c instanceof HTMLTableCaptionElement
                      ? (e = 'tcap')
                      : c instanceof HTMLTableCellElement
                      ? (e = 'td')
                      : c instanceof HTMLTableRowElement
                      ? (e = 'tr')
                      : ((e = a.utils.isDefined(c.tagName) ? b(c.tagName) : ''), a.log('M109', e));
                    l.Vh = f;
                    l.className = n;
                    l.tagName = e;
                  ...
                  l(
                    ...
                    function (c) {
                      ...
                      (c === document ||
                        ...
                        null != c &&
                        c['on' + b] &&
                        ((c['on' + b] = a.c.vc(b, c['on' + b], a.CauseType.USER, !0)),
                        (c['on' + b].I = !0));
                    },
                    !0
                  );
              ...
              f.jh = function (b) {
                ...
                a.utils.isBoolean(b)
                  ? (c = b)
                  : a.utils.isObject(b) && a.utils.isDefined(b.capture) && (c = !!b.capture);
                return c;
              };
              f.Ng = function (b, c, f, g) {
                if (
                  !a.utils.isDefined(b.eventListenerMap) ||
                  !a.utils.isDefined(b.eventListenerMap[c]) ||
                  !a.utils.isDefined(f)
                )
                  return -1;
                b = b.eventListenerMap[c];
                for (c = 0; c < b.length; c++) if (b[c][0] == f && b[c][1] == g) return c;
                return -1;
              };
              f.Hf = function (b, c, f, g, n) {
                a.utils.isDefined(b) &&
                  a.utils.isDefined(n) &&
                  (a.utils.isDefined(b.eventListenerMap) || (b.eventListenerMap = {}),
                  a.utils.isDefined(b.eventListenerMap[c]) || (b.eventListenerMap[c] = []),
                  b.eventListenerMap[c].push([f, g, n]));
              };
              f.dm = function (a, b, c) {
                if (-1 < c) {
              ...
              f.fn = function () {
                EventTarget.prototype.addEventListener = function (b, c, g) {
                  ...
                  var l = f.jh(g),
                    s = a.utils.isDefined(this) ? this : window;
                  if (!(-1 < f.Ng(s, b, c, l))) {
                    var r = c;
                    switch (b) {
                      case 'click':
              ...
              f.gn = function () {
                EventTarget.prototype.removeEventListener = function (b, g, e) {
                  if (a.utils.isDefined(g) && g.I) return c.call(this, b, g, e);
                  var l = f.jh(e),
                    s = a.utils.isDefined(this) ? this : window,
                    l = f.Ng(s, b, g, l);
                  0 <= l
                    ? (c.call(s, b, this.eventListenerMap[b][l][2], e), f.dm(s, b, l))
                    : c.call(s, b, g, e);
                };
              };
              f.Jf = function (b) {
          ...
          (function (a) {
            (function (b) {
              ...
              b.rf = function (a) {
                var c = a.urls;
                if (c && 0 < c.length && ((a.urls = b.yj(c)), 0 < a.urls.length)) return a;
              };
            })(a.utils || (a.utils = {}));
          })(k || (k = {}));
          (function (a) {
          ...
          (function (a) {
            ...
            b.metricSpec[a.EventType.PageView] = {
              Mj: { start: b.b.navigationStart, end: b.b.loadEventEnd, name: 'PLT' },
              Uj: { start: b.b.navigationStart, end: b.b.responseStart, name: 'FBT' },
              uo: { start: b.b.navigationStart, end: b.b.requestStart, name: 'SCT' },
              vo: { start: b.b.secureConnectionStart, end: b.b.connectEnd, name: 'SHT' },
              Nn: { start: b.b.domainLookupStart, end: b.b.domainLookupEnd, name: 'DLT' },
              yo: { start: b.b.connectStart, end: b.b.connectEnd, name: 'TCP' },
              qo: { start: b.b.requestStart, end: b.b.responseStart, name: 'RAT' },
              Pn: { start: b.b.responseStart, end: b.b.loadEventEnd, name: 'FET' },
              Tn: { start: b.b.responseStart, end: b.b.domContentLoadedEventStart, name: 'DRT' },
              Sn: { start: b.b.responseStart, end: b.b.responseEnd, name: 'DDT' },
              Ln: { start: b.b.responseEnd, end: b.b.domContentLoadedEventStart, name: 'DPT' },
              po: { start: b.b.domContentLoadedEventStart, end: b.b.loadEventEnd, name: 'PRT' },
              Mn: { start: b.b.navigationStart, end: b.b.domContentLoadedEventStart, name: 'DOM' },
            };
            b.metricSpec[a.EventType.Ajax] = {
              Uj: { start: b.b.Og, end: b.b.jf, name: 'FBT' },
              zn: { start: b.b.jf, end: b.b.Ig, name: 'DDT' },
              yn: { start: b.b.Ig, end: b.b.Jg, name: 'DPT' },
              Mj: { start: b.b.Og, end: b.b.Jg, name: 'PLT' },
            };
            b.metricSpec[a.EventType.VPageView] = {
              ho: { start: b.b.Td, end: b.b.an, name: 'PLT' },
              Hn: { start: b.b.Rd, end: b.b.lh, name: 'DDT' },
              co: { start: b.b.Rd, end: b.b.Sd, name: 'DRT' },
              qn: { start: b.b.lh, end: b.b.Sd, name: 'DPT' },
              rn: { start: b.b.Rd, end: b.b.Sd, name: 'DOM' },
              oo: { start: 'viewChangeEnd', end: 'xhrRequestsCompleted', name: null },
              eo: { start: 'viewChangeEnd', end: 'viewPartialsLoaded', name: null },
              bo: { start: 'viewPartialsLoaded', end: 'viewFragmentsLoaded', name: null },
              fo: { start: 'viewPartialsLoaded', end: 'viewResourcesLoaded', name: null },
            };
            ...
            (function (b) {
              var l = (function (e) {
                function c (g) {
                  ...
                  g.constructor != c &&
                    g.constructor != b.AdrumAjax &&
                    a.reportAPIMessage(a.W.ma, a.Xa, 'ADRUM.events.Ajax', []);
                  return g;
                }
                v(c, e);
                c.prototype.type = function () {
              ...
              var l = a.utils.isDefined,
                e = (function () {
                  ...
                  c.wj = function (g, f) {
                    var n = a.c.Ic(g.h);
                    if (
                      l(a.monitor.AnySpaMonitor.vp) &&
                      !a.monitor.AnySpaMonitor.Ca &&
                      a.monitor.AnySpaMonitor.vp.fb == n
                    ) {
                      f.parent(a.monitor.AnySpaMonitor.vp);
                      if (++a.monitor.AnySpaMonitor.vp.Ke > b.va.maxPerPageView) return;
                      c.Mg(g, f);
                    } else
                      l(a.monitor.AnySpaMonitor.vp) &&
                        !a.monitor.AnySpaMonitor.Ca &&
                    ...
                    if (g instanceof XMLHttpRequest)
                      try {
                        if (
                          ...
                          if (b.isString(g.statusText)) m.statusText = g.statusText;
                          else
                            try {
                  ...
                  c.hh = function (a, c) {
                    ...
                    if (n.getAllResponseHeaders) {
                      var l = b.isFunction(n.getAllResponseHeaders)
                  ...
                  c.em = function () {
                    for (var g in c.ia) {
                      for (var f = 0, n = c.ia[g]; f < n.length; f++) {
                        var m = n[f];
                        !l(a.monitor.AnySpaMonitor.vp) && ++c.jj <= b.va.maxPerPageView
                          ? a.command('reportXhr', m)
                          : l(a.monitor.AnySpaMonitor.vp) &&
                            ++a.monitor.AnySpaMonitor.vp.Ke <= b.va.maxPerPageView &&
                            a.command('reportXhr', m);
                      }
                      c.Cg(g);
                    }
            ...
            (function (b) {
              var l = a.utils.isDefined,
                e = (function () {
                  ...
                  c.ug = function (a) {
                    l(a) &&
                      ((c.exclude = c.exclude.concat(b.Ab(b.qc, a.exclude))),
                      (c.include = c.include.concat(b.Ab(b.qc, a.include))),
                      (c.payloadParams = c.payloadParams.concat(b.Ab(b.qc, a.payloadParams))),
                      (c.parameter = b.Ab(b.Ym, a.parameter)));
                  };
                  c.Xl = function (g) {
                    if (l(g)) {
                      g = g.maxPerPageView;
                      if (b.isNumber(g) && 0 < g) return g;
                      if ('UNLIMITED' === g) return Infinity;
                      a.reportAPIMessage(
                        a.W.Ah,
                        'Invalid maxPerPageView value: ' + g,
                        'xhr.maxPerPageView',
                        [g]
                      );
                    }
                  ...
                  c.mc = function (a, f) {
                    var n = c.include,
                      m = c.exclude;
                    return (
                      (l(n) && 0 < n.length && !b.Wb(f, a, n)) ||
                      (l(m) && 0 < m.length && b.Wb(f, a, m))
                    );
                  };
                  c.Wg = function (a, f) {
                  ...
                  : ((g = p.protocol),
                    ...
                    s.pathname
                      ? ('/' === s.pathname.charAt(0)
                          ? (t = c(s.pathname))
                          : ((t = p.pathname
                              ? p.pathname.slice(0, p.pathname.lastIndexOf('/') + 1) + s.pathname
                              : f
                              ? '/' + s.pathname
                              : s.pathname),
                            (t = c(t))),
                        (p = s.search))
                      : ((t = c(p.pathname)), (p = s.search || p.search)));
                return (
                  g +
                  f +
                  (n ? n + (m ? ':' + m : '') + '@' : '') +
                ...
                e = (function (c) {
                  ...
                  g.Qf = function (a) {
                    ...
                    return (
                      ...
                      g.Rl(b.XHRMonitor.Dj[m], c.port, a.port)
                    );
                  };
                  g.Rl = function (a, b, c) {
                    return (b || a) === (c || a);
            ...
            (function (b) {
              ...
              var p = (function (p) {
                ...
                k.prototype.Pk = function () {
                  var a = this,
                    c = Object.getOwnPropertyDescriptor(window, 'fetch');
                  if (!c || c.configurable) {
                    c && delete c.writable;
                    c && delete c.value;
                    ...
                    c.set = function (c) {
                      !0 !== c.isAgentFetch &&
                        (n(f) && f.apply(this, arguments), n(b.eb) || a.setUp(c));
                    };
                    c.get = function () {
                      var a = b.qh;
                  ...
                  if (n(f)) {
                    var q = function (c) {
                      return function (f, g) {
                        ...
                        var q = c.apply(this, n),
                          p = new window.Promise(function (b, c) {
                            q.then(function (c) {
                              a.log('M119', m._adrumAjaxT.url());
                              a.log('M120', l, m._adrumAjaxT.url());
                              e.Um(c, p._adrumAjaxT);
                              p._adrumAjaxT.markFirstByteTime(
                                p._adrumAjaxT.getFirstByteTime() || a.utils.now()
                              );
                              ...
                              if (h(c.clone)) {
                                ...
                                k.zk(f, p);
                              } else a.log('M122', m._adrumAjaxT.url()), k.ym(p, c);
                              b(c);
                            });
                            q['catch'](function (b) {
                        ...
                        t &&
                          (p.h = new a.Eb(a.c.ja(), new a.La('window.fetch'), a.CauseType.FETCH));
                        return p;
                      };
                    };
                    q.isAgentFetch = !0;
                    b.eb = a.aop.around(
                      ...
                      function () {
                        ...
                        (!t && ++m.da + b.xhrMonitor.da >= l.maxPerPageView) ||
                        l.mc(f.url, f.method)
                          ? a.log('M125', f.url)
                          : ((m._adrumAjaxT = new g(c(f, m.status))),
                            t &&
                              ((m.h = a.c.Pa(
                                'window.fetch.send',
                                void 0,
                      ...
                      function () {
                        !t && m.da + b.xhrMonitor.da >= l.maxPerPageView
                          ? a.log('M126', m._adrumAjaxT.url())
                          : l.mc(m._adrumAjaxT.url(), m._adrumAjaxT.method())
                          ? a.log('M127', m._adrumAjaxT.url())
                          : t && (a.j.n.G.Ce(m._adrumAjaxT.url()), a.c.L());
                      },
                      'fetch',
                      b.wa.l
                    );
                ...
                k.zk = function (b, c) {
                  b.then(function (b) {
                    ...
                    k.ba(c) &&
                      ...
                      k.ag(c._adrumAjaxT, f),
                      (b = c._adrumAjaxT.getRespProcTime()),
                      n(b) ||
                        (n(c._adrumAjaxT.w) && 0 !== c._adrumAjaxT.w) ||
                        (a.log('M128', f, c._adrumAjaxT.url()),
                        c._adrumAjaxT.markRespProcTime(f),
                        k.Ua(c)));
                  })['catch'](function () {
                    k.Tc(c);
                  });
                ...
                k.Bb = function (b, c) {
                  return a.aop.around(
                    ...
                    'wrapResponseReader',
                    a.monitor.ErrorMonitor.l
                  );
                };
                k.Ti = function (a) {
                  1 == a.length
                    ? f(a[0])
                      ? ([].push.call(a, {}), k.Fc(a[1]))
                      : k.Fc(a[0])
                    : 2 == a.length && k.Fc(a[1]);
                  return a;
                };
                k.Fc = function (b) {
                  n(b) &&
                    (n(b.headers) || ((b.headers = new Headers()), a.log('M132')),
                ...
                k.sk = function (b) {
                  ...
                  a.utils.isObject(b[0])
                    ? ((c.url =
                        b[0].url || (a.utils.isDefined(b[0].toString) ? b[0].toString() : void 0)),
                      (c.method = b[0].method || 'GET'))
                    : f(b[0]) && ((c.url = b[0]), (c.method = (b[1] && b[1].method) || 'GET'));
                  c.url = n(c.url) ? c.url : '';
                  c.url = q(c.url);
                  c.method = c.method;
                  return c;
                ...
                k.Jk = function (b) {
                  ...
                  n(b._adrumAjaxT.w) &&
                    m(b._adrumAjaxT.w) &&
                    ((b._adrumAjaxT.w += c), a.log('M134', b._adrumAjaxT.w, b._adrumAjaxT.url()));
                };
                k.Nb = function (b) {
                  var c;
                  ...
                  n(b._adrumAjaxT.w) &&
                    m(b._adrumAjaxT.w) &&
                    ((b._adrumAjaxT.w -= c), a.log('M136', b._adrumAjaxT.w, b._adrumAjaxT.url()));
                };
                k.ba = function (a) {
                ...
                k.Pd = function (b) {
                  var c = !1,
                    f = a.utils.now(),
                    m = b._adrumAjaxT.getRespAvailTime();
          ...
          (function (a) {
            (function (b) {
              var l = a.utils.isObject,
                ...
                w = (function (w) {
                  function u () {
                    const $___old_b5aa9e14ae805576 = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                    try {
                      if ($___old_b5aa9e14ae805576)
                        ({}.constructor.defineProperty(
                          window,
                          'XMLHttpRequest',
                          $___stub_c92db3a21e6ea955.XMLHttpRequest
                      ...
                      return function () {
                        ...
                        b.Id = !1;
                        if (!0 === window['adrum-xhr-disable']) return a.log('M139'), b;
                        if (!window.XMLHttpRequest) return a.log('M140'), b;
                        b.C = window.XMLHttpRequest.prototype;
                        if (!b.C) return a.log('M141'), b;
                        if (!('open' in b.C && 'send' in b.C)) return a.log('M142'), b;
                      ...
                      if ($___old_b5aa9e14ae805576)
                        ({}.constructor.defineProperty(
                          window,
                          'XMLHttpRequest',
                          $___old_b5aa9e14ae805576
                        ));
                    }
                  }
                  v(u, w);
                  u.prototype.setUp = function () {
                    const $___old_69e5c50f013a789f = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'XMLHttpRequest'
                    );
                    try {
                      if ($___old_69e5c50f013a789f)
                        ({}.constructor.defineProperty(
                          window,
                          'XMLHttpRequest',
                          $___stub_c92db3a21e6ea955.XMLHttpRequest
                      ...
                      return function () {
                        if (this.Id) {
                          ...
                          p.setUp();
                          var c = this;
                          this.C.open = a.aop.around(
                            this.C.open,
                            function () {
                              u.jl(this) &&
                                (4 === this.readyState
                                  ? (a.log('M145'),
                                    u.Oj(this._adrumAjaxT),
                                    delete this.Ae,
                                    k.reportXhr(this, this._adrumAjaxT))
                                  : a.log('M146', this._adrumAjaxT.url()));
                              var f = 1 <= arguments.length ? String(arguments[0]) : '',
                                g = 2 <= arguments.length ? String(arguments[1]) : '',
                                g = a.utils.getFullyQualifiedUrl(g);
                              (!r && c.da + b.jb.da >= p.maxPerPageView) ||
                                p.mc(g, f) ||
                                (this._adrumAjaxT = new a.events.AdrumAjax(
                                  m({ method: f, url: g }, c.status)
                                ));
                            },
                            null,
                            'XHR.open',
                          ...
                          this.C.send = a.aop.around(
                            ...
                            function (f) {
                              ...
                              if (!(!n || (!r && ++c.da + b.jb.da >= p.maxPerPageView))) {
                                ...
                                b.wa.Qf(n.url())
                                  ? m.setRequestHeader('ADRUM', 'isAjax:true')
                                  : a.log('M148', document.location.href, n.url());
                                p.Wg(n, f);
                                ...
                                var k = 0,
                                  s = function () {
                                    if (4 == m.readyState)
                                      ...
                                      b
                                        ? a.aop.support(b)
                                          ? ((m.onreadystatechange = u.Ze(
                                              b,
                                              'XHR.onReadyStateChange'
                                            )),
                                            g && c.th.call(m, 'readystatechange', u.bf),
                                            a.log('M153', k))
                                          : g || (a.log('M154'), c.uc(m))
                                        : k < u.Qi
                                        ? t(s)
                          ...
                          var g =
                            'addEventListener' in this.C &&
                            'removeEventListener' in this.C &&
                            a.aop.support(this.C.addEventListener) &&
                            a.aop.support(this.C.removeEventListener);
                          if (g) {
                            var n = a.utils.of(this.C, 'addEventListener');
                            this.kn = n.addEventListener;
                            n.addEventListener = a.aop.around(
                              n.addEventListener,
                              function (b, c, m) {
                                const $___old_4a16b090b75de328 = {}.constructor.getOwnPropertyDescriptor(
                                  window,
                                  'XMLHttpRequest'
                                );
                                try {
                                  if ($___old_4a16b090b75de328)
                                    ({}.constructor.defineProperty(
                                      window,
                                      'XMLHttpRequest',
                                      $___stub_c92db3a21e6ea955.XMLHttpRequest
                            ...
                            n.removeEventListener = a.aop.around(
                              n.removeEventListener,
                              function (b, f, m) {
                                if (this instanceof XMLHttpRequest && this._adrumAjaxT) {
                                  var g = q(arguments);
                                  f.__adrumInterceptor
                                    ? ((g[1] = f.__adrumInterceptor),
                                      a.log('M161'),
                                      c.th.apply(this, g))
                                    : a.log('M162');
                                }
                  ...
                  u.ad = function (b) {
                    ...
                    if (c) {
                      var f = a.utils.now();
                      2 == b.readyState
                        ? c.markFirstByteTime(c.getFirstByteTime() || f)
                        : 4 == b.readyState &&
                          (c.markRespAvailTime(c.getRespAvailTime() || f),
                          c.markFirstByteTime(c.getFirstByteTime() || f),
                          r &&
                            ((b = b.h = a.c.Pa('XHR.load', void 0, b.h, a.CauseType.XHR)),
                            a.c.ra(b)));
                    }
                  };
                  u.Af = function (b) {
                      ...
                      var c = a.utils.now() + 30000,
                        f = function () {
                          ...
                          if (m) {
                            var g = a.utils.now();
                            4 == b.readyState
                              ? (a.assert(null === m.getRespProcTime(), 'M165'),
                                m.markRespProcTime(m.getRespProcTime() || g),
                                a.log('M166'),
                                k.wd(b, m),
                                a.conf.spa2 && a.c.L())
                              : g < c
                              ? a.utils.oSTO(f, u.be)
                              : (delete b._adrumAjaxT, a.log('M167'));
                          }
                        };
                      f();
                    }
              ...
              var l = a.utils.wc,
                e = (function (c) {
                  ...
                  g.prototype.startCorrelatingXhrs = function () {
                    a.log('M169');
                    a.utils.isDefined(this.fb) &&
                      !a.monitor.AnySpaMonitor.Ca &&
                      l.yl(this, this.fb.guid);
                  };
          ...
          (function (a) {
            ...
            a.markVirtualPageBegin = function (b, l) {
              a.conf.spa2 &&
                ((this.Qa = a.utils.isDefined(l) ? l : !0),
                a.log('M171', document.URL),
                a.monitor.AnySpaMonitor.Dd(document.URL, b, !0),
                a.monitor.AnySpaMonitor.Rg());
            };
            a.markVirtualPageEnd = function () {
              a.conf.spa2 &&
                this.Qa &&
                (a.log('M172', a.monitor.AnySpaMonitor.ka),
                a.monitor.AnySpaMonitor.cg(a.monitor.AnySpaMonitor.vp.startTime, a.utils.now()),
                (this.Qa = !1));
            };
          })(k || (k = {}));
          (function (a) {
                ...
                g = (function () {
                  ...
                  f.Vg = function (c, m) {
                    ...
                    return a.aop.around(
                      ...
                      function () {
                        b.DOMEventsMonitor.$b &&
                          (a.Qa
                            ? (a.log('M175', m), f.vp.url(document.URL))
                            : (a.log('M176', m), f.Rg()));
                        f.ka = document.URL;
                      },
                      'history' + g + 'State'
                  ...
                  f.Sg = function () {
                    ...
                    a.log('M177', f.ka, c);
                    b.DOMEventsMonitor.$b &&
                      (a.Qa ? (a.log('M178'), f.vp.url(document.URL)) : (f.Dd(f.ka), f.Gd(c)));
                    f.ka = c;
                  };
                  f.vm = function () {
                    var b;
                  ...
                  f.pm = function () {
                    ...
                    a.conf.P &&
                      ...
                      (a.log('M179'),
                      c.G.B || c.J.B
                        ? c.navComplete(a.utils.now())
                        : c.navComplete(a.utils.max(c.G.Ea, c.J.ca)),
                      c.reset());
                    f.Ca ||
                      !a.utils.isDefined(f.vp) ||
                      f.vp.Eg ||
                      (a.log('M180'), (c = f.ek(a.j.n.B)), f.cg(f.vp.startTime, c));
                  };
                  f.ek = function (b) {
                    var c = a.utils.now();
                  ...
                  f.fk = function (b) {
                    var c = a.utils.now();
                    b
                      ? a.j.n.J.ej() || a.j.n.G.fj() || (c = a.utils.max(a.j.n.J.ca, a.j.n.G.Ea))
                      : (c = a.j.n.startTime);
                    return c;
                  };
                  f.cg = function (a, b) {
                  ...
                  f.kd = function (b, c) {
                    a.utils.isDefined(f.vp) &&
                      ...
                      a.utils.isDefined(c)
                        ? a.conf.P
                          ? f.vp.timestamp(c - b > f.vp.vct ? c : f.vp.vct + b)
                          : f.vp.timestamp(c)
                        : f.vp.timestamp(b));
                  };
                  f.rj = function (b) {
                  ...
                  f.cd = function () {
                    ...
                    return (
                      a.utils.isDefined(b) &&
                      a.utils.isDefined(f.vp) &&
                      (!a.utils.isDefined(f.vp.fb) || f.vp.fb != b)
                    );
                  };
                  f.report = function () {
                    if (a.utils.isDefined(f.vp))
                      if (f.Am(f.vp.url(), f.Sc)) a.log('M183', f.vp.url());
                      else {
                        a.log('M184');
                        var c = f.vp;
                        if (c.Eg) a.log('M185');
                        else {
                          var m = a.utils.isDefined(b.DOMEventsMonitor.currentBasePage)
            ...
            (function (b) {
              var l = (function () {
                function e () {
                  ...
                  this.maxInactiveTime =
                    ...
                    a.conf.userConf.navComplete.maxInactiveTime
                      ? a.conf.userConf.navComplete.maxInactiveTime
                      : Math.max(this.J.qb, this.G.qb) + this.Bl;
                  this.tg = 1000;
                }
                e.prototype.setUp = function (a) {
                ...
                e.prototype.Em = function () {
                  this.eh = a.utils.refs.setInterval.call(
                    window,
                    function () {
                      a.Q();
                      ...
                      if (this.currentTime - b >= this.maxInactiveTime) {
                        if (
                          a.conf.P &&
                          e.Ga &&
                          !a.utils.isDefined(a.monitor.DOMEventsMonitor.currentBasePage)
                        ) {
                          a.log('M186');
                ...
                e.prototype.navComplete = function (b) {
                  a.Q();
                  var g = a.utils.isDefined(
                    a.monitor.AnySpaMonitor.vp && a.monitor.AnySpaMonitor.vp.startTime
                  )
                  ...
                  a.conf.P
                    ? e.Ga
                      ? (a.monitor.PerformanceWrapper.perf &&
                          (a.monitor.navMonitor.Xe(), a.monitor.resourceMonitor.We()),
                        a.log('M189'),
                        (b = a.N.Ve(a.utils.ib())),
                        ...
                        (a.N.Aa = !1),
                        (e.Ga = !1))
                      : a.monitor.AnySpaMonitor.kd(g, b)
                    : ((a.monitor.resourceMonitor.basePageResourceBuffer = []),
                      a.monitor.AnySpaMonitor.kd(g, b));
                  a.monitor.AnySpaMonitor.Ca ||
                    (a.monitor.AnySpaMonitor.$f(g), a.monitor.AnySpaMonitor.report());
                  a.R();
                };
                e.prototype.Cm = function () {
                  this.zg = a.utils.refs.setInterval.call(
                    window,
                    function () {
                      a.Q();
                      this.currentTime = a.utils.now();
          ...
          (function (a) {
            var b = (function () {
              ...
              b.prototype.fc = function (a, b) {
                this.oc.push({ El: new Date().getTime(), Dl: b, qg: a });
                this.zj = a;
              };
              ...
              b.prototype.getPhaseID = function (a) {
                for (var c = 0; c < b.Ie.length; c++) if (b.Ie[c] === a) return c;
                return null;
              };
              b.prototype.getPhaseCallbackTime = function (a) {
                for (var b = this.oc, g = 0; g < b.length; g++) if (b[g].qg === a) return b[g].El;
                return null;
              };
              b.prototype.findPhaseAtNominalTime = function (e) {
                a.assert(0 <= e);
                for (var c = this.oc, g = c.length - 1; 0 <= g; g--)
                  if (e >= c[g].Dl) return c[g].qg;
              ...
              var l = a.utils.now,
                e = (function () {
                  ...
                  c.prototype.setUp = function () {
                    ...
                    if ('loading' === b) a.log('M195'), c.wm(), c.Ug();
                    else {
                      var f = { timeStamp: l() };
                      c.Za(f);
                      'interactive' === b
                        ? (a.log('M196'), c.Ug())
                        : (a.log('M197'), c.tb(f), c.lg(f));
                    }
                  };
                  c.Ug = function () {
                    ...
                    a.utils.hc(function () {
                      ...
                      a.conf.P
                        ...
                        : (b.PerformanceWrapper.perf &&
                            (b.navMonitor.Xe(), b.resourceMonitor.We()),
                  ...
                  c.tb = function (b) {
                    c.dg ||
                      (a.lifecycle.Fl(b && b.timeStamp),
                      a.command('mark', 'onready', l()),
                      (c.dg = !0));
                  };
                  c.Za = function (a) {
                    document.addEventListener
                      ? (document.removeEventListener('DOMContentLoaded', c.Za, !1), c.tb(a))
                      : 'complete' === document.readyState &&
                        (document.detachEvent('onreadystatechange', c.Za), c.tb(a));
                  };
                  return c;
                })();
              e.isReady = !1;
          ...
          (function (a) {
            ...
            var c = a.conf.spa2 && a.conf.modernBrowserFeaturesAvailable,
              g = a.conf.isZonePromise,
              f = a.conf.fetch,
              n = (function () {
                function f () {}
                f.Rk = function () {
                ...
                f.Kf = function () {
                  return (
                    b(window.__zone_symbol__Promise) || b(window.__zone_symbol__ZoneAwarePromise)
                  );
                };
                f.If = function (c) {
                  b(window.Zone) &&
                  ...
                  if (b(a.ph)) {
                    ...
                    var g = (function (g) {
                      function n (e) {
                        ...
                        c &&
                          (b(this.h) && (e.h = this.h),
                          b(this.Ha) ? (e.h = this.Ha.h) : (e.h = a.c.ja()));
                        e.$ = this.$;
                        this.Ha = e;
                        a.log('M205', e.$);
                  ...
                  c &&
                    (g = a.aop.around(
                      ...
                      function () {
                        ...
                        b(arguments[1]) &&
                          (a.log('M212'),
                          (c = a.aop.around(arguments[1], f.za(f.H.ke, e))),
                          (arguments[1] = c));
                  ...
                  g = a.aop.around(
                    ...
                    function () {
                        ...
                        var l = a.aop.around(
                          ...
                          function () {
                            ...
                            b(n) && b(n.D) && f.il(n) && e.ba(g)
                              ...
                              : (e.ba(g) &&
                                  ...
                                  (e.Pd(g),
                                  e.Nb(g),
                                  !0 === e.Qd(g) && (a.log('M220'), a.log('M221'), e.Ua(g))),
                                c && (a.log('M222'), a.c.L()));
                          },
                          ...
                          function (b) {
                            e.ba(g) &&
                              e.Sb(g) &&
                              (e.Pd(g) && e.Nb(g),
                              !0 === e.Qd(g) && (a.log('M223'), a.log('M224'), e.Ua(g)));
                            f.sb(b);
                          }
                        );
                        arguments[0] = l;
                      ...
                      b(arguments[1]) &&
                        !f.fd(arguments[1]) &&
                        (a.log('M225', g.$),
                        (l = a.aop.around(arguments[1], f.za(f.H.je, g), function () {
                          c && (a.log('M226'), a.c.L());
                        })),
                        (arguments[1] = l));
                      return a.utils.xa(arguments);
                    ...
                    function () {
                      ...
                      !b(g) ||
                        (b(arguments[0]) && f.fd(arguments[0])) ||
                        (c && (g.h = this.h),
                        f.Pf(this) &&
                          e.ba(this) &&
                          ((g._adrumAjaxT = this._adrumAjaxT), e.Sb(this) || e.Lk(g)));
                    },
                    ...
                    function (b) {
                      ...
                      e.ba(c) &&
                        e.Sb(c) &&
                        (e.Pd(c) && e.Nb(c),
                        !0 === e.Qd(c) && (a.log('M227'), a.log('M228'), e.Ua(c)));
                      f.sb(b);
                    }
                  );
                  g.usedByAgent = !0;
                ...
                f.wg = function (g) {
                  if (b(window.Promise.prototype['finally']))
                    return (
                      (g = g || window.Promise.prototype['finally']),
                      (g = a.aop.around(
                        g,
                        function () {
                          b(this._adrumAjaxT) && b(this._adrumAjaxT.w)
                            ? e.Nb(this)
                            : b(this.D) && f.Cj(this);
                          if (b(arguments[0])) {
                            a.log('M229', this.$);
                      ...
                      (g.usedByAgent = !0),
                      (window.Promise.prototype['finally'] = g)
                    );
                };
                f.$l = function () {
          ...
          (function (a) {
            (function (b) {
              function l (a, b) {
                ...
                if (e) {
                  ...
                  if ('R' === k[0] && Number(k[1]) === b)
                    for (g(l), l = 1; l < e.length; l++) c.push(e[l]);
                }
                return c;
              }
              function e (a, b) {
                ...
                if (c) {
                  var e = c[1],
                    l = c[4],
                    k = c[5];
                  if (Number(c[3]) === b) return g(e), { index: Number(l), value: k };
                }
                return null;
              }
              function c (b) {
                ...
                if (c) {
                  a.log('M236', b);
                  if (3 === c.length)
                    return g('ADRUM'), { startTime: Number(c[1]), startPage: c[2] };
                  a.error('M237', b);
                  return null;
                }
              }
              ...
              b.cf = function (f, g) {
                a.log('M234');
                for (
                  var m = g ? g.length : 0, k = [], t = f.split(';'), p = 0;
                  p < t.length;
                  p++
                ) {
                  var s = t[p],
                ...
                s = [];
                for (p = 0; p < k.length; p++) s.push(k[p].value);
          ...
          (function (a) {
            ...
            a.conf.fetch &&
              ...
              (a.Fi.setUp(), a.monitor.setUpMonitors(a.monitor.jb));
            a.conf.spa2 &&
              a.conf.modernBrowserFeaturesAvailable &&
              a.monitor.setUpMonitors(a.monitor.dj);
            a.conf.enablePrimaryMetrics &&
              a.utils.isDefined(window.MutationObserver) &&
              ((a.conf.P = !0), a.j.n.J.Tg(), a.j.n.start(a.utils.ib()), a.N.start());
          })(k || (k = {}));
          (function (a) {
            a = a.ng || (a.ng = {});
            a = a.k || (a.k = {});
          ...
          (function (a) {
            (function (b) {
              function l (a, c, e, m, l, k) {
                if (c)
                  try {
                    return c.apply(a, [e, m, l].concat(k));
                  } catch (p) {
                ...
                return function () {
                  ...
                  if (this.tj(a))
                    return this.error(
                      ...
                      k,
                      b.Error.$h,
                      'event ' + a + 'M239' + this.current
                    );
                  if (!1 === l(this, this['onbefore' + a], a, e, m, k)) return b.Gb.Xd;
                  m === b.Hb && (m = e);
                  if (e === m)
              ...
              var c = a.utils.hasOwnPropertyDefined;
              b.VERSION = '2.3.5';
              b.Gb = { Ki: 1, zi: 2, Xd: 3, tn: 4 };
              b.Error = { $h: 100, un: 200, Zh: 300 };
              b.Hb = '*';
              b.create = function (a, f) {
                function n (a) {
                  ...
                  for (var f = 0; f < c.length; f++)
                    (r[c[f]] = r[c[f]] || []),
                      r[c[f]].push(a.name),
                      (s[a.name][c[f]] = a.to || c[f]);
                }
                var m = 'string' == typeof a.initial ? { state: a.initial } : a.initial,
                  l = f || a.target || {},
                  k = a.events || [],
                  p = a.callbacks || {},
                  s = {},
                  r = {};
                m &&
                  ((m.event = m.event || 'startup'),
                  n({ name: m.event, from: 'none', to: m.state }));
                for (var w = 0; w < k.length; w++) n(k[w]);
                for (var A in s) c(s, A) && (l[A] = e(A, s[A]));
                for (A in p) c(p, A) && (l[A] = p[A]);
                l.current = 'none';
                l.Un = function (a) {
                ...
                l.error =
                  a.error ||
                  function (a, b, c, f, g, m, e) {
                    throw e || m;
                  };
                if (m && !m.defer) l[m.event]();
                return l;
              };
            })(a.we || (a.we = {}));
          })(k || (k = {}));
              ...
              var l = (function (e) {
                function c (b) {
                  ...
                  a.utils.isDefined(a.ng) &&
                    ...
                    b.constructor != c &&
                    a.reportAPIMessage(a.W.ma, a.Xa, 'ADRUM.events.VPageView', []);
          ...
          (function (a) {
            ...
            a.conf.userConf &&
              ...
              (a.conf.userConf.spa.angular.vp.xhr &&
                a.utils.va.ug(a.conf.userConf.spa.angular.vp.xhr),
              a.conf.userConf.spa.angular.vp.metrics &&
                a.utils.mergeJSON(b.metrics, a.conf.userConf.spa.angular.vp.metrics));
          })(k || (k = {}));
          (function (a) {
            (function (b) {
              var l = a.utils.map,
                ...
                g = (function (f) {
                  ...
                  g.prototype.pj = function () {
                    var b = [],
                      c = this;
                    0 < this.vb.nc &&
                      (b = a.monitor.resourceMonitor.kb().filter(function (a) {
                        return c.mj(a);
                      }));
                    this.resTiming(b);
                  };
                  g.Rj = function (b) {
                    return c(b, function (b) {
                      return (
                        ...
                        !a.utils.va.mc(b.eventUrl, b.method)
                      );
                    });
                  };
                  g.jk = function (a) {
                  ...
                  g.prototype.aj = function () {
                    if (b.conf.xhr) {
                      var c = g.Rj(a.channel.getEventsWithParentGUID(this.guid())),
                        c = g.jk(c);
                      if (0 < c) {
                        var f = this.perf.getEntryByName(a.events.b.uh);
                        this.markXhrRequestsCompleted(
                          Math.min((f && f.startTime) || Number.MAX_VALUE, c)
                        );
                      }
                    }
                  };
                  ...
                  g.prototype.$i = function () {
                    if (0 < this.vb.nc) {
                      ...
                      b &&
                        ...
                        this.markViewResourcesLoaded(a.PerformanceTracker.Jc(b)));
                    }
                  };
              ...
              g.Hg = { img: 'src', script: 'src', link: 'href' };
              b.NgVPageView = g;
              ...
              a.we.create(
                {
                  ...
                  callbacks: {
                    ...
                    onleaveXhrPending: function (a, b, g) {
                      if ('abort' === a) return this.yd(), !0;
                      if ('xhrCompleted' === a && 'End' === g) {
                        if (this.A.Ak()) return !1;
                    ...
                    onbeforeXhrReq: function (b, c, g, f) {
                      ...
                      f[3] &&
                        (f[3] = a.aop.before(f[3], function (b, c, f) {
                          a.log('M252');
                          n.Bj();
                          f &&
                            (b = a.utils.Ql(f)['content-type']) &&
              ...
              var l = (function () {
                ...
                e.prototype.T = function (c, g) {
                  ...
                  switch (c) {
                    ...
                    case b.k.Zg:
                      this.O.start();
                      var f = g.next.url || document.URL,
                        n = new b.NgVPageView({ url: f, identifier: g.next });
                      this.distinguishVPwithItsTemplateUrl && e.al(this.O.A, n)
                        ? this.O.A.lc({ url: f, identifier: g.next })
                        : this.Im(n);
                      break;
                    case b.k.Lg:
                    case b.k.$g:
                ...
                e.al = function (b, g) {
                  var f = b.identifier(),
                    ...
                    m = !1;
                  return (m =
                    (!a.utils.isDefined(f) && !a.utils.isDefined(e)) || f === e
                      ? !0
                      : a.utils.isDefined(f) && a.utils.isDefined(e)
                      ? f.state || e.state
                        ? a.utils.isDefined(f.state) && a.utils.isDefined(e.state)
                          ? f.state.name === e.state.name &&
                            f.state.wb === e.state.wb &&
                            f.state.xb === e.state.xb &&
                            f.state.url === e.state.url
                          : !1
                        : f.M && e.M
                        ? f.M.td === e.M.td && f.M.wb === e.M.wb && f.M.xb === e.M.xb
                        : f.url === e.url
                      : !1);
                };
                return e;
          ...
          (function (a) {
            (function (b) {
              var l = a.utils.addEventListener,
                e = (function () {
                  function c () {
                    this.V = new b.Oi();
                    this.Gf = !1;
                  ...
                  c.prototype.init = function () {
                    if ('loading' === document.readyState) a.log('M257');
                    ...
                    c.decorator('$rootScope', [
                      ...
                      function (a) {
                        ...
                        a.$on('$locationChangeStart', function (a, c) {
                          var f = { url: c },
                            g = a && a.hb && a.hb.$state && a.hb.$state.current;
                          g && (f.state = g);
                          e.V.T(b.k.Yf, { next: f });
                        });
                        ...
                        a.$on('$viewContentLoaded', function (a) {
                          ...
                          if ((a = a && a.hb && a.hb.$state && a.hb.$state.current)) c.state = a;
                          e.V.T(b.k.mh, { next: c });
                        });
