{
  const $___stub_024f5a017bce3827 = {};
  (exports => {
    'use strict';
    let isSealed = false;
  ...
  (function () {
    ...
    if (typeof window.Piwik !== 'object') {
      window.Matomo = window.Piwik = (function () {
        const $___old_913c64b9d9b2b12b = {}.constructor.getOwnPropertyDescriptor(
          window,
          'performance'
        );
        try {
          if ($___old_913c64b9d9b2b12b)
            ({}.constructor.defineProperty(
              window,
              'performance',
              $___stub_024f5a017bce3827.performance
            ));
          return function () {
            var r,
              b = {},
            ...
            function Q (ce, b9) {
              ...
              function dg (ds, dq, dp, dr, dn, dm) {
                const $___old_49b56b077d0f1224 = {}.constructor.getOwnPropertyDescriptor(
                  Document.prototype,
                  'cookie'
                );
                try {
                  if ($___old_49b56b077d0f1224)
                    ({}.constructor.defineProperty(
                      Document.prototype,
                      'cookie',
                  ...
                  if ($___old_49b56b077d0f1224)
                    ({}.constructor.defineProperty(
                      Document.prototype,
                      'cookie',
                      $___old_49b56b077d0f1224
                    ));
                }
              }
              function aD (dn) {
                const $___old_3e9f82cfb7b8ce1c = {}.constructor.getOwnPropertyDescriptor(
                  Document.prototype,
                  'cookie'
                );
                try {
                  if ($___old_3e9f82cfb7b8ce1c)
                    ({}.constructor.defineProperty(
                      Document.prototype,
                      'cookie',
                      $___stub_1c5cc68fe6204532.cookie
              ...
              function cq (dl, dn) {
                ...
                dm.onload = function () {
                  ...
                  if (typeof dn === 'function') {
                    dn({ request: dl, trackerUrl: aE, success: true });
                  }
                };
                dm.onerror = function () {
                  if (typeof dn === 'function') {
                    dn({ request: dl, trackerUrl: aE, success: false });
                  }
                };
              ...
              function a7 (dq, dt, ds) {
                ...
                if (du && typeof dt === 'function') {
                  dt({ request: dq, trackerUrl: aE, success: true, isSendBeacon: true });
                }
                return du;
              }
                ...
                setTimeout(function () {
                  ...
                  try {
                    ...
                    dq.onreadystatechange = function () {
                      if (this.readyState === 4 && !(this.status >= 200 && this.status < 300)) {
                        ...
                        if (!ds && dl) {
                          ...
                          if (typeof dn === 'function') {
                            dn({ request: dm, trackerUrl: aE, success: false, xhr: this });
                          }
                        }
                      } else {
                        if (this.readyState === 4 && typeof dn === 'function') {
                          dn({ request: dm, trackerUrl: aE, success: true, xhr: this });
                        }
                      }
                    };
                    ...
                    if (!dr && dl) {
                      ...
                      if (typeof dn === 'function') {
                        dn({ request: dm, trackerUrl: aE, success: false });
                      }
                    }
                  }
                }, 50);
              ...
              function cI () {
                const $___old_a97447eae45ee7d8 = {}.constructor.getOwnPropertyDescriptor(
                  Navigator.prototype,
                  'userAgent'
                );
                try {
                  if ($___old_a97447eae45ee7d8)
                    ({}.constructor.defineProperty(
                      Navigator.prototype,
                      'userAgent',
              ...
              function cS () {
                const $___old_a6b94e0c6eadbe53 = {}.constructor.getOwnPropertyDescriptor(
                    Navigator.prototype,
                    'userAgent'
                  ),
                  $___old_1cf6e50fc1e2aacc = {}.constructor.getOwnPropertyDescriptor(
                    Navigator.prototype,
                    'platform'
                  );
                try {
                  if ($___old_a6b94e0c6eadbe53)
                    ({}.constructor.defineProperty(
                      Navigator.prototype,
                      'userAgent',
                      $___stub_8938c767ccc6c19c.userAgent
                    ));
                  if ($___old_1cf6e50fc1e2aacc)
                    ({}.constructor.defineProperty(
                      Navigator.prototype,
                      'platform',
                      $___stub_8938c767ccc6c19c.platform
                    ));
                  return function () {
                    var dl = cI();
                    return b7(
                  ...
                  if ($___old_a6b94e0c6eadbe53)
                    ({}.constructor.defineProperty(
                      Navigator.prototype,
                      'userAgent',
                      $___old_a6b94e0c6eadbe53
                    ));
                  if ($___old_1cf6e50fc1e2aacc)
                    ({}.constructor.defineProperty(
                      Navigator.prototype,
                      'platform',
                      $___old_1cf6e50fc1e2aacc
                    ));
                }
              }
              function aA () {
                var dl = cI();
                return b7(
                  (h.userAgent || '') + (h.platform || '') + JSON_PIWIK.stringify(dl)
                ).slice(0, 6);
              }
              function bg () {
              ...
              function ct (dn, dJ, dK, dp) {
                ...
                dn +=
                  ...
                  '&url=' +
                  t(b2(dM)) +
                  (bn.length ? '&urlref=' + t(b2(bn)) : '') +
                  (by && by.length ? '&uid=' + t(by) : '') +
                  '&_id=' +
                  dC.uuid +
                  '&_idts=' +
                  dC.createTs +
                  ...
                  '&_viewts=' +
                  dC.lastVisitTs +
                  (String(dC.lastEcommerceOrderTs).length
                    ? '&_ects=' + dC.lastEcommerceOrderTs
                    : '') +
                  (String(dH).length ? '&_ref=' + t(b2(dH.slice(0, dq))) : '') +
                  (dz ? '&cs=' + t(dz) : '') +
                  '&send_image=0';
                var dP = cI();
                for (dI in dP) {
                ...
                if (dJ) {
                  for (dI in dJ) {
                    if (
                      Object.prototype.hasOwnProperty.call(dJ, dI) &&
                      /^dimension\d+$/.test(dI)
                    ) {
                ...
                dC.lastEcommerceOrderTs =
                  J(dp) && String(dp).length ? dp : dC.lastEcommerceOrderTs;
                aM(dC);
                cd();
                dn += ac(dK, { tracker: bI, request: dn });
                if (c1.length) {
                  dn += '&' + c1;
                }
                if (A(cb)) {
              ...
              function bE (dp) {
                ...
                if (ae.isLinkElement(ds) && ae.hasNodeAttributeWithValue(ds, 'href')) {
                  ...
                  var dr = dq.target;
                  if (
                    !ae.hasNodeAttributeWithValue(ds, v.CONTENT_TARGET_ATTR) ||
                    ds.wasContentTargetAttrReplaced
                  ) {
              ...
              function aY (dl) {
                return function (dm) {
                  ...
                  if (
                    ae.isLinkElement(dl) &&
                    ae.hasNodeAttributeWithValue(dl, 'href') &&
                    ae.hasNodeAttributeWithValue(dl, v.CONTENT_TARGET_ATTR)
                  ) {
              ...
              function bx (dn, dp) {
                ...
                for (dl = 0; dl < dn.length; dl++) {
                  dm = ct(
                    v.buildImpressionRequestParams(dn[dl].name, dn[dl].piece, dn[dl].target),
                    undefined,
                    'contentImpressions'
                  );
                  if (dm) {
          ...
          if ($___old_913c64b9d9b2b12b)
            ({}.constructor.defineProperty(window, 'performance', $___old_913c64b9d9b2b12b));
        }
      })();
    }
    (function () {
