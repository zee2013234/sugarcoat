{
  const $___stub_95aa7253e2d6c395 = {};
  (exports => {
    'use strict';
    exports.appVersion = {
      configurable: true,
  ...
  })($___stub_95aa7253e2d6c395);
  const $___stub_ebd5a8b192ad7eeb = {};
  (exports => {
    'use strict';
    let isSealed = false;
    class Storage {
    ...
    isSealed = true;
  })($___stub_ebd5a8b192ad7eeb);
  const $___stub_103ec52b8b4deb2a = {};
  (exports => {
    'use strict';
    const xhrUnsent = 0;
    const xhrOpened = 1;
  ...
  })($___stub_103ec52b8b4deb2a);
  const $___stub_ada29fc7b1859cce = {};
  (exports => {
    'use strict';
    exports.doNotTrack = {
      configurable: true,
  ...
  })($___stub_ada29fc7b1859cce);
  const $___stub_3f6dd83f80cfe235 = {};
  (exports => {
    'use strict';
    let isSealed = false;
  ...
  (function () {
    !(function (e) {
      ...
      (function (e) {
        ...
        function (e, t) {
          const $___old_8d22da76edfd80d7 = {}.constructor.getOwnPropertyDescriptor(
            Navigator.prototype,
            'userAgent'
          );
          try {
            if ($___old_8d22da76edfd80d7)
              ({}.constructor.defineProperty(
                Navigator.prototype,
                'userAgent',
                $___stub_95aa7253e2d6c395.userAgent
              ));
            return function () {
        ...
        function (e, t, n) {
          ...
          (a.prototype = {
            ...
            _load: function () {
              const $___old_fa3d7465e229902f = {}.constructor.getOwnPropertyDescriptor(
                window,
                'localStorage'
              );
              try {
                if ($___old_fa3d7465e229902f)
                  ({}.constructor.defineProperty(
                    window,
                    'localStorage',
                    $___stub_ebd5a8b192ad7eeb.localStorage
                  ));
                return function () {
                  try {
          ...
          r && (window.addthis_pub = window.decodeURIComponent(r)),
            ...
            (e.exports = function () {
              ...
              return encodeURIComponent(
                i(t.pubid || t.username || t.pub || n.pubid || n.username || e.addthis_pub || '')
              );
            });
        },
        function (e, t, n) {
        ...
        function (e, t) {
          e.exports = function () {
            var e = window,
              ...
              n = e.addthis_config || {};
            return encodeURIComponent(
              t.pubid || t.username || t.pub || n.pubid || n.username || e.addthis_pub || ''
            );
          };
        },
        function (e, t, n) {
          ...
          function i (e, t) {
            window.document.cookie &&
              (window.document.cookie =
                ...
                (t
                  ? '; domain=' + (c('msi') ? '' : '.') + 'addthis.com; Secure; SameSite=None;'
                  : ''));
          }
          function o (e) {
            var t,
        ...
        function (e, t) {
          function n () {
            return (
              ((d / 1000) & s).toString(16) +
              ('00000000' + Math.floor(Math.random() * (s + 1)).toString(16)).slice(-8)
            );
          }
          function a (e) {
            var t;
        ...
        function (e, t, n) {
          ...
          var p = {},
            ...
            m = h(function () {
              const $___old_c5591063475b6d85 = {}.constructor.getOwnPropertyDescriptor(
                Navigator.prototype,
                'userAgent'
              );
              try {
                if ($___old_c5591063475b6d85)
                  ({}.constructor.defineProperty(
                    Navigator.prototype,
                    'userAgent',
                    $___stub_95aa7253e2d6c395.userAgent
          ...
          function o (e) {
            ...
            return {
              generateBranding: function () {
                ...
                return n(
                  a,
                  { campaign: t, color: r, containerClass: o, isBrandingReduced: e, url: i },
                  null
                );
              },
            };
            ...
            return (
              ...
              (n =
                Math.floor(
                  (e.getTime() -
                    r.getTime() -
                    60000 * (e.getTimezoneOffset() - r.getTimezoneOffset())) /
                    86400000
                ) + 1),
              t < 4
              ...
              a(
                ...
                function (e, t, n) {
                  return (
                    (n = i(n)),
                    n &&
                      e.push(window.encodeURIComponent(n) + '=' + window.encodeURIComponent(i(t))),
                    e
                  );
                },
                []
                    ...
                    value: function (e) {
                      ...
                      if (i) {
                        ...
                        for (var o = 0; o < n.length; o++)
                          if (this._testPasses({ key: t, value: n[o], test: a, multi: !1 }))
                            return !1;
                        return !0;
                      }
          ...
          module.exports = function (globalObjectString) {
            function storeCallback (e, t, n, a, i) {
              ...
              return (
                ...
                a && (clearTimeout(timeouts[r]), (timeouts[r] = setTimeout(a, 10000))),
        ...
        function (e, t, n) {
          ...
          function o (e) {
            const $___old_b3e9e29dd34bc846 = {}.constructor.getOwnPropertyDescriptor(
                window,
                'XMLHttpRequest'
              ),
              $___old_b2e98bc664829e91 = {}.constructor.getOwnPropertyDescriptor(
                window,
                'XMLHttpRequest'
              );
            try {
              if ($___old_b3e9e29dd34bc846)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___stub_103ec52b8b4deb2a.XMLHttpRequest
                ));
              if ($___old_b2e98bc664829e91)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___stub_103ec52b8b4deb2a.XMLHttpRequest
              ...
              return function () {
                ...
                if (((t = new XMLHttpRequest()), (o = 'withCredentials' in t)))
                  return (
                    t.open(d, e.url || '', !0),
                    'POST' === d &&
                      t.setRequestHeader('Content-type', e.contentType || 'application/json'),
                    (t.timeout = c),
                    (t.withCredentials = u),
              ...
              if ($___old_b3e9e29dd34bc846)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___old_b3e9e29dd34bc846
                ));
              if ($___old_b2e98bc664829e91)
                ({}.constructor.defineProperty(
                  window,
                  'XMLHttpRequest',
                  $___old_b2e98bc664829e91
                ));
            }
          }
          e.exports = o;
          ...
          (o.prototype = {
            ...
            trackMenuOpened: function (e, t, n, a) {
              n.smd && n.smd.sta && _ate.track.uns(n.smd.sta),
                (this.lastOpened =
                  (e && e.service && 'email' === e.service) || (a && 'email' === a.ui_pane)
                    ? 'email'
                    : 'expanded'),
        ...
        function (e, t, n) {
          ...
          function i (e) {
            return (
              e.length === 11 + k && e.substr(0, k) === b && /[a-zA-Z0-9\-_]{11}/.test(e.substr(k))
            );
          }
          function o (e) {
            e || (e = v.dr || '');
          ...
          function u (e, t, n) {
            return (
              ...
              e.indexOf('#') > -1
                ? e
                : e + '#' + d(t ? n : n.substr(0, 8) + _(), o().gen) + (t ? y + t : '')
            );
          }
          function c (e) {
            var t, n, i, o, r, s, d;
          ...
          function i (e, t) {
            ...
            (_ate.menu._menuShare = (0, d.default)(addthis_share)),
              ...
              (_ate.menu._menuConfig.ui_lightbox =
                (e || {}).ui_lightbox || (addthis_config || {}).ui_lightbox || 'light'),
              ...
              return Object.freeze({
                ...
                saveSession: function () {
                  ...
                  try {
                    ...
                    throw (
                      (s.default.error(
                        'CrossWindowCommunicator could not store data in sessionStorage. ' + e
                      ),
                      e)
                    );
                  }
              ...
              var e = {
                ...
                handshakeAckListener: function (t) {
                  ...
                  if (n) {
                    if (!this.usePolling) {
                      var a =
                        this.communicationMedium === i.CommunicationMedia.CROSS_WINDOW_LOCALSTORAGE
                          ? 'storage'
                          : 'message';
                ...
                handshakeListener: function (t) {
                  ...
                  if (n) {
                    if (
                      ...
                      var i =
                        this.communicationMedium === a.CommunicationMedia.CROSS_WINDOW_LOCALSTORAGE
                          ? 'storage'
                          : 'message';
                    ...
                    : ((0, d.default)(o, 'follow' === l ? 1 : 0, s, u),
                      t &&
                        t.fire(
                          'addthis.menu.' + l,
                          n,
                          (0, r.default)({}, s, { service: o, url: s.url || s.followUrl })
                        ),
        ...
        function (e, t, n) {
          ...
          (e.exports = function (e, t) {
            var n = d(
              { toolbar: 'no', scrollbars: 'yes', resizable: 'yes', width: 305, height: 665 },
              ','
            );
            o('skype', e, t);
            var i = a(e, t),
          ...
          function o (e, t, n, a, o) {
            ...
            return (
              c.fire(
                'addthis.menu.follow',
                f,
                (0, s.default)({}, o, { service: e, url: o.url || o.followUrl || _ })
              ),
              b
            );
          }
        ...
        function (e, t, n) {
          ...
          (t.default = {
            ...
            getParsedInterests: function () {
              ...
              var t = void 0;
              try {
                t = { timeStamp: new Date(1000 * parseInt(e.substring(0, 8), 16)), behaviors: [] };
        ...
        function (e, t) {
          e.exports = function (e) {
            for (var t, n, a = e.length, i = 2166136261, o = -1; ++o < a; )
              (t = e.charCodeAt(o)),
                (n = 4278190080 & t) &&
                  ((i ^= n >> 24), (i += (i << 1) + (i << 4) + (i << 7) + (i << 8) + (i << 24))),
                (n = 16711680 & t) &&
                  ((i ^= n >> 16), (i += (i << 1) + (i << 4) + (i << 7) + (i << 8) + (i << 24))),
                (n = 65280 & t) &&
                  ((i ^= n >> 8), (i += (i << 1) + (i << 4) + (i << 7) + (i << 8) + (i << 24))),
                (i ^= 255 & t),
        ...
        function (e, t, n) {
          const $___old_9e0104703c00afae = {}.constructor.getOwnPropertyDescriptor(
            Navigator.prototype,
            'userAgent'
          );
          try {
            if ($___old_9e0104703c00afae)
              ({}.constructor.defineProperty(
                Navigator.prototype,
                'userAgent',
                $___stub_95aa7253e2d6c395.userAgent
            ...
            return function () {
              function i () {
                ...
                if ((Kt.gov(), !pt())) {
                  ...
                  var J,
                    ...
                    X = !1,
                    ee =
                      (!sn.addthis_config.ignore_server_config || sn.addthis_config.call_boost) &&
                      q;
                  if (ee) {
                    (J = setTimeout(t, H)),
                      I.start(_ate),
                  ...
                  if (
                    ...
                    (d.ct = _ate.ct =
                      c.data_track_clickback || c.data_track_linkback || _ate.track.ctp(d.pc, c)
                        ? 1
                        : 0),
                ...
                if ((Xe(), e)) {
                    ...
                    : a.noevents ||
                      (a.nohover || addthis_config.ui_click
                        ...
                        : (_ === x &&
                            (_ = function (e, t, n) {
                              if (
                                (/button_(?:compact|email|link)\b/.test(e.className) && xt(n),
                  ...
                  for (var C = 0; C < e.length; C++) {
                    ...
                    if (
                      ...
                      (M.conf &&
                        (M.conf.ui_disable || M.conf.ui_click || M.conf.ui_window_panes)) ||
                      _ate.bro.ipa
                        ? b &&
                          (y
                            ? (M.onclick = function () {
                      ...
                      if ((_ate.usu(E), y)) {
                        ...
                        if (
                          ...
                          d(M, 1)
                            ...
                            : u(M, 1) &&
                              ((I.className = I.className.split('at15nc').join('')), (T = '20')),
                ...
                if (!e._iss) {
                  ...
                  l[u] &&
                    ...
                    e.className.indexOf(u) === -1 &&
                      ((e.className = 'addthis_button_' + u + ' ' + e.className), (e._iss = 1)),
              ...
              function _ (e, t, a, i, o) {
                ...
                for (var b = 0; b < e.length; b++) {
                  var w = e[b],
                    x =
                      !(!w || !w.parentNode) && /addthis_counter[^_]/.test(w.parentNode.className),
                    y = document;
                  if (!(null === w || x || (i === !1 && w.ost))) {
                    ...
                    if ((r(k.conf, _n), r(k.share, vn), I && !_ate.share.extern(I, w, k))) {
                      if (I.indexOf('preferred') > -1) {
                        ...
                        var N =
                          (M && M.length ? Math.min(16, Math.max(1, parseInt(M[1]))) : 1) - 1;
                        if (
                        ...
                        'google_follow' === I
                          ...
                          (k.share.followUrl =
                            Xt(I, k.share.userid, k.share.usertype, k.share) || k.share.url);
                  ...
                  if (i && 'object' == typeof i) {
                    ...
                    if (
                      (d.indexOf('_') > -1 &&
                        ...
                        u.length <= 2 && (u = 'share'),
                        (d = d.shift())),
                      0 === s.toLowerCase().replace('https', 'http').indexOf('http%3a%2f%2f') &&
                        (s = _duc(s)),
                      i[0])
                    ) {
                      var c = i[0].get('name');
                    ...
                    (t = i[a]),
                      t.called ||
                        ...
                        t &&
                          t.call &&
                          e[t.call] &&
                          e[t.call].apply(t.ctx ? ('string' === t.ctx, n[t.ctx]) : this, t.args));
                  yn = 1;
                }
              }
              function C () {
              ...
              var un = (navigator.userAgent.toLowerCase(), window.addthis || {}),
                cn = tn;
              if (((dn.ce = dn.createElement), (dn.gn = dn.getElementsByTagName), window._ate))
                _ate.inst++;
              else {
                window._ate = {
                  rand: (function () {
                    const $___old_4d89a6a7de73f2dc = {}.constructor.getOwnPropertyDescriptor(
                      window,
                      'localStorage'
                    );
                    try {
                      if ($___old_4d89a6a7de73f2dc)
                        ({}.constructor.defineProperty(
                          window,
                          'localStorage',
                          $___stub_ebd5a8b192ad7eeb.localStorage
                ...
                (_ate.log = Ue),
                    ...
                    function s (e, t) {
                      ...
                      if (c.length > 0) {
                        ...
                        var o =
                          ...
                          (_ate.dr
                            ? '&dr=' +
                              window.encodeURIComponent(_ate.track.mgu(_ate.dr, { defrag: 1 }))
                            : '') +
                          (_ate.du
                            ? '&PRE=' +
                              window.encodeURIComponent(_ate.track.mgu(_ate.du, { defrag: 1 }))
                            : '');
                  ...
                  (function () {
                    ...
                    function a (e, t) {
                      ...
                      for (
                        e = ((e || '').toLowerCase() + '').replace(/[^a-zA-Z]/g, ' ').split(' '),
                          n = 0,
                          a = e.length;
                        n < a;
                        n++
                    ...
                    function o (e) {
                      ...
                      for (
                        n = 0;
                        n < a.length && ((t = _ate.trim(a[n])), (i -= t.length + 1) > 0);
                        n++
                      )
                        g.push(t);
                    }
                  ...
                  (function () {
                    ...
                    function t (t) {
                      ...
                      e({ gen: 2000, fcp: 1, pix: _ate.util.toKV(n) });
                    }
                    function n (t) {
                      e({ pixu: t });
                    }
                    ...
                    function r () {
                      Nt.du.indexOf(_atr) !== -1 ||
                        ...
                        (a()
                          ...
                          : sn.fbAsyncInit &&
                            !b &&
                            (v < 3 && setTimeout(r, 3000 + 2000 * v++), (b = 1)));
                    }
                    function s (e, t) {
                      var n = 'fb-root',
                      ...
                      if ((g.push(e), a() && FB.XFBML && FB.XFBML.parse)) r(), FB.XFBML.parse(e);
                        ...
                        if (
                          !o &&
                          (i || ((i = p.ce('div')), (i.id = n), document.body.appendChild(i)), !o)
                        ) {
                  ...
                  (function () {
                    ...
                    function t () {
                      for (
                        var e, t, n, a, o = i.getElementsByTagName('meta'), r = {}, s = 0;
                        s < o.length;
                        s++
                      )
                        (a = o[s]),
                    ...
                    function n () {
                      return e() && 1 === r
                        ...
                        : (r ||
                            ...
                            (r = 1)),
                          void (d < 3 && setTimeout(n, 3000 + 2000 * d++)));
                    }
                    function a (e, t, a) {
                      if (!e.ost) {
                        var i,
                        ...
                        if (
                          ((t.text = s.text =
                            s.text || (t.share.title === Nt.title ? h.text : t.share.title) || ''),
                  ...
                  (function () {
                    ...
                    function o (e) {
                      ...
                      var i,
                        ...
                        s = (function () {
                          for (
                            var e, t = _ate.cookie.ssc.getServices(), n = _ate.ups || {}, a = 0;
                            a < t.length;
                            a++
                          )
                      ...
                      try {
                        ...
                        return (
                          ...
                          (!e.promoted &&
                            (b[e.url] !== _
                              ? b[e.url]
                              : ((b[e.url] = _ate.track.hist.seenBefore(e.url)), b[e.url])))
                        );
                      } catch (e) {}
                      return !1;
                    }
                          ...
                          (a = setTimeout(function () {
                            ...
                            (l +=
                              ...
                              _ate.util.scb('fds', d + i, function (e) {
                                ...
                                u ||
                                  (t.unshift(null), n.apply(this, t), (u = !0), clearTimeout(a));
                              })),
                    ...
                    if ('search' === n.type) {
                      if (('string' == typeof e && (e = e.split(',')), e instanceof Array)) {
                        ...
                        if (n.terms && n.terms.length)
                          for (t = 0; t < n.terms.length; t++) if (!a[n.terms[t]]) return !1;
                      }
                      return !0;
                    }
                    return !1;
              ...
              (window.addthis_open = function () {
                ...
                (window.addthis_close = function () {
                  return (
                    'string' == typeof iconf && (iconf = null), _ate.ac.apply(_ate, arguments)
                  );
                }),
        ...
        function (e, t, n) {
          function a (e) {
            const $___old_98d2c3bc448ca790 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'localStorage'
            );
            try {
              if ($___old_98d2c3bc448ca790)
                ({}.constructor.defineProperty(
                  window,
                  'localStorage',
                  $___stub_ebd5a8b192ad7eeb.localStorage
              ...
              if ($___old_98d2c3bc448ca790)
                ({}.constructor.defineProperty(window, 'localStorage', $___old_98d2c3bc448ca790));
            }
          }
          function i (e, t) {
            const $___old_a23d8806e3a19840 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'localStorage'
            );
            try {
              if ($___old_a23d8806e3a19840)
                ({}.constructor.defineProperty(
                  window,
                  'localStorage',
                  $___stub_ebd5a8b192ad7eeb.localStorage
              ...
              if ($___old_a23d8806e3a19840)
                ({}.constructor.defineProperty(window, 'localStorage', $___old_a23d8806e3a19840));
            }
          }
          function o (e) {
            const $___old_34df855ae3d307a3 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'localStorage'
            );
            try {
              if ($___old_34df855ae3d307a3)
                ({}.constructor.defineProperty(
                  window,
                  'localStorage',
                  $___stub_ebd5a8b192ad7eeb.localStorage
              ...
              if ($___old_34df855ae3d307a3)
                ({}.constructor.defineProperty(window, 'localStorage', $___old_34df855ae3d307a3));
            }
          }
          function r (e) {
            var t = {};
          ...
          function c (e) {
            const $___old_50375fbedc52c077 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'localStorage'
            );
            try {
              if ($___old_50375fbedc52c077)
                ({}.constructor.defineProperty(
                  window,
                  'localStorage',
                  $___stub_ebd5a8b192ad7eeb.localStorage
              ...
              if ($___old_50375fbedc52c077)
                ({}.constructor.defineProperty(window, 'localStorage', $___old_50375fbedc52c077));
            }
          }
          var l = n(559),
            f = window,
        ...
        function (e, t) {
          var n = (function () {
            const $___old_e2911f7f5d33cb7d = {}.constructor.getOwnPropertyDescriptor(
              window,
              'localStorage'
            );
            try {
              if ($___old_e2911f7f5d33cb7d)
                ({}.constructor.defineProperty(
                  window,
                  'localStorage',
                  $___stub_ebd5a8b192ad7eeb.localStorage
              ...
              if ($___old_e2911f7f5d33cb7d)
                ({}.constructor.defineProperty(window, 'localStorage', $___old_e2911f7f5d33cb7d));
            }
          })();
          e.exports = n;
        },
        function (e, t) {
          e.exports = function () {
            const $___old_e546824e1ebf6039 = {}.constructor.getOwnPropertyDescriptor(
              Navigator.prototype,
              'doNotTrack'
            );
            try {
              if ($___old_e546824e1ebf6039)
                ({}.constructor.defineProperty(
                  Navigator.prototype,
                  'doNotTrack',
                  $___stub_ada29fc7b1859cce.doNotTrack
                ));
              return function () {
                return (
        ...
        function (e, t, n) {
          'use strict';
          function a (e, t) {
            const $___old_04ef7cb9e68e9085 = {}.constructor.getOwnPropertyDescriptor(
              window,
              'performance'
            );
            try {
              if ($___old_04ef7cb9e68e9085)
                ({}.constructor.defineProperty(
                  window,
                  'performance',
                  $___stub_3f6dd83f80cfe235.performance
                ));
              return function () {
                var n = t.once,
                  a = void 0 !== n && n;
              ...
              if ($___old_04ef7cb9e68e9085)
                ({}.constructor.defineProperty(window, 'performance', $___old_04ef7cb9e68e9085));
            }
          }
          Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = a);
          var i = n(563);
        ...
        function (e, t) {
          'use strict';
          function n () {
            const $___old_1d16cbf21592114e = {}.constructor.getOwnPropertyDescriptor(
              window,
              'performance'
            );
            try {
              if ($___old_1d16cbf21592114e)
                ({}.constructor.defineProperty(
                  window,
                  'performance',
                  $___stub_3f6dd83f80cfe235.performance
              ...
              if ($___old_1d16cbf21592114e)
                ({}.constructor.defineProperty(window, 'performance', $___old_1d16cbf21592114e));
            }
          }
          function a () {
            const $___old_09fe0306e45abf2e = {}.constructor.getOwnPropertyDescriptor(
              window,
              'performance'
            );
            try {
              if ($___old_09fe0306e45abf2e)
                ({}.constructor.defineProperty(
                  window,
                  'performance',
                  $___stub_3f6dd83f80cfe235.performance
              ...
              if ($___old_09fe0306e45abf2e)
                ({}.constructor.defineProperty(window, 'performance', $___old_09fe0306e45abf2e));
            }
          }
          Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.basicSupport = n),
            ...
            (t = t || ''),
              ...
              a.addEventListener('load', function (e) {
                ...
                t &&
                  t.id === o.id &&
                  o.loading &&
                  ((o.loading = !1), (o.ready = !0), r.fire(e.type, t, { resource: t }));
              });
          }
        ...
        function (e, t, n) {
          ...
          e.exports = function () {
            ...
            t.decorate(t).decorate(e),
              (this.resources =
                arguments.length && arguments[0] instanceof Array ? arguments[0] : r(arguments)),
          ...
          function n (e, t, n) {
            ...
            if (
              ...
              e &&
                ((i = e.substr(0, n)),
                i !== e &&
                  ((r = i.lastIndexOf('%')) >= i.length - 4 && (i = i.substr(0, r)), i !== e)))
            ) {
        ...
        function (e, t, n) {
          ...
          function c () {
            var e,
              ...
              n = [];
            for (e in w)
              w.hasOwnProperty(e) && w[e] / 2 >= 1 && ((t[e] = parseInt(w[e] / 2)), n.push(e));
            (w = t), (y = n);
          }
          function l (e) {
        ...
        function (e, t) {
          ...
          e.exports = function (e, t) {
            ...
            if (
              ((t = t || {}),
              (t.cacheDuration = void 0 !== t.cacheDuration ? t.cacheDuration : 3000),
              !e)
            )
              return !1;
            if (e.scrollCheckID) {
        ...
        function (e, t) {
          e.exports = function (e, t) {
            var n, a, i, o, r, s, d, u;
            for (
              n = 3 & e.length, a = e.length - n, i = t, r = 3432918353, s = 461845907, u = 0;
              u < a;
          ...
          e.exports = function (e) {
            if (!o) {
              ...
              i.addthis_config
                ...
                addthis_share.title ||
                  (addthis_share.title = (i.addthis_title || t.title || document.title)
                    .split('#{')
                    .shift()),
        ...
        function (e, t, n) {
          function a (e, t, n, a) {
            ...
            (this.locations = function (e) {
              ...
              (this.add = function (e) {
                for (
                  var t = this.locations(e + ''), n = -1, a = this.k, i = this.buckets;
                  ++n < a;
              ...
              (this.test = function (e) {
                for (
                  var t, n = this.locations(e + ''), a = -1, i = this.k, o = this.buckets;
                  ++a < i;
          ...
          function a (e, t) {
            void 0 === e ||
              ...
              (t.minDurationVisible =
                void 0 !== t.minDurationVisible ? t.minDurationVisible : 1000),
              (t.sampleRate = void 0 !== t.sampleRate ? t.sampleRate : 1),
              (t.onView = void 0 !== t.onView ? t.onView : function () {}),
              (this.element = e),
              (this.sampleTimeout = 1000 / t.sampleRate),
          ...
          (e.exports = a),
            ...
            (a.resizeHandler = function () {
              clearTimeout(a.resizeHandlerTimeout),
                (a.resizeHandlerTimeout = setTimeout(a.handler, 1000));
            }),
            ...
            j = function () {
              if (!window.addthis.firedExitEvent && !(0, O.isBlacklisted)()) {
                ...
                I.forEach(function (e) {
                  ...
                  (0, u.default)(
                    'https://m.addthis.com/live/red_lojson/100eng.json?' + (0, s.default)(S),
                    ''
                  );
              }
            },
        ...
        function (e, t, n) {
          ...
          function f () {
            const $___old_a119745f8d1818ec = {}.constructor.getOwnPropertyDescriptor(
              window,
              'performance'
            );
            try {
              if ($___old_a119745f8d1818ec)
                ({}.constructor.defineProperty(
                  window,
                  'performance',
                  $___stub_3f6dd83f80cfe235.performance
              ...
              if ($___old_a119745f8d1818ec)
                ({}.constructor.defineProperty(window, 'performance', $___old_a119745f8d1818ec));
            }
          }
          function p () {
            return (0, b.basicSupport)()
        ...
        function (e, t, n) {
          ...
          var o = n(563),
            ...
            s = {
              ...
              cast: function () {
                return (
                  i(window.cast) && i(window.cast.framework) && i(window.cast.framework.VERSION)
                );
              },
              redux: function () {
            ...
            d = {
              ...
              hammer: function () {
                var e = void 0;
                return (
                  i(window.Hammer) && i(window.Hammer.VERSION) && (e = window.Hammer.VERSION), e
                );
              },
              three: function () {
                var e = void 0;
                return (
                  i(window.THREE) && i(window.THREE.REVISION) && (e = window.THREE.REVISION), e
                );
              },
              prototype: function () {
                    ...
                    _ate.ed.fire('addthis.lojson.response', null, {
                      ...
                      _ate.ed.after('addthis-internal.frame.ready', function () {
                        l.default
                          .getPostMan()
                          .post(
                            JSON.stringify({ remoteEvent: 'addthis.lojson.response', data: e })
                          ),
                          r || o(),
                          s();
                      });
